var gl = c.getContext("webgl") || c.getContext("experimental-webgl"),
  ...
  shader_varying =
    "precision highp float;" + "varying vec3 vl;" + "varying vec2 vuv;",
  ...
  vertex_shader =
    ...
    "];" +
    shader_const_mat4 +
    "v=mat4(1,0,0,0,0,.707,.707,0,0,-.707,.707,0,0,-22.627,-22.627,1);" + // view
    shader_const_mat4 +
    "r=mat4(.977,0,0,0,0,1.303,0,0,0,0,-1,-1,0,0,-2,0);" + // projection
    "void main(void){" +
