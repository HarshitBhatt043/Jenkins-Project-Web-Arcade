...
!(function (a) {
  ...
  var d = (function (a) {
    function b(b, c) {
      ...
      return (
        (d.onContentPaused = new Phaser.Signal()),
        ...
        (d.provider = null),
        (d.wasMuted = !1),
        Object.defineProperty(b, "ads", { value: d }),
        d
      );
    }
    return (
      __extends(b, a),
      (b.prototype.setAdProvider = function (a) {
      ...
      (b.prototype.showAd = function () {
        ...
        a[0] !== c.banner &&
          ((this.wasMuted = this.game.sound.mute), (this.game.sound.mute = !0)),
          this.provider.showAd.apply(this.provider, a);
      }),
      ...
      return (
        ...
        (b.prototype.showAd = function (b) {
          ...
          if (b === a.AdType.banner) {
            if (!this.bannerShowable || null === this.banner)
              return void this.adManager.unMuteAfterAd();
            this.adManager.onBannerShown.dispatch(
              this.banner.width,
              this.banner.height
            ),
          ...
          if (b === a.AdType.rewarded) {
            if (!this.rewardedShowable || null === this.rewarded)
              return (
                this.adManager.unMuteAfterAd(),
                void this.adManager.onContentResumed.dispatch(a.AdType.rewarded)
              );
            this.rewarded.show();
          }
        }),
        (b.prototype.preloadAd = function (b, c, d) {
          ...
          this.adsEnabled &&
            (this.destroyAd(b),
            b === a.AdType.banner &&
              ((this.banner = this.cocoonProvider.createBanner(c)),
            ...
            b === a.AdType.interstitial &&
              ((this.interstitial = this.cocoonProvider.createInterstitial(c)),
              ...
              this.interstitial.on("dismiss", function () {
                e.adManager.unMuteAfterAd(),
                  e.adManager.onContentResumed.dispatch(a.AdType.interstitial),
                  (e.interstitialShowable = !1),
                  (e.interstitial = null);
              }),
              this.interstitial.load()),
            b === a.AdType.rewarded &&
              ((this.rewarded = this.cocoonProvider.createRewardedVideo(c)),
              ...
              this.rewarded.on("dismiss", function () {
                e.adManager.unMuteAfterAd(),
                  e.adManager.onContentResumed.dispatch(a.AdType.rewarded),
                  (e.rewardedShowable = !1),
                  (e.rewarded = null);
              }),
              this.rewarded.on("reward", function () {
                e.adManager.unMuteAfterAd(),
                  e.adManager.onAdRewardGranted.dispatch(a.AdType.rewarded),
                  (e.rewardedShowable = !1),
                  (e.rewarded = null);
              }),
              this.rewarded.load()));
        ...
        (b.prototype.hideAd = function (b) {
          this.adsEnabled &&
            ...
            b === a.AdType.banner &&
              null !== this.banner &&
              (this.adManager.bannerActive &&
                ((this.adManager.bannerActive = !1),
                this.adManager.onBannerHidden.dispatch(
                  this.banner.width,
                  this.banner.height
                )),
              this.banner.hide()),
...
!(function (a) {
  ...
  !(function (a) {
    var b = (function () {
      function a(a, b, c, d) {
        void 0 === d && (d = !1),
          ...
          void 0 === cordova.plugins ||
            ...
            (d && cordova.plugins.gdApi.enableTestAds(),
            this.setAdListeners(),
      ...
      return (
        (a.prototype.setAdListeners = function () {
          var a = this;
          ...
          switch (
            ...
            case b.Interstitial:
              HeyzapAds.InterstitialAd.addEventListener(
                ...
                HeyzapAds.InterstitialAd.addEventListener(
                  ...
                  function () {
                    d.adManager.onAdClicked.dispatch(
                      HeyzapAds.InterstitialAd.Events.CLICKED
                    );
                  }
                ),
            ...
            case b.Video:
              HeyzapAds.VideoAd.addEventListener(
                ...
                HeyzapAds.VideoAd.addEventListener(
                  HeyzapAds.VideoAd.Events.CLICKED,
                  function () {
                    d.adManager.onAdClicked.dispatch(
                      HeyzapAds.VideoAd.Events.CLICKED
                    );
    ...
    var c = (function () {
        ...
        (this.adsEnabled = !0),
          ...
          (GD_OPTIONS = {
            ...
            onEvent: function (a) {
              switch (a.name) {
                case "SDK_GAME_START":
                  "undefined" != typeof gdApi && gdApi.play(),
                    d.adManager.unMuteAfterAd(),
                    d.adManager.onContentResumed.dispatch();
                  break;
                case "SDK_GAME_PAUSE":
          ...
          (function (a, b, c) {
            ...
            a.getElementById(c) ||
              ((d = a.createElement(b)),
              (d.id = c),
              (d.src = "//htmi.api.gamedistribution.com/main.min.js"),
      ...
      return (
        ...
        (a.prototype.showAd = function () {
          if (this.adsEnabled) {
            if (
              "undefined" == typeof gdApi ||
              (gdApi && "undefined" == typeof gdApi.showBanner)
            )
              return (
                (this.adsEnabled = !1),
                this.adManager.unMuteAfterAd(),
        ...
        (a.prototype.areAdsEnabled = function () {
          ...
          var c = function () {
            var a = !0;
            return (
              0 === b.offsetHeight && (a = !1), b.parentNode.removeChild(b), a
            );
          };
    ...
    var c = (function () {
          ...
          "undefined" != typeof google &&
            ...
            (this.gameContent =
              "string" == typeof a.parent
                ? document.getElementById(a.parent)
                : a.parent),
            (this.gameContent.style.position = "absolute"),
            (this.gameContent.style.width = "100%"),
            (this.adContent = this.gameContent.parentNode.appendChild(
            ...
            (this.adTagUrl = b),
            (this.game = a),
            (this.adDisplay = new google.ima.AdDisplayContainer(
              this.adContent
            )),
      ...
      return (
        ...
        (b.prototype.showAd = function (a) {
          if (!this.adRequested) {
            if (
              (this.adsEnabled || this.adManager.onAdsDisabled.dispatch(!0),
              !this.googleEnabled)
            )
              return void this.onContentResumeRequested();
            this.adDisplay.initialize();
            var b = new google.ima.AdsRequest();
            b.adTagUrl = this.adTagUrl + this.parseCustomParams(a);
            var c = window.innerWidth,
              d = window.innerHeight;
            this.game.scale.isFullScreen &&
