  ...
  if (!Math.fround && n && "asmUrl" == n.id) {
    ...
    for (
      ...
      if (
        ...
        u ||
        61 != e[s] ||
        String.fromCharCode.apply(null, e.subarray(s + 1, s + 1 + r.length)) !==
          r
      ) {
        if (u && 40 == e[s]) {
        ...
        function (e, t, n) {
          ...
          function u(e) {
            if (ge) {
              ...
              for (
                y(S, e.lens, 0, 288, p, 0, e.work, { bits: 9 }), t = 0;
                32 > t;
          ...
          function m(e, t) {
            ...
            return e && e.state
              ? ((n = e.state),
                0 === (2 & n.wrap) ? L : ((n.head = t), (t.done = !1), D))
              : L;
          }
          var p,
            b,
