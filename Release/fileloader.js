...
(function () {
  var loadPackage = function (metadata) {
    ...
    function runWithFS() {
      ...
      new DataRequest(6340412, 6340431, 0, 0).open(
        "GET",
        "/methods_pointedto_by_uievents.xml"
      );
      new DataRequest(6340431, 12198315, 0, 0).open("GET", "/resources.assets");
      new DataRequest(12198315, 21454051, 0, 0).open(
        "GET",
        "/sharedassets0.assets"
      );
      new DataRequest(21454051, 22731287, 0, 0).open(
        "GET",
        "/sharedassets0.resource"
      );
      new DataRequest(22731287, 22781167, 0, 0).open(
        "GET",
        "/sharedassets1.assets"
      );
      new DataRequest(22781167, 48157651, 0, 0).open(
        "GET",
        "/sharedassets2.assets"
      );
      new DataRequest(48157651, 50284064, 0, 0).open(
        "GET",
        "/sharedassets2.resource"
      );
      new DataRequest(50284064, 57279072, 0, 0).open(
        "GET",
        "/sharedassets3.assets"
      );
      new DataRequest(57279072, 62086724, 0, 0).open(
        "GET",
        "/sharedassets4.assets"
      );
      new DataRequest(62086724, 66094592, 0, 0).open(
        "GET",
        "/sharedassets5.assets"
      );
      new DataRequest(66094592, 68210332, 0, 0).open(
        "GET",
        "/Il2CppData/Metadata/global-metadata.dat"
      );
      new DataRequest(68210332, 70097756, 0, 0).open(
        "GET",
        "/Resources/unity_default_resources"
      );
      new DataRequest(70097756, 70308416, 0, 0).open(
        "GET",
