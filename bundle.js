!(function (e) {
  ...
  function (e, t, r) {
    ...
    function n(e) {
      e in d.a ||
        (Object(v.d)("warn", "There is no level " + e + "."), (e = 0)),
        p.a.dispatch({ type: h.a, levelNumber: e });
    }
    function o(e, t) {
      var r = p.a.getState(),
        n = r.playerPosition;
    ...
    function i(e, t) {
      ...
      if (Object(m.a)(r, e, t)) {
        1 !== Object(m.b)(r, e, t) ||
          (p.a.dispatch({ type: h.c, row: e, column: t }),
          Object(v.e)(b.b),
          c());
      }
    }
    ...
    function f() {
      var e = p.a.getState(),
        t = e.moveCount;
      Object(v.d)("info", "Completed in " + t + " moves."),
        p.a.dispatch({ type: h.d }),
        Object(v.e)(b.c),
        s();
    }
  ...
  function (e, t, r) {
    ...
    var o = [
      ...
      },
      {
        maxMoves: 12,
        playerPosition: { row: 0, column: 2 },
        tiles: n(["_0__", "x_x_", "0_00", "0000"]),
      },
      {
        maxMoves: 13,
        playerPosition: { row: 3, column: 3 },
        tiles: n(["__x0", "x___", "0_x0", "_x00"]),
      },
      {
        maxMoves: 10,
        playerPosition: { row: 2, column: 1 },
        tiles: n(["_x00", "0_0_", "x_0_", "_0__"]),
      },
      {
        maxMoves: 11,
        playerPosition: { row: 2, column: 3 },
        tiles: n(["x00x", "_000", "x_0x", "0_xx"]),
      },
      {
        maxMoves: 12,
        playerPosition: { row: 3, column: 0 },
        tiles: n(["000_", "0x_0", "00_0", "_x__"]),
      },
      {
        maxMoves: 9,
        playerPosition: { row: 1, column: 2 },
        tiles: n(["__0_", "x000", "_00_", "_0__"]),
      },
      {
        maxMoves: 17,
        playerPosition: { row: 0, column: 1 },
        tiles: n(["00__", "x_x_", "x_x0", "x0x0"]),
      },
      {
        maxMoves: 20,
        playerPosition: { row: 2, column: 1 },
        tiles: n(["00x0", "x000", "00x0", "00x0"]),
      },
      {
        maxMoves: 13,
        playerPosition: { row: 2, column: 1 },
        tiles: n(["_x00", "00_0", "_x0x", "000_"]),
      },
      {
        maxMoves: 12,
        playerPosition: { row: 2, column: 2 },
        tiles: n(["0_00", "_0_0", "____", "0___"]),
      },
      {
        maxMoves: 17,
        playerPosition: { row: 3, column: 4 },
        tiles: n(["__0__", "_xx_x", "0_0_0", "x0xxx", "_0000"]),
      },
      {
        maxMoves: 21,
        playerPosition: { row: 2, column: 3 },
        tiles: n(["00000", "x_0_0", "0_0_0", "0_x_0", "00000"]),
      },
      {
        maxMoves: 27,
        playerPosition: { row: 2, column: 0 },
        tiles: n(["x0000", "00x00", "x0_00", "0__00", "00000"]),
      },
      {
        maxMoves: 27,
        playerPosition: { row: 2, column: 1 },
        tiles: n(["00000", "x0x00", "x000_", "00x00", "_0000"]),
      },
      {
        maxMoves: 21,
        playerPosition: { row: 4, column: 2 },
        tiles: n(["___00", "0x0x0", "_x_x0", "_x0x0", "0__00"]),
      },
      {
        maxMoves: 20,
        playerPosition: { row: 2, column: 2 },
        tiles: n(["00_00", "0_0_0", "000__", "___00", "x__00"]),
      },
      {
        maxMoves: 24,
        playerPosition: { row: 2, column: 2 },
        tiles: n(["00_00", "0x_x0", "__000", "0x_x_", "0_0__"]),
      },
      {
        maxMoves: 23,
        playerPosition: { row: 1, column: 3 },
        tiles: n(["00x00", "00_x0", "0x_0_", "000_0", "x____"]),
      },
      {
        maxMoves: 17,
        playerPosition: { row: 3, column: 3 },
        tiles: n(["00_xx", "0___x", "____0", "_00x0", "_00_x"]),
      },
      {
        maxMoves: 23,
        playerPosition: { row: 2, column: 3 },
        tiles: n(["___00", "0000_", "0x0x_", "00x__", "_00_0"]),
      },
    ];
    t.a = o;
  },
  ...
  function (e, t, r) {
    ...
    (n.NONE = 0),
      ...
      (n.THUNK = 8),
      (e.exports = n),
      (n.prototype.version = o),
      (n.prototype.type = "VirtualPatch");
  },
  function (e, t, r) {
    function n(e, t) {
      var r = e,
    ...
    function o(e, t) {
      var r = e.vnode;
      if ((r || (r = e.vnode = e.render(t)), !(i(r) || a(r) || c(r))))
  ...
  function (e, t, r) {
    function n(e, t) {
      ...
      var f =
          null === e.namespace
            ? r.createElement(e.tagName)
            : r.createElementNS(e.namespace, e.tagName),
        d = e.properties;
      i(f, d);
    ...
    function n(e, t, r) {
      for (var n in t) {
        ...
        void 0 === a
          ? o(e, n, a, r)
          : s(a)
          ? (o(e, n, a, r), a.hook && a.hook(e, n, r ? r[n] : void 0))
          : c(a)
          ? i(e, t, r, n, a)
          : (e[n] = a);
      }
      ...
      for (var y = 0; y < d; y++) {
        ...
        i(x)
          ? ((p += x.count || 0),
            !m && x.hasWidgets && (m = !0),
            !v && x.hasThunks && (v = !0),
            h || (!x.hooks && !x.descendantHooks) || (h = !0))
          : !m && a(x)
  ...
  function (e, t, r) {
    ...
    function n(e, t, r) {
      ...
      return (
        l({ type: c.INIT }),
        (p = { dispatch: l, subscribe: u, getState: s, replaceReducer: f }),
        (p[a.a] = d),
        p
      );
    }
  ...
  function (e, t, r) {
    ...
    function p(e, t, r) {
      ...
      (t.convertToAbsoluteUrls || i) && (n = x(n)),
        o &&
          (n +=
  ...
  function (e, t, r) {
    ...
    function o(e, t, r, n) {
      if (e !== t) {
        ...
        if (w(e) || w(t)) s(e, t, r, n);
          ...
          x(e) || (a(e, r, n), (o = r[n])), (o = v(o, new b(b.REMOVE, e, t)));
        else if (g(t))
          if (g(e))
            if (
              e.tagName === t.tagName &&
          ...
          y(t)
            ? y(e)
              ? e.text !== t.text && (o = v(o, new b(b.VTEXT, e, t)))
              : ((o = v(o, new b(b.VTEXT, e, t))), (c = !0))
            : x(t) && (x(e) || (c = !0), (o = v(o, new b(b.WIDGET, e, t))));
        o && (r[n] = o), c && a(e, r, n);
      }
    }
    function i(e, t, r, n, i) {
      for (
        ...
        var m = a[p],
          h = s[p];
        (i += 1),
          m ? o(m, h, r, i) : h && (n = v(n, new b(b.INSERT, null, h))),
          g(m) && m.count && (i += m.count);
      }
    ...
    function c(e, t, r) {
      if (x(e))
        "function" == typeof e.destroy &&
          (t[r] = v(t[r], new b(b.REMOVE, e, null)));
    ...
    function l(e, t, r) {
      if (g(e)) {
        if (
          (e.hooks && (t[r] = v(t[r], new b(b.PROPS, e, f(e.hooks)))),
    ...
    function d(e, t) {
      ...
      for (var c = [], s = 0, u = o.length, l = 0, f = 0; f < e.length; f++) {
        var d,
          v = e[f];
        v.key
          ? n.hasOwnProperty(v.key)
            ? ((d = n[v.key]), c.push(t[d]))
            : ((d = f - l++), c.push(null))
          : s < u
          ? ((d = o[s++]), c.push(t[d]))
          : ((d = f - l++), c.push(null));
      ...
      for (var y, x = c.slice(), w = 0, k = [], _ = [], O = 0; O < t.length; ) {
        var E = t[O];
        for (y = x[w]; null === y && x.length; )
          k.push(p(x, w, null)), (y = x[w]);
        y && y.key === E.key
          ? (w++, O++)
          : E.key
          ? (y && y.key && n[y.key] !== O + 1
              ? (k.push(p(x, w, y.key)),
                (y = x[w]),
                y && y.key === E.key ? w++ : _.push({ key: E.key, to: O }))
              : _.push({ key: E.key, to: O }),
            O++)
          : y && y.key && k.push(p(x, w, y.key));
      }
      for (; w < x.length; ) (y = x[w]), k.push(p(x, w, y && y.key));
      return k.length !== l || _.length
        ? { children: c, moves: { removes: k, inserts: _ } }
        : { children: c, moves: null };
    }
    function p(e, t, r) {
  ...
  function (e, t, r) {
    function n(e, t, r) {
      return (
        (r = r || {}),
        (r.patch = r.patch && r.patch !== n ? r.patch : o),
        (r.render = r.render || u),
        r.patch(e, t, r)
      );
    }
  ...
  function (e, t, r) {
    ...
    function l(e, t) {
      for (
        var r, n, o, i = e.childNodes, a = {}, c = 0;
        c < t.removes.length;
        c++
      )
        (n = t.removes[c]),
          ...
          n.key && (a[n.key] = r),
          e.removeChild(r);
      for (var s = i.length, u = 0; u < t.inserts.length; u++)
        (o = t.inserts[u]),
          (r = a[o.key]),
          e.insertBefore(r, o.to >= s++ ? null : i[o.to]);
    }
    function f(e, t) {
      return (
        e && t && e !== t && e.parentNode && e.parentNode.replaceChild(t, e), t
      );
    }
    var d = r(22),
      p = r(1),
  ...
  function (e, t, r) {
    function n(e, t) {
      return (
        !(!o(e) || !o(t)) &&
        ("name" in e && "name" in t ? e.id === t.id : e.init === t.init)
      );
    }
    var o = r(1);
    e.exports = n;
  ...
  function (e, t, r) {
    ...
    function n(e, t, r) {
      ...
      return (
        ...
        a.hasOwnProperty("namespace") &&
          ((u = a.namespace), (a.namespace = void 0)),
        "INPUT" !== n ||
          u ||
    ...
    function o(e, t, r, n) {
      if ("string" == typeof e) t.push(new d(e));
        ...
        if (!l(e)) {
          ...
          throw s({
            foreignObject: e,
            parentVnode: { tagName: r, properties: n },
          });
        }
    ...
    function n(e, t) {
      ...
      for (f = 0; f < n.length; f++)
        (u = n[f]) &&
          ...
          c
            ? "." === l
              ? ((s = s || []), s.push(u.substring(1, u.length)))
              : "#" === l && r && (t.id = u.substring(1, u.length))
            : (c = u));
      return (
        s && (t.className && s.push(t.className), (t.className = s.join(" "))),
      ...
      return function (n, o, i) {
        ...
        for (
          ...
          !(
            ...
            c.length > 1 &&
              c.index < n.length &&
              Array.prototype.push.apply(l, c.slice(1)),
            (u = c[0].length),
            (d = s),
            l.length >= i)
          );
    ...
    function n(e) {
      var t = e.currentDifficulty,
        ...
        n =
          r === u.b
            ? [Object(i.a)(e)]
            : [Object(s.a)(e), Object(a.a)(e), Object(c.a)(e)];
      return Object(o.h)(
        "div#game",
        { className: [t, r].join(" ").toLowerCase().replace("_", "-") },
        n
      );
    }
    t.a = n;
    ...
    function o(e) {
      ...
      return Object(i.h)(
        ...
        Object(i.h)(
          ...
          {
            style: {
              height: r.length * a.c + "rem",
              width: r[0].length * a.c + "rem",
            },
          },
          [Object(s.a)(t)].concat(n(o))
        )
      );
    }
    t.a = o;
  ...
  function (e, t, r) {
    ...
    function n(e) {
      var t = e.column,
        r = e.row;
      return Object(o.h)("div.player", {
        key: "player",
        style: { top: r * i.c + "rem", left: t * i.c + "rem" },
      });
    }
    t.a = n;
    var o = r(0),
  ...
  function (e, t, r) {
    ...
    function n(e) {
      var t = e.currentDifficulty,
        ...
        n = e.maxLevelReached;
      return Object(o.h)("nav", [
        Object(a.a)({ currentDifficulty: t }),
        Object(i.a)({
          currentDifficulty: t,
          currentLevelNumber: r,
          maxLevelReached: n,
        }),
      ]);
    }
  ...
  function (e, t, r) {
    ...
    function n(e) {
      ...
      return Object(o.h)(
        "header",
        { style: { width: t * i.b + "rem" }, title: "Move " + r + " of " + t },
        [Object(o.h)("div.progress", { style: { width: r * i.b + "rem" } })]
      );
    }
    t.a = n;
    var o = r(0),
