...
*/
  ...
  var v = window,
    ...
    y = function (a, b) {
      x.addEventListener
        ? x.addEventListener(a, b, !1)
        : x.attachEvent && x.attachEvent("on" + a, b);
    };
  var z = {},
    A = function () {
      z.TAGGING = z.TAGGING || [];
  ...
  var B = /:[0-9]+$/,
    ...
    F = function (a, b) {
      ...
      "port" === b
        ? (a.port = String(
            Number(a.hostname ? a.port : v.location.port) ||
              ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")
          ))
        : "host" === b &&
          (a.hostname = (a.hostname || v.location.hostname)
            .replace(B, "")
            .toLowerCase());
    ...
    y = function (a, b, c, d, e) {
      if (!ea(Yd.get(b)) && !$d.get(b)) {
        ...
        if (g) {
          ...
          (g && 0 <= g.indexOf("/")) ||
            (g = (ca || bd(!1)) + "/plugins/ua/" + g);
          ca = ae(g);
          ne(ca.protocol) &&
            B(ca) &&
            (Id(ca.url, void 0, e, void 0, c), $d.set(b, !0));
        }
      }
    },
    v = function (a, b) {
