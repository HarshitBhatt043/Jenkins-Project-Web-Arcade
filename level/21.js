      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(
              c,
              "Looks like the zombies are giving up on attacking your front yard.(Click to continue)"
            );
            break;
          case 1:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "Now they want to try your backyard.(Click to continue)"
            );
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "But most importantly you can't use your mushrooms!(Click to continue)"
            );
            break;
          case 3:
            ...
            innerText(
              c,
              "Because they sleep during the day!(Click to continue)"
            );
            break;
          case 4:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(c, "Isn't this the style of playboy?(Click to continue)");
            break;
          case 5:
