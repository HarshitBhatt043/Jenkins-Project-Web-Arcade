      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(c, "咳咳，我们已经到达这座塔的顶峰了(Click to continue)");
            break;
          case 1:
            ...
            innerText(c, "你最好边打边默念：我不会输(Click to continue)");
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(c, "尽管这是徒劳的祈祷(Click to continue)");
            break;
          case 3:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(c, "当然，我还是祝你好运(Click to continue)");
            break;
          case 4:
