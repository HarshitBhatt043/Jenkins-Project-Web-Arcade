oS.Init(
  {
    ...
    LargeWaveFlag: { 4: $("imgFlag3"), 8: $("imgFlag2"), 12: $("imgFlag1") },
      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(c, "伙计，离一百层越来越近了！(Click to continue)");
            break;
          case 1:
            ...
            innerText(c, "难度上升也越来越快了(Click to continue)");
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(c, "至少现在雾已经退去了，加油吧！(Click to continue)");
            break;
          case 3:
