      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(
              c,
              "Dude, have you ever imagined you being alone in a cemetery one night?(Click to continue)"
            );
            break;
          case 1:
            ...
            innerText(
              c,
              "Of course, there have to be zombies in the cemetery.(Click to continue)"
            );
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "Don't relax too much, zombies will pop out of tombstones at any time! .(Click to continue)"
            );
            break;
          case 3:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "Hmm, we might need some quick plants!(Click to continue)"
            );
            break;
          case 4:
