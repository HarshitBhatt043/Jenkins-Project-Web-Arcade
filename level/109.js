      ...
      (function (d) {
        ...
        switch (d) {
          ...
          case 1:
            ...
            c.innerHTML =
              '<span style="font-size:22px">But there is no ice here, only oil!(Click to continue)</span>';
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">And its not me, itI enjoyed skating when I was a kid, the feeling of moving fast on the ices the zombies!(Click to continue)</span>';
            break;
          case 3:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
          ...
          case 4:
            ...
            c.innerHTML =
              '<span style="font-size:22px">And a little secret, wood cant stand fire!(Click to continue)</span>';
            break;
          case 5:
