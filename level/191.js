oS.Init(
  {
    ...
    LargeWaveFlag: { 5: $("imgFlag3"), 10: $("imgFlag2"), 15: $("imgFlag1") },
      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(c, "伙计，欢迎来到常青之塔41层。(Click to continue)");
            break;
          case 1:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(c, "这里是常青之塔的一个重要分水岭。(Click to continue)");
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
          ...
          case 3:
            ...
            innerText(c, "祝你好运！(Click to continue)");
            break;
          case 4:
