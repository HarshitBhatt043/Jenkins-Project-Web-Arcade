      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(
              c,
              "Good evening," + $User.Visitor.UserName + "。(Click to continue)"
            );
            break;
          case 1:
            ...
            innerText(
              c,
              "Clicking on those zombies won't weaken the offensive, will it?(Click to continue)"
            );
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "You'll notice that fighting zombies at night is different from daytime.(Click to continue)"
            );
            break;
          case 3:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "First, you can't get sunlight from the sky.(Click to continue)"
            );
            break;
          case 4:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "But you can still get sunlight through sunflowers.(Click to continue)"
            );
            break;
          case 5:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "And you're lucky, you got little squirt mushrooms.(Click to continue)"
            );
            break;
          case 6:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "Plant as many of these mushrooms as you can and you'll get through.(Click to continue)"
            );
            break;
          case 7:
