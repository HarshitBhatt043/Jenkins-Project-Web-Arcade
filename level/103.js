      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            c.innerHTML =
              '<span style="font-size:22px">The situation seems very bad.(Click to continue)</span>';
            break;
          case 1:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">The ancient zombies actually invited reinforcements(Click to continue)</span>';
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">Well, you must have guessed who they were(Click to continue)</span>';
            break;
          case 3:
