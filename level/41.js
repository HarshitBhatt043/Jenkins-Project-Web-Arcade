      ...
      (function (d) {
        ...
        switch (d) {
          ...
          case 1:
            ...
            innerText(c, "A small town in Xincheng.(Click to continue)");
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(
              c,
              "Look at the beautiful bridges and the food there(Click to continue)"
            );
            break;
          case 3:
            ...
            innerText(
              c,
              "However, the author zombie also seems to be stationed here with troops(Click to continue)"
            );
            break;
          case 4:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "Good luck~ I went to eat Li Minsheng fried buns(Click to continue)"
            );
            break;
          case 5:
