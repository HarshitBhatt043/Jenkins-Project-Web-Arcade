      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(c, "Greetings, neighbor!");
            break;
          case 1:
            ...
            innerText(
              c,
              "The name's Crazy Dave. But you can just call me Dave."
            );
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(c, "Listen, there's a bunch of zombies coming to town!");
            break;
          case 3:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(
              c,
              "You have to defeat them with \nthose plants in my garden."
            );
            break;
          case 4:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(c, "Good luck! COMMENCE");
            break;
          case 5:
