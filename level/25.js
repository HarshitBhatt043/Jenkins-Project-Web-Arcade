      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(
              c,
              "Have you ever thought that zombies can also practice a pair of fast feet?(Click to continue)"
            );
            break;
          case 1:
            ...
            innerText(c, "What a terrible thing that is!(Click to continue)");
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(c, "Protect our house(Click to continue)");
            break;
          case 3:
