      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            c.innerHTML =
              '<span style="font-size:22px">We are getting closer and closer to King Qins lair, arent we?(Click to continue)</span>';
            break;
          case 1:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">We have encountered the level of the stone ground in the middle before.,(Click to continue)</span>';
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">CanWhat kind of crooked way is this!t even grow on it!(Click to continue)</span>';
            break;
          case 3:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">What kind of crooked way is this!(Click to continue)</span>';
            break;
          case 4:
