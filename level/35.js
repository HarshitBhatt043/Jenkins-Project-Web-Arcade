      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(
              c,
              "I still remember the fun of playing petanque with Peter as a kid(Click to continue)"
            );
            break;
          case 1:
            ...
            innerText(
              c,
              "Now Peter's not in this damn place, come and play with me~(Click to continue)"
            );
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "However, this time we are not rolling balls, but starfish! .(Click to continue)"
            );
            break;
          case 3:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "I believe this is a very fun thing to do!(Click to continue)"
            );
            break;
          case 4:
