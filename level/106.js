      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            c.innerHTML =
              '<span style="font-size:22px">Good evening, neighbors.(Click to continue)</span>';
            break;
          case 1:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
          ...
          case 2:
            ...
            c.innerHTML =
              '<span style="font-size:22px">But it seems, there is a cemetery full of zombies behind the village(Click to continue)</span>';
            break;
          case 3:
            ...
            c.innerHTML =
              '<span style="font-size:22px">Unfortunately, the road in front of the village is a stone road.(Click to continue)</span>';
            break;
          case 4:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">Worse yet, its already late at night.(Click to continue)</span>';
            break;
          case 4:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">This fucking place is crazier than me!(Click to continue)</span>';
            break;
          case 5:
