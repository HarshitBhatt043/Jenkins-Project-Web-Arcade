      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            c.innerHTML =
              '<span style="font-size:12px">Dude, have you heard of assassins?(Click to continue)</span>';
            break;
          case 1:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">I hate those killers who come and go!(Click to continue)</span>';
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">Good luck.(Click to continue)</span>';
            break;
          case 3:
