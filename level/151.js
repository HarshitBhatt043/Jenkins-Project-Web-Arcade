      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(c, "欢迎来到常青之塔(Click to continue)");
            break;
          case 1:
            ...
            innerText(
              c,
              "这里可是危机四伏,你必须一层一层的挑战(Click to continue)"
            );
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(c, "难度也会随着层数上涨！(Click to continue)");
            break;
          case 3:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(c, "祝你挑战愉快，别丢掉脑子哈！(Click to continue)");
            break;
          case 4:
