      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(
              c,
              "Judging from the battles of the days, this town is full of dangers. . .(Click to continue)"
            );
            break;
          case 1:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "Finally. Now the real challenge arises(Click to continue)"
            );
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            ...
            innerText(
              c,
              "Author Zombies, here we come! Be careful, he will split into a lot of replicas!(Click to continue)"
            );
            break;
          case 3:
            ...
            innerText(
              c,
              "Run away after hitting him, I don't want to stay in this ghost place!(Click to continue)"
            );
            break;
          case 4:
