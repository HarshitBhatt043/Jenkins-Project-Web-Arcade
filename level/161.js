      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(c, "僵尸越来越多了。(Click to continue)");
            break;
          case 1:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(c, "不过你很幸运。(Click to continue)");
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(c, "你获得了激光蚕豆！(Click to continue)");
            break;
          case 3:
            ...
            innerText(c, "任何僵尸都躲不过他的天眼~(Click to continue)");
            break;
          case 4:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
