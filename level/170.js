      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            innerText(c, "天哪,不知不觉已经到20层了。(Click to continue)");
            break;
          case 1:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(c, "难度你也是知道的。(Click to continue)");
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            innerText(c, "只是,这次你可能没有那么顺利(Click to continue)");
            break;
          case 3:
            ...
            innerText(c, "祝你好运，不要被僵尸吃了！(Click to continue)");
            break;
          case 4:
