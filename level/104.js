      ...
      (function (d) {
        ...
        switch (d) {
          case 0:
            ...
            c.innerHTML =
              '<span style="font-size:22px">Welcome to the second stop of our trip to China, neighbors.(Click to continue)</span>';
            break;
          case 1:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">请你放心(Click to continue)</span>';
            break;
          case 2:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
          ...
          case 3:
            ...
            c.innerHTML =
              '<span style="font-size:22px">Listen up, here, fight the zombies.(Click to continue)</span>';
            break;
          case 4:
            PlayAudio("crazydavelong" + Math.floor(1 + Math.random() * 3));
            c.onclick = null;
            ...
            c.innerHTML =
              '<span style="font-size:22px">Remember to bring lotus leaves and flower pots at the same time. Good luck!(Click to continue)</span>';
            break;
          case 5:
