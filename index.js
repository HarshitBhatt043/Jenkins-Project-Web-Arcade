  ...
  RuntimeEnvironment: function (Module, exposedLibs) {
    ...
    var ASM_CONSTS = [
      ...
      function ($0) {
        ...
        try {
          _audioDriver_scriptNode =
            _audioDriver_audioContext.createScriptProcessor(0, 2, channelCount);
        } catch (e) {
          _audioDriver_scriptNode =
            _audioDriver_audioContext.createScriptProcessor(
              4096,
              2,
              channelCount
            );
      ...
      function () {
        function gotMediaInput(stream) {
          ...
          _audioDriver_audioInput =
            _audioDriver_audioContext.createMediaStreamSource(stream);
