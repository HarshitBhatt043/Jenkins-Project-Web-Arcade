!(function (t) {
              ...
              function d(n, e, i, r, d) {
                if (o)
                  ...
                  (A.func = s.computeStackTrace.guessFunctionName(
                    ...
                    a(
                      { name: l, message: m, mode: "onerror", stack: [A] },
                      !0,
                      null
                    );
                }
  ...
  function (t, n, e) {
    ...
    t.exports = function (t, n, e, u, m, w, y) {
      ...
      if (
        ...
        else i({ target: n, proto: !0, forced: f || x }, v);
      return v;
    };
  },
  function (t, n, e) {
  ...
  function (t, n, e) {
    ...
    t.exports = function (t, n, e) {
      var c = n + " Iterator";
      return (
        (t.prototype = r(i, { next: o(1, e) })), a(t, c, !1, !0), (s[c] = d), t
      );
    };
  },
  function (t, n, e) {
  ...
  function (t, n, e) {
    ...
    var s = e(11),
      ...
      c = {
        ...
        tracking: {
          ...
          ads: {
            ...
            video: { clicked: "pokiTrackingAdsVideoClicked" },
          },
        },
      },
      u = function () {
      ...
      g = (function () {
        ...
        return (
          ...
          (t.track = function (t, n) {
            ...
            m.sendMessage(c.message.event, { event: t, data: n });
          }),
      ...
      C = x(
        [
          {
            bidder: "appnexus",
            params: E(E({ placementId: 13184250 }, z), {
              video: E(E({}, z.video), { skippable: !0 }),
            }),
          },
          {
            bidder: "appnexus",
            params: E(E({ placementId: 13184309 }, z), {
              video: E(E({}, z.video), { skippable: !1, maxduration: 15 }),
            }),
          },
          {
            bidder: "openx",
          ...
          {
            bidder: "districtm",
            params: E(E({ placementId: 12906789 }, z), {
              video: E(E({}, z.video), { skippable: !1, maxduration: 15 }),
            }),
          },
          {
          ...
          { bidder: "emx_digital", params: { tagid: "100598" } },
        ],
          ...
          (t.prototype.moveThroughWaterfall = function () {
            if (!1 !== this.running) {
              ...
              (this.running = !1),
                ...
                l.dispatchEvent(c.ads.error, { message: "No ads" });
            }
          }),
      ...
      K = (function () {
        ...
        return (
          ...
          (t.prototype.onAdEvent = function (t) {
            ...
            switch (t.type) {
              ...
              case google.ima.AdEvent.Type.COMPLETE:
                l.dispatchEvent(c.ads.completed, { rewardAllowed: !0 }),
                  this.tearDown();
                break;
          ...
          (t.prototype.onAdError = function (t) {
            ...
            l.dispatchEvent(c.ads.video.error, { message: n });
          }),
    ...
    var rt = e(67),
      ...
      ut = {},
      lt = { gameId: S("game_id"), versionId: S("game_version_id") },
      At = function (t) {
        return (
          "poki-display-" +
          t[0] +
                ...
                .then(function (e) {
                  if (void 0 !== e) {
                    ...
                    n.debug && (o.adTiming.startAdsAfter = 0),
                      ...
                      (n.googletag = window.googletag || { cmd: [] }),
                      (n.isInitialized = !0),
            ...
            l.addEventListener(c.ready, function () {
              ...
              l.addEventListener(c.ads.started, function () {
                t.playerSkin.hideSpinner(),
                  t.callHandler("onStart", { type: c.ads.limit });
              }),
          ...
          (t.prototype.genericCriteria = function () {
            ...
            return (
              ...
              n.includes("-exp-minimize-ads-c.")
                ...
                ? (t.exp_min_video = 3)
                : n.includes("-exp-minimize-ads-3.") && (t.exp_min_video = 4),
    ...
    function xt(t) {
      return function (n, e) {
        ...
        var o = i[0];
        return (
          vt(o) && (i[0] = Et(o)), t.apply ? t.apply(this, i) : t(i[0], i[1])
        );
      };
    }
    ...
    var Tt = function () {
      ...
      zt = (function () {
        function t() {
          ...
          (this.gameStarted = !1),
              ...
              return (
                ...
                new Promise(function (e, i) {
                  n &&
                    ...
                    t.SDK.init(Tt({ onReady: e, onAdblocked: i }, n)),
                    m.sendMessage(c.message.sdkDetails, { version: "2.102.0" });
                })
              );
            }),
            ...
            (this.roundStart = function (t) {
              void 0 === t && (t = ""),
                (t = String(t)),
                g.track(c.tracking.screen.roundStart, { identifier: t });
            }),
            (this.roundEnd = function (t) {
              void 0 === t && (t = ""),
                (t = String(t)),
                g.track(c.tracking.screen.roundEnd, { identifier: t });
            }),
            ...
            (this.happyTime = function (n) {
              void 0 === n && (n = 1),
                ...
                g.track(c.tracking.screen.happyTime, { intensity: n });
            }),
            (this.muteAd = function () {
              t.SDK.muteAd();
            }),
            (this.setPlayerAge = function (n) {
              g.track(c.tracking.setPlayerAge, { age: n }),
            ...
            (this.logError = function (t) {
              ft(t)
                ? s.report(t)
                : kt({ name: "logError", message: JSON.stringify(t) });
            }),
            (this.sendHighscore = function (t) {
              g.track(c.tracking.screen.sendHighscore, { score: t });
            }),
        ...
        return (
          ...
          (t.prototype.displayAd = function (t, n) {
            g.track(c.tracking.screen.displayAd, { size: n }),
