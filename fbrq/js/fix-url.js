...
function fbrqFixUrl(url) {
  url = url.replace(
    "https://cdn.fbrq.io/@orange-games/splash/assets/spine/",
    "kizi/"
  );
  url = url.replace(
    "https://cdn.fbrq.io/@orange-games/splash/assets/images/",
    "kizi/"
  );
  ...
  url = url.replace(
    "https://cdn.fbrq.io/@orange-games/splash/assets/json/",
    "json/null.json?"
  );
