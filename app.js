!(function () {
  ...
  function BaseMesh(e, t, r) {
    (this.module = e),
      ...
      (this.step = this.module.cwrap("step", "number", [
        "number",
        "number",
        "number",
        "number",
      ...
      (this.setVertex = this.module.cwrap("setVertex", "number", [
        "number",
        "number",
        "number",
        "number",
      ])),
      (this.getFacePositionData = this.module.cwrap(
        "getFacePositionData",
        "number",
        []
      )),
      (this.getFaceNormalData = this.module.cwrap(
        "getFaceNormalData",
        "number",
        []
      )),
      (this.getFaceVertexCount = this.module.cwrap(
        "getFaceVertexCount",
        "number",
        []
      )),
      (this.getWrinkleStrengths = this.module.cwrap(
        "getWrinkleStrengths",
        "number",
        []
      )),
      (this.getMouthiness = this.module.cwrap("getMouthiness", "number", [])),
      (this.getFaceIndexData = this.module.cwrap(
        "getFaceIndexData",
        "number",
        []
      )),
      (this.getFaceIndexCount = this.module.cwrap(
        "getFaceIndexCount",
        "number",
        []
      )),
      (this.getHiddenTriangles = this.module.cwrap(
        "getHiddenTriangles",
        "number",
        []
      )),
      (this.getHiddenTriangleCount = this.module.cwrap(
        "getHiddenTriangleCount",
        "number",
        []
      )),
      (this.rayIntersect = this.module.cwrap("rayIntersect", "number", [
        "number",
        "number",
        "number",
        "number",
      ...
      (this.computeAverageSpeed = this.module.cwrap(
        "computeAverageSpeed",
        "number",
        []
      )),
      (this.computeEyeVolume = this.module.cwrap("computeEyeVolume", "number", [
        "number",
      ])),
      (this.computeEyeAverageSpeed = this.module.cwrap(
        "computeEyeAverageSpeed",
        "number",
        ["number"]
      )),
      this.initializeFace(),
      ...
      (this.basePositionsTexture = t.buildTexture(
        t.RGBA,
        t.FLOAT,
        this.textureWidth,
        this.textureHeight,
      ...
      (this.baseNormalsTexture = t.buildTexture(
        t.RGBA,
        t.FLOAT,
        this.textureWidth,
        this.textureHeight,
    ...
    for (var n = [], i = 0; i < this.vertexCount; ++i) {
      var o = ((i % this.textureWidth) + 0.5) / this.textureWidth,
        a = (Math.floor(i / this.textureWidth) + 0.5) / this.textureHeight;
      n.push(o), n.push(a);
    }
    if (
      (t.bufferData(
      ...
      (this.baseIndices = this.module.HEAPU16.subarray(
        this.getFaceIndexData() >> 1,
        (this.getFaceIndexData() >> 1) + this.getFaceIndexCount()
      )),
      this.wireframe)
    ) {
      for (var s = [], i = 0; i < this.baseIndices.length; i += 3) {
        ...
        s.push(u), s.push(l), s.push(l), s.push(c), s.push(c), s.push(u);
      }
      (this.renderingIndexBuffer = t.buildBuffer(
      ...
      (this.baseIndexBuffer = t.buildBuffer(
        t.ELEMENT_ARRAY_BUFFER,
        this.baseIndices,
        t.STATIC_DRAW
      )),
    ...
    (this.restBasePositions = this.module.HEAPF32.subarray(
      this.getFacePositionData() >> 2,
      (this.getFacePositionData() >> 2) + 3 * this.getFaceVertexCount()
    ).slice(0)),
      (this.restBaseNormals = this.module.HEAPF32.subarray(
        this.getFaceNormalData() >> 2,
        (this.getFaceNormalData() >> 2) + 3 * this.getFaceVertexCount()
      ).slice(0)),
      (this.wrinkleStrengths = this.module.HEAPF32.subarray(
        this.getWrinkleStrengths() >> 2,
        (this.getWrinkleStrengths() >> 2) + this.getFaceVertexCount()
      )),
      (this.mouthinesses = this.module.HEAPF32.subarray(
        this.getMouthiness() >> 2,
        (this.getMouthiness() >> 2) + this.getFaceVertexCount()
      )),
      (this.hiddenTriangles = this.module.HEAPU16.subarray(
        this.getHiddenTriangles() >> 1,
        (this.getHiddenTriangles() >> 1) + this.getHiddenTriangleCount()
      )),
      (this.basePositionsData = new Float32Array(
        this.textureWidth * this.textureHeight * 4
      )),
      (this.baseNormalsData = new Float32Array(
        this.textureWidth * this.textureHeight * 4
      ));
  }
  ...
  function RawWrinkleMesh(e, t, r, n, i) {
    ...
    function a(e, t) {
      var r = o(e, t);
      if (this.midpointMap[r] !== undefined) return (h = this.midpointMap[r]);
      for (
        var n = new Vertex([]),
          i = this.vertices[e],
          a = this.vertices[t],
          s = 0;
        s < i.baseAssociations.length;
        ++s
      )
        for (
          var u = i.baseAssociations[s], l = 0;
          l < a.baseAssociations.length;
          ++l
        ) {
          var c = a.baseAssociations[l];
          u.baseTriangleIndex === c.baseTriangleIndex &&
            n.baseAssociations.push(
              new BaseAssociation(
                u.baseTriangleIndex,
                mixBarycentric(
                  u.barycentricCoordinates,
                  c.barycentricCoordinates,
                  0.5
                )
              )
            );
      ...
      return (this.midpointMap[r] = h), h;
    }
    function s(e, t, r) {
      var n = o(e, t);
      if (S[n] === undefined) S[n] = r;
      else {
        var i = S[n];
    ...
    for (T = 0; T < t.hiddenTriangles.length; ++T) {
      ...
      (this.baseTriangles[u].hidden = !0), (this.triangles[u].hidden = !0);
    }
    for (T = 0; T < t.vertexCount; ++T) this.vertices.push(new Vertex([]));
    for (T = 0; T < this.baseTriangles.length; ++T) {
      y = this.baseTriangles[T];
      this.vertices[y.a].baseAssociations.push(
        new BaseAssociation(T, [1, 0, 0])
      ),
        this.vertices[y.b].baseAssociations.push(
          new BaseAssociation(T, [0, 1, 0])
        ),
        this.vertices[y.c].baseAssociations.push(
          new BaseAssociation(T, [0, 0, 1])
        );
    }
    a = a.bind(this);
    ...
    for (var g = [], T = 0; T < this.vertices.length; ++T) g[T] = !1;
    for (T = 0; T < this.triangles.length; ++T)
      (y = this.triangles[T]).hidden ||
        ((g[y.a] = !0), (g[y.b] = !0), (g[y.c] = !0));
    for (T = 0; T < this.triangles.length; ++T)
      (y = this.triangles[T]).hidden &&
        (g[y.a] || g[y.b] || g[y.c]) &&
        (g[y.a]
          ? (this.vertices[y.a].isOnBorder = !0)
          : (this.vertices[y.a].isBeyondBorder = !0),
        g[y.b]
          ? (this.vertices[y.b].isOnBorder = !0)
          : (this.vertices[y.b].isBeyondBorder = !0),
        g[y.c]
          ? (this.vertices[y.c].isOnBorder = !0)
          : (this.vertices[y.c].isBeyondBorder = !0),
        (g[y.a] = !0),
        (g[y.b] = !0),
        (g[y.c] = !0),
        (y.isBeyondBorder = !0));
    ...
    for (var R = [0, 1, 2, 3, 4, 5], T = 0; T < this.vertices.length; ++T)
      this.vertices[T].isBeyondBorder
        ? (this.vertices[T].neighbours = R)
        : this.vertices[T].sortTriangles(T);
    var S = {};
    s = s.bind(this);
    for (T = 0; T < this.triangles.length; ++T)
    ...
    for (T = 0; T < this.vertices.length; ++T)
      for (c = 0; c < this.vertices[T].baseAssociations.length; ++c)
        this.baseTriangles[
          this.vertices[T].baseAssociations[c].baseTriangleIndex
        ].wrinkleIndices.push(T);
  }
  function getMouthRing(e, t) {
    ...
    for (var l = [n]; r[l[l.length - 1]] !== l[0]; ) l.push(r[l[l.length - 1]]);
    return l;
  }
  ...
  function Mouth(e, t) {
    ...
    (this.mouthRings = []), (r = r.bind(this));
    for (var n = 0.5 * Math.pow(0.5, e.subdivisions), i = 0; i < 1; i += n)
      r(i);
    for (var o = 0; o < e.vertices.length; ++o) {
      var a = e.vertices[o];
      1 === a.mouthiness &&
        this.mouthRings.push(
          new MouthRing(1, [new MouthPoint(o, a.baseAssociations[0])], t)
        );
    }
  }
  function WrinkleMesh(e, t, r, n, i, o, a, s) {
    function u(t) {
      return e.buildTexture(
        e.RGBA,
        e.FLOAT,
        c,
        h,
    ...
    var l = (this.rawMesh = new RawWrinkleMesh(
      t,
      r,
      r.baseIndices,
      r.wrinkleStrengths,
    ...
    for (
      var c = (this.textureWidth = Math.ceil(Math.sqrt(l.vertices.length))),
        h = (this.textureHeight = c),
        d = [],
        f = 0;
      f < l.vertices.length;
      ++f
    ...
    for (var p = [], f = 0; f < l.triangles.length; ++f) {
      ...
      a
        ? (p.push(g.a),
          ...
          p.push(g.c),
          p.push(g.a))
        : (p.push(g.a), p.push(g.b), p.push(g.c));
    }
    ...
    for (
      var T = new Float32Array(c * h * 4),
        E = new Float32Array(c * h * 4),
        v = new Float32Array(c * h * 4),
        A = new Float32Array(c * h * 4),
        M = new Float32Array(c * h * 4),
        x = new Float32Array(c * h * 4),
        b = new Float32Array(c * h * 4),
        y = new Float32Array(c * h * 4),
        f = 0;
      f < c * h;
      ++f
    )
      if (f < l.vertices.length) {
        for (
          var R = l.vertices[f],
            S = R.baseAssociations[0],
            P = l.baseTriangles[S.baseTriangleIndex],
            C = R.wrinkleStrength,
            D = R.mouthiness,
            I = 0;
          I < 4;
    ...
    (this.wrinkleAssociationTexture = u(T)),
      ...
      (this.fixedTexture = e.buildTexture(
        e.RGBA,
        e.UNSIGNED_BYTE,
        c,
        h,
  ...
  function WrinkleSimulator(e, t) {
    (this.wgl = e),
      (this.wireframe = t),
      (this.attachmentPositionsProgram = e.createProgram(
        Shaders["fullscreen.vert"],
        Shaders["attachmentpositions.frag"],
        {
          a_position: 0,
        }
      )),
      (this.attachmentConstraintProgram = e.createProgram(
        Shaders["fullscreen.vert"],
        Shaders["attachmentconstraint.frag"],
        {
          a_position: 0,
        }
      )),
      (this.distanceConstraintProgram = e.createProgram(
        Shaders["fullscreen.vert"],
      ...
      (this.normalsProgram = e.createProgram(
        Shaders["fullscreen.vert"],
      ...
      (this.copyProgram = e.createProgram(
        Shaders["fullscreen.vert"],
        Shaders["copy.frag"],
        {
          a_position: 0,
      ...
      (this.constraintDistanceProgram = e.createProgram(
        Shaders["fullscreen.vert"],
        Shaders["constraintdistance.frag"],
        {
          a_position: 0,
        }
      )),
      (this.markFixedProgram = e.createProgram(
        Shaders["markfixed.vert"],
        Shaders["markfixed.frag"],
        {
          a_index: 0,
        }
      )),
      (this.setPositionProgram = e.createProgram(
        Shaders["setposition.vert"],
        Shaders["setposition.frag"],
        {
          a_index: 0,
          a_position: 1,
        }
  ...
  function StaticSkin(e, t, r, n, i) {
    for (
      var o = (this.rawMesh = new RawWrinkleMesh(
          1,
          t,
          t.baseIndices,
          t.wrinkleStrengths,
        ...
        a = [],
        s = 0;
      s < o.triangles.length;
      ++s
    ) {
      var u = o.triangles[s];
      a.push(u.a), a.push(u.b), a.push(u.c);
    }
    (this.indexBuffer = e.buildBuffer(
      e.ELEMENT_ARRAY_BUFFER,
      new Uint16Array(a),
      e.STATIC_DRAW
    )),
    ...
    for (
      var l = new Float32Array(3 * o.vertices.length),
        c = new Float32Array(3 * o.vertices.length),
        h = new Float32Array(o.vertices.length),
        s = 0;
      s < o.vertices.length;
      ++s
    ) {
    ...
    (this.associationsBuffer = e.buildBuffer(e.ARRAY_BUFFER, l, e.STATIC_DRAW)),
      (this.barycentricCoordinatesBuffer = e.buildBuffer(
        e.ARRAY_BUFFER,
        c,
        e.STATIC_DRAW
      )),
      (this.mouthinessesBuffer = e.buildBuffer(
        e.ARRAY_BUFFER,
        h,
        e.STATIC_DRAW
      ));
  ...
  function Light(e, t, r, n, i) {
    (this.azimuth = t),
      ...
      (this.projectionViewMatrix = Matrix4.premultiply(
        new Float32Array(16),
        this.viewMatrix,
        this.projectionMatrix
      )),
      (this.shadowMapWidth = 1024),
      (this.depthColorTexture = e.buildTexture(
        e.RGBA,
        e.UNSIGNED_BYTE,
        this.shadowMapWidth,
        this.shadowMapWidth,
      ...
      (this.depthTexture = e.buildTexture(
        e.DEPTH_COMPONENT,
        e.UNSIGNED_SHORT,
        this.shadowMapWidth,
        this.shadowMapWidth,
  ...
  function ShadowRenderer(e, t) {
    (this.wgl = e),
      ...
      (this.skinDepthProgram = e.createProgram(
        Shaders["skindepth.vert"],
        Shaders["skindepth.frag"],
        {
          a_textureCoordinates: 0,
        }
      )),
      (this.eyeDepthProgram = e.createProgram(
        Shaders["eyedepth.vert"],
        Shaders["eyedepth.frag"],
        {
          a_position: 0,
        }
      )),
      (this.hairDepthProgram = e.createProgram(
        "#define DEPTH 1 \n" + Shaders["hair.vert"],
        Shaders["hairdepth.frag"]
      )),
      (this.staticSkinDepthProgram = e.createProgram(
        "#define DEPTH 1 \n" + Shaders["staticskin.vert"],
        Shaders["skindepth.frag"]
      )),
      (this.framebuffer = e.createFramebuffer());
  }
  function gaussian(e, t) {
    for (var r = [], n = 0; n < 3; ++n) {
      var i = t / (0.001 + falloff[n]);
      r[n] = Math.exp((-i * i) / (2 * e)) / (2 * Math.PI * e);
    }
    return r;
  }
  function profile(e) {
    return Vector3.addList(
      [],
      [
        Vector3.multiplyByScalar([], gaussian(0.0484, e), 0.1),
        Vector3.multiplyByScalar([], gaussian(0.187, e), 0.118),
        Vector3.multiplyByScalar([], gaussian(0.567, e), 0.113),
        Vector3.multiplyByScalar([], gaussian(1.99, e), 0.358),
        Vector3.multiplyByScalar([], gaussian(7.41, e), 0.078),
      ]
    );
  }
  function generateSamples(e) {
    for (
      var t = e > 20 ? 3 : 2, r = [], n = (2 * t) / (e - 1), i = 0;
      i < e;
      ++i
    ) {
      var o = i * n - t,
    ...
    for (var s = [], i = 0; i < e; ++i) {
      var u =
        ((i > 0 ? Math.abs(r[i] - r[i - 1]) : 0) +
          (i < e - 1 ? Math.abs(r[i] - r[i + 1]) : 0)) /
        2;
      profile(r[i]);
    ...
    for (var c = Vector3.addList([], s), i = 0; i < e; ++i)
      (s[i][0] /= c[0]), (s[i][1] /= c[1]), (s[i][2] /= c[2]);
    var h = [0.58, 0.2, 0];
    (s[0][0] = 1 * (1 - h[0]) + h[0] * s[0][0]),
      (s[0][1] = 1 * (1 - h[1]) + h[1] * s[0][1]),
      (s[0][2] = 1 * (1 - h[2]) + h[2] * s[0][2]);
    for (i = 1; i < e; ++i) Vector3.multiply(s[i], s[i], h);
    return s;
  }
  function createSSSBlurShader(e) {
    var t = generateSamples(e),
      r = [
        ...
        "float z = linearizeDepth(texture2D(u_depthTexture, v_coordinates).r, u_near, u_far);",
        "float width = 0.2;",
    ...
    for (var n = 1; n < t.length; ++n) {
      ...
      (r += [
        "vec4 " +
          ...
          i[3].toFixed(10) +
          ");",
        o + ".rgb = mix(colorM, " + o + ".rgb, step(0.5, " + o + ".a));",
  ...
  function generateShadowFunction(e, t) {
    for (
      var r = generateGridOffsets(e, t / 1024),
        n = ["float shadow = 0.0;"],
        i = 1 / r.length,
        o = 0;
      o < r.length;
      ...
      n.push(
        "shadow += " +
          i.toFixed(8) +
          " * texture2DShadowLerp(depthTexture, resolution, lightSpaceCoordinates + " +
          s +
          ", lightSpacePosition.z - 0.0001);"
      );
    }
    return n.push("return shadow;"), n.join("\n");
  }
  function generateLightingCommon(e, t) {
    return Shaders["lightingcommon.glsl"].replace(
      "<shadow>",
      generateShadowFunction(e, t)
    );
  }
  function Renderer(e, t) {
    (this.canvas = e),
      ...
      (this.programSets = {
        0: {
          sssBlurProgram: t.createProgram(
            Shaders["fullscreen.vert"],
            createSSSBlurShader(13),
            {
              a_position: 0,
            }
          ),
      ...
      (this.compositeProgram = t.createProgram(
        Shaders["fullscreen.vert"],
      ...
      (this.fxaaProgram = t.createProgram(
        Shaders["fullscreen.vert"],
        Shaders["fxaa.frag"],
        {
          a_position: 0,
      ...
      (this.backgroundProgram = t.createProgram(
      ...
      (this.imageProgram = t.createProgram(
        Shaders["image.vert"],
        Shaders["image.frag"],
        {
          a_position: 0,
      ...
      (this.staticSkinProgram = t.createProgram(
        Shaders["staticskin.vert"],
        this.lightingCommons[0] + Shaders["wrinkle.frag"]
      )),
      ...
      (this.viewMatrix = Matrix4.makeTranslation(
        new Float32Array(16),
        -this.cameraPosition[0],
        -this.cameraPosition[1],
        -this.cameraPosition[2]
      )),
      (this.lights = [new Light(t, -1, 0, 5, 1), new Light(t, 1, 0, 5, 0.2)]),
      (this.framebuffer = t.createFramebuffer()),
      (this.colorTexture = t.buildTexture(
        t.RGBA,
        t.UNSIGNED_BYTE,
        this.canvas.width,
        this.canvas.height,
      ...
      (this.colorTextureTemp = t.buildTexture(
        t.RGBA,
        t.UNSIGNED_BYTE,
        this.canvas.width,
        this.canvas.height,
      ...
      (this.depthTexture = t.buildTexture(
        t.DEPTH_COMPONENT,
        t.UNSIGNED_SHORT,
        this.canvas.width,
        this.canvas.height,
  ...
  function Eye(e, t, r) {
    (this.module = e),
      (this.wgl = t),
      (this.index = r),
      (this.getEyePositionData = this.module.cwrap(
        "getEyePositionData",
        "number",
        ["number"]
      )),
      (this.getEyeNormalData = this.module.cwrap("getEyeNormalData", "number", [
        "number",
      ])),
      (this.getEyeVertexCount = this.module.cwrap(
        "getEyeVertexCount",
        "number",
        ["number"]
      )),
      (this.getEyeIndices = this.module.cwrap("getEyeIndices", "number", [
        "number",
      ])),
      (this.getEyeIndexCount = this.module.cwrap("getEyeIndexCount", "number", [
        "number",
      ])),
      (this.getEyeIndex = this.module.cwrap("getEyeIndex", "number", [
        "number",
      ])),
      (this.baseIndex = this.getEyeIndex(r)),
      (this.indices = this.module.HEAPU16.subarray(
        this.getEyeIndices(r) >> 1,
        (this.getEyeIndices(r) >> 1) + this.getEyeIndexCount()
      )),
      (this.vertices = this.module.HEAPF32.subarray(
        this.getEyePositionData(r) >> 2,
        (this.getEyePositionData(r) >> 2) + 3 * this.getEyeVertexCount(r)
      )),
      (this.normals = this.module.HEAPF32.subarray(
        this.getEyeNormalData(r) >> 2,
        (this.getEyeNormalData(r) >> 2) + 3 * this.getEyeVertexCount(r)
      )),
      (this.positionsBuffer = t.buildBuffer(
        t.ARRAY_BUFFER,
        this.vertices,
        t.STATIC_DRAW
      )),
      (this.normalsBuffer = t.buildBuffer(
        t.ARRAY_BUFFER,
        this.normals,
        t.STATIC_DRAW
      )),
      (this.indexBuffer = t.buildBuffer(
        t.ELEMENT_ARRAY_BUFFER,
        this.indices,
        t.STATIC_DRAW
      )),
  ...
  function Ear(e, t, r) {
    (this.module = e),
      (this.wgl = t),
      (this.index = r),
      (this.getPositionData = this.module.cwrap(
        "getEarPositionData",
        "number",
        ["number"]
      )),
      (this.getNormalData = this.module.cwrap("getEarNormalData", "number", [
        "number",
      ])),
      (this.getVertexCount = this.module.cwrap("getEarVertexCount", "number", [
        "number",
      ])),
      (this.getIndices = this.module.cwrap("getEarIndices", "number", [
        "number",
      ])),
      (this.getIndexCount = this.module.cwrap("getEarIndexCount", "number", [
        "number",
      ])),
      (this.indices = this.module.HEAPU16.subarray(
        this.getIndices(this.index) >> 1,
        (this.getIndices(this.index) >> 1) + this.getIndexCount(this.index)
      )),
      (this.vertices = this.module.HEAPF32.subarray(
        this.getPositionData(this.index) >> 2,
        (this.getPositionData(this.index) >> 2) +
          3 * this.getVertexCount(this.index)
      )),
      (this.normals = this.module.HEAPF32.subarray(
        this.getNormalData(this.index) >> 2,
        (this.getNormalData(this.index) >> 2) +
          3 * this.getVertexCount(this.index)
      )),
      (this.positionsBuffer = t.buildBuffer(
  ...
  function PNMesh(e, t, r, n) {
    ...
    function o(e, t) {
      ...
      for (
        var n = new Vertex$1([]),
          ...
          a = this.vertices[t],
          s = 0;
        s < o.baseAssociations.length;
        ++s
      )
        for (
          var u = o.baseAssociations[s], l = 0;
          l < a.baseAssociations.length;
          ++l
        ) {
          var c = a.baseAssociations[l];
    ...
    for (p = 0; p < t; ++p) this.vertices.push(new Vertex$1([]));
    for (p = 0; p < this.baseTriangles.length; ++p) {
      var s = this.baseTriangles[p];
      this.vertices[s.a].baseAssociations.push(
        new BaseAssociation$1(p, [1, 0, 0])
      ),
        this.vertices[s.b].baseAssociations.push(
          new BaseAssociation$1(p, [0, 1, 0])
        ),
        this.vertices[s.c].baseAssociations.push(
          new BaseAssociation$1(p, [0, 0, 1])
        );
    }
    o = o.bind(this);
    for (p = 0; p < e; ++p) {
    ...
    for (var p = 0; p < this.vertices.length; ++p) {
      ...
      g.restPosition = interpolateBarycentric$1(
        M,
        x,
        b,
        T.barycentricCoordinates[0],
        T.barycentricCoordinates[1],
        T.barycentricCoordinates[2]
      );
    }
  }
  function HairMesh(e, t, r, n, i) {
    for (
      var o = new PNMesh(t, r, n, i), a = [], s = 0;
      s < o.triangles.length;
      ++s
    ) {
      var u = o.triangles[s];
    ...
    for (
      var l = new Float32Array(3 * o.vertices.length),
        c = new Float32Array(3 * o.vertices.length),
        h = new Float32Array(3 * o.vertices.length),
        s = 0;
      s < o.vertices.length;
      ++s
    ) {
    ...
    (this.associationsBuffer = e.buildBuffer(e.ARRAY_BUFFER, l, e.STATIC_DRAW)),
      ...
      (this.restPositionsBuffer = e.buildBuffer(
        e.ARRAY_BUFFER,
        h,
        e.STATIC_DRAW
      ));
  ...
  function Hair(e, t) {
    (this.module = e),
      (this.wgl = t),
      (this.getHairPositionData = this.module.cwrap(
        "getHairPositionData",
        "number",
        []
      )),
      (this.getHairNormalData = this.module.cwrap(
        "getHairNormalData",
        "number",
        []
      )),
      (this.getHairVertexCount = this.module.cwrap(
        "getHairVertexCount",
        "number",
        []
      )),
      (this.getHairIndexData = this.module.cwrap(
        "getHairIndexData",
        "number",
        []
      )),
      (this.getHairIndexCount = this.module.cwrap(
        "getHairIndexCount",
        "number",
        []
      )),
      ...
      (this.baseRestPositions = this.module.HEAPF32.subarray(
        this.getHairPositionData() >> 2,
        (this.getHairPositionData() >> 2) + 3 * this.getHairVertexCount()
      )),
      (this.hairIndices = this.module.HEAPU16.subarray(
        this.getHairIndexData() >> 1,
        (this.getHairIndexData() >> 1) + this.getHairIndexCount()
      )),
      (this.perturbationTexture3DWidth = 32),
      (this.perturbationTexture3D = generate3DPerturbationTexture(
        t,
        this.perturbationTexture3DWidth
      )),
      (this.basePositionsData = new Float32Array(
        this.baseTextureWidth * this.baseTextureHeight * 4
      )),
      (this.baseNormalsData = new Float32Array(
        this.baseTextureWidth * this.baseTextureHeight * 4
      )),
  ...
  function Nose(e, t) {
    (this.module = e),
      (this.wgl = t),
      (this.getNosePositionData = this.module.cwrap(
        "getNosePositionData",
        "number",
        []
      )),
      (this.getNoseNormalData = this.module.cwrap(
        "getNoseNormalData",
        "number",
        []
      )),
      (this.getNoseVertexCount = this.module.cwrap(
        "getNoseVertexCount",
        "number",
        []
      )),
      (this.getNoseIndices = this.module.cwrap("getNoseIndices", "number", [])),
      (this.getNoseIndexCount = this.module.cwrap(
        "getNoseIndexCount",
        "number",
        []
      )),
      (this.indices = this.module.HEAPU16.subarray(
        this.getNoseIndices() >> 1,
        (this.getNoseIndices() >> 1) + this.getNoseIndexCount()
      )),
      (this.vertices = this.module.HEAPF32.subarray(
        this.getNosePositionData() >> 2,
        (this.getNosePositionData() >> 2) + 3 * this.getNoseVertexCount()
      )),
      (this.normals = this.module.HEAPF32.subarray(
        this.getNoseNormalData() >> 2,
        (this.getNoseNormalData() >> 2) + 3 * this.getNoseVertexCount()
      )),
      (this.positionsBuffer = t.buildBuffer(
        t.ARRAY_BUFFER,
  ...
  function QualitySelector(e, t) {
    var r = (this.buttons = [
      document.getElementById("quality-medium"),
      document.getElementById("quality-high"),
    ]);
    this.currentValue = e;
  ...
  function Face(e, t, r) {
    ...
    o.getExtension("OES_texture_float"), o.getExtension("WEBGL_depth_texture");
    var a,
      s = "object" == typeof WebAssembly,
      u = [
        function (e) {
          s
            ? (console.log("using webassembly"),
              ((a = FaceLib()).onRuntimeInitialized = e))
        ...
        function (e) {
          (this.baseMesh = new BaseMesh(a, o, WIREFRAME)), e();
        },
        function (e) {
          (this.hair = new Hair(a, o)), this.hair.createMesh(0), e();
        },
        function (e) {
        ...
        function (e) {
          this.isSimplified
            ? ((this.staticSkin = new StaticSkin(
                o,
                this.baseMesh,
                this.baseMesh.baseIndices,
                this.baseMesh.wrinkleStrengths,
                this.baseMesh.mouthinesses
              )),
              (this.wrinkleSimulator = null))
            : ((this.wrinkleSimulator = new WrinkleSimulator(o, WIREFRAME)),
              (this.staticSkin = null)),
            e();
        },
        function (e) {
          this.isSimplified ||
            this.wrinkleSimulator.createMesh(
              0,
              this.baseMesh,
              this.baseMesh.baseIndices,
              this.baseMesh.wrinkleStrengths,
        ...
        function (e) {
          (this.renderer = new Renderer(i, o)), e();
        },
        function (e) {
    ...
    u.push(function (e) {
      (this.webAudioProcessor = this.webAudioContext.createScriptProcessor(
        this.blockSize,
        this.heavy.getNumInputChannels(),
        Math.max(this.heavy.getNumOutputChannels(), 1)
      )),
        (this.lastAudioProcessTime = new Date().getTime());
      var t = this;
      (this.webAudioProcessor.onaudioprocess = function (e) {
        (t.lastAudioProcessTime = new Date().getTime()), t.heavy.process(e);
      }),
        this.webAudioProcessor.connect(this.webAudioContext.destination),
        e();
    });
    for (var l = 0; l < u.length; ++l) u[l] = u[l].bind(this);
    var c = 0;
    (n = n.bind(this))();
  }
  function isMobile() {
  ...
  var FaceLib = function (FaceLib) {
        ...
        ((a =
          r == ALLOC_NONE
            ...
            : [
              ...
              ][r === undefined ? ALLOC_STATIC : r](
                Math.max(o, s ? 1 : t.length)
              )),
        i)
      ) {
        var u,
          n = a;
        for (assert(0 == (3 & a)), u = a + (-4 & o); n < u; n += 4)
          HEAP32[n >> 2] = 0;
        for (u = a + o; n < u; ) HEAP8[n++ >> 0] = 0;
        return a;
      }
      if ("i8" === s)
        return (
      ...
      for (var l, c, h, d = 0; d < o; ) {
        ...
        "function" == typeof f && (f = Runtime.getFunctionIndex(f)),
          0 !== (l = s || t[d])
            ? ("i64" == l && (l = "i32"),
              setValue(a + d, f, l),
              h !== l && ((c = Runtime.getNativeTypeSize(l)), (h = l)),
              (d += c))
            : d++;
      }
      return a;
    ...
    function Pointer_stringify(e, t) {
      if (0 === t || !e) return "";
      for (var r, n = 0, i = 0; ; ) {
        if (((r = HEAPU8[(e + i) >> 0]), (n |= r), 0 == r && !t)) break;
        if ((i++, t && i == t)) break;
      }
      t || (t = i);
      var o = "";
    ...
    function intArrayToString(e) {
      for (var t = [], r = 0; r < e.length; r++) {
        var n = e[r];
        n > 255 && (n &= 255), t.push(String.fromCharCode(n));
      }
      return t.join("");
    }
    function writeStringToMemory(e, t, r) {
      ...
      var n, i;
      r && ((i = t + lengthBytesUTF8(e)), (n = HEAP8[i])),
    ...
    function integrateWasmJS(Module) {
      ...
      function getBinary() {
        try {
          ...
          if (Module.wasmBinary)
            (e = Module.wasmBinary), (e = new Uint8Array(e));
          else {
      ...
      function getBinaryPromise() {
        return Module.wasmBinary || "function" != typeof fetch
      ...
      function doJustAsm(global, env, providedBuffer) {
        return (
          ("function" == typeof Module.asm && Module.asm !== methodHandler) ||
            (Module.asmPreload
      ...
      function doNativeWasm(e, t, r) {
        ...
        if (
          ...
          try {
            ...
            return (
              Module.printErr(
                "Module.instantiateWasm callback failed with error: " + i
              ),
              !1
            );
          }
      ...
      function doWasmPolyfill(e, t, r, n) {
        if ("function" != typeof WasmJS)
          return (
            Module.printErr("WasmJS not detected - polyfill not bundled?"), !1
          );
        var i = WasmJS({});
        (i.outside = Module),
          (i.info = info),
        ...
        o =
          "interpret-binary" === n
            ? getBinary()
            : Module.read(
                "interpret-asm2wasm" == n ? asmjsCodeFile : wasmTextFile
              );
        var a;
        if ("interpret-asm2wasm" == n)
          ...
          if ("interpret-binary" !== n) throw "what? " + n;
      ...
      var asmjsReallocBuffer = Module.reallocBuffer,
        wasmReallocBuffer = function (e) {
          ...
          if (!Module.usingWasm)
            return (
              exports.__growWasmMemory((e - r) / wasmPageSize),
              Module.buffer !== t ? Module.buffer : null
            );
          try {
            return -1 !== Module.wasmMemory.grow((e - r) / wasmPageSize)
      ...
      Module.reallocBuffer = function (e) {
        return "asmjs" === finalMethod
          ? asmjsReallocBuffer(e)
          : wasmReallocBuffer(e);
      };
      var finalMethod = "";
      Module.asm = function (e, t, r) {
        if (((e = fixImports(e)), !(t = fixImports(t)).table)) {
        ...
        for (var o, a = method.split(","), s = 0; s < a.length; s++) {
          var u = a[s];
          if (((finalMethod = u), "native-wasm" === u)) {
            if ((o = doNativeWasm(e, t))) break;
          } else if ("asmjs" === u) {
            if ((o = doJustAsm(e, t, r))) break;
          } else if (
            "interpret-asm2wasm" === u ||
            "interpret-s-expr" === u ||
            "interpret-binary" === u
          ) {
            if ((o = doWasmPolyfill(e, t, r, u))) break;
          } else abort("bad method: " + u);
        }
        if (!o)
    ...
    function ___cxa_find_matching_catch() {
      ...
      var t = EXCEPTIONS.infos[e],
        r = t.type;
      if (!r) return 0 | (Runtime.setTempRet0(0), e);
      ...
      return (e = HEAP32[e >> 2]), 0 | (Runtime.setTempRet0(r), e);
    }
    ...
    function _pthread_once(e, t) {
      _pthread_once.seen || (_pthread_once.seen = {}),
        e in _pthread_once.seen ||
          (Module.dynCall_v(t), (_pthread_once.seen[e] = 1));
    }
    ...
    function ___cxa_begin_catch(e) {
      ...
      return (
        t &&
          !t.caught &&
          ((t.caught = !0), __ZSt18uncaught_exceptionv.uncaught_exception--),
        t && (t.rethrown = !1),
    ...
    function ___syscall146(e, t) {
      ...
      try {
        ...
        return (
          ("undefined" != typeof FS && c instanceof FS.ErrnoError) || abort(c),
          -c.errno
        );
      }
    }
    ...
    var Runtime = {
      ...
      dynCall: function (e, t, r) {
        return r && r.length
          ? Module["dynCall_" + e].apply(null, [t].concat(r))
      ...
      stackAlloc: function (e) {
        var t = STACKTOP;
        return (
          (STACKTOP = (STACKTOP + e) | 0), (STACKTOP = (STACKTOP + 15) & -16), t
        );
      },
      ...
      dynamicAlloc: function (e) {
        ...
        return (
          ...
          r >= TOTAL_MEMORY && !enlargeMemory()
            ? ((HEAP32[DYNAMICTOP_PTR >> 2] = t), 0)
            : t
        );
      },
      ...
      function ensureJSsource() {
        if (!JSsource) {
          ...
          for (var e in JSfuncs)
            JSfuncs.hasOwnProperty(e) &&
              (JSsource[e] = parseJSFunc(JSfuncs[e]));
        }
      }
      var JSfuncs = {
          stackSave: function () {
    ...
    (STATICTOP += 16), (Module._roundf = _roundf);
    var EXCEPTIONS = {
      last: 0,
      caught: [],
      infos: {},
      ...
      decRef: function (e) {
        if (e) {
          ...
          assert(t.refcount > 0),
            ...
            0 !== t.refcount ||
              t.rethrown ||
              (t.destructor && Module.dynCall_vi(t.destructor, e),
    ...
    var _computeArea = (Module._computeArea = function () {
      ...
      _hv_sendFloatToReceiverWithDelay =
        (Module._hv_sendFloatToReceiverWithDelay = function () {
          return Module.asm._hv_sendFloatToReceiverWithDelay.apply(
            null,
            arguments
          );
        }),
      ...
      __GLOBAL__sub_I_face_cpp = (Module.__GLOBAL__sub_I_face_cpp =
        function () {
      ...
      _hv_getNumOutputChannels = (Module._hv_getNumOutputChannels =
        function () {
      ...
      _hv_samplesToMilliseconds = (Module._hv_samplesToMilliseconds =
        function () {
      ...
      _hv_sendMessageToReceiverV = (Module._hv_sendMessageToReceiverV =
        function () {
      ...
      _hv_sendSymbolToReceiver = (Module._hv_sendSymbolToReceiver =
        function () {
      ...
      _hv_facesynth_new_with_options = (Module._hv_facesynth_new_with_options =
        function () {
          return Module.asm._hv_facesynth_new_with_options.apply(
            null,
            arguments
          );
        }),
  ...
  var facesynth_AudioLib = function (e, t) {
    (this.module = e),
      ...
      (this.heavyContext = this.module._hv_facesynth_new_with_options(
        this.sampleRate,
        1e3,
        1e3,
        0
    ...
    this.processBuffer = new Float32Array(
      ...
      this.module._malloc(r * Float32Array.BYTES_PER_ELEMENT),
      r
    );
  };
  ...
  (facesynth_AudioLib.prototype.process = function (e) {
    ...
    for (var t = 0; t < this.getNumOutputChannels(); ++t)
      for (
        var r = e.outputBuffer.getChannelData(t), n = t * this.blockSize, i = 0;
        i < this.blockSize;
        ++i
      )
    ...
    (facesynth_AudioLib.prototype.getNumInputChannels = function () {
      return this.heavyContext
        ? this.module._hv_getNumInputChannels(this.heavyContext)
        : -1;
    }),
    (facesynth_AudioLib.prototype.getNumOutputChannels = function () {
      return this.heavyContext
        ? this.module._hv_getNumOutputChannels(this.heavyContext)
        : -1;
    }),
    (facesynth_AudioLib.prototype.setFloatParameter = function (e, t) {
      this.heavyContext &&
        this.module._hv_sendFloatToReceiver(
          this.heavyContext,
          parameterInHashes[e],
          parseFloat(t)
        );
    }),
    (facesynth_AudioLib.prototype.setFloatParameterWithDelay = function (
      e,
      t,
      r
    ) {
      this.heavyContext &&
        this.module._hv_sendFloatToReceiverWithDelay(
          this.heavyContext,
          parameterInHashes[e],
          parseFloat(t),
          r
    ...
    (facesynth_AudioLib.prototype.setFloatParametersWithDelay = function (
      e,
      t
    ) {
  ...
  var WrappedGL = (function () {
    function e(e) {
      this.gl = e;
      for (r = 0; r < l.length; r += 1) this[l[r]] = e[l[r]];
      ...
      for (var n = e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS), r = 0; r < n; ++r)
        this.parameters["texture" + r.toString()] = {
          ...
          setter: (function () {
            var t = r;
            return function (r, n) {
              e.activeTexture(e.TEXTURE0 + t), e.bindTexture(r, n);
            };
          })(),
          usedInDraw: !0,
        };
    ...
    function n(e, t, n, i) {
      ...
      if ((o.attachShader(u, a), o.attachShader(u, s), i !== undefined))
        for (var l in i) o.bindAttribLocation(u, i[l], l);
      o.linkProgram(u), (this.attributeLocations = {});
      for (
        var c = o.getProgramParameter(u, o.ACTIVE_ATTRIBUTES), h = 0;
        h < c;
        ++h
      ) {
      ...
      for (
        var d = (this.uniformLocations = {}),
          f = o.getProgramParameter(u, o.ACTIVE_UNIFORMS),
          h = 0;
        h < f;
        h += 1
      ) {
    ...
    return (
      ...
      (e.prototype.getExtension = function (e) {
        ...
        if ("ANGLE_instanced_arrays" === e) {
          ...
          if (null !== r) {
            this.instancedExt = r;
            for (
              var n = t.getParameter(t.MAX_VERTEX_ATTRIBS), i = 0;
              i < n;
              ++i
            )
            ...
            return (
              (a.prototype.vertexAttribPointer = function (
                e,
                t,
                r,
                n,
                ...
                return (
                  this.setParameter("attributeArray" + t.toString(), [
                    e,
                    r,
                    n,
                    i,
                  ...
                  this.changedParameters.hasOwnProperty(
                    "attributeDivisor" + t.toString()
                  ) &&
                    this.setParameter("attributeDivisor" + t.toString(), [0]),
                  this
                );
              }),
              (a.prototype.vertexAttribDivisorANGLE = function (e, t) {
                return (
                  this.setParameter("attributeDivisor" + e.toString(), [t]),
                  this
                );
              }),
      ...
      (e.prototype.hasHalfFloatTextureSupport = function () {
        ...
        return (
          null !== e &&
          null !== this.getExtension("OES_texture_half_float_linear") &&
          !!this.canRenderToTexture(e.HALF_FLOAT_OES)
        );
      }),
      (e.prototype.hasFloatTextureSupport = function () {
        return (
          null !== this.getExtension("OES_texture_float") &&
          null !== this.getExtension("OES_texture_float_linear") &&
          !!this.canRenderToTexture(this.FLOAT)
        );
      }),
      (e.prototype.resolveState = function (e, t) {
        this.gl;
        for (var r in this.changedParameters)
          this.changedParameters.hasOwnProperty(r) &&
            (e.changedParameters.hasOwnProperty(r) ||
              (this.parameters[r][t] &&
                (this.parameters[r].setter.apply(
                  this.gl,
                  this.parameters[r].defaults
                ),
                delete this.changedParameters[r])));
        for (var r in e.changedParameters)
          e.changedParameters.hasOwnProperty(r) &&
            ((this.changedParameters.hasOwnProperty(r) &&
              o(this.changedParameters[r], e.changedParameters[r])) ||
              ((this.changedParameters[r] = e.changedParameters[r]),
              this.parameters[r].setter.apply(
                this.gl,
                this.changedParameters[r]
              )));
      }),
      ...
      (e.prototype.bindTextureForEditing = function (e, t) {
        this.gl.activeTexture(this.gl.TEXTURE0 + this.defaultTextureUnit),
          ...
          (this.changedParameters[
            "texture" + this.defaultTextureUnit.toString()
          ] = [e, t]);
      }),
      ...
      (e.prototype.texParameteri = function (e, t, r, n) {
        return (
          this.bindTextureForEditing(e, t), this.gl.texParameteri(e, r, n), this
        );
      }),
      (e.prototype.texParameterf = function (e, t, r, n) {
        return (
          this.bindTextureForEditing(e, t), this.gl.texParameterf(e, r, n), this
        );
      }),
      (e.prototype.pixelStorei = function (e, t, r, n) {
        return (
          this.bindTextureForEditing(e, t), this.gl.pixelStorei(r, n), this
        );
      }),
      ...
      (e.prototype.generateMipmap = function (e, t) {
        return (
          this.bindTextureForEditing(e, t), this.gl.generateMipmap(e), this
        );
      }),
      (e.prototype.buildTexture = function (e, t, r, n, i, o, a, s, u) {
        var l = this.createTexture();
        return this.rebuildTexture(l, e, t, r, n, i, o, a, s, u), l;
      }),
      (e.prototype.rebuildTexture = function (e, t, r, n, i, o, a, s, u, l) {
        return (
          this.texImage2D(
            ...
            r,
            o
          ).setTextureFiltering(this.TEXTURE_2D, e, a, s, u, l),
          this
        );
      }),
      ...
      (e.prototype.bufferData = function (e, t, r, n) {
        ...
        t === i.ARRAY_BUFFER ||
          (t === i.ELEMENT_ARRAY_BUFFER &&
            (this.changedParameters.indexBuffer = [e])),
          i.bindBuffer(t, e),
          i.bufferData(t, r, n);
      }),
      ...
      (e.prototype.createProgramFromFiles = function (t, r, n, i, o) {
        ...
        Array.isArray(t) ? (s = s.concat(t)) : s.push(t),
          ...
          e.loadTextFiles(s, function (e) {
            var o = [];
            if (Array.isArray(t))
              for (u = 0; u < t.length; ++u) o.push(e[t[u]]);
            else o.push(e[t]);
            var s = [];
            if (Array.isArray(r))
              for (var u = 0; u < r.length; ++u) s.push(e[r[u]]);
            else s.push(e[r]);
      ...
      (e.prototype.createProgramsFromFiles = function (e, r, n) {
        ...
        for (var s in e)
          if (e.hasOwnProperty(s)) {
            ...
            !(function () {
              var e = s;
              l.createProgramFromFiles(
                u.vertexShader,
                u.fragmentShader,
                u.attributeLocations,
                function (t) {
                  (a[e] = t), ++o === i && r(a);
                }
              );
      ...
      (i.prototype.setParameter = function (e, t) {
        o(t, this.wgl.parameters[e].defaults)
          ? this.changedParameters.hasOwnProperty(e) &&
            delete this.changedParameters[e]
          : (this.changedParameters[e] = t);
      }),
      (i.prototype.clone = function () {
        ...
        for (var t in this.changedParameters)
          if (this.changedParameters.hasOwnProperty(t)) {
            for (
              var r = this.changedParameters[t], n = [], i = 0;
              i < r.length;
              ++i
            )
              n.push(r[i]);
      ...
      (a.prototype.enable = function (e) {
        return (
          e === this.wgl.DEPTH_TEST
            ? this.setParameter("depthTest", [!0])
            : e === this.wgl.BLEND
            ? this.setParameter("blend", [!0])
            : e === this.wgl.CULL_FACE
            ? this.setParameter("cullFace", [!0])
            : e === this.wgl.POLYGON_OFFSET_FILL
            ? this.setParameter("polygonOffsetFill", [!0])
            : e === this.wgl.SCISSOR_TEST &&
              this.setParameter("scissorTest", [!0]),
          this
        );
      }),
      (a.prototype.disable = function (e) {
        return (
          e === this.wgl.DEPTH_TEST
            ? this.setParameter("depthTest", [!1])
            : e === this.wgl.BLEND
            ? this.setParameter("blend", [!1])
            : e === this.wgl.CULL_FACE
            ? this.setParameter("cullFace", [!1])
            : e === this.wgl.POLYGON_OFFSET_FILL
            ? this.setParameter("polygonOffsetFill", [!1])
            : e === this.wgl.SCISSOR_TEST &&
              this.setParameter("scissorTest", [!1]),
          this
        );
      }),
      ...
      (s.prototype.enable = function (e) {
        return (
          e === this.wgl.SCISSOR_TEST && this.setParameter("scissorTest", [!0]),
          this
        );
      }),
      (s.prototype.disable = function (e) {
        return (
          e === this.wgl.SCISSOR_TEST && this.setParameter("scissorTest", [!1]),
          this
        );
      }),
  ...
  Float32Array.prototype.slice ||
    ...
    (BaseMesh.prototype.update = function (e, t, r, n, i, o, a, s) {
      ...
      var l = this.module.HEAPF32.subarray(
          this.getFacePositionData() >> 2,
          (this.getFacePositionData() >> 2) + 3 * this.getFaceVertexCount()
        ),
        c = this.module.HEAPF32.subarray(
          this.getFaceNormalData() >> 2,
          (this.getFaceNormalData() >> 2) + 3 * this.getFaceVertexCount()
        );
      (this.positions = l), (this.normals = c);
      ...
      u.texImage2D(
        ...
        u.RGBA,
        u.FLOAT,
        this.basePositionsData
      ),
        u.texImage2D(
          u.TEXTURE_2D,
          this.baseNormalsTexture,
          0,
          u.RGBA,
          this.textureWidth,
          this.textureHeight,
    ...
    (Vertex.prototype.sortTriangles = function (e) {
      ...
      do {
        t.push(n),
          n.a === e
            ? (n = this.findTriangle(n.b, e))
            : n.b === e
            ? (n = this.findTriangle(n.c, e))
            : n.c === e && (n = this.findTriangle(n.a, e));
      } while (n !== r);
      this.triangles = t;
      for (var i = 0; i < this.triangles.length; ++i) {
        var o = this.triangles[i];
        o.a === e
          ? this.neighbours.push(o.b)
          : o.b === e
          ? this.neighbours.push(o.c)
          : o.c === e && this.neighbours.push(o.a);
      }
    });
  var Shaders = {
      "attachmentconstraint.frag":
    ...
    Vector3 = {
      ...
      rotateTowards: function (e, t, r, n) {
        ...
        return Vector3.multiplyByQuaternion(e, t, a), e;
      },
      add: function (e, t, r) {
        return (
      ...
      slerp: function (e, t, r, n) {
        ...
        for (
          var o = Math.acos(i) * n,
            a = Vector3.subtract([], r, Vector3.multiplyByScalar([], t, i)),
            s = 0;
          s < 3;
          ++s
        )
      ...
      hsvToRGB: function (e, t) {
        var r = t[0],
          ...
          h = i - t;
        return (
          (u += h), (l += h), (c += h), (e[0] = u), (e[1] = l), (e[2] = c), e
        );
      },
  ...
  (MouthRing.prototype.setBasePositions = function (e, t, r) {
    for (
      var n = [0, 0, 0], i = 0.03 * -smoothstep(0, 0.2, this.mouthiness), o = 0;
      o < this.mouthPoints.length;
      ++o
    ) {
      for (
        var a = this.mouthPoints[o].baseAssociation,
          s = e[a.baseTriangleIndex].a,
          u = e[a.baseTriangleIndex].b,
          l = e[a.baseTriangleIndex].c,
          c = a.barycentricCoordinates[0],
          h = a.barycentricCoordinates[1],
          d = a.barycentricCoordinates[2],
          f = 0;
        f < 3;
        ++f
      )
      ...
      if ((this.setBasePositions(e, t, r), 1 !== this.mouthPoints.length))
        for (var n = 0; n < this.smoothingIterations; ++n) {
          for (var i = 0; i < this.mouthPoints.length; ++i)
            for (
              var o = mod(i - 1, this.mouthPoints.length),
                a = mod(i + 1, this.mouthPoints.length),
                s = 0;
              s < 3;
              ++s
            ) {
              var u = this.positions[3 * o + s],
                ...
                h = 0.5 * (l - c) + 0.5 * (u - c);
              this.positionsTemp[3 * i + s] =
                this.positions[3 * i + s] + 0.5 * h;
            }
          var d = this.positions;
          (this.positions = this.positionsTemp), (this.positionsTemp = d);
        }
    }),
    (WrinkleSimulator.prototype.createMesh = function (e, t, r, n, i) {
      var o = this.wgl;
      0 === e
        ? (this.wrinkleMeshes[0] = new WrinkleMesh(
            o,
            1,
            t,
            t.baseIndices,
        ...
        : 1 === e &&
          (this.wrinkleMeshes[1] = new WrinkleMesh(
            o,
            2,
            t,
            t.baseIndices,
    ...
    (WrinkleSimulator.prototype.computeAttachmentPositions = function (
      e,
      t,
      r,
      n,
      ...
      var l = u
        .createDrawState()
        .useProgram(this.attachmentPositionsProgram)
        .bindFramebuffer(this.framebuffer)
        .viewport(0, 0, e.textureWidth, e.textureHeight)
        .uniformTexture("u_basePositionsTexture", 0, u.TEXTURE_2D, i)
        .uniformTexture("u_baseNormalsTexture", 1, u.TEXTURE_2D, o)
        .uniformTexture(
          "u_wrinkleAssociationsTexture",
          2,
          u.TEXTURE_2D,
          e.wrinkleAssociationTexture
        )
        .uniformTexture(
          "u_wrinkleBarycentricCoordinatesTexture",
          3,
          u.TEXTURE_2D,
          e.wrinkleBarycentricCoordinatesTexture
        )
        .uniform2f("u_baseTextureResolution", r, n)
        .vertexAttribPointer(this.quadVertexBuffer, 0, 2, u.FLOAT, !1, 0, 0);
      u.drawArrays(l, u.TRIANGLE_STRIP, 0, 4);
      for (
        var c = [], h = [], d = e.mouth, f = 0;
        f < d.mouthRings.length;
        ++f
      ) {
      ...
      u.bufferData(
        this.mouthIndicesBuffer,
        u.ARRAY_BUFFER,
        new Float32Array(c),
        u.STATIC_DRAW
      ),
        u.bufferData(
          this.mouthPositionsBuffer,
          u.ARRAY_BUFFER,
          new Float32Array(h),
          u.STATIC_DRAW
        );
      var g = u
        .createDrawState()
        .useProgram(this.setPositionProgram)
        .bindFramebuffer(this.framebuffer)
        .viewport(0, 0, e.textureWidth, e.textureHeight)
        .uniform2f("u_resolution", e.textureWidth, e.textureHeight)
        .vertexAttribPointer(this.mouthIndicesBuffer, 0, 1, u.FLOAT, !1, 0, 0)
        .vertexAttribPointer(
          this.mouthPositionsBuffer,
          1,
          3,
    ...
    (WrinkleSimulator.prototype.computeConstraintDistance = function (e, t, r) {
      ...
      var i = n
        .createDrawState()
        .useProgram(this.constraintDistanceProgram)
        .bindFramebuffer(this.framebuffer)
        .viewport(0, 0, e.textureWidth, e.textureHeight)
        .uniformTexture(
          "u_positionsTexture",
          0,
          n.TEXTURE_2D,
          e.attachmentPositionsTexture
        )
        .uniformTexture("u_connectionsTexture", 1, n.TEXTURE_2D, t)
        .uniform2f("u_resolution", e.textureWidth, e.textureHeight)
        .vertexAttribPointer(this.quadVertexBuffer, 0, 2, n.FLOAT, !1, 0, 0);
    ...
    (WrinkleSimulator.prototype.update = function (e, t, r, n, i, o, a, s, u) {
      function l(e, t, r, n, i) {
        ...
        var o = c
          ...
          .bindFramebuffer(this.framebuffer)
          .viewport(0, 0, h.textureWidth, h.textureHeight)
          .uniformTexture(
            "u_positionsTexture",
            0,
            c.TEXTURE_2D,
          ...
          .uniformTexture("u_neighboursTextureA", 1, c.TEXTURE_2D, e)
          .uniformTexture("u_neighboursTextureB", 2, c.TEXTURE_2D, t)
          .uniformTexture("u_distancesTextureA", 3, c.TEXTURE_2D, r)
          .uniformTexture("u_distancesTextureB", 4, c.TEXTURE_2D, n)
          .uniformTexture("u_fixedTexture", 5, c.TEXTURE_2D, h.fixedTexture)
          .uniformTexture(
            "u_strengthsTexture",
            6,
            c.TEXTURE_2D,
            h.wrinkleStrengthTexture
          )
          .uniform2f("u_resolution", h.textureWidth, h.textureHeight)
          .uniform1i("u_respectFixed", i ? 1 : 0)
          .vertexAttribPointer(this.quadVertexBuffer, 0, 2, c.FLOAT, !1, 0, 0);
      ...
      if (!this.initialized) {
        for (var d in this.wrinkleMeshes) {
          ...
          this.computeAttachmentPositions(
            h,
            h.positionsTexture,
            e,
            t,
            ...
            this.computeConstraintDistance(
              h,
              h.neighboursTextureA,
              h.neighboursDistancesTextureA
            ),
            this.computeConstraintDistance(
              h,
              h.neighboursTextureB,
              h.neighboursDistancesTextureB
            ),
            this.computeConstraintDistance(
              h,
              h.oppositesTextureA,
              h.oppositesDistancesTextureA
            ),
            this.computeConstraintDistance(
              h,
              h.oppositesTextureB,
              h.oppositesDistancesTextureB
            );
        }
        this.initialized = !0;
      }
      if (
        ...
        c.bufferData(this.markBuffer, c.ARRAY_BUFFER, f, c.STATIC_DRAW),
          ...
          c.clear(
            c.createClearState().bindFramebuffer(this.framebuffer),
            c.COLOR_BUFFER_BIT
          );
        var _ = c
          .createDrawState()
          .useProgram(this.markFixedProgram)
          .bindFramebuffer(this.framebuffer)
          .viewport(0, 0, h.textureWidth, h.textureHeight)
          .uniform2f("u_resolution", h.textureWidth, h.textureHeight)
          .vertexAttribPointer(this.markBuffer, 0, 1, c.FLOAT, !1, 0, 0);
      ...
      for (d = 0; d < 15; ++d) {
        ...
        var m = c
          .createDrawState()
          .useProgram(this.attachmentConstraintProgram)
          .bindFramebuffer(this.framebuffer)
          .viewport(0, 0, h.textureWidth, h.textureHeight)
          .uniformTexture(
            "u_positionsTexture",
          ...
          .vertexAttribPointer(this.quadVertexBuffer, 0, 2, c.FLOAT, !1, 0, 0);
        0 === d &&
          (c.drawArrays(m, c.TRIANGLE_STRIP, 0, 4),
          swap(h, "positionsTexture", "positionsTextureTemp"));
        var p = d < 14;
        l(
          h.neighboursTextureA,
      ...
      var g = c
        .createDrawState()
        .useProgram(this.normalsProgram)
        .bindFramebuffer(this.framebuffer)
        .viewport(0, 0, h.textureWidth, h.textureHeight)
        .uniformTexture(
          "u_positionsTexture",
        ...
        .uniformTexture(
          "u_neighboursTextureA",
          1,
          c.TEXTURE_2D,
          h.neighboursTextureA
        )
        .uniformTexture(
          "u_neighboursTextureB",
          2,
          c.TEXTURE_2D,
          h.neighboursTextureB
        )
  ...
  var Matrix4 = {
    ...
    makeTranslation: function (e, t, r, n) {
      return Matrix4.makeIdentity(e), (e[12] = t), (e[13] = r), (e[14] = n), e;
    },
  ...
  (Light.prototype.recomputeViewMatrix = function () {
    ...
    (ShadowRenderer.prototype.renderForLight = function (
      e,
      t,
      r,
      n,
      ...
      function f(e) {
        var t = _.createDrawState()
          .bindFramebuffer(this.framebuffer)
          .enable(_.DEPTH_TEST)
          .viewport(0, 0, h.shadowMapWidth, h.shadowMapWidth)
          .depthMask(!0)
          .colorMask(!1, !1, !1, !1)
          .uniformMatrix4fv("u_projectionViewModelMatrix", !1, m)
          .vertexAttribPointer(e.positionsBuffer, 0, 3, _.FLOAT, !1, 0, 0)
          .bindIndexBuffer(e.indexBuffer)
      ...
      _.framebufferTexture2D(
        ...
        _.clear(
          _.createClearState().bindFramebuffer(this.framebuffer),
          _.COLOR_BUFFER_BIT | _.DEPTH_BUFFER_BIT
        );
      var m = Matrix4.premultiply(
        new Float32Array(16),
        e,
        h.projectionViewMatrix
      );
      if (i) {
        var p = _.createDrawState()
          ...
          .uniformMatrix4fv("u_projectionViewModelMatrix", !1, m)
          .uniformTexture(
            "u_basePositionsTexture",
            2,
            _.TEXTURE_2D,
            t.basePositionsTexture
          )
          .uniformTexture(
            "u_baseNormalsTexture",
            3,
            _.TEXTURE_2D,
            t.baseNormalsTexture
          )
          .uniform2f("u_baseTextureResolution", t.textureWidth, t.textureHeight)
          .vertexAttribPointer(
            n.associationsBuffer,
            this.staticSkinDepthProgram.getAttribLocation("a_associations"),
            3,
            _.FLOAT,
            !1,
            0,
          ...
          .vertexAttribPointer(
            n.barycentricCoordinatesBuffer,
            this.staticSkinDepthProgram.getAttribLocation(
          ...
          .bindIndexBuffer(n.indexBuffer)
          .useProgram(this.staticSkinDepthProgram);
        ...
        var g = r.getWrinkleMesh(d),
          T = _.createDrawState()
            ...
            .depthMask(!0)
            .colorMask(!1, !1, !1, !1)
            .vertexAttribPointer(g.vertexBuffer, 0, 2, _.FLOAT, _.FALSE, 0, 0)
            .bindIndexBuffer(g.indexBuffer)
            .uniformMatrix4fv("u_projectionViewModelMatrix", !1, m)
            .uniformTexture(
              "u_positionsTexture",
              0,
        ...
        _.drawElements(
          T,
          g.wireframe ? _.LINES : _.TRIANGLES,
          g.wrinkleIndexCount,
          _.UNSIGNED_SHORT,
          0
        );
      ...
      var v = s.getMesh(d),
        A = _.createDrawState()
          ...
          .uniformTexture(
            ...
            2,
            _.TEXTURE_2D,
            s.basePositionsTexture
          )
          .uniformTexture(
            "u_baseNormalsTexture",
            3,
            _.TEXTURE_2D,
            s.baseNormalsTexture
          )
          .uniform2f(
            "u_baseTextureResolution",
            s.baseTextureWidth,
            s.baseTextureHeight
          )
          .vertexAttribPointer(
            v.associationsBuffer,
            this.hairDepthProgram.getAttribLocation("a_associations"),
            3,
            _.FLOAT,
            !1,
            0,
          ...
          .vertexAttribPointer(
            v.barycentricCoordinatesBuffer,
  ...
  var falloff = [1, 0.37, 0.3],
    MIN_FOV = 0.5 * Math.PI,
    MAX_FOV = 0.62 * Math.PI,
    GAMMA = 2.2,
    NON_LINEAR_SKIN_COLOR = Vector3.multiplyByScalar(
      [],
      [255, 201, 167],
      1 / 255
    ),
    LINEAR_SKIN_COLOR = Vector3.pow([], NON_LINEAR_SKIN_COLOR, GAMMA),
    HAIR_ALBEDO = Vector3.pow(
      [],
      Vector3.multiplyByScalar([], [152, 100, 52], 1 / 255),
      GAMMA
    ),
    NON_LINEAR_SKIN_HSV = Vector3.rgbToHSV([], NON_LINEAR_SKIN_COLOR),
    BACKGROUND_COLOR = Vector3.hsvToRGB(
      [],
      [NON_LINEAR_SKIN_HSV[0] + 0.5, 0.9, 0.4]
    ),
    NON_LINEAR_MOUTH_COLOR = Vector3.multiplyByScalar(
      [],
      [126, 13, 12],
      0.5 / 255
    ),
  ...
  (Renderer.prototype.createPrograms = function (e, t) {
    var r = this.wgl;
    0 === t
      ? (this.programSets[e].wrinkleProgram = r.createProgram(
          Shaders["wrinkle.vert"],
          this.lightingCommons[e] + Shaders["wrinkle.frag"],
          {
            a_textureCoordinates: 0,
          }
        ))
      : 1 === t
      ? (this.programSets[e].hairProgram = r.createProgram(
          Shaders["hair.vert"],
          this.lightingCommons[e] + Shaders["hair.frag"]
        ))
      : 2 === t
      ? (this.programSets[e].eyeProgram = r.createProgram(
          Shaders["eye.vert"],
          this.lightingCommons[e] + Shaders["eye.frag"],
          {
            a_position: 0,
            a_normal: 1,
          }
      ...
      : 3 === t &&
        (this.programSets[e].appendageProgram = r.createProgram(
          Shaders["nose.vert"],
          this.lightingCommons[e] + Shaders["nose.frag"],
          {
            a_position: 0,
            a_normal: 1,
          }
    ...
    (Renderer.prototype.setLightingUniforms = function (e, t) {
      ...
      e.uniformMatrix4fv(
        ...
        .uniformMatrix4fv("u_modelMatrix", !1, this.modelMatrix)
        .uniform3f(
          "u_cameraPosition",
          this.cameraPosition[0],
          this.cameraPosition[1],
      ...
      for (var i = 0; i < this.lights.length; ++i) {
        r = this.lights[i];
        e.uniform3f(
          "u_lightPosition" + i.toFixed(0),
          r.getPosition()[0],
          r.getPosition()[1],
          r.getPosition()[2]
        )
          .uniform3f(
            "u_lightColor" + i.toFixed(0),
            r.brightness,
            r.brightness,
            r.brightness
          )
          .uniformTexture(
            "u_shadowDepthTexture" + i.toFixed(0),
            t + i,
            n.TEXTURE_2D,
            r.depthTexture
          )
          .uniform2f(
            "u_shadowResolution" + i.toFixed(0),
            r.shadowMapWidth,
            r.shadowMapWidth
          )
          .uniformMatrix4fv(
            "u_lightProjectionViewMatrix" + i.toFixed(0),
            !1,
            r.projectionViewMatrix
          )
          .uniform1f("u_lightNear" + i.toFixed(0), r.near)
          .uniform1f("u_lightFar" + i.toFixed(0), r.far);
      }
    }),
    (Renderer.prototype.update = function () {
      (this.fov += 0.05 * (this.targetFOV - this.fov)),
        this.canvas.width > this.canvas.height
          ...
          : (this.projectionMatrix = Matrix4.makePerspectiveHorizontal(
              new Float32Array(16),
              this.fov,
              this.canvas.width / this.canvas.height,
              NEAR,
    ...
    (Renderer.prototype.render = function (
      ...
      function m(e, t) {
        var r = g
          ...
          .vertexAttribPointer(e.positionsBuffer, 0, 3, g.FLOAT, !1, 0, 0)
          .vertexAttribPointer(e.normalsBuffer, 1, 3, g.FLOAT, !1, 0, 0)
          .bindIndexBuffer(e.indexBuffer)
          .uniform3f(
            "u_eyePosition",
            e.position[0],
          ...
          .uniform1f("u_pupilNoiseOffset", t)
          .uniform3f(
            "u_lookDirection",
            e.lookDirection[0],
            e.lookDirection[1],
      ...
      this.shadowRenderer.render(
        ...
        g.clear(
          g.createClearState().bindFramebuffer(this.framebuffer),
          g.COLOR_BUFFER_BIT | g.DEPTH_BUFFER_BIT
        ),
        g.framebufferTexture2D(
          this.framebuffer,
          g.FRAMEBUFFER,
      ...
      var T = s.getMesh(_),
        E = g
          ...
          .uniformTexture(
            "u_perturbationTexture3D",
            2,
            g.TEXTURE_2D,
            s.perturbationTexture3D
          )
          .uniform1f("u_perturbationTextureWidth", s.perturbationTexture3DWidth)
          .uniform2f(
            "u_baseTextureResolution",
            s.baseTextureWidth,
            s.baseTextureHeight
          ...
          .vertexAttribPointer(
            T.associationsBuffer,
            p.hairProgram.getAttribLocation("a_associations"),
            3,
            g.FLOAT,
            !1,
            0,
          ...
          .vertexAttribPointer(
            T.barycentricCoordinatesBuffer,
            p.hairProgram.getAttribLocation("a_barycentricCoordinates"),
            3,
            g.FLOAT,
            !1,
            0,
          ...
          .vertexAttribPointer(
            T.restPositionsBuffer,
            p.hairProgram.getAttribLocation("a_restPosition"),
            3,
            g.FLOAT,
            !1,
            0,
          ...
          .bindIndexBuffer(T.indexBuffer)
          .useProgram(p.hairProgram);
      if (
        (this.setLightingUniforms(E, 3),
        E.colorMask(!1, !1, !1, !1),
        ...
        var v = g
          ...
          .vertexAttribPointer(
            n.associationsBuffer,
            this.staticSkinProgram.getAttribLocation("a_associations"),
            3,
            g.FLOAT,
            !1,
            0,
          ...
          .vertexAttribPointer(
            n.barycentricCoordinatesBuffer,
            this.staticSkinProgram.getAttribLocation(
              "a_barycentricCoordinates"
            ),
            3,
            g.FLOAT,
          ...
          .vertexAttribPointer(
            n.mouthinessesBuffer,
            this.staticSkinProgram.getAttribLocation("a_mouthiness"),
            1,
            g.FLOAT,
            !1,
            0,
          ...
          .uniform3f(
            "u_mouthColor",
            LINEAR_MOUTH_COLOR[0],
            LINEAR_MOUTH_COLOR[1],
            LINEAR_MOUTH_COLOR[2]
          )
          .bindIndexBuffer(n.indexBuffer)
          .useProgram(this.staticSkinProgram);
        ...
        var A = r.getWrinkleMesh(_),
          M = g
            ...
            .viewport(0, 0, this.canvas.width, this.canvas.height)
            .enable(g.DEPTH_TEST)
            .vertexAttribPointer(A.vertexBuffer, 0, 2, g.FLOAT, g.FALSE, 0, 0)
            .bindIndexBuffer(A.indexBuffer)
            .uniformTexture(
              "u_positionsTexture",
              0,
              g.TEXTURE_2D,
            ...
            .useProgram(p.wrinkleProgram);
        this.setLightingUniforms(M, 3),
          M.colorMask(!1, !1, !1, !1),
          g.drawElements(
            M,
            A.wireframe ? g.LINES : g.TRIANGLES,
            A.wrinkleIndexCount,
            g.UNSIGNED_SHORT,
            0
          ),
      ...
      var x = function (e) {
        var t = g
          ...
          .viewport(0, 0, this.canvas.width, this.canvas.height)
          .enable(g.DEPTH_TEST)
          .vertexAttribPointer(e.positionsBuffer, 0, 3, g.FLOAT, g.FALSE, 0, 0)
          .vertexAttribPointer(e.normalsBuffer, 1, 3, g.FLOAT, g.FALSE, 0, 0)
          .bindIndexBuffer(e.indexBuffer)
      ...
      x(u),
        ...
        x(c),
        g.clear(
          g.createClearState().clearColor(0, 0, 0, 1),
          g.COLOR_BUFFER_BIT,
          g.DEPTH_BUFFER_BIT
        ),
        g.framebufferTexture2D(
      ...
      var b = g
        .createDrawState()
        .viewport(0, 0, this.canvas.width, this.canvas.height)
        .vertexAttribPointer(this.quadVertexBuffer, 0, 2, g.FLOAT, !1, 0, 0)
        .uniformTexture("u_depthTexture", 1, g.TEXTURE_2D, this.depthTexture)
        .uniform2f("u_resolution", this.canvas.width, this.canvas.height)
        .uniformMatrix4fv("u_projectionMatrix", !1, this.projectionMatrix)
        .uniform1f("u_near", NEAR)
        .uniform1f("u_far", FAR)
        .useProgram(p.sssBlurProgram);
      g.framebufferTexture2D(
        this.framebuffer,
        g.FRAMEBUFFER,
        g.COLOR_ATTACHMENT0,
        ...
        b
          .bindFramebuffer(this.framebuffer)
          .uniformTexture("u_colorTexture", 0, g.TEXTURE_2D, this.colorTexture)
      ...
      if (
        (this.canvas.width > this.canvas.height
          ? y.uniform2f(
              "u_scale",
              (Math.tan(this.fov / 2) * this.canvas.width) / this.canvas.height,
              Math.tan(this.fov / 2)
            )
          : y.uniform2f(
              "u_scale",
              Math.tan(this.fov / 2),
              (Math.tan(this.fov / 2) * this.canvas.height) / this.canvas.width
            ),
        ...
        R = g
          ...
          .viewport(0, 0, this.canvas.width, this.canvas.height)
          .vertexAttribPointer(this.quadVertexBuffer, 0, 2, g.FLOAT, !1, 0, 0)
          .uniformTexture("u_input", 0, g.TEXTURE_2D, this.colorTexture)
          .uniform2f("u_resolution", this.canvas.width, this.canvas.height)
          .uniform1f("u_scale", h)
        ...
        var P =
            this.canvas.height * ((S[1] / S[3]) * 0.5 + 0.5) -
            0.06 * this.canvas.height,
          C = Math.floor(this.canvas.width / 2 - d.width / 2),
          D = g
            .createDrawState()
            .bindFramebuffer(this.framebuffer)
            .viewport(C, P - d.height, d.width, d.height)
            .enable(g.DEPTH_TEST)
            .depthMask(!1)
            .vertexAttribPointer(this.quadVertexBuffer, 0, 2, g.FLOAT, !1, 0, 0)
            .useProgram(this.imageProgram)
            .enable(g.BLEND)
            .blendFunc(g.ONE, g.ONE_MINUS_SRC_ALPHA)
            .uniformTexture("u_image", 0, g.TEXTURE_2D, d.texture)
            .uniform1f("u_alpha", f);
    ...
    (Renderer.prototype.getRayDirection = function (e, t) {
      var r = 2 * Math.atan(1 / this.projectionMatrix[5]),
        n = [
          e * Math.tan(r / 2) * (this.canvas.width / this.canvas.height),
          t * Math.tan(r / 2),
          -1,
        ],
        i = Matrix4.invert([], this.viewMatrix),
        o = Matrix4.transformDirection([], n, i);
      return Vector3.normalize(o, o), o;
    }),
    (Eye.prototype.update = function (e, t, r) {
      var n = this.wgl;
      (this.vertices = this.module.HEAPF32.subarray(
        this.getEyePositionData(this.index) >> 2,
        (this.getEyePositionData(this.index) >> 2) +
          3 * this.getEyeVertexCount(this.index)
      )),
        (this.normals = this.module.HEAPF32.subarray(
          this.getEyeNormalData(this.index) >> 2,
          (this.getEyeNormalData(this.index) >> 2) +
            3 * this.getEyeVertexCount(this.index)
        )),
        n.bufferData(
        ...
        (this.position = [
          e.positions[3 * this.baseIndex + 0],
          e.positions[3 * this.baseIndex + 1],
          e.positions[3 * this.baseIndex + 2],
        ]);
      var i = [
        e.normals[3 * this.baseIndex + 0],
        e.normals[3 * this.baseIndex + 1],
        e.normals[3 * this.baseIndex + 2],
      ];
      ...
      Vector3.coneClamp(o, i, o, 1.3),
        Vector3.slerp(this.lookDirection, this.lookDirection, o, 0.7);
    }),
    ...
    (Hair.prototype.createMesh = function (e) {
      var t = this.wgl;
      0 === e
        ? (this.meshes[0] = new HairMesh(
            t,
            1,
            this.getHairVertexCount(),
            this.hairIndices,
            this.baseRestPositions
          ))
        : 1 === e &&
          (this.meshes[1] = new HairMesh(
            t,
            2,
            this.getHairVertexCount(),
            this.hairIndices,
      ...
      for (
        var e = this.wgl,
          ...
          r = this.module.HEAPF32.subarray(
            this.getHairNormalData() >> 2,
            (this.getHairNormalData() >> 2) + 3 * this.getHairVertexCount()
          ),
          n = 0;
        n < this.baseTextureWidth * this.baseTextureHeight;
        ++n
      )
        if (n < t.length / 3)
  ...
  QualitySelector.prototype.refresh = function () {
    for (var e = 0; e < this.buttons.length; ++e)
      e === this.currentValue
        ? (this.buttons[e].className = "quality quality-selected")
        : (this.buttons[e].className = "quality quality-unselected");
  };
  var Maths = {
      clamp: function (e, t, r) {
        return Math.max(t, Math.min(r, e));
  ...
  (Plane.prototype.distanceToPoint = function (e) {
    ...
    (Face.prototype.onMouseDown = function (e) {
      ...
      var r = this.renderer.getRayDirection(this.mouseX, this.mouseY),
        ...
        i = this.baseMesh.intersect(
          Vector3.multiplyByQuaternion([], this.renderer.cameraPosition, n),
          Vector3.multiplyByQuaternion([], r, n)
        );
      -1 !== i
        ? ((this.draggingTriangleIndex = i),
          (this.lastDraggingTriangleIndex = -1),
          -1 === this.framesAtFirstDrag &&
            (this.framesAtFirstDrag = this.framesSinceStart))
        : (this.draggingTriangleIndex = -1);
    }),
    ...
    (Face.prototype.onMouseUp = function (e) {
      -1 !== this.draggingTriangleIndex &&
        (this.lastDraggingTriangleIndex = this.draggingTriangleIndex),
        (this.draggingTriangleIndex = -1);
    }),
    (Face.prototype.onTouchStart = function (e) {
      if (
        (e.preventDefault(),
        1 === e.touches.length &&
          (this.onMouseDown(e.targetTouches[0]), !this.hasUnlockedAudio))
      ) {
    ...
    (Face.prototype.update = function () {
      if (
        ...
        Vector3.length(this.baseMesh.getPosition(e)) <
          Vector3.length(
            this.baseMesh.getRestPosition(this.lastDraggingTriangleIndex)
          ) &&
          ((this.audioParameters.slap = 1),
          (this.lastDraggingTriangleIndex = -1));
      }
      var t = [0, 0, 0];
      this.isDragging() &&
        (t = Vector3.subtract(
          [],
          this.baseMesh.getPosition(
            this.baseMesh.baseIndices[3 * this.draggingTriangleIndex]
          ),
          this.baseMesh.getRestPosition(this.draggingTriangleIndex)
        )),
      ...
      for (var r in this.audioParameters)
        Math.abs(this.audioParameters[r]) < 1e-4 &&
          (this.audioParameters[r] = 0);
      ...
      if (this.isDragging()) {
        var a,
          s = this.baseMesh.getRestPosition(this.draggingTriangleIndex),
          u = Vector3.normalize([], s),
          l = Vector3.normalize([], [u[0], u[1], 0]),
          c = new Plane(s, [0, 0, 1]),
          h = new Plane(s, l),
          d = c.intersect(this.renderer.cameraPosition, i),
          f = 0;
        if (h.distanceToPoint(d) < 0) {
          var _ = Math.acos(Vector3.dot(u, [0, 0, 1])) + 0.1,
            m = -h.distanceToPoint(d),
            p = Vector3.normalize([], Vector3.cross([], l, [0, 0, 1])),
            g = Math.min(_, 2 * Math.abs(m));
          (a = Quaternion.fromAxisAngle([], p, g)), (f = 0.15 * g);
        } else a = Quaternion.identity();
        var T = Quaternion.invert([], this.faceRotation),
          E = Vector3.multiplyByQuaternion(
            [],
            this.baseMesh.getRestPosition(this.draggingTriangleIndex),
            this.faceRotation
          );
        (o = new Plane(Vector3.add([], E, [0, 0, f]), [0, 0, 1]).intersect(
          this.renderer.cameraPosition,
          i
        )),
          Vector3.multiplyByQuaternion(o, o, T);
      } else a = Quaternion.identity();
      (this.faceRotation = Quaternion.slerp(
        [],
        this.faceRotation,
        a,
        this.isDragging() ? 0.1 : 0.05
      )),
        this.baseMesh.update(
          [0, 0, 0, 1],
          this.isDragging() ? 1 : 0,
          this.draggingTriangleIndex,
          o,
          this.isDragging() ? 0.8 : 0.97,
          0,
          this.renderer.cameraPosition,
          i
        );
      var v = new Plane([0, 0, 1.2], [0, 0, 1]).intersect(
        this.renderer.cameraPosition,
        i
      );
      this.hair.update(),
      ...
      this.isSimplified ||
        this.wrinkleSimulator.update(
          this.baseMesh.textureWidth,
          this.baseMesh.textureHeight,
          this.baseMesh.basePositionsTexture,
          this.baseMesh.baseNormalsTexture,
          this.baseMesh.positions,
          this.baseMesh.normals,
          this.isDragging(),
          this.draggingTriangleIndex,
          this.quality
        ),
      ...
      if (-1 === this.framesAtFirstDrag) x *= 1;
      else {
  ...
  if (
    null !== wgl &&
    null !== wgl.getExtension("OES_texture_float") &&
    null !== wgl.getExtension("WEBGL_depth_texture") &&
    hasWebAudioSupport()
  ) {
    ...
    document.getElementById("placeholder").outerHTML = document.getElementById(
      "no-support-template"
    ).innerHTML;
})();
