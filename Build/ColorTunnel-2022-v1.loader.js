function createUnityInstance(e, t, r) {
  ...
  function i(e) {
    ...
    if (
      ...
      var i = e.filename || (t && (t.fileName || t.sourceURL)) || "",
  ...
  function s(e, t) {
    if ("symbolsUrl" != e) {
      ...
      for (var e in c.downloadProgress) {
        ...
        a++,
          n.lengthComputable
            ? ((i += n.loaded), (o += n.total), s++)
            : n.finished || l++;
      }
      var d = a ? (a - l - (o ? (s * (o - i)) / o : 0)) / a : 0;
      r(0.9 * d);
    }
  }
  function l(e, t, r) {
    ...
    return new Promise(function (t, r) {
      ...
      i.open("GET", c[e]),
        ...
        i.addEventListener("load", function (r) {
          s(e, r), l(new Uint8Array(i.response), c[e], t);
        }),
      ...
      c.addRunDependency("dataUrl"),
        e.then(function (e) {
          ...
          for (r += 4; r < i; ) {
            ...
            c.FS_createDataFile(l, null, e.subarray(o, o + a), !0, !0, !0);
          }
  ...
  (c.SystemInfo = (function () {
    ...
    return {
      ...
      os: n || "Unknown OS",
      osVersion: i || "Unknown OS Version",
      gpu: a || "Unknown GPU",
      ...
      require: function (e) {
        var t = {
                ...
                c.next_out &&
                  ((0 !== c.avail_out &&
                    ...
                    ("string" === this.options.to
                      ? ((i = l.utf8border(c.output, c.next_out)),
                        (o = c.next_out - i),
                        (f = l.buf2string(c.output, i)),
                        (c.next_out = o),
                        (c.avail_out = b - o),
                        o && s.arraySet(c.output, c.output, i, o, 0),
                        this.onData(f))
          ...
          "utils/strings.js": function (e, t, r) {
            ...
            (s[254] = s[254] = 1),
              (r.string2buf = function (e) {
                ...
                for (t = new i.Buf8(l), a = 0, o = 0; a < l; o++)
                  (r = e.charCodeAt(o)),
                    55296 === (64512 & r) &&
                      o + 1 < s &&
                      ((n = e.charCodeAt(o + 1)),
              ...
              (r.buf2string = function (e, t) {
                var r,
                  ...
                  d = new Array(2 * l);
                for (i = 0, r = 0; r < l; )
                  if (((o = e[r++]), o < 128)) d[i++] = o;
                  else if (((a = s[o]), a > 4)) (d[i++] = 65533), (r += a - 1);
                  else {
          ...
          "zlib/inflate.js": function (e, t, r) {
            ...
            function o(e) {
              ...
              return e && e.state
                ? ((t = e.state),
                  ...
                  (t.hold = 0),
                  (t.bits = 0),
                  (t.lencode = t.lendyn = new p.Buf32(me)),
                  (t.distcode = t.distdyn = new p.Buf32(ge)),
                  (t.sane = 1),
                  (t.back = -1),
                  B)
                : O;
            ...
            function f(e) {
              if (ve) {
                var t;
                for (
                  g = new p.Buf32(512), w = new p.Buf32(32), t = 0;
                  t < 144;
                ...
                for (
                  _(S, e.lens, 0, 288, g, 0, e.work, { bits: 9 }), t = 0;
                  t < 32;
            ...
            function u(e, t, r, n) {
              ...
              return (
                ...
                n >= o.wsize
                  ? (p.arraySet(o.window, t, r - o.wsize, o.wsize, 0),
                    (o.wnext = 0),
                    (o.whave = o.wsize))
                  : ((i = o.wsize - o.wnext),
                    i > n && (i = n),
                    p.arraySet(o.window, t, r - n, i, o.wnext),
                    (n -= i),
                    n
                      ? (p.arraySet(o.window, t, r - n, n, 0),
                        (o.wnext = n),
                        (o.whave = o.wsize))
                      : ((o.wnext += i),
              ...
              e: for (;;)
                switch (r.mode) {
                    ...
                    if (
                      ...
                      g &&
                        (r.head &&
                          ...
                          p.arraySet(r.head.extra, i, a, g, _e)),
                        512 & r.flags && (r.check = k(r.check, i, g, a)),
                        (l -= g),
                        (a += g),
                        (r.length -= g)),
                      r.length)
                  ...
                  case K:
                    ...
                    (e.adler = r.check = n(c)), (c = 0), (h = 0), (r.mode = V);
                  case V:
                    if (0 === r.havedict)
                      return (
                        (e.next_out = s),
              ...
              return (
                ...
                (r.wsize ||
                  (m !== e.avail_out &&
                    r.mode < ce &&
                    (r.mode < de || t !== U))) &&
                u(e, e.output, e.next_out, m - e.avail_out)
                  ? ((r.mode = he), I)
                  : ((b -= e.avail_in),
                    (m -= e.avail_out),
                    (e.total_in += b),
                    ...
                    r.wrap &&
                      ...
                      (e.adler = r.check =
                        r.flags
                          ? k(r.check, o, m, e.next_out - m)
                          : v(r.check, o, m, e.next_out - m)),
                    (e.data_type =
                      r.bits +
                      (r.last ? 64 : 0) +
                      (r.mode === Y ? 128 : 0) +
                      (r.mode === re || r.mode === Q ? 256 : 0)),
                    ((0 === b && 0 === m) || t === U) && xe === B && (xe = F),
                    xe)
              );
            }
            function h(e) {
            ...
            function b(e, t) {
              ...
              return e && e.state
                ? ((r = e.state),
                  0 === (2 & r.wrap) ? O : ((r.head = t), (t.done = !1), B))
                : O;
            }
            function m(e, t) {
              var r,
          ...
          "zlib/inftrees.js": function (e, t, r) {
            ...
            t.exports = function (e, t, r, b, m, g, w, p) {
              var v,
                k,
                y,
                _,
              ...
              for (A = T, O = i; O >= 1 && 0 === D[O]; O--);
              if ((A > O && (A = O), 0 === O))
                return (
                  (m[g++] = 20971520), (m[g++] = 20971520), (p.bits = 1), 0
                );
              for (R = 1; R < O && 0 === D[R]; R++);
              for (A < R && (A = R), z = 1, B = 1; B <= i; B++)
                if (((z <<= 1), (z -= D[B]), z < 0)) return -1;
              if (z > 0 && (e === s || 1 !== O)) return -1;
              for (j[1] = 0, B = 1; B < i; B++) j[B + 1] = j[B] + D[B];
              for (L = 0; L < b; L++) 0 !== t[r + L] && (w[j[t[r + L]]++] = L);
              if (
                (e === s
                  ? ((P = M = w), (S = 19))
                  : e === l
                  ? ((P = f), (H -= 257), (M = u), (W -= 257), (S = 256))
                  : ((P = c), (M = h), (S = -1)),
                (N = 0),
                (L = 0),
                (B = R),
              ...
              for (;;) {
                ...
                if (B > A && (N & _) !== y) {
                  for (
                    0 === F && (F = A), x += R, I = B - F, z = 1 << I;
                    I + F < O && ((z -= D[I + F]), !(z <= 0));

                  )
                    I++, (z <<= 1);
                  if (((Z += 1 << I), (e === l && Z > o) || (e === d && Z > a)))
                    return 1;
                  (y = N & _), (m[y] = (A << 24) | (I << 16) | (x - g) | 0);
                }
              }
              return (
                0 !== N && (m[x + N] = ((B - F) << 24) | (64 << 16) | 0),
                (p.bits = A),
                0
              );
            };
        ...
        var n = function (e) {
          ...
          i = function (e, t) {
            return e
              ? n(e.folder + "node_modules/" + t) || i(e.parent, t)
              : null;
          },
          o = function (e, t) {
            var r = t.match(/^\//)
