...
(function (i, g) {
  function R(R, fa) {
    ...
    var Ga,
      ...
      Va =
        !ga.match(/usehtml5audio/i) &&
        !ga.match(/sm2\-ignorebadua/i) &&
        Aa &&
        !q.match(/silk/i) &&
        q.match(/OS X 10_6_([3-7])/i),
    ...
    this.setup = function (b) {
      ...
      b !== g &&
        ...
        u &&
        c.ok() &&
        (b.flashVersion !== g || b.url !== g || b.html5Test !== g) &&
        H(v("setupLate"));
      ka(b);
    ...
    this.createSound = function (b, e) {
      ...
      ba(a)
        ? ((f = d()), f._setup_html5(a))
        : (8 < k &&
            null === a.isMovieStar &&
            (a.isMovieStar = !(
              !a.serverURL && !((a.type && a.type.match(Za)) || a.url.match(fb))
            )),
          (a = Z(a, void 0)),
          (f = d()),
          8 === k
            ? h._createSound(a.id, a.loops || 1, a.usePolicyFile)
            : (h._createSound(
                a.id,
                a.url,
                a.usePeakData,
    ...
    this.start = this.play = function (b, e) {
      var d = !1;
      return !j || !c.ok()
        ? (H("soundManager.play(): " + v(!j ? "notReady" : "notOK")), d)
        : !p(b)
    ...
    this.mute = function (b) {
      ...
      if (b) return !p(b) ? !1 : c.sounds[b].mute();
    ...
    this.canPlayMIME = function (b) {
      ...
      !e &&
        ...
        (e =
          b && c.ok()
            ? !!((8 < k && b.match(Za)) || b.match(c.mimePattern))
            : null);
      return e;
    };
    ...
    this.ontimeout = function (b, c) {
      if ("function" === typeof b)
        c || (c = i), la("ontimeout", b, c), B({ type: "ontimeout" });
    ...
    Ga = function (b) {
      ...
      this.load = function (b) {
        ...
        if (ba(b))
          (c = a._setup_html5(b)),
            c._called_load ||
              ((a._html5_canplay = !1),
              a.url !== b.url && ((a._a.src = b.url), a.setPosition(0)),
          ...
          try {
            (a.isHTML5 = !1),
              ...
              (b = a._iO),
              8 === k
                ? h._load(a.id, b.url, b.stream, b.autoPlay, b.usePolicyFile)
                : h._load(
                    a.id,
                    b.url,
                    !!b.stream,
      ...
      this.unload = function () {
        0 !== a.readyState &&
          (a.isHTML5
            ? (I(),
              a._a &&
                (a._a.pause(), wa(a._a, "about:blank"), (r = "about:blank")))
            : 8 === k
            ? h._unload(a.id, "about:blank")
            : h._unload(a.id),
          f());
        return a;
      };
        ...
        a.isHTML5
          ? (I(),
            a._a &&
              ...
              (a._a._s = null),
              (a._a = null)))
          : ((a._iO.onfailure = null), h._destroySound(a.id));
      ...
      this.start = this.play = function (b, c) {
        ...
        if (a.paused && 0 <= a.position && (!a._iO.serverURL || 0 < a.position))
          ...
          (!a.instanceCount ||
            ...
            (!a.isHTML5 && 8 < k && !a.getAutoPlay())) &&
            a.instanceCount++;
          a._iO.onposition && 0 === a.playState && m(a);
          a.playState = 1;
          a.paused = !1;
          a.position =
            a._iO.position !== g && !isNaN(a._iO.position) ? a._iO.position : 0;
          ...
          a.isHTML5
            ...
            : ((d = h._start(
                a.id,
                a._iO.loops || 1,
                9 === k ? a._iO.position : a._iO.position / 1e3,
                a._iO.multiShot
              )),
        ...
        1 === a.playState &&
          ...
          a.isHTML5
            ? a._a &&
              ...
              a._onTimer(),
              I())
            : (h._stop(a.id, b), c.serverURL && a.unload()),
          (a.instanceCount = 0),
          (a._iO = {}),
      ...
      this.pause = function (b) {
        ...
        a.paused = !0;
        a.isHTML5
          ? (a._setup_html5().pause(), I())
          : (b || b === g) && h._pause(a.id, a._iO.multiShot);
      ...
      this.setVolume = function (b, e) {
        ...
        e === g && (e = !1);
        a.isHTML5
          ? a._a && (a._a.volume = Math.max(0, Math.min(1, b / 100)))
          : h._setVolume(a.id, (c.muted && !a.muted) || a.muted ? 0 : b);
        a._iO.volume = b;
      ...
      this.unmute = function () {
        ...
        a.isHTML5
          ? a._a && (a._a.muted = !1)
          : h._setVolume(a.id, b ? a._iO.volume : a.options.volume);
        return a;
      };
        ...
        for (b -= 1; 0 <= b; b--)
          (c = j[b]),
            !c.fired &&
              ...
              ((c.fired = !0), n++, c.method.apply(c.scope, [c.position]));
        return !0;
      };
      ...
      this._setup_html5 = function (b) {
        ...
        if (e) {
          if (e._s)
            if (w) e._s && e._s.playState && !g && e._s.stop();
    ...
    t = function (b, e) {
      ...
      for (f in a)
        a.hasOwnProperty(f) &&
          d[f] === g &&
          (d[f] =
            "object" !== typeof a[f] || null === a[f] ? a[f] : t(d[f], a[f]));
      return d;
    };
    U = {
      onready: 1,
        ...
        if (b.hasOwnProperty(d))
          if (
            ...
            f && U[e] !== g
              ...
              : U[d] === g
              ? (H(v(c[d] === g ? "setupUndef" : "setupError", d), 2), (a = !1))
    ...
    var bb = function (b) {
        var b = db.call(b),
          c = b.length;
        ea ? ((b[1] = "on" + b[1]), 3 < c && b.pop()) : 3 === c && b.push(!1);
        return b;
      },
      cb = function (b, c) {
        var d = b.shift(),
    ...
    ba = function (b) {
      return b.serverURL || (b.type && S(b.type))
        ? !1
        : b.type
        ? Q({ type: b.type })
        : Q({ url: b.url }) || c.html5Only;
    };
    wa = function (b, c) {
    ...
    Q = function (b) {
      ...
      if (!y) {
        ...
        for (a in d)
          d.hasOwnProperty(a) &&
            (y.push(a), d[a].related && (y = y.concat(d[a].related)));
        y = RegExp("\\.(" + y.join("|") + ")(\\?.*)?$", "i");
      }
    ...
    ma = function () {
      ...
      c.version =
        ...
        (c.html5Only
          ...
          : " (AS2/Flash 8)");
      8 < k
        ? ((c.defaultOptions = t(c.defaultOptions, c.flash9Options)),
      ...
      c.movieURL = (
        8 === k ? "soundmanager2.swf" : "soundmanager2_flash9.swf"
      ).replace(".swf", b);
    ...
    ua = function () {
      ...
      c.ok()
        ...
        : (u &&
          ...
          (c.didFlashBlock = !0),
          B({ type: "ontimeout", ignoreInit: !0, error: e }),
          F(e));
    };
    la = function (b, c, d) {
      r[b] === g && (r[b] = []);
    ...
    B = function (b) {
      ...
      if (
        (!j && b && !b.ignoreInit) ||
        ("ontimeout" === b.type && (c.ok() || (s && !b.ignoreInit)))
      )
        return !1;
      var e = { success: b && b.ignoreInit ? c.ok() : !s },
        d = b && b.type ? r[b.type] || [] : [],
        a = [],
        f,
        e = [e],
    ...
    Ra = function () {
      ...
      if (c.useHTML5Audio && c.hasHTML5)
        for (e in d)
          if (
            d.hasOwnProperty(e) &&
            ((d[e].required && !c.html5.canPlayType(d[e].type)) ||
              (c.preferFlash && (c.flash[e] || c.flash[d[e].type])))
          )
            b = !0;
      c.ignoreFlash && (b = !1);
    ...
    Na = function (b) {
      b._hasTimer ||
        ...
        !Ca &&
          ...
          (null === P &&
            0 === $ &&
            (P = i.setInterval(Pa, c.html5PollingInterval)),
          $++));
    };
    Oa = function (b) {
    ...
    F = function (b) {
      ...
      "function" === typeof c.onerror &&
        c.onerror.apply(i, [{ type: b.type !== g ? b.type : null }]);
    ...
    X = function (b, e) {
      ...
      if (J && K) return !1;
      if (c.html5Only)
        return ma(), (c.oMC = T(c.movieID)), ia(), (K = J = !0), !1;
      var a = e || c.url,
        f = c.altURL || a,
        h = qa(),
        i = G(),
      ...
      if (
        null !== c.wmode &&
        (q.match(/msie 8/i) || (!z && !c.useHighPerformance)) &&
        navigator.platform.match(/win32|win64/i)
      )
        Qa.push(na.spcWmode), (c.wmode = null);
      h = {
        name: b,
        id: b,
        src: e,
      ...
      if (z)
        ...
        for (j in ((a = l.createElement("embed")), h))
          h.hasOwnProperty(j) && a.setAttribute(j, h[j]);
      ra();
      i = G();
      if ((h = qa()))
        if (((c.oMC = T(c.movieID) || l.createElement("div")), c.oMC.id))
          (m = c.oMC.className),
            (c.oMC.className =
              (m ? m + " " : "movieContainer") + (i ? " " + i : "")),
            c.oMC.appendChild(a),
            z &&
              ((j = c.oMC.appendChild(l.createElement("div"))),
    ...
    W = function () {
      ...
      h ||
        (N
          ? (z ? (c.oMC.innerHTML = ta) : c.oMC.appendChild(N),
            (N = null),
            (J = !0))
          : X(c.id, c.url),
        (h = c.getMovie(c.id)));
    ...
    V = function () {
      if (Da || !da) return n.remove(i, "focus", V), !0;
      Da = Wa = !0;
      O = !1;
      D();
      n.remove(i, "focus", V);
    ...
    L = function (b) {
      ...
      if (!c.useFlashBlock || !c.flashLoadTimeout || c.getMoviePercent())
        (j = !0), s && (d = { type: !A && u ? "NO_FLASH" : "INIT_TIMEOUT" });
      if (s || b)
        c.useFlashBlock &&
          c.oMC &&
          (c.oMC.className =
          ...
          B({ type: "ontimeout", error: d, ignoreInit: !0 }),
          F(d),
          (e = !1);
    ...
    ia = function () {
      ...
      if (c.html5Only)
        return (
          j || (n.remove(i, "load", c.beginDelayedInit), (c.enabled = !0), L()),
          !0
        );
      W();
      try {
    ...
    xa = function () {
      "complete" === l.readyState &&
        (E(), l.detachEvent("onreadystatechange", xa));
      return !0;
    };
    pa = function () {
      ja = !0;
    ...
    n.add(i, "load", pa);
    l.addEventListener
      ? l.addEventListener("DOMContentLoaded", E, !1)
      : l.attachEvent
      ? l.attachEvent("onreadystatechange", xa)
      : F({ type: "NO_DOM2_EVENTS", fatal: !0 });
  }
  var fa = null;
