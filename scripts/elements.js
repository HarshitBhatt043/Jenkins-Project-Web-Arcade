...
function PLANT_ACTION(a, e, n) {
  if ((doGrow(a, e, n, WATER, 50), random() < 5)) {
    if (-1 !== bordering(a, e, n, SALT))
      return void (gameImagedata32[n] = BACKGROUND);
  }
}
function FIRE_ACTION(a, e, n) {
  if (random() < 80) {
    ...
    if (
      (-1 === t && (t = bordering(a, e, n, SALT_WATER)),
      -1 !== t && -1 === bordering(a, e, n, BURNING_THERMITE))
    )
      return (
        (gameImagedata32[t] = STEAM), void (gameImagedata32[n] = BACKGROUND)
      );
  }
  if (random() < 20) {
...
function SALT_ACTION(a, e, n) {
  doGravity(a, e, n, !0, 95) ||
    doTransform(a, e, n, WATER, SALT_WATER, 25, 50) ||
    doDensitySink(a, e, n, SALT_WATER, !0, 25);
}
function SALT_WATER_ACTION(a, e, n) {
  doGravity(a, e, n, !0, 95) || doDensityLiquid(a, e, n, WATER, 50, 50);
}
function OIL_ACTION(a, e, n) {
  random() < 30 && -1 !== bordering(a, e, n, FIRE)
    ? __doBorderBurn(a, e, n)
    : doGravity(a, e, n, !0, 95);
}
...
function GUNPOWDER_ACTION(a, e, n) {
  if (random() < 95 && -1 !== bordering(a, e, n, FIRE))
    if (
      ...
      t &&
        (t.setColor(FIRE), particles.reinitializeParticle(t, MAGIC1_PARTICLE));
...
function NAPALM_ACTION(a, e, n) {
  random() < 25 && -1 !== bordering(a, e, n, FIRE)
    ? particles.addActiveParticle(NAPALM_PARTICLE, a, e, n) ||
      (gameImagedata32[n] = FIRE)
    : doGravity(a, e, n, !0, 95);
}
function C4_ACTION(a, e, n) {
  random() < 60 &&
    -1 !== bordering(a, e, n, FIRE) &&
    (particles.addActiveParticle(C4_PARTICLE, a, e, n) ||
      (gameImagedata32[n] = FIRE));
}
function CONCRETE_ACTION(a, e, n) {
  ...
  if (random() < 10 && random() < 10) {
    if (-1 !== borderingAdjacent(a, e, n, WALL))
      return void (gameImagedata32[n] = WALL);
  }
  doGravity(a, e, n, !0, 95) ||
    (random() < 10 &&
      random() < 10 &&
      random() < 5 &&
      (gameImagedata32[n] = WALL));
}
function FUSE_ACTION(a, e, n) {}
function ICE_ACTION(a, e, n) {
  if (!surroundedBy(a, e, n, ICE))
    if (random() < 1 && -1 !== bordering(a, e, n, WATER))
      gameImagedata32[n] = WATER;
    else {
      if (random() < 70) {
        ...
        if (-1 !== t)
          return (
            (gameImagedata32[n] = WATER),
            void (random() < 50 && (gameImagedata32[t] = WATER))
          );
      }
      if (random() < 10) {
        var t = bordering(a, e, n, SALT);
        if ((-1 === t && (t = bordering(a, e, n, SALT_WATER)), -1 !== t))
          return void (gameImagedata32[n] = WATER);
      }
      ((random() < 50 && -1 !== bordering(a, e, n, FIRE)) ||
        (random() < 50 && -1 !== bordering(a, e, n, LAVA))) &&
        (gameImagedata32[n] = WATER);
    }
}
function CHILLED_ICE_ACTION(a, e, n) {
  random() < 6
    ? (gameImagedata32[n] = ICE)
    : -1 === bordering(a, e, n, SALT) &&
      -1 === bordering(a, e, n, SALT_WATER) &&
      -1 === bordering(a, e, n, LAVA) &&
      -1 === bordering(a, e, n, FIRE) &&
      -1 === bordering(a, e, n, STEAM)
    ? doGrow(a, e, n, WATER, 50)
    : (gameImagedata32[n] = ICE);
}
const __lava_immune = [
  LAVA,
...
function LAVA_ACTION(a, e, n) {
  ...
  var r = !0;
  if (
    (((-1 !== t && gameImagedata32[t] !== LAVA) ||
      (-1 !== d &&
        gameImagedata32[d] !== LAVA &&
        gameImagedata32[d] !== BACKGROUND) ||
      (-1 !== i &&
        gameImagedata32[i] !== LAVA &&
        gameImagedata32[i] !== BACKGROUND) ||
      (-1 !== o &&
        gameImagedata32[o] !== LAVA &&
        gameImagedata32[o] !== BACKGROUND)) &&
      (r = !1),
    !r)
  ) {
    if (random() < 4) {
      const t = particles.particleCounts[LAVA_PARTICLE] < 10 ? 100 : 35;
      if (random() < t && -1 !== bordering(a, e, n, OIL))
        return (
          particles.addActiveParticle(LAVA_PARTICLE, a, e, n),
          void (gameImagedata32[n] = BACKGROUND)
        );
    }
    if (random() < 25) {
      const a = [t, o, d, i],
    ...
    if (
      ...
      else if (a === STEAM && random() < 95)
        return (gameImagedata32[o] = LAVA), void (gameImagedata32[n] = STEAM);
    }
    random() < 15 &&
      (-1 !== d &&
        gameImagedata32[d] === FIRE &&
        (gameImagedata32[d] = BACKGROUND),
      -1 !== i &&
...
function ROCK_ACTION(a, e, n) {
  ...
  if (
    ...
    if (-1 !== a)
      return void (random() < 50
        ? (gameImagedata32[a] = METHANE)
        : (gameImagedata32[n] = METHANE));
  }
}
function STEAM_ACTION(a, e, n) {
  doDensityGas(a, e, n, 70) ||
    doRise(a, e, n, 70, 60) ||
    (random() < 5 && -1 !== bordering(a, e, n, WATER)
      ? (gameImagedata32[n] = WATER)
      : random() < 5 &&
        random() < 40 &&
        -1 !== below(e, n, BACKGROUND) &&
        -1 === above(e, n, BACKGROUND)
      ? random() < 30
        ? (gameImagedata32[n] = WATER)
        : (gameImagedata32[n] = BACKGROUND)
      : random() < 5 && -1 !== bordering(a, e, n, SPOUT)
      ? (gameImagedata32[n] = WATER)
      : random() < 1 &&
        random() < 5 &&
        -1 === below(e, n, STEAM) &&
...
function CRYO_ACTION(a, e, n) {
  ...
  for (m = o; m !== i; m++) {
    ...
    for (r = t; r !== d; r++) {
      ...
      const t = o + r,
        d = gameImagedata32[t];
      if (d !== CRYO) {
        if (d === CHILLED_ICE && random() < 1 && random() < 5)
          return void (gameImagedata32[n] = CHILLED_ICE);
        if (
          d === WALL ||
          d === SPOUT ||
          d === WAX ||
        ...
        if (d === WATER || d === ICE)
          return (
            (gameImagedata32[t] = CHILLED_ICE),
            void (gameImagedata32[n] = CHILLED_ICE)
          );
        if (d === LAVA)
          return (
            (gameImagedata32[n] = BACKGROUND), void (gameImagedata32[t] = ROCK)
          );
      }
    }
  }
  doGravity(a, e, n, !0, 95) ||
    (random() < 1 &&
      random() < 50 &&
      -1 === bordering(a, e, n, BACKGROUND) &&
      !surroundedBy(a, e, n, CRYO) &&
      (gameImagedata32[n] = CHILLED_ICE));
}
function MYSTERY_ACTION(a, e, n) {
  if (
    ...
    if (-1 !== borderingAdjacent(a, e, n, SAND))
      return (
        particles.addActiveParticle(MAGIC1_PARTICLE, a, e, n),
        void (gameImagedata32[n] = BACKGROUND)
      );
    if (-1 !== borderingAdjacent(a, e, n, SALT))
      return (
        particles.addActiveParticle(MAGIC2_PARTICLE, a, e, n),
        void (gameImagedata32[n] = BACKGROUND)
      );
    if (-1 !== bordering(a, e, n, FIRE))
      for (var t = MAX_IDX; 0 !== t; t--) {
        ...
        n !== WALL &&
          n !== FIRE &&
          n !== MYSTERY &&
          ((gameImagedata32[t] = n), (gameImagedata32[e] = a));
      }
    return -1 !== bordering(a, e, n, POLLEN)
      ? (particles.addActiveParticle(NUKE_PARTICLE, a, e, n),
        void (gameImagedata32[n] = BACKGROUND))
      : void 0;
  }
}
function METHANE_ACTION(a, e, n) {
  random() < 25 && -1 !== bordering(a, e, n, FIRE)
    ? particles.addActiveParticle(METHANE_PARTICLE, a, e, n) ||
      (gameImagedata32[n] = FIRE)
    : doRise(a, e, n, 25, 65) || doDensityGas(a, e, n, 70);
}
  ...
  if (!doGravity(a, e, n, !1, 99)) {
    ...
    if (!doTransform(a, e, n, NITRO, CHARGED_NITRO, 25, 100) && random() < 15) {
      ...
      if (-1 !== t)
        return (
          (gameImagedata32[t] = BACKGROUND),
          void (gameImagedata32[n] = WET_SOIL)
        );
    }
  }
}
function WET_SOIL_ACTION(a, e, n) {
  if (random() < 15) {
    const t = aboveAdjacent(a, e, n, WATER);
    -1 !== t && (gameImagedata32[t] = BACKGROUND);
  }
  if (
    !doGravity(a, e, n, !1, 99) &&
    !doDensitySink(a, e, n, WATER, !0, 50) &&
    !doDensitySink(a, e, n, SALT_WATER, !0, 50) &&
    random() < 5
  ) {
    if (random() < 97)
      return void (
        -1 === borderingAdjacent(a, e, n, WATER) && (gameImagedata32[n] = SOIL)
      );
    if (random() < 35) return;
    -1 === aboveAdjacent(a, e, n, BACKGROUND) ||
      (-1 === belowAdjacent(a, e, n, SOIL) &&
        -1 === belowAdjacent(a, e, n, WALL)) ||
      (particles.addActiveParticle(TREE_PARTICLE, a, e, n) &&
        (gameImagedata32[n] = SOIL));
  }
}
function BRANCH_ACTION(a, e, n) {
  random() < 3 &&
    -1 !== borderingAdjacent(a, e, n, FIRE) &&
    (gameImagedata32[n] = FIRE);
}
...
function CHARGED_NITRO_ACTION(a, e, n) {
  if (!doGravity(a, e, n, !0, 95)) {
    ...
    return -1 !== borderingAdjacent(a, e, n, FIRE)
      ? (particles.addActiveParticle(CHARGED_NITRO_PARTICLE, a, e, n),
        void (gameImagedata32[n] = FIRE))
      : void 0;
  }
}
function ACID_ACTION(a, e, n) {
  if (random() < 10) {
    ...
    var t, o;
    for (
      random() < 50 && ((A[0] = m), (A[1] = r)),
        random() < 50 && ((I[0] = d), (I[1] = i)),
        o = 0;
      3 !== o;
      o++
    ) {
      ...
      for (t = 0; 3 !== t; t++) {
        ...
        if (
          ...
          return d !== e + 1
            ? void (gameImagedata32[i] = BACKGROUND)
            : ((gameImagedata32[n] = BACKGROUND),
              void (
                (m !== WALL || random() < 75) &&
                (gameImagedata32[i] = ACID)
              ));
      }
    }
  }
  doDensityLiquid(a, e, n, WATER, 25, 30) ||
    doDensityLiquid(a, e, n, SALT_WATER, 25, 30) ||
    doGravity(a, e, n, !0, 100);
}
function THERMITE_ACTION(a, e, n) {
  surroundedByAdjacent(a, e, n, THERMITE) ||
    (random() < 50 && -1 !== borderingAdjacent(a, e, n, FIRE)
      ? (gameImagedata32[n] = BURNING_THERMITE)
      : doDensitySink(a, e, n, WATER, !1, 95) ||
        doDensitySink(a, e, n, SALT_WATER, !1, 95) ||
        doDensitySink(a, e, n, OIL, !1, 95) ||
        doGravity(a, e, n, !1, 99));
}
function BURNING_THERMITE_ACTION(a, e, n) {
  ...
  if (random() < 8) {
    const t = adjacent(a, n, WALL);
    -1 !== t && (gameImagedata32[t] = BACKGROUND);
    const o = below(e, n, WALL);
    -1 !== o && (gameImagedata32[o] = BACKGROUND);
  }
  const d = below(e, n, FIRE);
  -1 !== d && (gameImagedata32[d] = BACKGROUND),
    doGravity(a, e, n, !1, 99) ||
      doDensitySink(a, e, n, WATER, !1, 95) ||
      doDensitySink(a, e, n, SALT_WATER, !1, 95) ||
      doDensitySink(a, e, n, OIL, !1, 95);
...
function belowAdjacent(a, e, n, t) {
  ...
  const d = o - 1,
    i = o + 1;
  return __pickRandValid(
    0 !== a && gameImagedata32[d] === t ? d : -1,
    a !== MAX_X_IDX && gameImagedata32[i] === t ? i : -1
  );
}
...
function adjacent(a, e, n) {
  const t = e - 1,
    o = e + 1;
  return __pickRandValid(
    0 !== a && gameImagedata32[t] === n ? t : -1,
    a !== MAX_X_IDX && gameImagedata32[o] === n ? o : -1
  );
}
...
function surroundedBy(a, e, n, t) {
  return (
    (e === MAX_Y_IDX || gameImagedata32[n + width] === t) &&
    (0 === e || gameImagedata32[n - width] === t) &&
    (0 === a || gameImagedata32[n - 1] === t) &&
    (a === MAX_X_IDX || gameImagedata32[n + 1] === t)
  );
}
...
function surroundedByCount(a, e, n, t) {
  var o = 0;
  return (
    e !== MAX_Y_IDX && gameImagedata32[n + width] === t && o++,
    0 !== e && gameImagedata32[n - width] === t && o++,
    0 !== a && gameImagedata32[n - 1] === t && o++,
    a !== MAX_X_IDX && gameImagedata32[n + 1] === t && o++,
    o
  );
}
function surroundedByAdjacentCount(a, e, n, t) {
  ...
  var i = 0;
  if (
    (o || gameImagedata32[n + width] !== t || i++,
    d || gameImagedata32[n - width] !== t || i++,
    0 !== a)
  ) {
    const a = n - 1;
    gameImagedata32[a] === t && i++,
      d || gameImagedata32[a - width] !== t || i++,
      o || gameImagedata32[a + width] !== t || i++;
  }
  if (a !== MAX_X_IDX) {
    const a = n + 1;
    gameImagedata32[a] === t && i++,
...
function doGravity(a, e, n, t, o) {
  return (
    !(random() >= o) &&
    (e === MAX_Y_IDX
      ? ((gameImagedata32[n] = BACKGROUND), !0)
      : (-1 ===
          (d = t
            ? belowAdjacent(a, e, n, BACKGROUND)
            : below(e, n, BACKGROUND)) &&
          t &&
          (d = adjacent(a, n, BACKGROUND)),
        -1 !== d &&
          ((gameImagedata32[d] = gameImagedata32[n]),
          (gameImagedata32[n] = BACKGROUND),
          !0)))
  );
  var d;
...
function doRise(a, e, n, t, o) {
  ...
  return (
    -1 === d && random() < o && (d = adjacent(a, n, BACKGROUND)),
    -1 !== d &&
      ((gameImagedata32[d] = gameImagedata32[n]),
      (gameImagedata32[n] = BACKGROUND),
      !0)
...
function doDensitySink(a, e, n, t, o, d) {
  return (
    !(random() >= d) &&
    e !== MAX_Y_IDX &&
    -1 !== (i = o ? belowAdjacent(a, e, n, t) : below(e, n, t)) &&
    ((gameImagedata32[i] = gameImagedata32[n]), (gameImagedata32[n] = t), !0)
  );
  var i;
}
function doDensityLiquid(a, e, n, t, o, d) {
  var i = -1;
  return (
    random() < o && (i = belowAdjacent(a, e, n, t)),
...
function __doBorderBurn(a, e, n) {
  0 !== e && (gameImagedata32[n - width] = FIRE),
    e !== MAX_Y_IDX && (gameImagedata32[n + width] = FIRE),
    0 !== a && (gameImagedata32[n - 1] = FIRE),
    a !== MAX_X_IDX && (gameImagedata32[n + 1] = FIRE),
    (gameImagedata32[n] = FIRE);
}
function __doGunpowderExplosion(a, e, n) {
  ...
  if (((gameImagedata32[n] = o), 0 !== e)) {
    const a = n - width;
    (gameImagedata32[a] = o),
      d && (gameImagedata32[a - 1] = o),
      i && (gameImagedata32[a + 1] = o);
  }
  if (
    (d && (gameImagedata32[n - 1] = o),
    i && (gameImagedata32[n + 1] = o),
    e !== MAX_Y_IDX)
  ) {
    const a = n + width;
    (gameImagedata32[a] = o),
  ...
  if (t && !(random() >= 40)) {
    if (e - 2 >= 0) {
      const a = n - 2 * width;
      (gameImagedata32[a] !== GUNPOWDER || random() < 50) &&
        (gameImagedata32[a] = FIRE);
    }
    if (e + 2 >= 0) {
      const a = n + 2 * width;
...
function doTransform(a, e, n, t, o, d, i) {
  ...
  return (
    -1 !== m &&
    ((gameImagedata32[n] = o), r < i && (gameImagedata32[m] = o), !0)
  );
}
function doProducer(a, e, n, t, o, d) {
  ...
  const i = n - width,
    ...
    A = n + 1;
  0 === e ||
    (!o && gameImagedata32[i] !== BACKGROUND) ||
    (gameImagedata32[i] = t),
    e === MAX_Y_IDX ||
      (!o && gameImagedata32[r] !== BACKGROUND) ||
      (gameImagedata32[r] = t),
    0 === a ||
      (!o && gameImagedata32[m] !== BACKGROUND) ||
      (gameImagedata32[m] = t),
    a === MAX_X_IDX ||
      (!o && gameImagedata32[A] !== BACKGROUND) ||
      (gameImagedata32[A] = t);
}
function uniformBelowAdjacent(a, e, n) {
  ...
  const t = n + width,
    o = gameImagedata32[t];
  return (0 !== a && gameImagedata32[t - 1] !== o) ||
    (a !== MAX_X_IDX && gameImagedata32[t + 1] !== o)
    ? -1
    : o;
}
...
function doDensityGas(a, e, n, t) {
  ...
  if (gasPermeable(r)) d = i;
    ...
    var m = -1,
      A = -1;
    t !== r && gasPermeable(t) && (m = e),
      o !== r && ((-1 !== m && t === o) || gasPermeable(o)) && (A = n),
      (d = __pickRandValid(m, A));
  }
  if (-1 === d && 0 !== a && a !== MAX_X_IDX && e !== MAX_Y_IDX) {
    if (
      gasPermeable(gameImagedata32[n - 1]) &&
      gameImagedata32[n - 1 + width] !== o
    )
      d = n - 1;
    else {
      gasPermeable(gameImagedata32[n + 1]) &&
  ...
  return (
    -1 !== d &&
    ((gameImagedata32[n] = gameImagedata32[d]), (gameImagedata32[d] = o), !0)
  );
}
