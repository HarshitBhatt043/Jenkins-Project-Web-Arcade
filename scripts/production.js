...
var Board = (function () {
  ...
  function cell(x, y, value) {
    if (arguments.length == 3) cells[x][y].html(value);
    else return parseInt(cells[x][y].html());
  }
  ...
  var setNumLevels = function (num) {
    if (numLevels < 0)
      // This is a dirty workaround to bug #15, but it works
      numLevels = num;
  };
...
var Selector = (function () {
  ...
  var snapTo = function (x, y) {
    ...
    selector.animate(
      {
        top:
          $('td[data-x="' + x + '"][data-y="' + y + '"]').offset().top + "px",
        left:
          $('td[data-x="' + x + '"][data-y="' + y + '"]').offset().left + "px",
      },
      100,
      function () {
        //todo when complete
  ...
  var resnap = function () {
    selector.css(
      "top",
      $(
        'td[data-x="' + coordinates.x + '"][data-y="' + coordinates.y + '"]'
      ).offset().top + "px"
    );
    selector.css(
      "left",
...
var StateData = (function () {
  ...
  var save = function (saveObject) {
    ...
    document.cookie =
      options.cookieName + "=" + JSON.stringify(saveObject) + "; " + expires;
  };
  ...
  var domReady = function () {
    ...
    $("#swipeArea").swipe({
      ...
      swipe: function (
        ...
        if (direction == "left") mediator.publish("swipe_left_board");
        else if (direction == "right") mediator.publish("swipe_right_board");
        else if (direction == "up") mediator.publish("swipe_up_board");
        else if (direction == "down") mediator.publish("swipe_down_board");
      },
