    ...
    var ba = (function () {
      ...
      ca = (function () {
        ...
        a.prototype.rj = function (a) {
          return (
            this.F === a.F && this.K === a.K && this.J === a.J && this.B === a.B
          );
        };
        ...
        a.ND = new a(0, 0, 0, 1);
        a.dv = a.lb;
        a.Ck = { Zi: "rgba(255,255,255,1)", CD: "rgba(0,0,0,0)" };
        return a;
      })(),
      S = (function () {
        return {
          ...
          parse: function (a) {
            ...
            0 < a.indexOf("LEFT")
              ...
              ? (c = this.Tb)
              : 0 < a.indexOf("RIGHT") && (c = this.Mf);
            0 < a.indexOf("TOP")
              ? (c |= this.Jb)
              : 0 < a.indexOf("VCENTER") || "CENTER" === a
              ? (c |= this.Nf)
              : 0 < a.indexOf("BOTTOM") && (c |= this.Df);
            return c;
          },
        };
      })(),
      ...
      Ia = { Yd: 0, Oe: 1, Ne: 2, Fe: 3, zd: 4, uC: 5 },
      oa = (function (a, c, d, b) {
        function f() {
          this.b = a.Qa();
          this.scale = a.Qa();
      ...
      qb = (function (a, c, d, b) {
        return a.extend({
          ...
          Uu: function (a) {
            0 === this.state
              ? this.ub.vd
                ? this.ub.time + a < this.startTime ||
                  this.ub.time > this.ie ||
                  (1 < this.ka.length
                    ? ((this.state = 1),
                      (this.ba = this.ka.length - 1),
                      (this.kb = this.ie - this.ub.time),
                      this.ba--,
                      this.fg(this.ka[this.ba + 1], this.ka[this.ba].Pc))
                    : this.fg(this.ka[0], 0))
                : this.ub.time - a > this.ie ||
                  this.ub.time < this.startTime ||
                  (1 < this.ka.length
                    ? ((this.state = 1),
                      (this.ba = 0),
                      (this.kb = this.ub.time - this.startTime),
                      this.ba++,
                      this.fg(this.ka[this.ba - 1], this.ka[this.ba].Pc))
                    : this.fg(this.ka[0], 0))
              : ((this.Da -= a),
                this.Da <= b.Ef &&
                  (this.ub.Qh && this.ub.Qh(this.ub, this.ka[this.ba], this.ba),
                  (this.kb = -this.Da),
                  this.ba === this.ka.length - 1
                    ? (this.vg(this.ka[this.ba]), (this.state = 0))
                    : 0 === this.ba
                    ? (this.vg(this.ka[this.ba]), (this.state = 0))
                    : this.ub.vd
                    ? (this.ba--, (a = this.ka[this.ba + 1]), this.fg(a, a.Pc))
                    : (this.ba++,
                      this.fg(this.ka[this.ba - 1], this.ka[this.ba].Pc))));
          },
          Yu: function (a) {
            ...
            if (0 === this.state)
              e.time >= this.startTime &&
                ...
                e.vd
                  ? ((this.ba = this.ka.length - 1),
                    (this.kb = this.ie - e.time),
                    this.ba--,
                    (g = this.ka[this.ba + 1]),
                    this.zj(g, this.ka[this.ba], g.Pc))
                  : ((this.ba = 0),
                    (this.kb = e.time - this.startTime),
                    this.ba++,
                    (g = this.ka[this.ba]),
                    this.zj(this.ka[this.ba - 1], g, g.Pc)));
            else {
              this.Da -= a;
              g = this.ka[this.ba];
              if (g.Cg === c.A.Ad || g.Cg === c.A.Hb)
                switch (this.type) {
                  case d.Yd:
              ...
              else if (g.Cg === c.A.LINEAR)
                switch (((g = e.element), (k = this.ce.value), this.type)) {
                  case d.Yd:
                    g.x += k.b.x * a;
                    g.y += k.b.y * a;
                    break;
                  ...
                  case d.Fe:
                    (g.color.F += k.color.F * a),
                      (g.color.K += k.color.K * a),
                      (g.color.J += k.color.J * a),
                      (g.color.B += k.color.B * a);
                }
              this.Da <= b.Ef &&
                (e.Qh && e.Qh(e, this.ka[this.ba], this.ba),
                (this.kb = -this.Da),
                this.ba === this.ka.length - 1
                  ? (this.vg(this.ka[this.ba]), (this.state = 0))
                  : 0 === this.ba
          ...
          vg: function (a) {
            switch (this.type) {
              ...
              case d.Oe:
                ...
                b = this.ub.element;
                this.fk
                  ? ((c = this.qh.value.scale),
                    (b.X = c.x + a.x),
                    (b.da = c.y + a.y))
                  : ((b.X = a.x), (b.da = a.y));
                break;
              case d.Ne:
                this.ub.element.rotation = this.fk
                  ? this.qh.value.Sa + a.value.Sa
                  : a.value.Sa;
                break;
              case d.Fe:
          ...
          zj: function (a, b, g) {
            ...
            0 < this.kb && (this.Yu(this.kb), (this.kb = 0));
          },
        });
      })(ba, oa, Ia, N),
      fa = (function (a, c, d, b) {
        var f = a.extend({
          ...
          play: function () {
            if (this.state !== f.Z.Tg) {
              this.time = 0;
              this.vd = !1;
              for (var a = (this.length = 0), b = this.Qc.length; a < b; a++) {
                var c = this.Qc[a];
          ...
          update: function (a) {
            if (this.state === f.Z.Hq) {
              ...
              for (var c = 0, k = this.Qc.length; c < k; c++) {
                var l = this.Qc[c];
                null != l && (l.type === d.zd ? l.Uu(a) : l.Yu(a));
              }
              switch (this.Jj) {
                case f.ha.Gq:
                  !1 === this.vd && this.time >= this.length - b.Ef
                    ? ((this.time = Math.max(
                        0,
                  ...
                  break;
                case f.ha.vb:
                  this.time >= this.length - b.Ef &&
                    (0 < this.jf &&
                      (this.jf--,
                      0 === this.jf && (this.stop(), this.cb && this.cb(this))),
                    (this.time = Math.min(
      ...
      ia = (function (a, c, d, b, f, e, g, k) {
        return a.extend({
          ...
          dh: function () {
            ...
            a !== d.e
              ? (a & d.mb
                  ...
                  : a & d.Mf && (this.ea = b.ea + this.x + b.width),
                a & d.Jb
                  ? (this.fa = b.fa + this.y)
                  : a & d.Nf
                  ? (this.fa = b.fa + this.y + b.height / 2)
                  : a & d.Df && (this.fa = b.fa + this.y + b.height))
              : ((this.ea = this.x), (this.fa = this.y));
            f & d.Jb ||
              (f & d.Nf
                ? (this.fa -= this.height / 2)
                : f & d.Df && (this.fa -= this.height));
            f & d.mb ||
              (f & d.Tb
                ? (this.ea -= this.width / 2)
                : f & d.Mf && (this.ea -= this.width));
          },
          vc: function () {
            this.dh();
            var a =
            ...
            c && d.translate(this.Qu, this.Ru);
            this.ak = d.globalAlpha;
            1 !== this.color.B &&
              this.color.B !== this.ak &&
          ...
          uc: function () {
            ...
            this.te
              ? !this.Wh && b && (f.context.globalAlpha = this.ak)
              : (this.Ss && this.Yf(),
                a.restore(),
                this.Wh && b && (f.context.globalAlpha = this.color.B));
            for (var c = this.children, d = c.length, e = 0; e < d; e++) {
              var g = c[e];
              g.visible && g.v();
            }
            this.te
              ? (this.Ss && this.Yf(), a.restore())
              : this.Wh && b && (f.context.globalAlpha = this.ak);
          },
          update: function (a) {
          ...
          Sj: function (a, b) {
            for (var f = !1, c = this.children.length - 1; 0 <= c; c--) {
              ...
              if (d && d.Yb && d.Sj(a, b) && !1 === f && ((f = !0), !this.Vj))
                break;
            }
            return f;
          },
          Tj: function (a, b) {
            for (var f = !1, c = this.children.length - 1; 0 <= c; c--) {
              var d = this.children[c];
              if (d && d.Yb && d.Tj(a, b) && !1 === f && ((f = !0), !this.Vj))
                break;
            }
            return f;
          },
          ro: function (a, b) {
            for (var f = !1, c = this.children.length - 1; 0 <= c; c--) {
              var d = this.children[c];
              if (d && d.Yb && d.ro(a, b) && !1 === f && ((f = !0), !this.Vj))
                break;
            }
            return f;
          },
          st: function (a, b) {
            for (var f = !1, c = this.children.length - 1; 0 <= c; c--) {
              var d = this.children[c];
              if (d && d.Yb && d.st(a, b) && !1 === f && ((f = !0), !this.Vj))
                break;
            }
            return f;
          },
          ...
          ws: function (a) {
            ...
            for (var b = c.context, d = 0; d < a; d++) {
              ...
              if (0 !== m && 0 !== p) {
                ...
                var z, h, C;
                this.Ha
                  ? ((z = Math.round(l.x / this.Ha) * this.Ha),
                    (h = Math.round(l.y / this.Ha) * this.Ha),
                    (C = Math.round(l.M / this.Ha) * this.Ha),
                    (l = Math.round(l.U / this.Ha) * this.Ha))
                  : ((z = Math.round(l.x)),
                    (h = Math.round(l.y)),
                    (C = Math.ceil(l.M)),
                    (l = Math.ceil(l.U)));
      ...
      rb = [
        ...
        { id: 63, D: 833, C: 250, f: [0, 0, 566, 93], p: [133, 76] },
        {
          id: 64,
          D: 250,
          C: 250,
        ...
        { id: 69, D: 833, C: 250, f: [0, 0, 453, 93], p: [191, 76] },
        { id: 70, D: 833, C: 250, f: [0, 0, 333, 93], p: [251, 79] },
        { id: 71, D: 833, C: 250, f: [0, 0, 212, 93], p: [310, 79] },
        {
          id: 72,
          D: 640,
          C: 640,
        ...
        { id: 108, f: [0, 0, 198, 194, 0, 194, 198, 194, 0, 388, 198, 194] },
        { id: 111, f: [0, 0, 202, 81], p: [316, 87], D: 833, C: 250 },
        { id: 112, f: [0, 0, 319, 83], p: [260, 87], D: 833, C: 250 },
        { id: 113, f: [0, 0, 444, 86], p: [195, 81], D: 833, C: 250 },
        { id: 114, f: [0, 0, 559, 89], p: [137, 77], D: 833, C: 250 },
        {
          id: 115,
          f: [
      ...
      Ka = (function (a, c, d) {
        ...
        b[d.sl] = new a("obj_spikes_03.png", c.l);
        ...
        b[d.jl] = new a("obj_bouncer_02.png", c.l);
        b[d.bm] = new a("menu_music", c.V);
        b[d.am] = new a("game_music", c.V);
        b[d.sw] = new a("game_music3", c.V);
        ...
        b[d.Wi] = new a("spike_rotate_in", c.V);
        ...
        b[d.aq] = new a("bgr_04_p2.jpg", c.l);
        ...
        b[d.Cv] = new a("Painter_animations_2_hd.png", c.l);
        ...
        b[d.Nv] = new a("Prehistoric_animations_1_hd.png", c.l);
        ...
        b[d.br] = new a("prehistoric_monster_open", c.V);
        ...
        return {
          SA: function (a, c) {
            ...
            for (k = a.length; g < k; g++)
              (e = a[g]), (e = e.wa || 1), this.RA(a[g], d(c, e));
          },
          RA: function (a, c) {
            a.dd && (a.dd = d(a.dd, c));
            a.sc && (a.sc = d(a.sc, c));
          ...
          QA: function (a, f) {
            ...
            for (u = 0; u < n; u++)
              (p = a[u]),
                (m = (m + 1) % r),
                1 === m && ((g += l + 2), (k = 2), (l = 0)),
                (p = new c(g, k, d(p.M, f), d(p.U, f))),
                e.push(p),
                (k += Math.ceil(p.U) + 2),
                (l = Math.max(l, Math.ceil(p.M)));
            return e;
          },
          $z: function (b) {
      ...
      va = (function (a) {
        ...
        c.sD = [a.Og, a.Ki];
        c.tD = [a.Ti, a.Ui, a.Vi];
        c.ED = [a.If, a.Je, a.Og, a.Hf, a.Mi, a.nl, a.ol, a.pl, a.Qg, a.Ki];
        c.FD = [a.dm, a.Wi, a.Xi, a.Vg, a.Zq, a.$q, a.br, a.ar, a.cr, a.Ti];
        c.BC = [
          a.Je,
          a.Og,
          a.Hf,
      ...
      R = (function (a) {
        ...
        jF: "holiday-",
        cs: ["box1_bgd.png", "boxmore_bgd.png"],
        as: [],
        Um: ["levelbg1.jpg"],
        jx: [pa.Le, pa.Cl],
        VB: [0, null],
        ...
        Tf: [
          {
            mg: [
              {
                settings: [
                  { name: 0, width: 320, height: 480, ma: 32 },
                  { name: 1, $: 1, O: 2, I: !1 },
                ],
                na: [
                  { name: 2, x: 161, y: 433 },
                  ...
                  { name: 52, x: 156, y: 139 },
                  { name: 3, x: 162, y: 244, timeout: -1 },
                  { name: 3, x: 161, y: 332, timeout: -1 },
                  { name: 3, x: 256, y: 331, timeout: -1 },
                  {
                    name: 4,
                    x: 177,
                    y: 27,
                  ...
                  { name: 5, x: 57, y: 111, locale: "en", g: 100, o: 100 },
                  { name: 8, x: 241, y: 433, locale: "en", g: 100, o: 100 },
                  { name: 5, x: 109, y: 111, locale: "en", g: 100, o: 100 },
                  { name: 5, x: 161, y: 111, locale: "en", g: 100, o: 100 },
                  { name: 5, x: 213, y: 111, locale: "en", g: 100, o: 100 },
                  { name: 5, x: 265, y: 111, locale: "en", g: 100, o: 100 },
                  {
                    name: 14,
                    x: 80,
                    y: 130,
                ...
                k: [
                  ...
                  { name: 5, x: 109, y: 126, locale: "ru", g: 100, o: 100 },
                  { name: 5, x: 57, y: 126, locale: "ru", g: 100, o: 100 },
                  { name: 5, x: 161, y: 126, locale: "ru", g: 100, o: 100 },
                  { name: 5, x: 213, y: 126, locale: "ru", g: 100, o: 100 },
                  { name: 5, x: 265, y: 126, locale: "ru", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 177,
                    y: 25,
                  ...
                  { name: 8, x: 231, y: 415, locale: "ru", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 176,
                    y: 340,
                ...
                j: [
                  ...
                  { name: 5, x: 109, y: 124, locale: "fr", g: 100, o: 100 },
                  { name: 5, x: 57, y: 124, locale: "fr", g: 100, o: 100 },
                  { name: 5, x: 161, y: 124, locale: "fr", g: 100, o: 100 },
                  { name: 5, x: 213, y: 124, locale: "fr", g: 100, o: 100 },
                  { name: 5, x: 265, y: 124, locale: "fr", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 177,
                    y: 24,
                  ...
                  { name: 8, x: 231, y: 435, locale: "fr", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 196,
                    y: 335,
                ...
                i: [
                  ...
                  { name: 5, x: 109, y: 129, locale: "de", g: 100, o: 100 },
                  { name: 5, x: 57, y: 129, locale: "de", g: 100, o: 100 },
                  { name: 5, x: 161, y: 129, locale: "de", g: 100, o: 100 },
                  { name: 5, x: 213, y: 129, locale: "de", g: 100, o: 100 },
                  { name: 5, x: 265, y: 129, locale: "de", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 179,
                    y: 24,
                  ...
                  { name: 8, x: 231, y: 436, locale: "de", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 200,
                    y: 337,
              ...
              },
              {
                ...
                na: [
                  { name: 2, x: 238, y: 417 },
                  { name: 52, x: 159, y: 153 },
                  { name: 3, x: 158, y: 357, timeout: -1 },
                  { name: 3, x: 82, y: 358, timeout: -1 },
                  { name: 3, x: 238, y: 360, timeout: -1 },
                  {
                    name: 100,
                    x: 79,
                    y: 220,
                  ...
                  { name: 13, x: 65, y: 307, locale: "en", g: 100, o: 100 },
                ],
                k: [
                  { name: 13, x: 60, y: 315, locale: "ru", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 73,
                    y: 278,
                ...
                j: [
                  ...
                  { name: 13, x: 83, y: 316, locale: "fr", g: 100, o: 100 },
                ],
                i: [
                  { name: 13, x: 66, y: 311, locale: "de", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 86,
                    y: 275,
              ...
              },
              {
                ...
                na: [
                  { name: 2, x: 159, y: 425 },
                  { name: 52, x: 63, y: 238 },
                  { name: 3, x: 97, y: 311, timeout: -1 },
                  { name: 3, x: 159, y: 140, timeout: -1 },
                  { name: 3, x: 159, y: 66, timeout: -1 },
                  {
                    name: 100,
                    x: 63,
                    y: 123,
                  ...
                  { name: 13, x: 241, y: 143, locale: "en", g: 100, o: 100 },
                ],
                k: [
                  {
                    name: 4,
                  ...
                  { name: 13, x: 239, y: 153, locale: "ru", g: 100, o: 100 },
                ],
                j: [
                  {
                    name: 4,
                  ...
                  { name: 13, x: 241, y: 147, locale: "fr", g: 100, o: 100 },
                ],
                i: [
                  {
                    name: 4,
                  ...
                  { name: 13, x: 241, y: 146, locale: "de", g: 100, o: 100 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  { name: 2, x: 159, y: 242 },
                  { name: 52, x: 255, y: 171 },
                  { name: 3, x: 134, y: 185, timeout: -1 },
                  { name: 3, x: 189, y: 184, timeout: -1 },
                  { name: 3, x: 161, y: 147, timeout: -1 },
                  {
                    name: 100,
                    x: 76,
                    y: 243,
                  ...
                  { name: 12, x: 129, y: 379, locale: "en", g: 100, o: 100 },
                ],
                k: [
                  {
                    name: 4,
                  ...
                  { name: 12, x: 234, y: 369, locale: "ru", g: 100, o: 100 },
                ],
                j: [
                  {
                    name: 4,
                    ...
                    y: 285,
                    locale: "fr",
                    text: "Vous pouvez redémarrer le niveau en appuyant sur le bouton",
                    width: 180,
                  },
                  { name: 12, x: 201, y: 371, locale: "fr", g: 100, o: 100 },
                ],
                i: [
                  {
                    name: 4,
                    ...
                    y: 282,
                    locale: "de",
                    text: "Du kannst das Level neustarten, indem du das Symbol antippst",
                    width: 250,
                  },
                  { name: 12, x: 238, y: 351, locale: "de", g: 100, o: 100 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  ...
                  { name: 52, x: 47, y: 150 },
                  { name: 3, x: 151, y: 384, timeout: -1 },
                  { name: 3, x: 121, y: 217, timeout: -1 },
                  { name: 3, x: 51, y: 217, timeout: -1 },
                  { name: 56, x: 127, y: 388, group: 0, a: 0 },
                  { name: 56, x: 194, y: 218, group: 0, a: -180 },
                  {
                    name: 4,
                    x: 51,
                    y: 247,
              ...
              },
              {
                ...
                na: [
                  ...
                  { name: 52, x: 154, y: 213 },
                  { name: 3, x: 159, y: 343, timeout: -1 },
                  { name: 3, x: 85, y: 231, timeout: -1 },
                  { name: 3, x: 251, y: 125, timeout: -1 },
                  { name: 54, x: 159, y: 343 },
                  { name: 56, x: 163, y: 404, group: 0, a: -90 },
                  { name: 56, x: 70, y: 261, group: 0, a: -60 },
                  {
                    name: 4,
                    x: 78,
                    y: 32,
                  ...
                  { name: 13, x: 59, y: 70, locale: "en", g: 100, o: 100 },
                ],
                j: [
                  {
                    name: 4,
                    ...
                    y: 23,
                    locale: "fr",
                    text: "Le bonbon garde sa vitesse lors de la t\u00E9l\u00E9portation",
                    width: 200,
                  },
                  { name: 13, x: 50, y: 73, locale: "fr", g: 100, o: 100 },
                ],
                i: [
                  {
                    name: 4,
                    ...
                    y: 28,
                    locale: "de",
                    text: "Die S\u00FC\u00DFigkeit beh\u00E4lt ihre Geschwindigkeit",
                    width: 200,
                  },
                  { name: 13, x: 54, y: 72, locale: "de", g: 100, o: 100 },
                ],
                k: [
                  {
                    name: 4,
                    ...
                    y: 31,
                    locale: "ru",
                    text: "\u041B\u0435\u0434\u0435\u043D\u0435\u0446 \u0441\u043E\u0445\u0440\u0430\u043D\u044F\u0435\u0442 \u0441\u0432\u043E\u044E \u0441\u043A\u043E\u0440\u043E\u0441\u0442\u044C \u043F\u0440\u0438 \u0442\u0435\u043B\u0435\u043F\u043E\u0440\u0442\u0430\u0446\u0438\u0438",
                    width: 240,
                  },
                  { name: 13, x: 43, y: 69, locale: "ru", g: 100, o: 100 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  ...
                  { name: 3, x: 158, y: 348, timeout: -1 },
                  { name: 3, x: 141, y: 442, timeout: -1 },
                  { name: 3, x: 183, y: 442, timeout: -1 },
                  { name: 54, x: 157, y: 347 },
                  {
                    name: 4,
                    x: 206,
                    y: 250,
                    locale: "en",
                    text: "Stretched ropes get red",
                    width: 100,
                  },
                  { name: 13, x: 255, y: 237, locale: "en", g: 100, o: 100 },
                ],
                k: [
                  { name: 13, x: 261, y: 221, locale: "ru", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 214,
                    y: 234,
                ...
                j: [
                  { name: 13, x: 258, y: 223, locale: "fr", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 211,
                    y: 236,
                ...
                i: [
                  ...
                  { name: 13, x: 252, y: 233, locale: "de", g: 100, o: 100 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  ...
                  { name: 3, x: 161, y: 159, timeout: -1 },
                  { name: 3, x: 161, y: 40, timeout: -1 },
                  { name: 3, x: 160, y: 359, timeout: -1 },
                  { name: 56, x: 165, y: 401, group: 0, a: 270 },
                  { name: 56, x: 248, y: 292, group: 0, a: 180 },
                  { name: 13, x: 73, y: 97, locale: "en", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 82,
                    y: 63,
                ...
                k: [
                  { name: 13, x: 40, y: 96, locale: "ru", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 60,
                    y: 50,
                ...
                j: [
                  { name: 13, x: 39, y: 78, locale: "fr", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 58,
                    y: 46,
                ...
                i: [
                  { name: 13, x: 46, y: 83, locale: "de", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 57,
                    y: 46,
              ...
              },
              {
                ...
                na: [
                  ...
                  { name: 52, x: 158, y: 235 },
                  { name: 3, x: 83, y: 99, timeout: -1 },
                  { name: 3, x: 160, y: 51, timeout: -1 },
                  { name: 3, x: 236, y: 100, timeout: -1 },
                  { name: 54, x: 79, y: 175 },
                  { name: 54, x: 237, y: 174 },
                  { name: 55, x: 37, y: 268, a: 0 },
                  { name: 55, x: 284, y: 265, a: 180 },
                  {
                    name: 4,
                    x: 93,
                    y: 279,
                    locale: "en",
                    text: "Click the air cushion to blow objects",
                    width: 180,
                  },
                  {
                    name: 8,
                ...
                j: [
                  ...
                  },
                  {
                    ...
                    y: 260,
                    locale: "fr",
                    text: "Tapotez le coussin d'air pour pousser les objets",
                    width: 150,
                  },
                ],
                i: [
                  ...
                  },
                  {
                    ...
                    y: 273,
                    locale: "de",
                    text: "Tippe das Luftkissen an, um Gegenstände wegzublasen",
                    width: 180,
                  },
                ],
              },
              {
                ...
                na: [
                  ...
                  { name: 52, x: 207, y: 288 },
                  { name: 3, x: 274, y: 182, timeout: -1 },
                  { name: 3, x: 207, y: 182, timeout: -1 },
                  { name: 3, x: 142, y: 182, timeout: -1 },
                  { name: 54, x: 207, y: 182 },
                  { name: 54, x: 142, y: 183 },
                  { name: 54, x: 273, y: 183 },
                  { name: 55, x: 37, y: 190, a: 0 },
                  { name: 56, x: 139, y: 403, group: 0, a: 270 },
                  { name: 56, x: 264, y: 106, group: 0, a: 90 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  ...
                  { name: 52, x: 207, y: 317 },
                  { name: 3, x: 212, y: 244, timeout: -1 },
                  { name: 3, x: 66, y: 252, timeout: -1 },
                  { name: 3, x: 150, y: 122, timeout: -1 },
                  { name: 54, x: 207, y: 182 },
                  { name: 54, x: 211, y: 242 },
                  { name: 54, x: 64, y: 310 },
                  { name: 55, x: 269, y: 160, a: 180 },
                  { name: 56, x: 213, y: 408, group: 0, a: 270 },
                  { name: 56, x: 66, y: 371, group: 0, a: 270 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  ...
                  { name: 54, x: 220, y: 309 },
                  { name: 54, x: 220, y: 372 },
                  { name: 55, x: 27, y: 244, a: 0 },
                  { name: 55, x: 289, y: 240, a: 180 },
                  { name: 2, x: 92, y: 49 },
                  { name: 54, x: 155, y: 555 },
                  { name: 52, x: 155, y: 556 },
                  { name: 3, x: 221, y: 115, timeout: -1 },
                  { name: 54, x: 92, y: 246 },
                  { name: 54, x: 157, y: 246 },
                  { name: 54, x: 219, y: 246 },
                  { name: 3, x: 94, y: 309, timeout: -1 },
                  { name: 56, x: 94, y: 407, group: 0, a: -90 },
                  { name: 56, x: 161, y: 147, group: 0, a: 090 },
                  { name: 54, x: 223, y: 440 },
                  { name: 3, x: 225, y: 440, timeout: -1 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  ...
                  { name: 3, x: 160, y: 187, timeout: -1 },
                  { name: 3, x: 257, y: 330, timeout: -1 },
                  { name: 3, x: 160, y: 331, timeout: -1 },
                  { name: 56, x: 167, y: 406, group: 0, a: 270 },
                  { name: 56, x: 253, y: 75, group: 0, a: 90 },
                  { name: 56, x: 163, y: 74, group: 1, a: 90 },
                  { name: 56, x: 228, y: 825, group: 0, a: 270 },
                  { name: 56, x: 323, y: 827, group: 0, a: 270 },
                  { name: 56, x: 261, y: 405, group: 1, a: 270 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  { name: 2, x: 254, y: 389 },
                  { name: 56, x: 72, y: 378, group: 0, a: -40 },
                  { name: 56, x: 72, y: 253, group: 1, a: -40 },
                  { name: 56, x: 234, y: 277, group: 0, a: 220 },
                  { name: 52, x: 154, y: 134 },
                  {
                    name: 100,
                    x: 159,
                  ...
                  { name: 56, x: 235, y: 155, group: 1, a: 220 },
                  { name: 55, x: 49, y: 153, a: 0 },
                  { name: 3, x: 150, y: 251, timeout: -1 },
                  { name: 3, x: 150, y: 369, timeout: -1 },
                  { name: 3, x: 41, y: 57, timeout: -1 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  ...
                  { name: 52, x: 159, y: 231 },
                  { name: 56, x: 253, y: 367, group: 0, a: 230 },
                  { name: 56, x: 62, y: 369, group: 0, a: 320 },
                  { name: 3, x: 161, y: 75, timeout: -1 },
                  { name: 3, x: 236, y: 322, timeout: -1 },
                  { name: 3, x: 91, y: 321, timeout: -1 },
                  {
                    name: 100,
                    x: 222,
                    y: 122,
                  ...
                  { name: 55, x: 36, y: 228, a: 0 },
                  { name: 55, x: 286, y: 223, a: 180 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  { name: 2, x: 269, y: 427 },
                  { name: 52, x: 114, y: 174 },
                  { name: 56, x: 152, y: 115, group: 0, a: 825 },
                  { name: 54, x: 107, y: 261 },
                  {
                    name: 100,
                    x: 89,
                  ...
                  { name: 56, x: 53, y: 261, group: 0, a: 300 },
                  { name: 54, x: 271, y: 322 },
                  { name: 56, x: 170, y: 271, group: 1, a: 290 },
                  { name: 56, x: 103, y: 378, group: 1, a: 269 },
                  { name: 3, x: 60, y: 219, timeout: -1 },
                  { name: 3, x: 275, y: 137, timeout: -1 },
                  { name: 3, x: 102, y: 335, timeout: -1 },
                  {
                    name: 100,
                    x: 203,
                    y: 112,
              ...
              },
              {
                ...
                na: [
                  { name: 3, x: 246, y: 254, timeout: -1 },
                  { name: 3, x: 266, y: 417, timeout: -1 },
                  { name: 3, x: 129, y: 347, timeout: -1 },
                  { name: 2, x: 259, y: 69 },
                  {
                    name: 100,
                    x: 186,
              ...
              },
              {
                ...
                na: [
                  ...
                  { name: 3, x: 254, y: 277, timeout: "-1" },
                  { name: 3, x: 160, y: 370, timeout: "-1" },
                  { name: 3, x: 65, y: 274, timeout: "-1" },
                ],
              },
              {
                settings: [
                ...
                na: [
                  ...
                  { name: 3, x: 71, y: 118, timeout: -1 },
                  { name: 3, x: 253, y: 118, timeout: -1 },
                  { name: 3, x: 253, y: 336, timeout: -1 },
                  { name: 2, x: 75, y: 421 },
                  { name: 54, x: 72, y: 178 },
                  { name: 58, x: 138, y: 106, a: 90, size: 3 },
                  { name: 58, x: 110, y: 376, a: 0, size: 4 },
                  { name: 56, x: 259, y: 390, group: 0, a: 270 },
                  { name: 56, x: 158, y: 428, group: 0, a: 180 },
                  { name: 58, x: 79, y: 46, a: 0, size: 2 },
                  { name: 10, x: 112, y: 256, locale: "en", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 38,
                    y: 273,
                ...
                k: [
                  { name: 10, x: 112, y: 256, locale: "ru", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 14,
                    y: 269,
                ...
                j: [
                  { name: 10, x: 111, y: 257, locale: "fr", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 34,
                    y: 268,
                ...
                i: [
                  { name: 10, x: 112, y: 256, locale: "de", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 26,
                    y: 273,
              ...
              },
              {
                ...
                na: [
                  ...
                  { name: 52, x: 115, y: 124 },
                  { name: 56, x: 68, y: 249, group: 0, a: 310 },
                  { name: 56, x: 254, y: 246, group: 1, a: 230 },
                  { name: 3, x: 96, y: 209, timeout: -1 },
                  { name: 56, x: 69, y: 410, group: 0, a: 310 },
                  { name: 56, x: 256, y: 405, group: 1, a: 230 },
                  { name: 3, x: 163, y: 357, timeout: -1 },
                  { name: 2, x: 260, y: 87 },
                  { name: 3, x: 230, y: 207, timeout: -1 },
                  {
                    name: 100,
                    x: 48,
                    y: 151,
                  ...
                  { name: 55, x: 164, y: 257, a: 270 },
                  { name: 58, x: 99, y: 330, a: -20, size: 3 },
                  { name: 58, x: 230, y: 330, a: 20, size: 3 },
                ],
              },
              {
                settings: [
                ...
                na: [
                  { name: 2, x: 161, y: 429 },
                  { name: 56, x: 260, y: 343, group: 0, a: 250 },
                  { name: 56, x: 58, y: 168, group: 0, a: 270 },
                  { name: 3, x: 61, y: 50, timeout: -1 },
                  { name: 58, x: 129, y: 92, a: 300, size: 3 },
                  { name: 52, x: 229, y: 200 },
                  { name: 3, x: 160, y: 122, timeout: -1 },
                  { name: 54, x: 70, y: 288 },
                  { name: 3, x: 70, y: 289, timeout: -1 },
                  {
                    name: 100,
                    x: 160,
                    y: 81,
                  ...
                  { name: 58, x: 193, y: 93, a: -300, size: 3 },
                  {
                    name: 100,
                    x: 162,
                    y: 289,
              ...
              },
              {
                ...
                na: [
                  { name: 2, x: 45, y: 76 },
                  { name: 55, x: 275, y: 430, a: 270 },
                  { name: 55, x: 274, y: 272, a: 270 },
                  { name: 56, x: 270, y: 102, group: 1, a: 90 },
                  { name: 56, x: 161, y: 399, group: 0, a: 270 },
                  { name: 58, x: 217, y: 160, a: 90, size: 4 },
                  { name: 58, x: 217, y: 335, a: 90, size: 4 },
                  { name: 58, x: 95, y: 161, a: 90, size: 4 },
                  { name: 58, x: 95, y: 336, a: 90, size: 4 },
                  { name: 54, x: 156, y: 160 },
                  { name: 56, x: 47, y: 398, group: 0, a: 270 },
                  { name: 56, x: 153, y: 105, group: 1, a: 90 },
                  { name: 3, x: 40, y: 159, timeout: -1 },
                  { name: 3, x: 158, y: 161, timeout: -1 },
                  { name: 3, x: 273, y: 343, timeout: -1 },
                  {
                    name: 100,
                    x: 240,
                    y: 144,
              ...
              {
                settings: [
                  { name: 0, width: 640, height: 480, ma: 32 },
                  { name: 1, $: 1, O: 2, I: !1 },
                ],
                na: [
                  { name: 52, x: 148, y: 302 },
                  ...
                  { name: 56, x: 149, y: 93, group: 0, a: 90 },
                  { name: 56, x: 267, y: 413, group: 0, a: 270 },
                  {
                    name: 100,
                    x: 328,
                    y: 184,
                  ...
                  { name: 2, x: 56, y: 407 },
                  { name: 3, x: 552, y: 98, timeout: -1 },
                  { name: 58, x: 113, y: 89, a: 90, size: 4 },
                  { name: 58, x: 113, y: 267, a: 90, size: 4 },
                  { name: 58, x: 113, y: 445, a: 90, size: 4 },
                  { name: 56, x: 554, y: 411, group: 1, a: 270 },
                  { name: 56, x: 49, y: 94, group: 1, a: 90 },
                  { name: 3, x: 251, y: 187, timeout: -1 },
                  { name: 54, x: 51, y: 233 },
                ],
              },
              {
                ...
                na: [
                  ...
                  { name: 56, x: 33, y: 395, group: 1, a: 270 },
                  { name: 2, x: 259, y: 419 },
                  { name: 3, x: 290, y: 228, timeout: -1 },
                  { name: 3, x: 32, y: 94, timeout: -1 },
                  { name: 54, x: 30, y: 325 },
                  { name: 13, x: 96, y: 294, locale: "en", g: 100, o: 100 },
                  {
                    name: 4,
                    x: 110,
                    y: 256,
                    locale: "en",
                    text: "Om Nom loves when you collect all 3 stars!",
                    width: 180,
                  },
                ],
                k: [
                  {
                    ...
                    y: 254,
                    locale: "ru",
                    text: "\0410\043c \041d\044f\043c\0443 \043d\0440\0430\0432\0438\0442\0441\044f, \043a\043e\0433\0434\0430 \0432\0441\0435 3 \0437\0432\0435\0437\0434\044b \0441\043e\0431\0440\0430\043d\044b!",
                    width: 200,
                  },
                  { name: 13, x: 77, y: 292, locale: "ru", g: 100, o: 100 },
                ],
                j: [
                  {
                    name: 4,
                    ...
                    y: 252,
                    locale: "fr",
                    text: "Om Nom adore que tu collectes les 3 \00e9toiles!",
                    width: 150,
                  },
                  { name: 13, x: 89, y: 293, locale: "fr", g: 100, o: 100 },
                ],
                i: [
                  {
                    name: 4,
                    ...
                    y: 252,
                    locale: "de",
                    text: "Om Nom ist gl\00fccklich, wenn du alle 3 Sterne aufsammelst!",
                    width: 180,
                  },
                  { name: 13, x: 91, y: 292, locale: "de", g: 100, o: 100 },
                ],
              },
              {
                settings: [
                  { name: 0, width: 320, height: 960, ma: 32 },
                  { name: 1, $: 1, O: 2, I: !1 },
                ],
                na: [
                  { name: 54, x: 45, y: 662 },
                  ...
                  { name: 54, x: 45, y: 595 },
                  { name: 54, x: 45, y: 799 },
                  { name: 3, x: 44, y: 898, timeout: -1 },
                  { name: 52, x: 175, y: 786 },
                  { name: 56, x: 44, y: 525, group: 0, a: 90 },
                  { name: 56, x: 230, y: 876, group: 0, a: 270 },
                  { name: 3, x: 232, y: 589, timeout: -1 },
                  {
                    name: 100,
                    x: 168,
                    y: 275,
                  ...
                  { name: 3, x: 120, y: 156, timeout: -1 },
                  { name: 55, x: 34, y: 150, a: 0 },
                  { name: 2, x: 244, y: 85 },
                  { name: 54, x: 114, y: 392 },
                  { name: 58, x: 103, y: 103, a: 0, size: 4 },
                  {
                    name: 100,
                    x: 116,
                    y: 669,
      ...
      V = (function () {
        ...
        a.unsubscribe = function (a, b) {
          ...
          for (f = c.length; 0 <= f; f--)
            (e = c[f]), e.name === a && e.eh === b && c.splice(f, 1);
        };
        a.ra = function (a) {
          var b = [],
      ...
      aa = (function (a, c, d, b, f, e, g, k) {
        var l = a.extend({
          ...
          Ua: function (a) {
            this.rf = a;
            this.jk ||
              ((a = this.L.f[a]), (this.width = a.M), (this.height = a.U));
          },
          YA: function () {
            this.rf = f.e;
          ...
          ya: function () {
            this.L.od.x !== e.TB.x &&
              ((this.jk = !0),
              (this.width = this.L.od.x),
              (this.height = this.L.od.y));
          },
          v: function () {
            this.vc();
          ...
          Kx: function (a) {
            ...
            this.jk &&
              (a = this.L.p[a]) &&
              ((e += a.x), (g += a.y), (d += this.L.be), (f += this.L.Pf));
            this.jj
              ? ((d = Math.round(d / this.jj) * this.jj),
                (f = Math.round(f / this.jj) * this.jj))
              : ((d = Math.ceil(d)), (f = Math.ceil(f)));
            this.Ha
              ? ((e = Math.round(e / this.Ha) * this.Ha),
                (g = Math.round(g / this.Ha) * this.Ha))
              : ((e = Math.round(e)), (g = Math.round(g)));
            0 === c.x || 0 === c.y
              ? b.context.drawImage(this.L.qc, c.x, c.y, d, f, e, g, d, f)
              : ((d += 2),
                (f += 2),
                b.context.drawImage(
                  this.L.qc,
          ...
          Mx: function (a, c, d, e, g) {
            var l = b.context,
              ...
              J;
            a === f.e
              ? ((a = this.L.zh), (z = this.L.yh))
              : ((z = this.L.f[a]), (k = z.x), (s = z.y), (a = z.M), (z = z.U));
            var x = Math.floor(a),
              E = Math.floor(z);
            for (h = 0; h < g; ) {
              for (C = 0; C < e; )
                (D = e - C),
                  ...
                  J > z && (J = z),
                  (J = Math.ceil(J)),
                  l.drawImage(this.L.qc, k, s, D, J, c + C, d + h, D, J),
                  (C += x);
              h += E;
            }
          },
          Xj: function (a, b) {
            if (this.rf === f.e)
              return c.Db(a, b, this.ea, this.fa, this.L.width, this.L.height);
            var d = this.L.f[this.rf],
              e = this.ea,
              g = this.fa;
            if (this.jk)
              var l = this.L.p[this.rf],
                e = e + l.x,
                g = g + l.y;
            return c.Db(a, b, e, g, d.M, d.U);
          },
          Ns: function (a) {
      ...
      da = (function (a, c, d, b, f, e, g, k, l) {
        ...
        var r = a.extend({
          ...
          lu: function (a, b) {
            ...
            this.Hg =
              null == b || b === c.e
                ? Math.ceil(this.font.Du(a))
                : Math.ceil(b);
            this.Ag && (this.by(), this.ZB());
          },
          ZB: function () {
            for (
              var a = 0,
              ...
              for (
                var a = this.je[h],
                  ...
                  a =
                    this.align !== d.mb
                      ? this.align === d.Tb || this.align === d.S
                        ? (this.Hg - a.width) / 2
                        : this.Hg - a.width
                      : 0,
                  J = 0;
                ...
                if (
                  ...
                  (E = this.font.L.f[x].M),
                  J === r - 1 ||
                    (J === r - 2 && a + 3 * (E + e) + this.font.fc > this.Hg))
                ) {
                  this.kh.Lj(x, Math.round(a), Math.round(b), g++);
                  a += E + e;
                  this.kh.Lj(x, Math.round(a), Math.round(b), g++);
            ...
            1 >= this.je.length
              ? ((this.height = this.font.sn()), (this.width = a))
              : ((this.height =
                  (this.font.sn() + this.font.sc) * this.je.length -
                  this.font.sc),
                (this.width = this.Hg));
            this.maxHeight !== c.e &&
          ...
          by: function () {
            for (
              ...
              if (" " == J || "\n" == J)
                (k += g),
                  ...
                  (f = r),
                  " " == J &&
                    (f--, (g = this.font.fc + this.font.cg(b, r - 1)));
              else
                var x = this.font.vj(J),
                  g = g + (this.font.L.f[x].M + this.font.cg(b, r - 1));
              x = l.au(k + g) > this.Hg;
              this.iC && x && h == e && ((k += g), (h = r), (g = 0), (f = r));
            ...
            this.je = [];
            for (c = 0; c < b; c++)
              (d = this.Ag.substring(a[c << 1], a[(c << 1) + 1])),
                (f = this.font.Du(d)),
                this.je.push(new n(d, f));
          },
          VD: function (a) {
            var b = Xml.dx(a, "font"),
              b = g.Is(b),
        ...
        r.hj = function (a) {
          ...
          a &&
            z > a &&
            ((a /= z), (x = Math.round(((1 - a) * c) / 2)), (z *= a), (c *= a));
      ...
      ga = (function (a, c, d, b, f) {
        ...
        [
          ...
          { id: 24, s: "Yes", j: "Oui", i: "Ja", k: "\u0414\u0430" },
          { id: 25, s: "No", j: "Non", i: "Nein", k: "\u041d\u0435\u0442" },
          {
            id: 26,
            s: "Replay",
            j: "Rejouer",
          ...
          { id: F.hw, s: "Name", j: "Nom", i: "Name", k: "\u0418\u043c\u044f" },
          {
            id: F.hp,
            s: "{0} & {1}",
            j: "{0} et {1}",
      ...
      T = (function (a, c, d, b, f, e) {
        var g = {
          ...
          k = {
            ...
            hu: function (b, c) {
              a.ja({ text: c, img: b.find("img")[0], ua: !0 });
            },
            ky: function (a, b) {
            ...
            ft: function () {
              var a =
                ...
                Modernizr.hq;
              a ||
                (Modernizr.load({ load: "css!css/nosupport.css?321" }),
                $(function () {
                  $("#yt-video").remove();
                }),
        ...
        function f() {
          if (g && k) {
            var b = new PxLoader({ pt: 3e4 }),
              ...
              q;
            m = 0;
            for (p = c.gt.length; m < p; m++)
              (u = c.gt[m]),
                (q = f + d[u].path + r),
                b.addSound("s" + u, q, "MENU");
            m = 0;
            for (p = c.Hs.length; m < p; m++)
              (u = c.Hs[m]), (q = f + d[u].path + r), b.addSound("s" + u, q);
      ...
      wb = (function (a, c, d, b, f, e, g, k, l) {
        function n() {
          function e(b, c, d) {
            if (b)
              for (
                c = c || a.Rc, d = d || "MENU", h = 0, C = b.length;
                h < C;
                h++
              )
          ...
          var p = new PxLoader({ pt: 3e4 }),
            u = a.Nn + b.pb + "/game/",
            h,
            C,
            D,
            J = ["PASSWORD", "EDITION", "FONT", "MENU"].concat(["GAME"]);
          n(l.Bw, "FONT");
          n(c.dy, "GAME");
          n(c.Ys, "GAME");
          n(c.Zs, "GAME");
        ...
        function r() {
          m &&
            p &&
            (g && (g.yz(), g.hide()), u && setTimeout(u, 0), (r = ha()));
        }
        var m = !1,
          p = !1,
          u = null;
            ...
            function f() {
              function b() {
                ...
                for (g = 0; g < p.length; g++) {
                  ...
                  q.ig
                    ? ((q.y.offset = 250),
                      (q.x.offset = d / 2 - (q.img.width + q.x.wd) / 2))
                    : e < q.delay
                    ? ((q.y.offset = -1e4), (q.y.$c = e))
                    : (e - q.y.$c >= q.y.duration &&
                        ((q.y.$c = e),
                        (q.ve = 0.5 + 0.5 * Math.random()),
                        (q.x.offset =
                          Math.random() * (d - q.x.wd * (1 / q.ve)))),
                      (q.y.offset =
                        c +
                        2 * q.img.height -
                        a.jo(e - q.y.$c, 1, q.y.duration) *
                          (c + 2 * q.img.height) -
                        q.img.height));
                  e - q.x.$c >= q.x.duration &&
                    ((q.x.$c = e), q.x.Wf && (q.x.$f = !q.x.$f));
                  q.x.val = a.xs(
                    e - q.x.$c,
                    q.x.ke,
                    q.x.wd - q.x.ke,
                  ...
                  q.x.abs > d - q.img.width * q.ve &&
                    (q.x.abs = d - q.img.width * q.ve);
                  q.ig
                    ? (e - q.y.$c >= q.y.duration &&
                        ((q.y.$c = e), q.y.Wf && (q.y.$f = !q.y.$f)),
                      (q.y.val = a.xs(
                        e - q.y.$c,
                        q.y.ke,
                        q.y.wd - q.y.ke,
                    ...
                    : (q.y.val = 0);
                  q.y.abs = q.y.offset + (q.y.$f ? q.y.wd - q.y.val : q.y.val);
                  if (q.ig) {
        ...
        var D = new (function () {
          ...
          this.load = function () {
            ...
            for (len = f.Tf.length; c < len; c++) {
              ...
              d[e] = new r(k, n, C, A);
              if (a.WD === c + 1)
                for (d = f.Tf[c].mg.length, len = d - 1, d = 0; d < len; d++)
                  D.we(c, d, 3, !0);
            }
            h && D.pi();
          };
          ...
          this.Mm = function (a) {
            a = b[a];
            if (null != a) {
              for (var h = 0, c = 0; c < a.Lc; c++)
                var d = a.Eb[c], h = h + (null == d ? 0 : d);
              return h;
            }
            return 0;
          };
          ...
          this.gg = function (h) {
            return 0 == h || a.Dg || (null != b[h] && D.zf() >= D.ei(h))
              ? !1
              : !0;
          };
          ...
          this.pi = function () {
            ...
            e.ja({ text: a, Kc: "#boxScore img", ua: !0 });
          };
      ...
      Ea = (function (a, c, d, b, f, e, g, k, l, n, r) {
        ...
        g.subscribe(g.r.Ib, function () {
          d.ja({ text: k.W(r.wi), Ab: "boxUpgradePlate", scale: 0.6 * b.bb });
        });
        var p = f.bs || f.Rc;
        return a.extend({
          ...
          Rt: function (a, c) {
            ...
            d &&
              ...
              a.fillRect(b.d(130), b.d(200), b.d(140), b.d(100)),
              null != c && a.drawImage(this.qt, c + b.d(4), b.d(215)));
            this.bh && a.drawImage(this.bh, b.d(25), b.d(0));
            if (d) {
              if (this.df) {
                var d = $(this.qd).width() || this.qd.width,
                ...
                a.scale(1 / 1.015, 1);
                this.qf &&
                  (a.drawImage(this.qd, e, b.d(220), d, f),
                  a.drawImage(this.uf, e + d + h, b.d(225)));
              }
              n.Mm(this.index) === n.Et(this.index) &&
                a.drawImage(this.At, b.d(260), b.d(250));
            }
            this.Hu || this.St();
            f = $(this.Gu);
            d = f.width();
              ...
              var d = b.d(1024),
                ...
                g = function () {
                  ...
                  100 > t
                    ? ((h = c.Qx()), (l = 1 - h), (h = 1 + h))
                    : 300 > t
                    ? ((h = c.nh(t - 100, 0, 0.11, 200)),
                      (l = 0.95 + h),
                      (h = 1.05 - h))
                    : 600 > t &&
                      ((h = c.ys(t - 300, 0, 0.05, 300)),
                      (l = 1.06 - h),
                      (h = 0.94 + h));
                  l = (d - d * l) / 2;
                  h = (f - f * h) / 2;
                  ...
                  isNaN(k) ||
                    ...
                    a.clearRect(b.d(312), b.d(100), b.d(400), b.d(460)),
                    a.restore(),
                    a.save(),
                    a.scale(k, n),
                    a.translate(l, h),
                    a.translate(b.d(312), b.d(130)),
                    e.v(a, b.d(140)),
                    a.restore());
        ...
        return a.extend({
              ...
              h
                ? (a.on("click", function () {
                  ...
                  f.subscribe(f.r.Ib, function () {
                    g.ja({ text: d.W(b.Pp), img: a.find("img")[0], ua: !0 });
                  }))
                : a.hide();
            });
          },
          ...
          Gy: function () {
            ...
            if (9 <= a || c.ay) {
              ...
              a || e || c.ay
                ? ((this.opacity = this.of = 1),
                  (this.pf = null),
                  a || (r.set("msIsSiteModeActivated", "true"), l.Rz && l.Rz()))
                : ((this.of = 3),
                  (this.opacity = 0.35),
                  (this.pf = "pinPrompt"),
                  f.subscribe(f.r.Ib, function () {
                    g.ja({ text: d.W(b.Tq), Kc: "#showMeBtn img", ua: !0 });
                  }));
            } else
              e
                ? ((this.of = 2), (this.opacity = 0.35), (this.pf = "iePrompt"))
                : ((this.of = 0), (this.opacity = 0.35), (this.pf = null));
          ...
          xB: function () {
            ...
            a.delay(500)
              .fadeIn()
              .delay(2250)
              .animate({ left: n.d(200) }, 500, "easeInOutCirc")
              .fadeOut()
              .animate({ top: n.d(65), left: n.d(45), scale: "1.0" }, 0);
            b.delay(500)
              .fadeIn()
              .delay(1e3)
              .animate({ top: n.d(305), left: n.d(165) }, 1e3, "easeInOutBack")
              .delay(1500)
              .animate({ scale: "0.65" }, 200)
              .delay(1500)
              .fadeOut(1e3)
              .animate({ top: n.d(115), left: n.d(-49), scale: "1.0" }, 50)
              .fadeIn(500);
      ...
      zb = (function (a, c, d, b, f, e, g) {
        ...
        c.subscribe(c.r.Ib, function () {
          ...
          b.ja({ text: d.W(f.wi), Ab: "boxUpgradeButton", scale: 0.6 * e.bb });
        });
        var n = !1;
      ...
      fb = (function (a, c, d, b, f, e, g, k, l, n, r, m, p, u, q) {
        ...
        a = c.extend({
          ...
          Rt: function (a) {
            a.drawImage(
              this.df || this.Gj || this.Cj ? this.dt : this.bh,
              b.d(25),
              b.d(0)
            );
            if (this.Gj) {
              ...
              this.Ve.complete &&
                a.drawImage(
                  ...
                  b.d(77),
                  b.d(195),
                  1.2 * this.Ve.width * b.bb,
                  1.2 * this.Ve.height * b.bb
                );
            } else if (this.Cj)
              wa ||
                ((wa = new Image()),
                ...
                d.ja({ text: "Enter Code", Ab: "boxEnterCodeButton", ua: !0 })),
                wa.complete && a.drawImage(wa, b.d(50), b.d(90));
            else if (this.df) {
              E ||
                ((E = new Image()), d.ja({ text: "Collect", img: E, ua: !0 }));
              ...
              I ||
                ((I = new Image()),
                d.ja({ text: "to unlock", img: I, ua: !0 }));
      ...
      Va = (function (a, c) {
        a.eb = function () {
          var a = c.$d / c.pb;
          1 !== a && (this.ZA(), (this.zoom = a), this.Wu());
        ...
        (function () {
          return new (function () {
            ...
            this.resize = function (a) {
              ...
              this.Wu({ "margin-top": d, "margin-left": a });
            };
          })();
        })(),
        H
      ...
      Wa = (function (a, c, d) {
        var b = a.extend({
          ...
          update: function () {
            if (this.nb !== c.e)
              for (
                var a = this.Nm(), b = Math.min(3, Math.floor(this.rh)), d = 0;
                d < b;
                d++
              )
                a.update(0.016), (this.rh -= 1);
          },
          DA: function () {
            this.Lh = c.e;
          },
          ...
          mx: function () {
            ...
            if (1 < this.Zg) {
              ...
              for (var a = (this.Ec = 0), b = this.Wj.length; a < b; a++)
                this.Ec += this.Wj[a];
              this.Ec /= b;
            }
          },
          ...
          ng: function (a, b) {
            return this.nb === c.e ? !1 : this.xd[this.nb].Tj(a, b);
          },
          it: function (a, b) {
      ...
      Bb = (function (a, c, d, b, f, e, g, k, l) {
        return a.extend({
          init: function (a) {
            ...
            g.subscribe(g.r.qv, $.proxy(this.Bz, this));
          ...
          Wz: function (a) {
            if (
              ...
              null !== this.la &&
              (this.la.gs(a),
              this.Pu === b.e && this.la.update(),
              this.gn && ((this.gn = !1), this.la.ps()),
              this.la.nb !== b.e)
            ) {
              (a = this.la.Nm()) && a.v();
              this.la.mx();
              ...
              f.Qo &&
                ...
                a.fillText(
                  "1-16-2014",
                  e.pb - a.measureText("1-16-2014").width - 10,
                  e.ab - 10
                ));
            }
          },
          ...
          Oj: function (a, b) {
            return this.la && this.la != this
              ? ((this.Xf = !0), this.la.Oj(a, b))
              : !1;
          },
          pz: function (a, b) {
            return this.la && this.la != this
              ? (this.Xf && this.la.it(a, b), this.la.jt(a, b))
              : !1;
          },
          ng: function (a, b) {
          ...
          lh: function (a, b) {
            return this.la && this.la != this
              ? (this.la.ng(a, b), (this.Xf = !1), this.la.lh(a, b))
              : !1;
          },
        });
      })(Wa, Ua, Va, N, qa, H, V, P, ca),
      ya = (function (a, c, d, b, f, e, g, k) {
        return a.extend({
          ...
          bj: function (a, c, d, k, p, u, q) {
            ...
            for (var s = 1; s < k; s++)
              q ? (p = q[s]) : p++,
                (A = [f.create(this, e.Ri, p, 0)]),
                u.w(g.Nh(A, c)),
                s == k - 1 && d === b.Z.vb && u.w(g.Nh(A, c));
            d && (u.Jj = d);
            this.Kb(u, a);
          },
          XA: function (a, b, c) {
        ...
        a = a.extend({
          ...
          iu: function (a, c) {
            if ("R" === a[0]) {
              ...
              "C" !== a[1] && (k = -k);
              for (var n = 0; n < g; ++n)
                this.Of(new d(c.x + e * Math.cos(l), c.y + e * Math.sin(l))),
                  (l += k);
            } else
              for (
                this.Of(c.copy()),
          ...
          start: function () {
            0 < this.path.length &&
              (this.b.qa(this.path[0]), (this.Oc = 1), this.Xm());
          },
          pause: function () {
            this.paused = !0;
          },
            ...
            if (!this.paused) {
              if (0 < this.path.length) {
                ...
                if (this.b.rj(f)) e = !0;
                  ...
                  (c.nk(this.offset.x, f.x - this.b.x) &&
                    c.nk(this.offset.y, f.y - this.b.y)) ||
                    ((this.kb = d.$a(this.b, f).hd()),
                    (this.kb /= this.offset.hd()),
                    this.b.qa(f),
                    (e = !0));
                }
                e &&
                  (this.reverse
                    ? (this.Oc--,
                      0 > this.Oc && (this.Oc = this.path.length - 1))
                    : (this.Oc++, this.Oc >= this.path.length && (this.Oc = 0)),
                  this.Xm());
              }
        ...
        a = a.extend({
          ...
          update: function (a) {
            ...
            this.Pa &&
              ...
              (this.x = this.Pa.b.x),
              (this.y = this.Pa.b.y),
              this.lk ? this.LA(this.Pa.a) : (this.rotation = this.Pa.a));
          },
          LA: function (a) {
            this.lk || (this.lk = !0);
            this.rotation = a;
          ...
          Yf: function () {
            ...
            this.lk
              ? (a.beginPath(),
                a.moveTo(b + e.Iu, c + e.Ju),
                a.lineTo(b + e.Nu, c + e.Ou),
                a.lineTo(b + e.es, c + e.fs),
                a.lineTo(b + e.Wr, c + e.Xr),
                a.stroke(),
                a.closePath())
              : a.strokeRect(b + d.x, c + d.y, d.M, d.U);
          },
          xo: function (a, b) {
            var c = this.aa;
      ...
      Eb = (function (a) {
        return a.extend({
          ...
          v: function () {
            this.ep ? (this.vc(), this.uc()) : this.h();
          },
        });
      })(Aa),
        ...
        (function (a, c, d, b, f, e, g) {
          ...
          return d.extend({
            ...
            Bh: function (d) {
              ...
              e.multiply(this.speed + this.wu * b.tb());
              d.dir = e;
              d.Zh = this.Zh + this.Kt * b.tb();
              d.ji = this.ji + this.Eu * b.tb();
              d.rc = this.rc + this.$s * b.tb();
              var e = new c(
                  this.wc.F + this.ye.F * b.tb(),
                  this.wc.K + this.ye.K * b.tb(),
                  this.wc.J + this.ye.J * b.tb(),
                  this.wc.B + this.ye.B * b.tb()
                ),
                f = new c(
                  this.oc.F + this.he.F * b.tb(),
                  this.oc.K + this.he.K * b.tb(),
                  this.oc.J + this.he.J * b.tb(),
                  this.oc.B + this.he.B * b.tb()
                );
              d.color = e;
              d.ee.F = (f.F - e.F) / d.rc;
              d.ee.K = (f.K - e.K) / d.rc;
            ...
            update: function (a) {
              this.h(a);
              if (this.cb && 0 === this.Vb.length && !this.active)
                this.cb(this);
              else {
                if (this.active && this.nj) {
                  var b = 1 / this.nj;
                  for (this.Ye += a; this.Vb.length < this.Xo && this.Ye > b; )
                    this.Tr(), (this.Ye -= b);
                  this.oh += a;
                  -1 !== this.duration && this.duration < this.oh && this.JB();
                }
                for (this.Pd = 0; this.Pd < this.Vb.length; )
                  (b = this.Vb[this.Pd]),
                    0 < b.rc
                      ? (this.Zu(b, a),
                        (b.color.F += b.ee.F * a),
            ...
            v: function () {
              ...
              if (0 !== this.color.B)
                for (
                  var a = f.context, b = this.L.qc, c = 0, d = this.Pd;
                  c < d;
                  c++
                ) {
                  var e = this.Vb[c];
      ...
      Ib = (function (a, c, d) {
        return a.extend({
          ...
          update: function (a) {
            for (var c = this.Ca, d = c.length, g = this.Eo, k = 0; k < d; k++)
              c[k].update(a);
            for (k = 0; k < g; k++) for (a = 0; a < d; a++) c[a].ok();
          },
        });
      })(ba, K, ja),
      Xa = { Ai: 0, Pi: 1, hD: 2 },
        ...
        return a.extend({
          ...
          update: function (a) {
            ...
            this.ts ||
              (b.Wn()
                ? this.Ud.add(this.Kd)
                : this.Ud.add(d.multiply(b.ed, this.fC)));
            a /= c.$i;
        ...
        return c.extend({
          ...
          update: function (a) {
            ...
            this.ts
              ...
              : 0 !== d.y || 0 !== d.x
              ? ((c.x = d.x), (c.y = d.y))
              : ((c.x = this.Kd.x * this.Dh), (c.y = this.Kd.y * this.Dh));
            c = ((a / b.$i) * a) / b.$i;
            this.B.x = this.Ud.x * c;
            this.B.y = this.Ud.y * c;
            this.va.x === b.Jf &&
              ((this.va.x = this.b.x), (this.va.y = this.b.y));
            this.tc.x = this.b.x - this.va.x + this.B.x;
            this.tc.y = this.b.y - this.va.y + this.B.y;
            0 < a &&
              ((a = 1 / a),
              (this.yc.x = this.tc.x * a),
              (this.yc.y = this.tc.y * a));
            this.va.x = this.b.x;
            this.va.y = this.b.y;
            this.b.x += this.tc.x;
            this.b.y += this.tc.y;
        ...
        a = a.extend({
          ...
          hd: function () {
            var a = 0,
              ...
              c = b.length;
            if (0 < c)
              for (var d = b[0].b, h = 1; h < c; h++)
                var e = b[h], a = a + d.Ma(e.b), d = e.b;
            return a;
          },
          $t: function (a, b) {
            null == b && (b = e.Qa());
            for (
              ...
              a >= this.La
                ? ((g = d[d.length - 2]),
                  ...
                  l.sd(0.02),
                  (l.b = e.add(g.b, b)),
                  this.Sr(l, this.Ca.length - 1),
                  h.js(g, l, k),
                  l.Re(g, this.La, f.Ai),
                  (a -= this.La))
                : ((l = a + k),
                  l > this.La
                    ? ((a = this.La), (k = l - this.La))
                    : ((g = d[d.length - 2]), h.ej(g, l), (a = 0)));
          },
          HA: function (a) {
            for (
              var b = this.Ca, c = b.length, d = this.hb, h = d.rd(b[c - 2]), e;
              0 < a;
              ...
              if (a >= this.La) {
                ...
                (g = h - a),
                  1 > g
                    ? ((a = this.La), (h = this.La + g + 1))
                    : ((e = b[c - 2]), d.ej(e, g), (a = 0));
            b = (c - 1) * (this.La + 3);
            d = d.Ub;
            c = d.length;
          ...
          mF: function () {
            for (var a = this.Ca, c = a.length, d = 0; d < c; d++) {
              ...
              this.Ya.Mc.x != b.e &&
                (e != this.hb && e.sd(0.5),
                0 < d && e.Re(this.Ya, d * (this.La + 3), f.Pi));
            }
          },
          update: function (a) {
            0 < this.de &&
              ((this.de = l.kf(this.de, 0, 1, a)),
              1.95 > this.de && this.ag && this.Qt(this.zb));
            var b = this.Ca,
              c = b.length,
              d = this.Eo,
              h = this.hb,
            ...
            for (e = 0; e < d; e++) for (a = 0; a < c; a++) b[a].ok();
          },
          Qt: function (a) {
            this.ag = !1;
            var b = this.Ca,
          ...
          kn: function (a) {
            var c = a.length,
              ...
              f = this.ij;
            if (!(2 > c)) {
              var h = this.zb === b.e || this.ag ? 1 : this.de / 1.95;
              if (!(0 >= h)) {
                var l = a[0],
                  D = a[1],
                  J = l.x - D.x,
                ...
                if (!(3 > c)) {
                  ...
                  for (var w, l = 1; l <= c; l++)
                    if (
                      ...
                      w = l - v - 1;
                      var Y = f[w++];
                      for (L.moveTo(Y.x, Y.y); w <= l; w++)
                        (Y = f[w]), L.lineTo(Y.x, Y.y);
                      L.stroke();
                      J = !J;
                      v += 1;
                      m.F += d * v;
      ...
      jb = (function (a, c, d) {
        return a.extend({
          ...
          sB: function (a, c, d) {
            ...
            this.p[0] = Math.floor((this.height - a) / 2);
          ...
          v: function () {
            ...
            var a = this.L.f[this.ud[0]],
              ...
              u = Math.ceil(e.U);
            0 <= g
              ? (k.drawImage(this.L.qc, a.x, a.y, r, m, l, n + this.p[0], r, m),
                this.Mx(this.ud[1], l + r, n + this.p[1], g, d.U),
                k.drawImage(
                  this.L.qc,
                  e.x,
                  e.y,
              ...
              : ((a = a.copy()),
                (d = e.copy()),
                (a.M = Math.min(a.M, this.width / 2)),
                (d.M = Math.min(d.M, this.width - a.M)),
                (d.x += e.M - d.M),
                k.drawImage(
                  this.L.qc,
                  a.x,
      ...
      Lb = (function (a, c, d, b, f, e, g, k, l, n, r, m, p, u, q, A, s, z, h) {
        return a.extend({
          ...
          vy: function (a) {
            ...
            c =
              0 < c
                ? Math.min(Math.max(1, c), l.Ei)
                : Math.max(Math.min(-1, c), -l.Ei);
            this.ta &&
              (0 < c
                ? this.ta.hd() < l.Zk && this.ta.$t(c)
                : 0 !== c && 3 < this.ta.Ca.length && this.ta.HA(-c),
              (this.bp = !0));
            this.Hj.qa(a);
          },
          update: function (a) {
            ...
            if (this.Xs && this.ta) {
              ...
              b.Mc.qa(b.b);
              this.Ij
                ? ((b = g.md(this.ff, 200, 30, a)),
                  (this.ff = b.value),
                  b.pd && (this.Ij = !1))
                : ((b = g.md(this.ff, 130, 30, a)),
                  (this.ff = b.value),
                  b.pd && (this.Ij = !0));
              this.Pa.gB(this.ff);
            }
            ...
            this.m &&
              ...
              (this.hc.X =
                0 === a
                  ? (this.hc.da = 0)
                  : (this.hc.da = Math.max(0, Math.min(1.2, 1 - a / l.$k)))));
          },
          dC: function (a) {
            this.Ic &&
              this.uk &&
              ((this.uk = !1), (this.xg = !0), b.N(f.nm), this.c.R(0));
            if (this.Ic && this.xg) {
              ...
              if (this.ta)
                for (
                  var d = this.ta.ij, g = l.La, m = 0, p = d.length;
                  m < p;
                  m++
                ) {
                  var q = d[m],
                  ...
                  if (this.tf >= h && (this.tf < h + r || m > p - 3)) {
                    ...
                    this.c.y = q.y + n.y;
                    m > p - 3 && (a = !0);
                    0 !== this.c.Vf && (this.c.rotation = c.Bg(n.og()) + 270);
                    break;
                  } else h += r;
                }
              a && (this.tf = k.e);
          ...
          Hx: function () {
            if (!this.pe && !this.G) {
              ...
              if (this.n !== k.e || this.xh)
                (a = new q(0.2, 0.5, 0.9, this.$h)),
                  this.vs(this.x, this.y, this.n !== k.e ? this.n : this.Gt, a);
            }
          },
          vs: function (a, b, c, h) {
            if (!(0 > c)) {
          ...
          v: function () {
            if (!this.pe) {
              var a = this.ta;
              this.m &&
                ((this.Eg.visible = this.Gg !== k.e),
                (this.Fg.visible = this.Gg === k.e),
                this.ri.v());
          ...
          lB: function (a) {
            ...
            a === k.e || a === k.lv
              ? ((a = s.gb(f.ll, f.ml)),
                ...
                this.back.ya(),
                (this.back.anchor = this.back.oa = m.S),
                (this.gd = p.create(a, 1)),
                (this.gd.anchor = this.gd.oa = m.S),
                this.T(this.back),
                this.T(this.gd),
                (this.back.visible = !1),
                (this.gd.visible = !1))
              : ((this.back = p.create(f.Ji, 0)),
                this.back.ya(),
                (this.back.anchor = this.back.oa = m.S),
                (this.gd = p.create(f.Ji, 1)),
                (this.gd.anchor = this.gd.oa = m.S),
                this.T(this.back),
                this.T(this.gd),
                (this.back.visible = !1),
                ...
                (this.xh = !1));
            this.m &&
              ((this.ri = p.create(f.Hf, 0)),
              (this.ri.anchor = this.ri.oa = m.S),
              this.T(this.ri),
              (this.ri.visible = !1),
              (this.hc = p.create(f.Hf, 1)),
              (this.hc.te = !1),
              (this.Eg = p.create(f.Hf, 2)),
              (this.Eg.anchor = this.Eg.oa = m.S),
              this.hc.T(this.Eg),
              (this.Fg = p.create(f.Hf, 3)),
              (this.Fg.anchor = this.Fg.oa = this.hc.anchor = this.hc.oa = m.S),
              this.hc.T(this.Fg),
              this.T(this.hc),
              (this.bp = this.hc.visible = !1));
          },
          fB: function (a, b, c) {
            this.q = a;
            this.u = b;
            ...
            0 < this.q &&
              ((this.Bb = new h(a)),
              (this.Bb.Rd = -Math.round(this.Bb.width / 2) + l.Di),
              (this.Bb.x = -l.Di),
              (this.bf = p.create(f.Je, 3)),
              (this.bf.visible = !1),
              (this.bf.anchor = this.bf.oa = m.S),
              this.T(this.bf),
              (this.le = p.create(f.Je, 4)),
              (this.le.visible = !1),
              (this.le.anchor = this.le.oa = m.S),
              this.T(this.le),
              this.le.T(this.Bb),
              this.u
                ? ((this.Bb.rotation = 90),
                  (this.Bb.y = -this.t),
                  (this.Nj = this.y - this.t),
                  (this.Mj = this.y + (this.q - this.t)),
                  (this.le.rotation = 90),
                  (this.bf.rotation = 90))
                : ((this.Nj = this.x - this.t),
                  (this.Mj = this.x + (this.q - this.t)),
                  (this.Bb.x += -this.t)),
              (this.Bb.anchor = m.Nf | m.mb),
              (this.Bb.x += this.x),
              (this.Bb.y += this.y),
              (this.Bb.visible = !1));
            this.lf = k.e;
      ...
      Ob = (function (a, c, d, b, f, e, g, k, l) {
        ...
        n.Lf = { zv: 0, Av: 1, Ni: 2, bD: 3, aD: 4 };
        n.Z = { nw: 0, Iw: 1, IDLE: 2 };
        n.tv = 0.8;
        return n;
          ...
          cf: function (a, c, e) {
            ...
            return this.bg.M !== b.e
              ...
              : d.Db(
                  ...
                  this.ea - this.Yo - e,
                  this.fa - this.Zo - e,
                  this.width + (this.Yo + this.Mu) + 2 * e,
                  this.height + (this.Zo + this.Lu) + 2 * e
                );
          },
          Sj: function (a, b) {
            this.h(a, b);
            return this.state === e.Z.Dd && this.cf(a, b, !0)
              ? (this.gi(e.Z.Ge), !0)
              : !1;
          },
          Tj: function (a, b) {
            this.h(a, b);
            return this.state === e.Z.Ge && (this.gi(e.Z.Dd), this.cf(a, b, !1))
              ? (this.Cb && this.Cb(this.Wm), !0)
              : !1;
          },
          ro: function (a, b) {
            this.h(a, b);
      ...
      Pb = (function (a, c, d, b, f, e, g, k, l, n, r, m, p, u) {
        return a.extend({
          init: function (a, c, g, k, h) {
            ...
            this.Sb();
            5 === g &&
              (this.jb(0, 0.05, f.ha.vb, 0, 0),
              this.jb(1, 0.05, f.ha.vb, 1, 4),
              this.ya());
            this.Ek = e.e;
          },
          Sb: function () {
          ...
          KA: function () {
            ...
            b.w(m.re(a, m.A.Hb, 0.3 * (Math.abs(a - this.rotation) / 90)));
          ...
          Cb: function (a) {
            0 === a &&
              (this.tt && this.tt(this.yf), this.zk ? c.N(d.Wi) : c.N(d.Xi));
          },
          Yf: function () {
            var a = p.context;
            a.beginPath();
      ...
      })(Ba, ma, w, K, fa, N, ea, na, aa, kb, S, oa, P, H),
        ...
        return a.extend({
          ...
          ih: function () {
            ...
            0 < this.timeout &&
              ((this.xc = new c()),
              this.xc.sa(d.Wc),
              (this.xc.anchor = this.xc.oa = b.S),
              this.xc.jb(0, this.timeout / 37, f.ha.Wa, 19, 55),
              this.xc.R(0),
              (this.time = this.timeout),
              (this.xc.visible = !1),
              this.T(this.xc),
              (a = new f()),
              a.w(e.za(g.lb.copy(), e.A.LINEAR, 0)),
              a.w(e.za(g.Fb.copy(), e.A.LINEAR, 0.5)),
              this.xc.Kb(a, 1),
              (a = new f()),
              a.w(e.Kj(1, 1, e.A.LINEAR, 0)),
              a.w(e.Kj(0, 0, e.A.LINEAR, 0.25)),
              a.w(e.za(g.lb.copy(), e.A.LINEAR, 0)),
              a.w(e.za(g.Fb.copy(), e.A.LINEAR, 0.25)),
              this.Kb(a, 1));
            this.aa = k.copy(r.ym);
            a = new f();
          ...
          update: function (a) {
            0 < this.timeout &&
              0 < this.time &&
              (this.time = n.kf(this.time, 0, 1, a));
            this.h(a);
          },
          v: function () {
            this.xc && this.xc.v();
      ...
      lb = (function (a, c, d) {
        return a.extend({
          ...
          Oo: function (a, f, e, g) {
            a = c.hj({ tj: a, text: f, width: e, Dc: g });
            this.ne(new d(a));
          },
        });
      })(aa, da, Sa),
      ...
      Sb = (function (a, c, d, b) {
        var f = a.extend({
          ...
          moveTo: function (a, b, d) {
            ...
            this.target.y = b;
            d
              ? this.b.qa(this.target)
              : this.type === f.Yc.zi
              ? ((this.offset = c.$a(this.target, this.b)),
          ...
          update: function (a) {
            this.b.rj(this.target) ||
              (this.b.add(c.multiply(this.offset, a)),
              this.b.round(),
              (b.nk(this.offset.x, this.target.x - this.b.x) &&
                b.nk(this.offset.y, this.target.y - this.b.y)) ||
                this.b.qa(this.target));
          },
          bx: function () {
            (0 === this.b.x && 0 === this.b.y) ||
              d.context.translate(-this.b.x, -this.b.y);
          },
          ox: function () {
            (0 === this.b.x && 0 === this.b.y) ||
              d.context.translate(this.b.x, this.b.y);
        ...
        return {
          ...
          update: function (a) {
            for (var d = this.fe.slice(0), b = 0, f = d.length; b < f; b++) {
              ...
              0 > g ||
                ((e.delay -= a),
                0 >= e.delay && (this.fe.splice(g, 1), e.Ex()));
            }
          },
        };
      })(),
      ...
      Vb = (function (a) {
        return a.extend({
          ...
          update: function (a) {
            for (var d = 0, b = this.bi.length; d < b; d++)
              this.removeChild(this.bi[d]);
            this.bi = [];
            this.h(a);
          },
          Wo: function (a) {
      ...
      mb = (function (a, c, d, b, f, e, g) {
        ...
        var l = a.extend({
          ...
          Xw: function (a, b) {
            ...
            this.ap();
            for (var d = f.e, e = 0, g = this.Hd.length; e < g; e++)
              if (this.Hd[e].L === a) {
                d = e;
                break;
              }
            d === f.e &&
              ((e = new c(a)), (d = this.Hd.length), this.Hd.push(e));
          ...
          fill: function (a, b, c, d, e) {
            ...
            for (b += d; f < b; f++) {
              d = a;
              for (var g = a + c; d < g; d++) this.Yn[f][d] = e;
            }
          },
          fF: ka("uo"),
          mB: function (a) {
          ...
          $u: function (a) {
            ...
            this.di !== l.kc.NONE &&
              ((k -= c),
              (q = Math.floor(k) % this.ki),
              (k = 0 > k ? q + c : q - this.ki + c));
            this.ci !== l.kc.NONE &&
              ((e -= b),
              (q = Math.floor(e) % this.li),
              (e = 0 > e ? q + b : q - this.li + b));
            if (
              d.ai(
                b,
                c,
              ...
              for (e = q.x; e <= A; e++) {
                ...
                for (var C = q.y; C <= h && !(z.y >= c + this.fh); C++) {
                  ...
                  this.di === l.kc.Lp &&
                    (z.y < y
                      ? (E = 0)
                      : z.y >= this.y + this.ki && (E = this.rows - 1));
                  this.ci === l.kc.Lp &&
                    (z.x < this.x
                      ? (x = 0)
                      : z.x >= this.x + this.li && (x = this.Te - 1));
                  this.yy &&
                    ((s = Math.sin(z.x) * this.Lt),
                    (x = Math.abs(Math.floor(s) % this.Te)));
                  this.eC &&
                    ((s = Math.sin(z.y) * this.Lt),
                    (E = Math.abs(Math.floor(s) % this.rows)));
                  x >= this.Te && (x %= this.Te);
                  ...
                  0 <= s &&
                    ...
                    (E = s.L),
                    x.It !== f.e &&
                      ((x = E.f[x.It]), (J.x += x.x), (J.y += x.y)),
                    (D = new d(a.x + D.x, a.y + D.y, D.M, D.U)),
                    s.Ua(s.Pj++, J, D));
                  z.y += this.wf;
                }
                z.x += this.xf;
          ...
          update: function (a) {
            ...
            for (c = 0; c < b; c++)
              (d = this.Yj[c]),
                (e = g.md(d.X, d.pj, 1, a)),
                (d.X = e.value),
                e.pd && ((e = d.Ak), (d.Ak = d.pj), (d.pj = e)),
                (e = g.md(d.da, d.qj, 1, a)),
                (d.da = e.value),
                e.pd && ((e = d.Bk), (d.Bk = d.qj), (d.qj = e)),
                (e = this.Jt * d.X),
                (f = this.Ht * d.da),
                (this.Ta.Ce[c] = new n(d.x - e / 2, d.y - f / 2, e, f)),
                (e = g.md(d.alpha, d.oj, 1, a)),
                (d.alpha = e.value),
                e.pd && ((e = d.To), (d.To = d.oj), (d.oj = e)),
                (this.Ta.Qf[c] = d.alpha);
          },
          v: function () {
            this.vc();
            this.Ta.v();
          ...
          q = a.extend({
            ...
            wx: function (a) {
              ...
              var b = this.Fc.length,
                c;
              for (c = 0; c < b; c++)
                if (0 <= a.Fc.indexOf(this.Fc[c])) return !0;
              return !1;
            },
            copy: function (a) {
              var b = new q();
      ...
      cc = (function (a, c, d, b) {
        ...
        (function (a, c, d, b, f, e, g, k, l, n, r, m, p, u, q, A) {
          return a.extend({
            ...
            hA: function () {
              this.Jc || this.R(this.Bs, this.As);
            },
            pA: function () {
            ...
            ih: function (a, d, h, f) {
              var k, l, p;
              l = 0;
              for (p = this.Vt.length; l < p; l++)
                (k = this.Uw(this.Vt[l])), (k.Ha = 1e-4);
              ...
              this.jb(this.co, this.bo, 0.05, e.ha.Wa, this.sz, this.rz);
              ...
              this.support.y = this.y + Math.round((this.KB || 0) * n.Gb);
            },
            KB: 0,
            Kz: function (a, b, c) {
              1 === c &&
                ...
                this.Mn--,
                0 === this.Mn &&
                  (1 === u.gb(0, 1) ? this.jA() : this.kA(),
                  (this.Mn = u.gb(5, 20))));
            },
            WB: function () {
              this.Tm--;
              0 === this.Tm &&
                ((this.blink.visible = !0), this.blink.R(0), (this.Tm = 3));
            },
            v: function () {
              this.support.v();
              this.h();
          ...
          (function (a, c, d, b, f, e) {
            return a.extend({
              ...
              Td: function (a, c, e, n, r) {
                ...
                e !== a &&
                  (c.push(d.create(a, b.Ul, 1, 1)),
                  c.push(d.create(a, b.Si, 1, 1)),
                  c.push(d.create(a, b.Tl, 1, 1)),
                  c.push(d.create(e, b.Ul, 0, 0)),
                  c.push(d.create(e, b.Si, 0, 0)),
                  c.push(d.create(e, b.Tl, 0, 0)));
                r = f.Nh(c, r);
                n.w(r);
              },
              R: function (a, b) {
      ...
      fc = (function (
        ...
        return h.extend({
          init: function () {
            ...
            this.Ao = Array(I.Xc);
            for (a = 0; a < I.Xc; a++)
              (this.mh[a] = !1), (this.ze[a] = G.Qa()), (this.Ao[a] = G.Qa());
          },
          yo: function (a) {
            var b = v.Gl;
          ...
          show: function () {
            ...
            2 !== this.I &&
              ((this.ad = new w()),
              this.ad.sa(E.Pg),
              (this.ad.oa = this.ad.anchor = W.S),
              this.ad.lc(0.05, X.ha.vb, 0, 12),
              this.ad.R(0),
              this.Ia.T(this.ad),
              (this.ad.visible = !1),
              (this.ad.Ha = 1e-4),
              (this.bd = new w()),
              this.bd.sa(E.Pg),
              (this.bd.oa = this.bd.anchor = W.S),
              this.bd.lc(0.05, X.ha.vb, 0, 12),
              this.bd.R(0),
              this.Ja.T(this.bd),
              (this.bd.visible = !1),
              (this.bd.Ha = 1e-4));
            for (var b = this.Ra.length, c, a = 0; a < b; a++)
              (c = this.Ra[a]), (c.Vh = I.e), (c.Gd = this.Ra);
            this.HB();
            this.yg = 0;
          ...
          HB: function () {
            ...
            if (this.ld > a || this.kd > b) {
              ...
              var c,
                h,
                d = 2 !== this.I ? this.ga : this.Q;
              this.ld > a
                ? ((c = d.b.x > this.ld / 2 ? 0 : this.ld - a), (h = 0))
                : d.b.y > this.kd / 2
                ? (h = c = 0)
                : ((c = 0), (h = this.kd - b));
              var e = d.b.y - b / 2,
          ...
          dz: function (a) {
            ...
            this.kd *= this.P;
            Ma.vB[Y.Od] &&
              (this.ld > v.pb && this.Id.push(new P(v.pb, 0)),
              this.kd > v.ab && this.Id.push(new P(0, v.ab)),
              this.Id.push(new P(0, 0)));
          },
          Yy: function (a) {
            this.O = a.O || 0;
            this.$ = a.$;
          ...
          Zy: function (a) {
            ...
            if (x.Pa && (x.TA(), !r)) {
              ...
              f = 0;
              for (g = x.Pa.path.length - 1; f < g; f++)
                (a && 0 !== f % 3) || this.ue.Ds(f, f + 1, x);
            ...
            d !== I.e ||
              D ||
              ((D = this.Q),
              2 !== this.I && (D = q ? this.ga : this.xa),
              (b = new V(null, b, c, D, D.b.x, D.b.y, h)),
              b.Ya.Mc.qa(b.Ya.b),
              x.ku(b),
              this.Sm());
            x.lB(d);
          ...
          lz: function (a) {
            if (!this.mu(a))
              if (null == a.text || "" === a.text)
                Ca.debug("Missing tutorial text");
              else {
                var b = new m();
                b.x = a.x * this.P + this.rb;
                b.y = a.y * this.P + this.ib;
          ...
          kz: function (a) {
            if (!this.mu(a)) {
              ...
              a.w(B.za(L.lb.copy(), B.A.LINEAR, 1));
              0 === Y.Od && 0 === Y.gf
                ? a.w(B.za(L.lb.copy(), B.A.LINEAR, 10))
                : a.w(B.za(L.lb.copy(), B.A.LINEAR, 5.2));
              a.w(B.za(L.Fb.copy(), B.A.LINEAR, 0.5));
              c.Kb(a, 0);
              0 === c.O
                ? c.R(0)
                : 2 === c.O &&
                  ((a = new X()),
                  a.w(B.za(L.Fb.copy(), B.A.LINEAR, 0)),
                  a.w(B.za(L.lb.copy(), B.A.LINEAR, 0.5)),
                  a.w(B.za(L.lb.copy(), B.A.LINEAR, 1)),
                  a.w(B.za(L.lb.copy(), B.A.LINEAR, 1.1)),
                  a.w(B.za(L.Fb.copy(), B.A.LINEAR, 0.5)),
                  a.w(B.Oa(c.x, c.y, B.A.LINEAR, 0)),
                  a.w(B.Oa(c.x, c.y, B.A.LINEAR, 0.5)),
                  a.w(B.Oa(c.x, c.y, B.A.LINEAR, 1)),
                  a.w(B.Oa(c.x + v.Hm, c.y, B.A.LINEAR, 0.5)),
                  a.w(B.Oa(c.x + v.Im, c.y, B.A.LINEAR, 0.5)),
                  (a.jf = 2),
                  (a.Jj = X.ha.vb),
                  c.Kb(a, 1),
                  c.R(1));
          ...
          update: function (a) {
            ...
            function c(a, b) {
              return (
                ...
                Q.hf(a.Aa.x, a.Aa.y, a.Ba.x, a.Ba.y, b.b.x - z, b.b.y - z, J, J)
              );
            }
            var h, e;
            h = 0;
            ...
            h = 0;
            for (e = this.Id.length; h < e; h++) this.Id[h].update(a);
            ...
            if (this.Y.type === q.Yc.Kf) {
              ...
              r < e && (this.me = !1);
              this.Cs
                ? this.Y.speed < v.Nk && (this.Y.speed *= 1.5)
                : r > this.Rs / 2
                ? ((this.Y.speed += a * g),
                  (this.Y.speed = Math.min(m, this.Y.speed)))
                : ((this.Y.speed -= a * k),
                  (this.Y.speed = Math.max(n, this.Y.speed)));
              1 > Math.abs(this.Y.b.x - h) &&
                1 > Math.abs(this.Y.b.y - f) &&
                ((this.Y.type = q.Yc.zi), (this.Y.speed = v.xi));
            } else this.time += a;
            f = this.Ga.length;
            if (0 < f) {
              m = k = e = !1;
              for (h = 0; h < f; h++) {
                ...
                s.Pa &&
                  g &&
                  ((g.Ya.b.x = s.x), (g.Ya.b.y = s.y), g.Ya.Mc.qa(g.Ya.b));
                if (g) {
                  if (g.zb !== I.e && 0 === g.de) {
                    s.rs();
                    continue;
                  ...
                  if (
                    s.Ic &&
                    ((this.Y.type == q.Yc.Kf && this.me) || s.dC(a),
                    s.tf === I.e)
                  ) {
                    this.FB(s);
                    break;
                ...
                if (s.n !== I.e && !s.ta) {
                  var B = v.zm,
                    n = $.proxy(function (a) {
                      new G(s.x, s.y).Ma(a.b) <= s.n + B &&
                        ((a = new V(null, s.x, s.y, a, a.b.x, a.b.y, s.n + B)),
                        a.Ya.Mc.qa(a.Ya.b),
                        (s.xh = !0),
                        s.ku(a),
                        this.Sm(),
                ...
                if (g) {
                  ...
                  e ||
                    (2 !== this.I
                      ? n !== this.ga || this.Pb || k
                        ? n !== this.xa || this.Qb || m || (C = !0)
                        : (C = !0)
                      : this.sb || e || (C = !0));
                  0 !== g.Fo && g.zb === I.e && C
                    ? ((r = N.Bg(r.og())),
                      2 !== this.I
                        ? ((C = n === this.ga ? this.Ia : this.Ja),
                          g.hh || (g.oe = C.rotation - r),
                          n === this.ga
                            ? ((this.Jh = r + g.oe - C.rotation), (k = !0))
                            : ((this.Kh = r + g.oe - C.rotation), (m = !0)),
                          (C.rotation = r + g.oe))
                        : (g.hh || (g.oe = this.Mb.rotation - r),
                          (this.Ih = r + g.oe - this.Mb.rotation),
                          (this.Mb.rotation = r + g.oe),
                          (e = !0)),
                      (g.hh = !0))
                    : (g.hh = !1);
                }
              ...
              2 !== this.I
                ? (k ||
                    this.Pb ||
                    ((this.Ia.rotation += Math.min(5, this.Jh)),
                    (this.Jh *= 0.98)),
                  m ||
                    this.Qb ||
                    ((this.Ja.rotation += Math.min(5, this.Kh)),
                    (this.Kh *= 0.98)))
                : e ||
                  this.sb ||
                  ((this.Mb.rotation += Math.min(5, this.Ih)),
                  (this.Ih *= 0.98));
            }
            ...
            if (2 !== this.I) {
              ...
              if (0 < this.se)
                if (
                  ((e = u.md(this.se, 0, 200, a)), (this.se = e.value), e.pd)
                ) {
                  x.N(E.$l);
                  this.I = 2;
                  this.sb = !1;
                  this.Qb = this.Pb = !0;
                  if (this.bc || this.mc)
                    (this.$b = this.bc ? this.bc : this.mc),
                      (this.ac.visible = !0);
                  ...
                  for (e = this.Ga.length; h < e; h++)
                    (s = this.Ga[h]),
                      !(g = s.ta) ||
                        g.zb === g.Ca.length - 3 ||
                        (g.hb !== this.ga && g.hb !== this.xa) ||
                        ((r = g.Ca[g.Ca.length - 2]),
                        (k = g.hb.rd(r)),
                        this.Q.Re(r, k, T.Ai),
                        (g.hb = this.Q),
                        (g.Ca[g.Ca.length - 1] = this.Q),
                        (g.oe = 0),
                        (g.hh = !1));
                  h = new w();
                  h.sa(E.Bc);
                  ...
                  this.ga.ej(this.xa, this.se), this.xa.ej(this.ga, this.se);
              this.Pb ||
                this.Qb ||
                0 !== this.I ||
                !O.Ch(this.Ia, this.Ja) ||
                ((this.I = 1),
                (this.se = this.ga.b.Ma(this.xa.b)),
                this.ga.Re(this.xa, this.se, T.Pi),
                this.xa.Re(this.ga, this.se, T.Pi));
            }
            this.target.update(a);
            if (this.Y.type !== q.Yc.Kf || !this.me)
              for (h = 0, e = this.Eb.length; h < e; h++)
                if (
                  ((k = this.Eb[h]), k.update(a), 0 < k.timeout && 0 === k.time)
                ) {
                  ...
                  (g =
                    2 !== this.I
                      ? (O.Ch(this.Ia, k) && !this.Pb) ||
                        (O.Ch(this.Ja, k) && !this.Qb)
                      : O.Ch(this.ca, k) && !this.sb))
                ) {
                  this.xb.R(1);
                  this.yg++;
            ...
            for (e = this.bubbles.length; h < e; h++) {
              ...
              if (!g.ep)
                for (n = this.Ra.length, m = 0; m < n; m++)
                  (k = this.Ra[m]),
                    G.Ma(g.x, g.y, k.x, k.y) < k.Rb && (g.ep = !0);
            }
            h = 0;
            ...
            for (e = this.wg.length; h < e; h++)
              if (
                ...
                (r = n = 2 * v.Wg),
                0 <= f.y &&
                  (Q.hf(k.Fa.x, k.Fa.y, k.Ka.x, k.Ka.y, g, m, n, r) ||
                    Q.hf(k.Aa.x, k.Aa.y, k.Ba.x, k.Ba.y, g, m, n, r)))
              ) {
                if (k.state === l.Z.IDLE) {
                  for (m = 0; m < e; m++)
            ...
            for (e = this.ec.length; h < e; h++)
              (g = this.ec[h]),
                ...
                f.pd && this.Xz(g, a);
            h = 0;
            for (e = this.ek.length; h < e; h++)
              (f = this.ek[h]), f.update(a), this.zb(f, null, null, !1);
            var z = v.Am,
              J = 2 * z;
            h = 0;
            for (e = this.Xb.length; h < e; h++)
              if (((k = this.Xb[h]), k.update(a), !k.ph || k.mj))
                if (
                  ((f = g = !1),
                  2 !== this.I
                    ? (g = !this.Pb && c(k, this.ga))
                      ? (f = !0)
                      : (g = !this.Qb && c(k, this.xa))
                    : (g = !this.sb && c(k, this.Q)),
                  g)
                ) {
                  2 !== this.I
                    ? f
                  ...
                  2 != this.I
                    ? f
                      ? ((g.x = this.Ia.x), (g.y = this.Ia.y), (this.Pb = !0))
                      : ((g.x = this.Ja.x), (g.y = this.Ja.y), (this.Qb = !0))
                    : ((g.x = this.ca.x), (g.y = this.ca.y), (this.sb = !0));
                  g.zu(5);
                  this.Xa.T(g);
                  x.N(E.Zl);
                  this.gk(f);
            ...
            if (
              ...
              h = this.O = 0;
              for (e = this.Af.length; h < e; h++)
                (g = this.Af[h]), 1 === g.O && g.R(0);
              h = 0;
              for (e = this.Vd.length; h < e; h++)
                (g = this.Vd[h]), 1 === g.O && g.R(0);
            }
            if (
              this.cn &&
              !this.me &&
              (this.Xt(),
              (h = new G(0, 0)),
              (f = G.add(this.yk, this.Y.b)),
              (g = (h = this.Js(h, f.x, f.y)) ? h.ta : null))
            ) {
              m = !1;
              this.Na &&
                this.Na.fb(this.Na.Vn() ? 1 : 0).cf(f.x, f.y, !0) &&
                (m = !0);
              if (this.$b || (2 != this.I && (this.bc || this.mc)))
                for (h = 0, e = this.bubbles.length; h < e; h++) {
                  ...
                  if (
                    this.$b &&
                    Q.Db(f.x, f.y, this.Q.b.x - k, this.Q.b.y - k, n, n)
                  ) {
                    m = !0;
                    break;
                  }
                  if (
                    this.bc &&
                    Q.Db(f.x, f.y, this.ga.b.x - k, this.ga.b.y - k, n, n)
                  ) {
                    m = !0;
                    break;
                  }
                  if (
                    this.mc &&
                    Q.Db(f.x, f.y, this.xa.b.x - k, this.xa.b.y - k, n, n)
                  ) {
                    m = !0;
                    break;
                  }
              ...
              h = 0;
              for (e = this.Xb.length; h < e; h++)
                (k = this.Xb[h]), k.Wb && k.Wb.cf(f.x, f.y, !0) && (m = !0);
              h = 0;
              for (e = this.ec.length; h < e; h++)
              ...
              for (e = this.Ra.length; h < e; h++) {
                ...
                if (
                  G.Ma(f.x, f.y, k.jd.x, k.jd.y) <= v.Zd ||
                  G.Ma(f.x, f.y, k.jd.x, k.jd.y) <= v.Zd
                ) {
                  m = !0;
                  break;
              ...
              for (e = this.Ga.length; h < e; h++) {
                ...
                if (
                  s.m &&
                  Q.Db(f.x, f.y, s.x - v.Vc, s.y - v.Vc, 2 * v.Vc, 2 * v.Vc)
                ) {
                  m = !0;
                  break;
                }
                if (
                  0 < s.q &&
                  (Q.Db(f.x, f.y, s.x - v.He, s.y - v.He, 2 * v.He, 2 * v.He) ||
                    s.lf !== I.e)
                ) {
                  m = !0;
                  break;
            ...
            e.pd &&
              (0 === this.Qd
                ? ((this.Qd = 1), this.hide(), this.show(), (this.We = I.Uk))
                : (this.Qd = I.e));
          },
          Qn: function (a, b, c, h) {
            var d = v.Lk,
              e = 2 * d;
            return Q.Db(b.x, b.y, a.x - d, a.y - d, e, e)
              ? (c && this.Zj(a.x, a.y),
                (h.visible = !0),
                x.N(E.Wl),
                (a.zo = !0),
          ...
          Rx: function (a, b, c, h, d, e) {
            return O.Ch(a, d)
              ? (d.pA(),
                x.N(d.ks),
                h && (a === this.SD ? this.SE() : this.rg(!1)),
                this.gk(e),
                (a.te = !0),
                (b.X = b.da = 1),
                (c.X = c.da = 1),
                (b = new X()),
                b.w(B.Oa(a.x, a.y, B.A.LINEAR, 0)),
                b.w(B.Oa(d.x, d.y + 10, B.A.LINEAR, 0.1)),
                b.w(B.Kj(0.71, 0.71, B.A.LINEAR, 0)),
                b.w(B.Kj(0, 0, B.A.LINEAR, 0.1)),
                b.w(B.za(L.lb.copy(), B.A.LINEAR, 0)),
                b.w(B.za(L.Fb.copy(), B.A.LINEAR, 0.1)),
                a.Kb(b, 0),
                a.R(0),
                (b.cb = this.Xa.Ae()),
                this.Xa.T(a),
          ...
          Xz: function (a, b) {
            ...
            2 !== this.I &&
              (this.Pb || this.Fn(a, this.ga, this.Ia, b),
              this.Qb || this.Fn(a, this.xa, this.Ja, b));
          },
          zb: function (a, b, c, h) {
            for (var d = 0, e = 0, f = this.Ga.length; e < f; e++) {
              ...
              if (k && k.zb === I.e)
                for (
                  var l = v.Vc, m = 2 * l, n = 0, r = k.Ca.length - 1;
                  n < r;
                  n++
                ) {
                  var q = k.Ca[n],
                  ...
                  a
                    ? q.va.x !== I.Jf &&
                      (D = Q.ai(
                        p.ht(q.b.x, q.va.x, s.b.x, s.va.x),
                        p.ht(q.b.y, q.va.y, s.b.y, s.va.y),
                        p.et(q.b.x, q.va.x, s.b.x, s.va.x),
                        p.et(q.b.y, q.va.y, s.b.y, s.va.y),
                        a.ea,
                        a.fa,
                        a.ea + a.width,
                        a.fa + a.height
                    ...
                    : (D =
                        g.m && Q.hf(b.x, b.y, c.x, c.y, g.x - l, g.y - l, m, m)
                          ? !1
                          : p.Sy(
                              b.x,
                              b.y,
          ...
          So: function (a) {
            x.N(E.om);
            a.Ic = !1;
            var b = S.create(E.Rg, 11);
            b.ya();
            var c = new X();
            this.Na && !this.dg
              ? (c.w(B.Oa(a.c.x, a.c.y, B.A.Hb, 0)),
                c.w(B.Oa(a.c.x, a.c.y + 50, B.A.Hb, 0.3)),
                c.w(B.Oa(a.c.x, a.c.y - v.ab, B.A.Ad, 1)))
              : (c.w(B.Oa(a.c.x, a.c.y, B.A.Hb, 0)),
                c.w(B.Oa(a.c.x, a.c.y - 50, B.A.Hb, 0.3)),
                c.w(B.Oa(a.c.x, a.c.y + v.ab, B.A.Ad, 1)));
            c.w(B.re(0, 0, 0));
          ...
          FB: function (a) {
            ...
            for (var b = 0, c = this.Ga.length; b < c; b++) {
              ...
              d &&
                ...
                (d.zb !== I.e
                  ? h.rs()
                  : (d.Ko(d.Ca.length - 2), this.gj(), (d.ag = !1)),
                h.Ic && h.xg && a !== h && this.So(h));
            }
            a.Ic = !1;
            this.sb = !0;
            b = S.create(E.Rg, 12);
            ...
            c = new X();
            this.Na && !this.dg
              ? (c.w(B.Oa(a.c.x, a.c.y - 10, B.A.Hb, 0)),
                c.w(B.Oa(a.c.x, a.c.y + 70, B.A.Hb, 0.3)),
                c.w(B.Oa(a.c.x, a.c.y - v.ab, B.A.Ad, 1)))
              : (c.w(B.Oa(a.c.x, a.c.y - 10, B.A.Hb, 0)),
                c.w(B.Oa(a.c.x, a.c.y - 70, B.A.Hb, 0.3)),
                c.w(B.Oa(a.c.x, a.c.y + v.ab, B.A.Ad, 1)));
          ...
          rg: function (a) {
            2 !== this.I
              ? a
                ? ((this.bc = null),
                  (this.ad.visible = !1),
                  this.Zj(this.Ia.x, this.Ia.y))
                : ((this.mc = null),
                  (this.bd.visible = !1),
                  this.Zj(this.Ja.x, this.Ja.y))
              : ((this.$b = null),
                (this.ac.visible = !1),
                this.Zj(this.ca.x, this.ca.y));
          },
          Zj: function (a, b) {
            this.gj();
            x.N(E.Xl);
          ...
          ny: function (a, b) {
            ...
            for (
              var f = v.Vc, g = 2 * f, k = 0, l = e.Ca.length - 1;
              k < l;
              k++
            ) {
              var m = e.Ca[k],
                p = m.b.Ma(d);
              p < h &&
                (!b.m || Q.Db(m.b.x, m.b.y, b.x - f, b.y - f, g, g)) &&
                ((h = p), (c = e), a.qa(m.b));
            }
            return c;
          },
          OB: function (a, b, c) {
            ...
            if (
              ...
              return (this.An = c), !0;
            if (
              (this.$b && this.En(this.Q, a, b)) ||
              (2 !== this.I &&
                ((this.bc && this.En(this.ga, a, b)) ||
                  (this.mc && this.En(this.xa, a, b))))
            )
              return !0;
            var h = new G(a, b);
            this.mh[c] ||
              ((this.mh[c] = !0), this.ze[c].qa(h), this.Ao[c].qa(h));
            var d,
              e,
              f = this.Y.b,
              h = a + f.x,
            ...
            for (e = this.ec.length; d < e; d++)
              if (((g = this.ec[d]), g.xo(h, f)))
                return (g.ni = 0.05), (g.touch = c), !0;
            var g = null,
              k = !1,
              l = !1;
            d = 0;
            ...
            e != this.Ra.length - 1 &&
              ...
              !k &&
              ((d = new X()),
              d.w(B.za(L.Fb.copy(), B.A.LINEAR, 0)),
              d.w(B.za(L.lb.copy(), B.A.LINEAR, 0.2)),
              (k = new X()),
              k.w(B.za(L.lb.copy(), B.A.LINEAR, 0.2)),
              (k.cb = $.proxy(this.Pz, this)),
              (l = g.copy()),
              l.Ur(k),
              l.R(0),
              g.Ur(d),
            ...
            for (e = this.Ga.length; d < e; d++)
              if (
                ((g = this.Ga[d]),
                g.m &&
                  Q.Db(h, f, g.x - k, g.y - k, l, l) &&
                  (g.wy(h, f), (g.Gg = c)),
                0 < g.q && Q.Db(h, f, g.x - m, g.y - m, p, p))
              )
                return (g.lf = c), !0;
            this.cn &&
              ((c = G.Qa()),
              (h = (g = this.Js(c, h, f)) ? g.ta : null) &&
                h.highlighted &&
                this.ny(c, g) &&
                this.zb(null, c, c, !1));
          ...
          RB: function (a, b, c) {
            if (this.me) return !0;
            this.mh[c] = !1;
            if (this.Uj && this.target.Xj(a, b))
              return (this.Uj = !1), F.ra(F.r.Eq), !0;
            this.Uj = !1;
            var h, d;
            h = this.Y.b;
            var e = a + h.x,
            ...
            for (d = this.Xb.length; h < d; h++)
              if (
                ...
                e.Wb &&
                  e.Ek === c &&
                  ((e.Ek = I.e), e.Wb.Tj(a + this.Y.b.x, b + this.Y.b.y)))
              )
                return !0;
            h = 0;
            for (d = this.Ra.length; h < d; h++)
              (a = this.Ra[h]),
                a.Vh === c && ((a.Vh = I.e), (a.Ro = I.e), a.fu(!1), a.gu(!1));
            h = 0;
            for (d = this.Ga.length; h < d; h++)
              (a = this.Ga[h]),
                a.m && a.Gg === c && (a.Gg = I.e),
                0 < a.q && a.lf === c && (a.lf = I.e);
            return !0;
          },
          QB: function (a, b, c) {
            ...
            if (10 < this.ze[c].Ma(h))
              for (d = 0, e = this.ec.length; d < e; d++) {
                var g = this.ec[d];
            ...
            for (e = this.Ra.length; d < e; d++)
              if (((b = this.Ra[d]), b.Vh === c)) {
                ...
                for (e = this.Ga.length; d < e; d++) {
                  var g = this.Ga[d],
                    k = new G(g.x, g.y);
                  k.Ma(c) <= b.Rb + 5 * this.P &&
                    (k.pa(h, b.x, b.y),
                    (g.x = k.x),
                    (g.y = k.y),
                    g.ta && (g.ta.Ya.b.qa(k), g.ta.Ya.Mc.qa(k)));
                }
                d = 0;
                for (e = this.ec.length; d < e; d++)
                  (g = this.ec[d]),
                ...
                for (e = this.bubbles.length; d < e; d++)
                  (g = this.bubbles[d]),
                    (k = new G(g.x, g.y)),
                    k.Ma(c) <= b.Rb + 10 * this.P &&
                      g !== this.$b &&
                      g !== this.mc &&
                      g !== this.bc &&
                      (k.pa(h, b.x, b.y), (g.x = k.x), (g.y = k.y));
                Q.Db(
                  this.target.x,
                  this.target.y,
                  b.x - b.size,
            ...
            for (e = this.Ga.length; d < e; d++)
              if ((b = this.Ga[d])) {
                ...
                if (0 < b.q && b.lf === c)
                  return (
                    b.u
                      ? (b.y = p.Zf(a.y, b.Nj, b.Mj))
                      : (b.x = p.Zf(a.x, b.Nj, b.Mj)),
                    b.ta &&
                      ((d = b.ta.Ya),
                      (d.b.x = d.Mc.x = b.x),
                      (d.b.y = d.Mc.y = b.y)),
            ...
            if (this.mh[c]) {
              ...
              for (e = a.length; d < e; d++)
                (g = a[d]), (b += this.zb(null, g.start, g.end, !1));
              0 < b &&
                ((this.cy = !1),
                (this.Io = 0 < this.Io && 0 < this.kk ? this.Io + b : b),
                (this.kk = 0.1));
      ...
      gc = (function (a, c, d, b, f) {
        ...
        e.Tc = { Uc: 0, jD: 1, nD: 2, gD: 3, kD: 4, oD: 5 };
        return e;
      })(
        (function (a, c) {
          return a.extend({
      ...
      ab = (function (a, c, d, b, f, e, g, k, l, n, r, m, p, u, q) {
        ...
        var s = {
          ...
          AB: function () {
            ...
            var c = $(
              ...
              d = $(
                m.ja({ text: r.W(p.Xq), width: 1200 * b.Gb, scale: 0.8 * b.bb })
              );
        ...
        k.subscribe(k.r.Ib, function () {
          ...
          m.ja({ text: r.W(p.wi), Ab: "payBtn", scale: 0.6 * b.bb });
        });
        $(function () {
          $("#payImg").click(A);
          $("#payBtn").click(A);
      ...
      ob = (function (a, c, d, b, f, e, g, k, l, n, r, m, p, u, q) {
          ...
          if (a === w) {
            ...
            a.Eh() &&
              ...
              !1 === a.qf
                ? l.ra(l.r.Rl)
                : k.gg(b)
                ? (p.ja({ text: m.W(u.sp), Ab: "missingLine1", ua: !0 }),
                  p.ja({ text: k.ei(b) - k.zf(), Ab: "missingCount", ua: !0 }),
                  p.ja({ text: m.W(u.tp), Ab: "missingLine2", ua: !0 }),
                  p.nc({ text: m.W(u.up), Ab: "missingLine3", ua: !0 }),
                  p.ja({ text: m.W(u.jw), Ab: "missingOkBtn", ua: !0 }),
                  n.N(r.ia),
                  q.wk("missingStars"))
                : F.Vz(b));
          }
        ...
        function J(a, b) {
          S
            ? (h(), (P = a - T), 5 < Math.abs(P) && ((G = !1), s(M + P)))
            : $(Y).toggleClass("ctrPointer", C(a, b));
        }
        function x(a, b) {
          if (S)
            if ((h(), (P = a - T), Math.abs(P) > L / 2)) {
              ...
              5 < Math.abs(P)
                ? ((c = f.d(30)), z(P > c ? w - 1 : P < -1 * c ? w + 1 : w))
                : ((c = I[w]), c.Eh() && (c.df || z(w), C(a, b) && A(w)));
          S = !1;
        }
        function E(a, b) {
          x(a, b);
        ...
        var I = [],
          ...
          W,
          N,
          K = new c(a.Sc, "boxPanel", "menuBackground", !0);
        $(function () {
      ...
      Qa = (function (a, c, d, b, f, e, g, k, l, n, r) {
        var m = new (function () {
          ...
          this.Ej = function () {
            return b.gg(this.Za) || b.Lc(this.Za) <= this.Nb
              ? !1
              : z || !e.lg
              ? !0
              : !e.lg(this.Za, this.Nb);
          };
      ...
      bb = (function (a, c, d, b, f) {
        ...
        l.so = function (a, b, c) {
          function d() {
            ...
            1 > c
              ? (l.Nc(a, e ? 1 - c : c), window.requestAnimationFrame(d))
              : (l.Nc(a, e ? 0 : 1),
      ...
      ic = (function (a, c, d, b, f, e, g, k, l, n, r, m, p, u, q, A) {
        function s() {
          ...
          if (f.Ny(e.Za, a)) h.Uz(a + 1, A.Vx);
          else if (C ? 0 : p.lg && p.lg(e.Za, a)) q.ru();
          else return;
          k.N(l.ia);
        }
        function z() {
          ...
          for (d = 0; d < b; d++)
            if ((c = $("#option" + (d + 1))))
              d < b
                ? (c.show(),
                  (g = C ? !1 : p.lg ? p.lg(e.Za, d) : !1),
                  (h = f.$e(a, d)),
                  null === h &&
                    !g &&
                    0 < d &&
                    ((k = f.wj(a, d - 1)), 0 < k && (f.we(a, d, 0), (h = 0))),
                  null != h
                    ? ((h = $("<div class='txt'/>")
                        .append($(r.ja({ text: d + 1, ua: !0 })))
          ...
          r.ja({ text: a, Kc: "#levelScore img", ua: !0 });
          e.Vu();
          f.pi();
        }
        ...
        a.init = function (a) {
          ...
          var l = d.d(420),
            ...
            q = c % 3;
          9 < c && 12 >= c
            ? ((k = -80), (a = 10), (n = 4), (l = d.d(500)), (m = d.d(153)))
            : 12 < c &&
              ((k = -30),
              (a = -40),
              (m = d.d(101)),
          ...
          function l() {
            function a() {
              if (w) {
                ...
                1 > F &&
                  ((F += 0.025), (F = Math.min(F, 1)), (b.globalAlpha = F));
                b.save();
                b.translate(0.5 * I.width, 0.5 * I.height);
                b.translate(e.d(-300), e.d(-510));
      ...
      cb = (function (a, c, d, b, f, e) {
        return new (function () {
          this.xk = c.xk;
          this.Qm = "267906546706935";
          var g = window.location.host || "";
          0 <= g.indexOf("thinkpixellab")
            ? (this.Qm = "239041062884795")
            : 0 <= g.indexOf(".dev") && (this.Qm = "261043477350153");
          var k = this;
          f.subscribe(f.r.Ib, function () {
            k.tu = d.W(b.Vq);
            k.CB = d.W(b.Wq);
            k.BB = [{ name: d.W(b.Uq), link: c.xk }];
          });
          this.Ey = function () {
            var a = {};
            a.appId = k.Qm;
      ...
      kc = (function (a, c, d, b, f, e, g, k, l, n) {
        return new (function () {
          ...
          function m(a) {
            function b() {
              ...
              u < q
                ...
                : u < s
                ? u > q + 100 &&
                  (p = m = -1 * e.Xe(u - (q + 100), 0, 10, s - (q + 100)))
                : u < v
                ? (p = m = -10 + e.lj(u - s, 20, v - s))
                : u < z
                ? u > v + 100 &&
                  (p = m = 10 - e.lj(u - (v + 100), 10, z - (v + 100)))
                : u < A || (u < w && (l = e.Xe(u - A, n, 50, w - A)));
              u > q && u < v && (F = e.kj(u - q, 0.02, v - q, 6));
              u > v && u < A && (F = 0.02 - e.kj(u - v, 0.02, A - v, 2));
              var H = 0 + k,
                K = 75 + l + g;
              c.save();
          ...
          function p() {
            $("#dpic").removeClass();
            $("#dframe").animate(
              { top: b.d(50), scale: 0.2 },
              350,
              "easeInExpo"
            );
            $("#dmsg").animate({ top: b.d(50), scale: 0.2 }, 350, "easeInExpo");
          ...
          this.Ed = function () {
            g.subscribe(g.r.Ib, function () {
              a.ja({ text: l.W(n.Op), Ah: "dmsg", ua: !0 });
              a.ja({ text: l.W(n.Qq), Kc: "#dshareBtn img", ua: !0 });
            });
          ...
          this.Po = function (a) {
            ...
            $("#dframe").animate({ top: b.d(100), scale: 0.35 }, 0);
            $("#dframe").fadeTo(0, 0);
            $("#dmsg").animate({ top: b.d(60), scale: 0.5 }, 0);
            $("#dmsg").fadeTo(0, 0);
          ...
          this.yB = function () {
            ...
            $("#e").fadeIn(function () {
              function c() {
                var O = Date.now() - d;
                O < v
                  ? ((g = e.mn(O, s, A, v)), (l = e.mn(O, u, A, v)))
                  : O < w
                  ? O > v + 100 &&
                    (q = n =
                      -1 * e.Xe(O - (v + 100), 0, b.d(10), w - (v + 100)))
                  : O < F
                  ? (q = n = b.d(-10) + e.lj(O - w, b.d(20), F - w))
                  : O < H
                  ? O > F + 100 &&
                    (q = n =
                      b.d(10) - e.lj(O - (F + 100), b.d(10), H - (F + 100)))
                  : !(O < K) &&
                    O < N &&
                    ((p = e.Xe(O - K, z, b.d(300), N - K)),
                    (g = b.d(A) - e.Xe(O - K, 0, b.d(2), v)),
                    (l = b.d(A) - e.Xe(O - K, 0, b.d(2), v)));
              ...
              if (a) {
                ...
                2 === c || 3 === c || 4 === c
                  ? (g.Xh(),
                    ...
                    a.addEventListener("ended", m.ms),
                    a.addEventListener("mousedown", m.ms))
                  : ($(a).remove(), f.Va(b.Mg, !1));
              }
            },
            ms: function () {
              f.Va(b.Mg, !0);
        ...
        var B = a.GE || p.bm,
          v = new (function () {
            ...
            function C() {
              f.Za >= f.Tt() - 1
                ? (H.hide(), z.oA())
                : ((M.Un = !0), g.Va(a.ss ? e.qb : e.Sc, !1));
            }
            function N() {
              if (f.Za !== f.Tt() - 1) return !1;
              var a = b.Lc(f.Za);
              return f.Nb !== a ? !1 : !0;
            }
            function P() {
            ...
            function O(a) {
              ...
              a == e.Bd
                ...
                ? ($("#levelResults").hide(),
                  H.aB(),
                  (a = D.W(x.Rp).replace("%d", b.zf())),
                  l.ja({ text: a, Kc: "#finalScore img", scale: 0.8 * c.bb }),
                  $("#congrats")
                    .empty()
                    .append(l.ja({ text: D.W(x.wp), scale: 1.2 * c.bb })),
                  l.ja({
                    text: D.W(x.Sq),
              ...
              if (k == e.qb) {
                ...
                var W = $("#resetBtn").click(function () {
                  var a = l.ja({
                    ...
                    b = l.nc({ text: D.W(x.Nq), ua: !0, ao: c.d(550) });
            ...
            function U(a, b, c) {
              if (void 0 != a) {
                ...
                l.nc({ text: b, img: d[0], ua: !0, alpha: 0.6 });
            ...
            function T(a, b) {
              ...
              e || d
                ? ((c = e ? x.gw : x.fw),
                  (d = d ? x.vw : x.uw),
                  (d = D.W(x.hp)
                    .replace("{0}", D.W(c).toLowerCase())
                    .replace("{1}", D.W(d).toLowerCase())))
                : (d = D.W(x.Mp));
              U(b, d);
            }
            function Q(a, b) {
              l.ja({ text: D.W(b), Kc: a, ua: !0 });
            }
            var M = this;
            this.av = c.Ky;
            ...
            this.mo = function (a) {
              function c(a, b, d) {
                function e() {
                  ...
                  0 >= h
                    ...
                    : n(e);
                  l.nc({ text: g(h), img: r[0], ua: !0 });
                  l.us({ text: p, Ab: "resultScore", ua: !0 });
                }
                var f = p + b,
                  h = a,
              ...
              l.ja({ text: n, Kc: "#resultStatus img", ua: !0 });
              ...
              l.nc({ text: D.W(x.xw), img: s[0], ua: !0 });
              l.nc({ text: q, img: r[0], ua: !0 });
              ...
              setTimeout(function () {
                ...
                u.fadeIn(300, function () {
                  e(q, function () {
                    l.nc({ text: D.W(x.Fm), img: s[0], ua: !0 });
                    s.fadeIn(300);
                    l.nc({ text: g(Math.ceil(m)), img: r[0], ua: !0 });
            ...
            var fa = !0;
            this.Xu = function () {
              $(window).width() < c.d(1024) + 120 && fa
                ? ($("#moreLink").fadeOut(function () {
                    fa = !1;
                  }),
                  $("#zenbox_tab").fadeOut())
                : $(window).width() > c.d(1024) + 120 &&
                  !fa &&
        ...
        return {
          ...
          eb: function () {
            f.Dx &&
              ...
              (document.body.onselectstart = Ga(!1));
            ...
            c.tC ||
              (c.Rk
                ? $(b.element).width(c.Rk).height(c.sC)
