var __extends =
    ...
    function (k, a) {
      ...
      k.prototype =
        null === a ? Object.create(a) : ((m.prototype = a.prototype), new m());
    },
  Photon;
(function (k) {
  ...
  var a = (function () {
    ...
    a.prototype.sendOperation = function (a, b, h, g) {
      ...
      this._send(a);
      this._logger.debug("PhotonPeer[sendOperation] - Sending request:", a);
    };
    ...
    a.prototype._dispatchResponse = function (a, b) {
      if (!this._dispatch(this._responseListeners, a.toString(), b, "response"))
    ...
    a.prototype._encode = function (a) {
      ...
      for (var g = 0, l = a.length; g < l; g++)
        (h = null === a[g] || void 0 === a[g] ? "" : this._stringify(a[g])),
    ...
    a.prototype._dispatchPeerStatus = function (a) {
      this._dispatch(this._peerStatusListeners, a, void 0, "peerStatus") ||
        this._logger.warn(
  ...
  (function (a) {
    var k = (function () {
      ...
      a.prototype.log = function (b, h, g) {
        if (b >= this.level && "undefined" !== typeof console && void 0 !== h)
          try {
    ...
    var m = (function (m) {
      ...
      b.prototype.join = function (h, g, b, k) {
        if (void 0 !== h && this.isConnected() && !this.isJoined) {
          this._logger.info("PhotonPeer.Lite[join] - Joining roomName:", h);
          this._logger.debug(
          ...
          p.push(h + "");
          "object" === typeof g &&
            (p.push(a.Constants.LiteOpKey.GameProperties), p.push(g));
          "object" === typeof b &&
            (p.push(a.Constants.LiteOpKey.ActorProperties), p.push(b));
          ...
          if (this.isJoined)
            throw Error("PhotonPeer.Lite[join] - you have already joined!");
        ...
        if (this.isJoined)
          if (void 0 !== g)
            this._logger.debug(
              ...
              this.sendOperation(a.Constants.LiteOpCode.RaiseEvent, [
      ...
      b.prototype.setActorProperties = function (h, g, b) {
        if (this.isJoined)
          this._logger.debug(
            ...
            this.sendOperation(a.Constants.LiteOpCode.SetProperties, [
      ...
      b.prototype.setRoomProperties = function (h, g) {
        if (this.isJoined)
          this._logger.debug(
            "PhotonPeer.Lite[setRoomProperties] - broadcast:" + g + ", data:",
            h
          ),
            this.sendOperation(a.Constants.LiteOpCode.SetProperties, [
              a.Constants.LiteOpKey.Broadcast,
      ...
      b.prototype.getRoomProperties = function (h) {
        if (this.isJoined) {
          ...
          void 0 !== h
            ? Exitgames.Common.Util.isArray(h) && 0 < h.length && g.push(h)
            : g.push(null);
        ...
        switch (b) {
          ...
          default:
            this._logger.info(
              ...
              this._dispatchEvent(b, { vals: g.vals, actorNr: l });
        }
      };
          ...
          for (p in l)
            (g = parseInt(l[p])),
              g !== this._myActor.photonId &&
                ...
                this._addActor(g),
                k.push(g));
          this._dispatchEvent(a.Constants.LiteEventCode.Join, { newActors: k });
        }
      };
      b.prototype._onEventLeave = function (b) {
        ...
        this._removeActor(b);
        this._dispatchEvent(a.Constants.LiteEventCode.Leave, { actorNr: b });
      };
      ...
      b.prototype._onResponseGetProperties = function (b) {
        ...
        void 0 !== b.vals[a.Constants.LiteOpKey.GameProperties] &&
          (this.room.properties = b.vals[a.Constants.LiteOpKey.GameProperties]);
      ...
      b.prototype._onResponseJoin = function (b) {
        ...
        this._dispatchResponse(a.Constants.LiteOpCode.Join, { actorNr: b });
      };
      b.prototype._onResponseLeave = function (b) {
        ...
        this.roomName = "";
        this.room = { properties: {} };
        this._dispatchResponse(a.Constants.LiteOpCode.Leave, { actorNr: b });
      };
...
(function (k) {
  ...
  a.CustomAuthenticationType = { Custom: 0, Steam: 1, Facebook: 2, None: 255 };
  ...
  (function (a) {
    ...
    var n = { ws: "ws://", wss: "wss://" },
      b = (function () {
        ...
        d.prototype._updateMyActorFromResponse = function (f) {
          this.joinToken = (this.actorNr = f[a.Constants.ParameterCode.ActorNr])
    ...
    var l = (function () {
        ...
        if ("number" == typeof f)
          ...
          "string" == typeof f
            ? ((this.connectionProtocol = k.ConnectionProtocol.Ws),
              (this.nameServerAddress = this.masterServerAddress = f))
            : ((this.connectionProtocol = k.ConnectionProtocol.Ws),
              (this.nameServerAddress = this.masterServerAddress =
      ...
      d.prototype.setCustomAuthentication = function (a, c, e) {
        void 0 === c &&
          (c = k.LoadBalancing.Constants.CustomAuthenticationType.Custom);
        this.userAuthType = c;
      ...
      d.prototype.connect = function (a) {
        "boolean" === typeof a &&
          (a = a ? { keepMasterConnection: !0 } : { keepMasterConnection: !1 });
        a || (a = {});
      ...
      d.prototype.fillCreateRoomOptions = function (f, c) {
        ...
        void 0 !== c.emptyRoomLiveTime &&
          f.push(a.Constants.ParameterCode.EmptyRoomTTL, c.emptyRoomLiveTime);
        ...
        void 0 !== c.uniqueUserId &&
          f.push(a.Constants.ParameterCode.CheckUserOnJoin, c.uniqueUserId);
        c.lobbyName &&
      ...
      d.prototype.joinRoom = function (f, c, e) {
        ...
        c &&
          ...
          c.joinToken &&
            (b.push(a.Constants.ParameterCode.ActorNr, parseInt(c.joinToken)),
            b.push(a.Constants.ParameterCode.JoinMode, d.JoinMode.Rejoin)));
      ...
      d.prototype.joinRandomRoom = function (f) {
        ...
        if (f) {
          void 0 != f.matchingType &&
            f.matchingType != a.Constants.MatchmakingMode.FillRoom &&
          ...
          if (void 0 != f.expectedCustomRoomProperties)
            for (var b in f.expectedCustomRoomProperties)
              (e[b] = f.expectedCustomRoomProperties[b]), (d = !0);
          void 0 != f.expectedMaxPlayers &&
            0 < f.expectedMaxPlayers &&
            ((e[a.Constants.GameProperties.MaxPlayers] = f.expectedMaxPlayers),
            (d = !0));
          ...
          f.lobbyName &&
            ...
            void 0 != f.lobbyType &&
              ...
              c.push(f.lobbyType)));
          f.sqlLobbyFilter &&
            (c.push(a.Constants.ParameterCode.Data), c.push(f.sqlLobbyFilter));
        }
        this.logger.info(
          "Join Random Room",
          f && f.lobbyName,
      ...
      d.prototype.leaveRoom = function () {
        this.isJoinedToRoom() &&
          (this.gamePeer &&
            (this.gamePeer.sendOperation(a.Constants.OperationCode.Leave),
              ...
              for (var c = 0; c < f.length; ++c) {
                ...
                if ("object" == typeof e) {
                  ...
                  if (d) {
                    ...
                    else if ("number" == typeof e[1]) e = e[1];
                    else {
      ...
      d.prototype.webRpc = function (a, c) {
        this.isConnectedToMaster()
          ? (this.logger.debug("WebRpc..."), this.masterPeer.webRpc(a, c))
          : this.isJoinedToRoom()
          ? (this.logger.debug("WebRpc..."), this.gamePeer.webRpc(a, c))
          : (this.logger.error(
      ...
      d.prototype.purgeRemovedRooms = function () {
        ...
        for (var a in this.roomInfosDict)
          this.roomInfosDict[a].removed && delete this.roomInfosDict[a];
      };
      ...
      d.prototype.createRoomInternal = function (f, c) {
        ...
        ).info("Create Room", c && c.lobbyName, c && c.lobbyType, "...");
      ...
      d.prototype.updateUserIdAndNickname = function (f, c) {
        ...
        void 0 != e &&
          (this.setUserId(e), c.info("Setting userId sent by server:", e));
      ...
      d.prototype.initNameServerPeer = function (f) {
        ...
        f.addPeerStatusListener(
          ...
          function () {
            ...
            c._onErrorInternal(
              ...
              "NameServer peer connect failed. " + c.nameServerAddress
            );
          }
        );
        ...
        f.addPeerStatusListener(
          ...
          function () {
            f == c.nameServerPeer &&
              (c._cleanupNameServerPeerData(), f._logger.info("Disconnected"));
          }
        );
        f.addPeerStatusListener(
        ...
        f.addResponseListener(
          ...
          function (e) {
            ...
            0 == e.errCode
              ...
              : (c.changeState(d.State.Error),
                c._onErrorInternal(
                  d.PeerErrorCode.NameServerAuthenticationFailed,
      ...
      d.prototype.initMasterPeer = function (f) {
        ...
        f.addPeerStatusListener(
          ...
          function () {
            ...
            c._onErrorInternal(
              ...
              "Master peer connect failed: " + c.masterServerAddress
            );
          }
        );
        f.addPeerStatusListener(k.PhotonPeer.StatusCodes.timeout, function () {
        ...
        f.addPeerStatusListener(k.PhotonPeer.StatusCodes.connect, function () {
          ...
          c.connectOptions.userAuthSecret
            ? (e.push(
              ...
              f.sendOperation(a.Constants.OperationCode.Authenticate, e),
            ...
            : (e.push(a.Constants.ParameterCode.ApplicationId),
              ...
              e.push(c.appVersion),
              c.userAuthType != a.Constants.CustomAuthenticationType.None &&
                (e.push(
              ...
              c.userId && e.push(a.Constants.ParameterCode.UserId, c.userId),
              c.connectOptions.lobbyStats &&
                e.push(a.Constants.ParameterCode.LobbyStats, !0),
              f.sendOperation(a.Constants.OperationCode.Authenticate, e),
        ...
        f.addPeerStatusListener(
          ...
          function () {
            f == c.masterPeer &&
              (c._cleanupMasterPeerData(), f._logger.info("Disconnected"));
          }
        );
        f.addPeerStatusListener(
          k.PhotonPeer.StatusCodes.connectClosed,
        ...
        f.addEventListener(a.Constants.EventCode.GameList, function (e) {
        ...
        f.addEventListener(a.Constants.EventCode.GameListUpdate, function (e) {
          ...
          for (l in e) {
            ...
            if (0 < k.length) {
              ...
              (k = new h(l)), k._updateFromProps(e[l]), c.addRoom(k), b.push(p);
          }
          c.purgeRemovedRooms();
        ...
        f.addResponseListener(
          ...
          function (e) {
            ...
            e.errCode
              ...
              : (f._logger.info("Authenticated"),
                c.updateUserIdAndNickname(e.vals, f._logger),
                void 0 != e.vals[a.Constants.ParameterCode.Secret] &&
                  (c.connectOptions.userAuthSecret =
                ...
                c.autoJoinLobby &&
                  (f.sendOperation(a.Constants.OperationCode.JoinLobby, e),
                  f._logger.info(
                    "Join Lobby",
                    c.connectOptions.lobbyName,
        ...
        f.addResponseListener(
          ...
          function (e) {
            ...
            e.errCode ||
              ...
              f._logger.debug("Created/Joined " + c.currentRoom.name),
              c.connectToGameServer(a.Constants.OperationCode.CreateGame));
            c._onOperationResponseInternal2(
              a.Constants.OperationCode.CreateGame,
              e
            );
        ...
        f.addResponseListener(a.Constants.OperationCode.JoinGame, function (e) {
          ...
          e.errCode ||
            ...
            c.connectToGameServer(a.Constants.OperationCode.JoinGame));
          c._onOperationResponseInternal2(
        ...
        f.addResponseListener(
          ...
          function (e) {
            ...
            e.errCode ||
              (c.currentRoom._updateFromMasterResponse(e.vals),
              f._logger.debug("Joined " + c.currentRoom.name),
              c.connectToGameServer(a.Constants.OperationCode.JoinRandomGame));
            c._onOperationResponseInternal2(
              a.Constants.OperationCode.JoinRandomGame,
              e
            );
        ...
        f.addResponseListener(
          ...
          function (e) {
            ...
            var d = {};
            if (e.errCode)
              f._logger.error("FindFriends request error:", e.errCode);
            else
              for (
                var b =
                    e.vals[
                      a.Constants.ParameterCode.FindFriendsResponseOnlineList
                    ] || {},
                  g =
                    e.vals[
                      a.Constants.ParameterCode.FindFriendsResponseRoomIdList
                    ] || {},
                  h = 0;
        ...
        f.addResponseListener(
          ...
          function (e) {
            ...
            var d = [];
            if (e.errCode)
              f._logger.error("LobbyStats request error:", e.errCode);
            else {
              ...
              if (b)
                ...
                for (k = 0; k < c.lobbyStatsRequestList.length; ++k)
      ...
      d.prototype.initGamePeer = function (f, c) {
        ...
        f.addPeerStatusListener(k.PhotonPeer.StatusCodes.connect, function () {
          ...
          e.userAuthType != a.Constants.CustomAuthenticationType.None &&
            (c.push(a.Constants.ParameterCode.ClientAuthenticationType),
        ...
        f.addPeerStatusListener(
          ...
          function () {
            f == e.gamePeer &&
              (e._cleanupGamePeerData(), f._logger.info("Disconnected"));
          }
        );
        f.addPeerStatusListener(
          k.PhotonPeer.StatusCodes.connectClosed,
              ...
              : (f._logger.info("Authenticated"),
                ...
                c == a.Constants.OperationCode.CreateGame
                  ...
                  : ((b = []),
                    ...
                    b.push(a.Constants.ParameterCode.Broadcast),
                    b.push(!0),
                    b.push(a.Constants.ParameterCode.PlayerProperties),
                    ...
                    c == a.Constants.OperationCode.JoinGame &&
                      (e.joinRoomOptions.createIfNotExists &&
                        ...
                        e.fillCreateRoomOptions(b, e.createRoomOptions)),
                      e.joinRoomOptions.joinToken &&
                        (b.push(
                          a.Constants.ParameterCode.ActorNr,
                          parseInt(e.joinRoomOptions.joinToken)
                        ),
                        b.push(
                          a.Constants.ParameterCode.JoinMode,
                          d.JoinMode.Rejoin
                        ))),
                    f.sendOperation(a.Constants.OperationCode.JoinGame, b)),
            ...
            if (void 0 !== b)
              for (var h in b) {
                ...
                l == e._myActor.actorNr
                  ? (l = e._myActor)
                  : ((l = e.actorFactoryInternal(p, l)), e.addActor(l));
        ...
        f.addEventListener(a.Constants.EventCode.Join, function (a) {
          ...
          if (b._getActorNrFromResponse(a.vals) === e._myActor.actorNr)
            e._myActor._updateFromResponse(a.vals), e.onActorJoin(e._myActor);
          else {
        ...
        f.addEventListener(a.Constants.EventCode.Disconnect, function (a) {
          ...
          (a = b._getActorNrFromResponse(a.vals)) &&
            e.actors[a] &&
            ((a = e.actors[a]), a._setSuspended(!0), e.onActorSuspend(a));
        });
        f.addEventListener(
        ...
        return function (d) {
          ...
          0 == d.errCode
            ? ((f = d.vals[a.Constants.ParameterCode.UriPath]),
              (b = d.vals[a.Constants.ParameterCode.RpcCallRetData]),
              (g = d.vals[a.Constants.ParameterCode.RpcCallRetCode]))
    ...
    var r = (function (d) {
      ...
      f.prototype.opAuth = function (c, e, d, f, b, g, h) {
        ...
        d != a.Constants.CustomAuthenticationType.None &&
          (l.push(a.Constants.ParameterCode.ClientAuthenticationType, d),
          l.push(a.Constants.ParameterCode.ClientAuthenticationParams, f),
          b && l.push(a.Constants.ParameterCode.ClientAuthenticationData, b));
        ...
        if (this.client.isJoinedToRoom()) {
          ...
          if (d) {
            ...
            void 0 != d.cache &&
              ...
              (c.push(a.Constants.ParameterCode.Cache), c.push(d.cache));
            if (void 0 != d.interestGroup)
              if (this.checkGroupNumber(d.interestGroup))
                ...
                throw Error(
                  "raiseEvent - Group not a number: " + d.interestGroup
                );
            void 0 != d.targetActors &&
              (c.push(a.Constants.ParameterCode.ActorList),
              c.push(d.targetActors));
            d.webForward &&
              (c.push(a.Constants.ParameterCode.Forward), c.push(!0));
          }
    ...
    var b = (function (b) {
      ...
      g.prototype.initMasterPeer = function (g) {
        ...
        g.addEventListener(a.Constants.EventCode.ChatMessages, function (b) {
          ...
          f
            ? ((h = f.addMessages(h, d)), k.onChatMessages(b, h))
            : g._logger.warn(
        ...
        g.addEventListener(a.Constants.EventCode.Subscribe, function (b) {
          ...
          for (var f in d) {
            ...
            f < b.length &&
              b[f] &&
              (k.getOrAddChannel(k.publicChannels, c, !1), (h[c] = !0));
          }
