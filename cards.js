...
cards.open = (function (c, f) {
  ...
  function d(i, h) {
    ...
    switch (typeof h) {
      ...
      default:
        throw TypeError(
          "linkData must be a string of JSON if defined, got " + h
        );
    }
  ...
  if (shimshamMeta && shimshamMeta.nodeName === "META") {
    ...
    try {
      ...
      if (xhr.status === 200) {
        ...
        console.log(
          "Failed to load shimsham, extension not installed get it at cards.kik.com"
        );
      }
    } catch (e) {}
  }
...
(function (window, document, picard) {
  ...
  function androidBridgeCall(bridgeFunctionName, argData, asyncCallbackName) {
    ...
    if (!asyncCallbackName) {
      ...
      if (androidBridge.invokeAsyncFunction) {
        response = androidBridge.invokeAsyncFunction(
          bridgeFunctionName,
          argData,
          asyncCallbackName
        );
        ...
        throw TypeError(
          "bridge: android bridge does not support async callbacks"
        );
      }
    }
    try {
      ...
      throw TypeError(
        "bridge call for " + bridgeFunctionName + " responded with invalid JSON"
      );
    }
  ...
  function makeBridgeCall(bridgeFunctionName, args, asyncCallback) {
    if (typeof bridgeFunctionName !== "string") {
      throw TypeError(
        "bridge call " + bridgeFunctionName + " must be a string"
      );
    }
    switch (typeof args) {
      case "function":
      ...
      default:
        throw TypeError(
          "bridge call arguments " +
            args +
            " must be a JSON object if specified"
        );
    }
    switch (typeof asyncCallback) {
      ...
      default:
        throw TypeError(
          "bridge async callback must be a function if defined, got " +
            asyncCallback
        );
    }
    var argData;
    try {
      ...
      throw TypeError(
        "bridge call arguments " + args + " must be a JSON object"
      );
    }
    ...
    if (
      asyncCallbackName &&
      (!result || !result.status || result.status !== 202)
    ) {
      setTimeout(function () {
        ...
        if (androidBridge) {
          window[asyncCallbackName](
            JSON.stringify({ status: 500, data: null })
          );
        } else {
    ...
    try {
      ...
      if (window.console && window.console.error) {
        window.console.error(
          "android poll failed to evaluate " + code + ", " + err
        );
      }
    }
    performAndroidPoll();
  ...
  function batchRequest(calls) {
    ...
    calls.forEach(function (data) {
      ...
      switch (typeof data.args) {
        ...
        default:
          throw TypeError(
            "batch call args must be an object if defined, got " + data.args
          );
      }
      switch (typeof data.callback) {
        ...
        default:
          throw TypeError(
            "batch call callback must be a function if defined, got " +
              data.callback
          );
      }
    });
    ...
    calls.forEach(function (data, index) {
      ...
      if (!isPluginRequest) {
        batchCalls.push(
          generateBatchSegment(data, function (responseData) {
        ...
        if (plugins[data.name]) {
          ...
          batchCalls.push(
            generatePluginBatchSegment(data, function (responseData) {
              responses[index] = responseData;
            })
          );
        }
...
(function (d) {
  ...
  if (
    !d._.bridge ||
    !d.utils.platform.os.ios ||
    d.utils.platform.browser.version < 6.5
  ) {
    return;
  }
  var a = [
...
(function (i, a) {
  ...
  function g() {
    ...
    if (
      typeof App === "object" &&
      typeof App.enableGoogleAnalytics === "function"
    ) {
...
(function (k, r, q) {
  function v(F, J) {
    var E = k.applicationCache,
      I = false;
    if (!E || !E.addEventListener || !E.swapCache || !E.update) {
      J(false);
      return;
    }
    if (E.status === E.UPDATEREADY) {
      D();
      return;
    }
    if (
      E.status !== E.IDLE &&
      E.status !== E.CHECKING &&
      E.status !== E.DOWNLOADING
    ) {
      J(false);
      return;
    }
    E.addEventListener("noupdate", G, false);
    E.addEventListener("updateready", D, false);
    E.addEventListener("error", D, false);
    E.addEventListener("obsolete", D, false);
    setTimeout(D, 30 * 1000);
    if (E.status === E.IDLE) {
      try {
        E.update();
      } catch (H) {
  ...
  if (k.location.hash) {
    q.linkData = j(k.location.hash.substr(1));
  }
  var a;
  try {
    a = q._.bridge("Browser");
  } catch (d) {
    return;
  }
  var A = q.events();
  ...
  if (a.setCardInfo) {
    var o = /(^|\s)icon(\s|$)/i,
      ...
      B,
      i;
    Array.prototype.forEach.call(r.getElementsByTagName("link"), function (D) {
      if (o.test(D.rel)) {
        z = D.href;
      } else {
        if (D.rel === "kik-icon") {
          ...
          if (D.rel === "kik-icon-fallback") {
            x = D.href;
          } else {
            if (D.rel === "kik-tray-icon") {
              g = D.href;
            } else {
              if (D.rel === "privacy") {
                B = D.href;
    ...
    var m = {
      ...
      icon: x || n || g || z,
      squareIcon: n || g || x || z,
      mediaTrayIcon: n || g || x || z,
      privacy: B,
      terms: i,
    };
    if (cards._.secondBatch) {
      cards._.secondBatch.push({ name: "Browser.setCardInfo", args: m });
    } else {
      a.setCardInfo(m);
    }
  }
  if (a.pageLoaded) {
    q.utils.windowReady(function () {
      if (r.body) {
        var D = r.body.offsetWidth;
        (function (E) {
          return E;
        })(D);
      }
  ...
  if (a.setStatusBarVisible) {
    var l = false;
    A.statusBar = function (D) {
      l = true;
      a.setStatusBarVisible({ visible: !!D });
      t = !!D;
    };
  }
  if (a.setStatusBarTransparent) {
    A.statusBarTransparent = function (E) {
      var D;
      if (E === "black") {
        D = false;
      } else {
      ...
      try {
        if (a.setStatusBarTransparent({ transparent: !!E, light: D })) {
          return true;
        }
      } catch (F) {}
      return false;
    ...
    var u;
    Array.prototype.forEach.call(r.getElementsByTagName("meta"), function (D) {
      if (D.name === "kik-transparent-statusbar") {
        u = (D.content || "").trim();
      }
    });
    if (u && u !== "false" && A.statusBarTransparent(u)) {
  ...
  if (a.getOrientationLock && a.setOrientationLock) {
    A.getOrientationLock = function () {
      var D = a.getOrientationLock().position;
      return D === "free" ? null : D;
    };
    A.setOrientationLock = function (D) {
      switch (D) {
        case "free":
        case "portrait":
        case "landscape":
        ...
        default:
          ...
          throw TypeError(
            "if defined, position " +
              D +
              ' must be one of "free", "portrait", or "landscape"'
          );
      }
      try {
        a.setOrientationLock({ position: D });
        if (!l && a.setStatusBarVisible && t !== (D !== "landscape")) {
          a.setStatusBarVisible({ visible: D !== "landscape" });
          t = D !== "landscape";
        }
        return true;
      } catch (E) {
  ...
  if (a.setBacklightTimeoutEnabled) {
    A.backlightTimeout = function (D) {
      a.setBacklightTimeoutEnabled({ enabled: !!D });
    };
  }
  if (a.forceRepaint) {
    A.paint = function () {
  ...
  A.back = function (D) {
    if (typeof D !== "function") {
      throw TypeError("back handler " + D + " must be a function");
    }
    e.push(D);
  };
  A.unbindBack = function (E) {
  ...
  a.on("back", function (G) {
    ...
    a.handleBack({ requestToken: G.requestToken, override: E });
  });
  A.back(function () {
  ...
  if (a.refresh && a.refreshPlanned) {
    A.refresh = function () {
      var D = k.applicationCache;
      c();
      if (!D || D.status === D.UNCACHED) {
        a.refresh({ withCache: false });
        return;
      }
      v(false, function (E) {
        a.refresh({ withCache: true });
      });
    };
  ...
  if (a.openCard && a.openExternal) {
    A.open = function (F, E, G) {
      if (typeof F !== "string") {
        throw TypeError("url " + F + " must be a string");
      }
      switch (typeof E) {
        case "undefined":
        case "string":
        ...
        default:
          throw TypeError(
            "card linkData must be a string or JSON if defined, got " + E
          );
      }
      switch (typeof G) {
        case "undefined":
        ...
        case "object":
          break;
        default:
          throw TypeError("card data must be an object if defined, got " + G);
      }
      var D = F.substr(0, 7) === "card://",
        H = F.substr(0, 8) === "cards://";
      if (!D && !H) {
        a.openExternal({ url: F });
        return;
      }
      F = "http" + F.substr(4);
      if (E) {
        F = F.split("#")[0] + "#" + encodeURIComponent(E);
      }
      a.openCard({
        url: F,
        title: G.title || undefined,
        icon: G.icon || undefined,
        clearHistory: !!G.clearHistory,
      });
    };
  }
  var h = false;
  ...
  function s(E, D) {
    A.linkData = j(E && E.data);
    q.linkData = A.linkData;
    if (D !== false && A.linkData) {
      A.trigger("linkData", A.linkData);
    }
  }
  A._processLinkData = s;
  if (a.getLastLinkData) {
    s(
      cards._.firstBatch["Browser.getLastLinkData"] || a.getLastLinkData(),
      false
    );
  }
  a.on("linkData", s);
  var p = true,
    ...
    w = true;
  A.background = p;
  a.on("pause", function (D) {
    y = true;
    f();
  });
  a.on("unpause", function (D) {
    y = false;
    f();
  });
  a.on("conceal", function (D) {
    w = true;
    f();
  });
  a.on("reveal", function (D) {
    w = false;
    f();
  });
  function b() {
  ...
  function f() {
    ...
    A.background = p;
    if (D !== p) {
      A.trigger(p ? "background" : "foreground");
    }
  }
})(window, document, cards);
(function (g, c, f) {
...
(function (j, k, i) {
  ...
  function e(o) {
    ...
    switch (typeof o.big) {
      ...
      default:
        throw TypeError(
          "message size (big) " + o.big + " must be a boolean if defined"
        );
    }
    ...
    switch (typeof o.pic) {
      ...
      default:
        throw TypeError(
          "message pic " + o.pic + " must be a string if defined"
        );
    }
    switch (typeof o.noForward) {
      ...
      default:
        throw TypeError(
          "message noForward flag must be a boolean if defined, got " +
            o.noForward
        );
    }
    switch (typeof o.fallback) {
      ...
      default:
        throw TypeError(
          "message fallback URL must be a string if defined, got " + o.fallback
        );
    }
    switch (typeof o.linkData) {
      ...
      case "object":
        try {
          ...
          throw TypeError(
            "message linkData must be a string or JSON if defined, got " +
              o.linkData
          );
        }
        break;
      ...
      case "object":
        if (o.data !== null) {
          try {
            ...
            throw TypeError(
              "message data must be a json object if defined, got " + o.data
            );
          }
        }
      case "undefined":
  ...
  function g(o, l) {
    ...
    if (
      ...
      i.browser._processLinkData({ data: o.extras.linkData }, l);
    }
  }
  if (c.getLastMessage) {
  ...
  if (c.openConversationWithUser) {
    b.openConversation = function (m, l) {
      c.openConversationWithUser({ username: m }, function (n) {
        l && l(n);
      });
    };
  }
...
(function (h, i, b) {
  ...
  if (k.getUserData) {
    c.getUser = function (n) {
      ...
      k.getUserData({ fields: ["profile"] }, function (p) {
  ...
  c.hasPermission = function () {
    try {
      return !!k.checkPermissions({ fields: ["profile"] }).permitted;
    } catch (l) {
      return false;
    }
  };
  if (k.pickUsers || k.pickFilteredUsers) {
    c.pickUsers = function (l, m) {
      ...
      switch (typeof l.preselected) {
        ...
        default:
          if (!Array.isArray(l.preselected)) {
            throw TypeError(
              "preselected users must be an array of users if defined, got " +
                l.preselected
            );
          }
          l.preselected.forEach(function (n) {
            ...
            if (typeof n.username !== "string") {
              throw TypeError(
                "user.username must be a string, got " + n.username
              );
            }
          });
          break;
      ...
      switch (typeof l.filtered) {
        ...
        default:
          if (!Array.isArray(l.filtered)) {
            throw TypeError(
              "filtered users must be an array of users if defined, got " +
                l.filtered
            );
          }
          l.filtered = l.filtered.map(function (n) {
            switch (typeof n) {
              ...
              default:
                throw TypeError(
                  "filtered user didnt have a username, got " + n
                );
            }
          });
          break;
      ...
      switch (typeof l.filterSelf) {
        ...
        default:
          throw TypeError(
            "filterSelf must be a boolean if defined, got " + l.filterSelf
          );
      }
      switch (typeof l.minResults) {
        ...
        case "number":
          if (l.minResults < 0) {
            throw TypeError(
              "minResults must be non-negative if defined, got " + l.minResults
            );
          }
          break;
        default:
          throw TypeError(
            "minResults must be a number if defined, got " + l.minResults
          );
      }
      switch (typeof l.maxResults) {
        ...
        case "number":
          if (l.maxResults < 1) {
            throw TypeError(
              "maxResults must be greater than 1 if defined, got " +
                l.maxResults
            );
          }
          break;
        default:
          throw TypeError(
            "maxResults must be a number if defined, got " + l.maxResults
          );
      }
      switch (typeof m) {
        case "undefined":
...
(function (e, a, g) {
  ...
  function f(i, k, h) {
    var j = c.hasPermission();
    b.signRequest({ request: i, skipPrompt: h }, function (m) {
      if (!m || !m.signedRequest) {
        k();
      } else {
        if (!j) {
          c.trigger("permission");
        }
        var l = m.host || e.location.host;
        k(m.signedRequest, m.username, l);
      }
    });
  }
  if (b.getAnonymousId) {
  ...
  if (b.signAnonymousRequest) {
    c.anonymousSign = function (h, i) {
      ...
      b.signAnonymousRequest({ request: h }, function (j) {
  ...
  function g(j, l, k, m) {
    switch (typeof l) {
      ...
      case "number":
        if (l < k || l > m) {
          throw TypeError(
            j + " must be within " + k + " and " + m + " if defined, got " + l
          );
        }
        break;
      default:
...
(function (e, f, a) {
  ...
  function h(k, j, l) {
    ...
    switch (typeof j) {
      ...
      default:
        throw TypeError(
          "picker options must be an object if defined, got " + j
        );
    }
    if (typeof l !== "function") {
  ...
  if (g.getRequest && g.completeRequest) {
    ...
    try {
      c = (
        a._.secondBatch ? a._.firstBatch["Picker.getRequest"] : g.getRequest()
      ).requestData;
    } catch (b) {}
    if (c && f.referrer) {
...
(function (f, g, b) {
  ...
  function a(n, l, m, j) {
    ...
    switch (typeof l) {
      ...
      default:
        throw TypeError(
          "purchase data must be a JSON object if defined, got " + l
        );
    }
    switch (typeof m) {
      case "boolean":
      ...
      default:
        throw TypeError(
          "purchase callback must be a function if defined, got " + m
        );
    }
    switch (typeof j) {
      case "undefined":
...
(function (g, h, a) {
  ...
  function b() {
    ...
    var m = "card" + l.updateQuery({ kikme: null }).substr(4),
      k = !!l.query.kikme;
    if (!k) {
      Array.prototype.forEach.call(
        h.getElementsByTagName("meta"),
        function (n) {
  ...
  function i(k) {
    if (g.console && g.console.error) {
      g.console.error(
        '"' + k + '" is an unsupported value for the "' + d + '" meta tag'
      );
    }
    return false;
  }
  function j() {
    ...
    p.style.backgroundImage =
      "url('http://cdn.kik.com/cards/unsupported_icon.png')";
    ...
    r.innerHTML = "Oh no! This Card isn't supported on your phone.";
    ...
    t.innerHTML =
      "This card is not available for your phone. But don't worry! You can still use the Kik Messenger you know and love :)";
    n.appendChild(p);
    n.appendChild(r);
    n.appendChild(t);
    k.appendChild(n);
