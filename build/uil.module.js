...
const T = {
  ...
  css: {
    ...
    basic:
      "position:absolute; pointer-events:none; box-sizing:border-box; margin:0; padding:0; overflow:hidden; " +
  ...
  svgs: {
    group:
      "M 7 7 L 7 8 8 8 8 7 7 7 M 5 7 L 5 8 6 8 6 7 5 7 M 3 7 L 3 8 4 8 4 7 3 7 M 7 5 L 7 6 8 6 8 5 7 5 M 6 6 L 6 5 5 5 5 6 6 6 M 7 3 L 7 4 8 4 8 3 7 3 M 6 4 L 6 3 5 3 5 4 6 4 M 3 5 L 3 6 4 6 4 5 3 5 M 3 3 L 3 4 4 4 4 3 3 3 Z",
    ...
    vehicle:
      "M 13 6 L 11 1 3 1 1 6 1 13 3 13 3 11 11 11 11 13 13 13 13 6 M 2.4 6 L 4 2 10 2 11.6 6 2.4 6 M 12 8 L 12 10 10 10 10 8 12 8 M 4 8 L 4 10 2 10 2 8 4 8 Z",
    articulation:
      "M 13 9 L 12 9 9 2 9 1 5 1 5 2 2 9 1 9 1 13 5 13 5 9 4 9 6 5 8 5 10 9 9 9 9 13 13 13 13 9 Z",
    character:
      "M 13 4 L 12 3 9 4 5 4 2 3 1 4 5 6 5 8 4 13 6 13 7 9 8 13 10 13 9 8 9 6 13 4 M 6 1 L 6 3 8 3 8 1 6 1 Z",
    terrain:
      "M 13 8 L 12 7 Q 9.06 -3.67 5.95 4.85 4.04 3.27 2 7 L 1 8 7 13 13 8 M 3 8 Q 3.78 5.420 5.4 6.6 5.20 7.25 5 8 L 7 8 Q 8.39 -0.16 11 8 L 7 11 3 8 Z",
    joint:
      "M 7.7 7.7 Q 8 7.45 8 7 8 6.6 7.7 6.3 7.45 6 7 6 6.6 6 6.3 6.3 6 6.6 6 7 6 7.45 6.3 7.7 6.6 8 7 8 7.45 8 7.7 7.7 M 3.35 8.65 L 1 11 3 13 5.35 10.65 Q 6.1 11 7 11 8.28 11 9.25 10.25 L 7.8 8.8 Q 7.45 9 7 9 6.15 9 5.55 8.4 5 7.85 5 7 5 6.54 5.15 6.15 L 3.7 4.7 Q 3 5.712 3 7 3 7.9 3.35 8.65 M 10.25 9.25 Q 11 8.28 11 7 11 6.1 10.65 5.35 L 13 3 11 1 8.65 3.35 Q 7.9 3 7 3 5.7 3 4.7 3.7 L 6.15 5.15 Q 6.54 5 7 5 7.85 5 8.4 5.55 9 6.15 9 7 9 7.45 8.8 7.8 L 10.25 9.25 Z",
    ...
    collision:
      "M 11 12 L 13 10 10 7 13 4 11 2 7.5 5.5 9 7 7.5 8.5 11 12 M 3 2 L 1 4 4 7 1 10 3 12 8 7 3 2 Z",
    map: "M 13 1 L 1 1 1 13 13 13 13 1 M 12 2 L 12 7 7 7 7 12 2 12 2 7 7 7 7 2 12 2 Z",
    material:
      "M 13 1 L 1 1 1 13 13 13 13 1 M 12 2 L 12 7 7 7 7 12 2 12 2 7 7 7 7 2 12 2 Z",
    texture: "M 13 4 L 13 1 1 1 1 4 5 4 5 13 9 13 9 4 13 4 Z",
    object:
      "M 10 1 L 7 4 4 1 1 1 1 13 4 13 4 5 7 8 10 5 10 13 13 13 13 1 10 1 Z",
  ...
  setText: function (size, color, font, shadow, weight) {
    ...
    T.css.txt =
      ...
      "px; color:" +
      cc.text +
      "; padding:0px 10px; left:0; top:2px; height:16px; width:100px; overflow:hidden; white-space: nowrap;";
    if (shadow !== "none")
      T.css.txt += " text-shadow: 1px 1px 1px " + shadow + ";";

    T.css.txtselect =
      T.css.txt + "padding:0px 4px; border:1px dashed " + cc.border + ";";
    //T.css.item = T.css.txt + ' position:relative; margin-bottom:1px; '//display:block; padding:4px 4px;';//
    T.css.item =
      T.css.txt +
      " position:relative; margin-bottom:1px; display:block; padding:2px 4px;"; //
  },
  ...
  setSvg: function (dom, type, value, id, id2) {
    if (id === -1) dom.setAttributeNS(null, type, value);
      ...
      dom.childNodes[id || 0].childNodes[id2 || 0].setAttributeNS(
        null,
        type,
        value
      );
  ...
  get: function (dom, id) {
    if (id === undefined) return dom; // root
      ...
      if (id.length === 3)
        return dom.childNodes[id[0]].childNodes[id[1]].childNodes[id[2]];
    }
  },
  ...
  dom: function (type, css, obj, dom, id) {
    ...
    if (
      T.SVG_TYPE_D.indexOf(type) !== -1 ||
      T.SVG_TYPE_G.indexOf(type) !== -1
    ) {
      // is svg element
...
*/
  ...
  findDeepInver: function (c) {
    return c[0] * 0.3 + c[1] * 0.59 + c[2] * 0.11 <= 0.6;
  },
  ...
  makeGradiant: function (type, settings, parent, colors) {
    ...
    for (let i = 0; i < colors.length; i++) {
      ...
      T.dom(
        "stop",
        null,
        { offset: c[0] + "%", "stop-color": c[1], "stop-opacity": c[2] },
        parent,
        [0, n]
      );
    }
  ...
  makePad: function (model) {
    ...
    Tools.dom(
      "rect",
      "",
      { x: d, y: d, width: w, height: w, fill: T.colors.back },
      svg
    ); // 0
    Tools.dom(
      "rect",
  ...
  makeJoystick: function (model) {
    ...
    if (model === 0) {
      ...
      T.makeGradiant(
        "radialGradient",
        { id: "grad", cx: "50%", cy: "50%", r: "50%", fx: "50%", fy: "50%" },
        svg,
        ccc
      );
      ...
      T.makeGradiant(
        "radialGradient",
        { id: "gradS", cx: "50%", cy: "50%", r: "50%", fx: "50%", fy: "50%" },
        svg,
        ccc
      );
      ...
      T.makeGradiant(
        "radialGradient",
        { id: "gradIn", cx: "50%", cy: "50%", r: "50%", fx: "50%", fy: "50%" },
        svg,
        ccc
      );
      ...
      T.makeGradiant(
        "radialGradient",
        { id: "gradIn2", cx: "50%", cy: "50%", r: "50%", fx: "50%", fy: "50%" },
        svg,
        ccc
      );
      ...
      T.dom(
        "circle",
        "",
        { cx: 64, cy: 64, r: radius, fill: "url(#grad)" },
        svg
      ); //2
      T.dom(
        "circle",
        "",
        { cx: 64 + 5, cy: 64 + 10, r: innerRadius + 10, fill: "url(#gradS)" },
        svg
      ); //3
      T.dom(
        "circle",
        "",
        { cx: 64, cy: 64, r: innerRadius, fill: "url(#gradIn)" },
        svg
      ); //4
      ...
      T.makeGradiant(
        "radialGradient",
        { id: "gradX", cx: "50%", cy: "50%", r: "50%", fx: "50%", fy: "50%" },
        svg,
        ccc
      );
      ...
      T.dom(
        "circle",
        "",
        { cx: 64, cy: 64, r: innerRadius + 14, fill: "url(#gradX)" },
        svg
      ); //3
      T.dom(
        "circle",
  ...
  makeColorRing: function () {
    ...
    T.dom(
      "g",
      null,
      { "transform-origin": "128px 128px", transform: "rotate(0)" },
      svg
    ); //2
    T.dom(
      "polygon",
      "",
      { points: "78.95 43.1 78.95 212.85 226 128", fill: "red" },
      svg,
      2
    ); // 2,0
    T.dom(
  ...
  icon: function (type, color, w) {
    ...
    let t = [
      "<svg xmlns='" +
        ...
        T.htmls +
        "' style='pointer-events:none;' preserveAspectRatio='xMinYMax meet' x='0px' y='0px' width='" +
        w +
        "px' height='" +
        w +
        "px' viewBox='" +
    ...
    switch (type) {
      ...
      case "save":
        t[1] =
          "<path stroke='" +
          color +
          "' stroke-width='4' stroke-linejoin='round' stroke-linecap='round' fill='none' d='M 26.125 17 L 20 22.95 14.05 17 M 20 9.95 L 20 22.95'/><path stroke='" +
          color;
        t[1] +=
          "' stroke-width='2.5' stroke-linejoin='round' stroke-linecap='round' fill='none' d='M 32.6 23 L 32.6 25.5 Q 32.6 28.5 29.6 28.5 L 10.6 28.5 Q 7.6 28.5 7.6 25.5 L 7.6 23'/>";
        break;
    }
    t[2] = "</g></svg>";
    return t.join("\n");
...
class Files {
  ...
  static autoTypes(type) {
    ...
    switch (type) {
      ...
      case "json":
        t = [
          { description: "JSON Files", accept: { "text/plain": [".json"] } },
        ];
        break;
      case "image":
        t = [
...
class V2 {
  ...
  nearEquals(v, n) {
    return (
      v.x.toFixed(n) === this.x.toFixed(n) &&
      v.y.toFixed(n) === this.y.toFixed(n)
    );
  }
    ...
    if (this.model === 0) {
      ...
      this.c[2] = this.dom(
        ...
        this.css.basic +
          ...
          "px; top:" +
          t +
          "px; border-radius:10px; border:2px solid " +
          cc.back
      );
      this.c[3] = this.dom(
        "div",
...
class Button extends Proto {
  ...
  mouseup(e) {
    ...
    this.isDown = false;
    if (this.res !== -1) {
      if (this.value === this.values[this.res] && this.unselectable)
        this.value = "";
      ...
      case 0: // base
        ...
        color =
          this.model > 0
            ? Tools.pack(
                Tools.lerpColor(
                  Tools.unpack(Tools.ColorLuma(cc.text, -0.75)),
                  Tools.unpack(cc.text),
                  this.percent
                )
              )
            : cc.text;
...
class Fps extends Proto {
  constructor(o = {}) {
    ...
    let panelCss =
      "display:none; left:10px; top:" +
      this.h +
      "px; height:" +
      (this.hplus - 8) +
      "px; box-sizing:border-box; background: rgba(0, 0, 0, 0.2); border:1px solid " +
      this.colors.border +
      ";";
    ...
    this.c[3] = this.dom(
      "path",
      this.css.basic +
        "position:absolute; width:10px; height:10px; left:4px; top:" +
        fltop +
        "px;",
      { d: this.svgs.arrow, fill: this.colors.text, stroke: "none" }
    );
    ...
    this.c[4] = this.dom(
      ...
      this.css.txt +
        ...
        (this.h + 2) +
        "px; display:none; width:100%; text-align:center;"
    );
    ...
    if (o.bottomLine)
      this.c[4] = this.dom(
        "div",
        this.css.basic +
          "width:100%; bottom:0px; height:1px; background: rgba(255, 255, 255, 0.2);"
      );
    ...
    if (this.colors.gborder !== "none")
      s[0].border = "1px solid " + this.colors.gborder;
    ...
    for (j = 0; j < this.names.length; j++) {
      ...
      this.textDisplay.push(
        "<span style='color:rgb(" + cc[j] + ")'> " + this.names[j] + " "
      );
    }
  ...
  upText(val) {
    let v = val || this.values,
      t = "";
    for (let j = 0, lng = this.names.length; j < lng; j++)
...
class Graph extends Proto {
  constructor(o = {}) {
    ...
    this.c[2] = this.dom(
      "div",
      this.css.txt +
        "display:block; text-align:center; padding:0px 0px; top:" +
        (this.h - 20) +
        "px; left:14px; width:" +
        this.gw +
        "px;  color:" +
  ...
  valueToHtml() {
    ...
    while (i--) {
      if (n === this.lng - 1)
        r += "<td style=" + style + ">" + this.value[n] + "</td></tr></table>";
  ...
  updateSVG() {
    ...
    for (let i = 0; i < this.lng; i++) {
      ...
      if (this.neg)
        this.value[i] =
          ((this.v[i] * 2 - 1) * this.multiplicator).toFixed(this.precision) *
          1;
      else
        this.value[i] =
          (this.v[i] * this.multiplicator).toFixed(this.precision) * 1;
    }
  ...
  mousemove(e) {
    ...
    if (name === "") {
      ...
      if (this.isDown) {
        this.v[name] = this.clamp(
          1 - (e.clientY - this.zone.y - this.top - 10) / this.gh,
          0,
          1
        );
        this.update(true);
...
class Group extends Proto {
  constructor(o = {}) {
    ...
    this.c[2] = this.dom(
      ...
      this.css.basic +
        flexible +
        "width:100%; left:0; height:auto; overflow:hidden; top:" +
        this.h +
        "px"
    ); //
    this.c[3] = this.dom(
      "path",
      this.css.basic +
        "position:absolute; width:10px; height:10px; left:0; top:" +
        fltop +
        "px;",
      { d: this.svgs.group, fill: this.colors.text, stroke: "none" }
    );
    this.c[4] = this.dom(
      "path",
      this.css.basic +
        "position:absolute; width:10px; height:10px; left:" +
        (4 + this.decal) +
        "px; top:" +
        fltop +
        "px;",
    ...
    if (this.isLine)
      this.c[5] = this.dom(
        "div",
        this.css.basic +
          "background:rgba(255, 255, 255, 0.2); width:100%; left:0; height:1px; bottom:0px"
      );
  ...
  add() {
    ...
    if (typeof a[1] === "object") {
      ...
      if (a[2] === undefined)
        [].push.call(a, { isUI: true, target: this.c[2], main: this.main });
      else {
        a[2].isUI = true;
        a[2].target = this.c[2];
        a[2].main = this.main;
...
class Joystick extends Proto {
  ...
  updateSVG() {
    ...
    this.value[0] =
      (this.pos.x * this.multiplicator).toFixed(this.precision) * 1;
    this.value[1] =
      (this.pos.y * this.multiplicator).toFixed(this.precision) * 1;
...
class Knob extends Proto {
  ...
  mousemove(e) {
    ...
    if (this.oldr !== null)
      this.r = Math.abs(this.r - this.oldr) > Math.PI ? this.oldr : this.r;
  ...
  update(up) {
    ...
    if (this.model > 0) {
      ...
      let color = Tools.pack(
        Tools.lerpColor(
          Tools.unpack(Tools.ColorLuma(this.colors.text, -0.75)),
          Tools.unpack(this.colors.text),
          this.percent
        )
      );
...
class List extends Proto {
  constructor(o = {}) {
    ...
    this.c[2] = this.dom(
      "div",
      this.css.basic +
        "top:0; display:none; border-radius:" +
        this.radius +
        "px;"
    );
    this.c[3] = this.dom(
      "div",
      this.css.item +
        "position:absolute; text-align:" +
        align +
        "; line-height:" +
        (this.h - 4) +
        "px; top:1px; background:" +
        cc.button +
        "; height:" +
        (this.h - 2) +
        "px; border:1px solid " +
    ...
    this.c[4] = this.dom(
      ...
      this.css.basic +
        ...
        fltop +
        "px;",
      { d: this.svgs.arrow, fill: cc.text, stroke: "none" }
    );

    this.scrollerBack = this.dom(
      "div",
      this.css.basic +
        "right:0px; width:" +
        ss +
    ...
    this.listIn = this.dom(
      "div",
      this.css.basic + "left:0; top:0; width:100%; background:none;"
    );
  ...
  mousedown(e) {
    ...
    if (name === "scroll") {
      ...
      if (this.current) {
        ...
        this.send(
          this.refObject !== null
            ? this.refObject[this.list[this.current.id]]
            : this.value
        );
  ...
  setList(list) {
    ...
    for (let i = 0; i < this.length; i++) {
      ...
      if (this.miniCanvas) {
        ...
        c.style.cssText =
          "position:relative; pointer-events:none; display:inline-block; float:left; margin-left:0px; margin-right:5px; top:2px";
...
class Numeric extends Proto {
  constructor(o = {}) {
    ...
    while (i--) {
      if (this.isAngle)
        this.value[i] = ((this.value[i] * 180) / Math.PI).toFixed(
          this.precision
        );
      this.c[3 + i] = this.dom(
        "div",
    ...
    this.c[this.selectId] = this.dom(
      "div",
      this.css.txtselect +
        "position:absolute; top:4px; height:" +
        (this.h - 8) +
        "px; padding:0px 0px; width:0px; color:" +
        cc.textSelect +
        "; background:" +
        cc.select +
    ...
    this.c[this.cursorId] = this.dom(
      "div",
      this.css.basic +
        "top:4px; height:" +
        (this.h - 8) +
        "px; width:0px; background:" +
        cc.text +
        ";"
    );
      ...
      if (name !== "") {
        ...
        this.prev = {
          ...
          v: this.isSingle
            ...
            : parseFloat(this.value[this.current]),
        };
...
class Slide extends Proto {
  ...
  mousemove(e) {
    ...
    if (this.isDown) {
      let n =
        ((e.clientX - (this.zone.x + this.sa) - 3) / this.ww) * this.range +
        this.min -
        this.old;
      if (n >= this.step || n <= this.step) {
        n = Math.floor(n / this.step);
  ...
  constructor(o = {}) {
    ...
    this.c[5] = this.dom(
      ...
      this.css.txtselect +
        "height:" +
        (this.h - 4) +
        "px; justify-content: center; font-style: italic; color:" +
        cc.border +
        ";"
    );
...
class Title extends Proto {
  constructor(o = {}) {
    ...
    this.c[2] = this.dom(
      "div",
      this.css.txt +
        "justify-content:right; width:60px; line-height:" +
        (this.h - 8) +
        "px; color:" +
        this.colors.text
    );
    ...
    this.c[1].textContent =
      this.txt.substring(0, 1).toUpperCase() +
      this.txt.substring(1).replace("-", " ");
  ...
  constructor(o = {}) {
    ...
    this.c[2] = this.dom(
      ...
      this.css.txt +
        ...
        "; border-radius:15px; width:30px; left:10px;"
    );
    ...
    this.c[4] = this.dom(
      "path",
      this.css.basic +
        "position:absolute; width:14px; height:14px; left:5px; top:" +
        fltop +
        "px;",
      { d: this.svgs["cursor"], fill: this.fontColor, stroke: "none" }
    );
  ...
  constructor(o = {}) {
    ...
    this.c[2] = this.dom(
      ...
      this.css.basic +
        ...
        fltop +
        "px;",
      { d: this.graph, fill: this.colors.text, stroke: "none" }
    );
  ...
  constructor(o = {}) {
    ...
    this.c[2] = this.dom(
      ...
      this.css.basic +
        "width:100%; top:" +
        (this.spaces[1] - 2) +
        "px; height:auto; border-collapse:separate; border:none; border-spacing: " +
        (this.spaces[0] - 2) +
        "px " +
        (this.spaces[1] - 2) +
        "px;"
      ...
      for (let j = 0; j < this.grid[0]; j++) {
        ...
        if (this.values[n]) {
          ...
          b.style.cssText =
            ...
            "px solid " +
            cc.border +
            "; left:auto; right:auto; border-radius:" +
            this.radius +
            "px;";
          ...
          b.style.cssText =
            ...
            "px; height:" +
            this.bsize[1] +
            "px; text-align:center; left:auto; right:auto; background:none;";
          td.appendChild(b);
        }
...
class Pad2D extends Proto {
  constructor(o = {}) {
    ...
    this.value =
      Array.isArray(o.value) && o.value.length == 2 ? o.value : [0, 0];
  ...
  setValue(v, up = false) {
    ...
    this.value[0] =
      Math.min(this.max, Math.max(this.min, v[0])).toFixed(this.precision) * 1;
    this.value[1] =
      Math.min(this.max, Math.max(this.min, v[1])).toFixed(this.precision) * 1;

    this.pos.set(
      (this.value[0] / this.range) * this.maxPos + 128,
      (this.value[1] / this.range) * this.maxPos + 128
    );
