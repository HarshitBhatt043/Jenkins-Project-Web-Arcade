MG.hud = (function () {
  ...
  return {
    init: function () {
      ...
      mRadar = (function () {
        var mMissilePositionDot = document.getElementById(
          "hud-radar-scope-missile"
        );
        var mMissileTargetDot = document.getElementById(
          "hud-radar-scope-missile-target"
        );
        ...
        return {
          ...
          updateDOM: function () {
            ...
            x =
              scopeRadius +
              (0.95 * scopeRadius * mMissileTarget.x) / MG.TUNNEL_RADIUS;
            y =
              scopeRadius +
              (0.95 * scopeRadius * mMissileTarget.y) / MG.TUNNEL_RADIUS;
            ...
            x =
              scopeRadius +
              (0.95 * scopeRadius * mMissilePosition.x) / MG.TUNNEL_RADIUS;
            y =
              scopeRadius +
              (0.95 * scopeRadius * mMissilePosition.y) / MG.TUNNEL_RADIUS;
      ...
      mSpeedometer = (function () {
        ...
        document
          .getElementById("hud-speedometer-speed-text")
          .appendChild(mTextNode);
      ...
      mProgressIndicator = (function () {
        var mProgressMarkNode = document.getElementById(
          "hud-progress-indicator-progress"
        );
        var mBestProgressMarkNode = document.getElementById(
          "hud-progress-indicator-best-progress"
        );
        ...
        return {
          ...
          updateDOM: function () {
            mProgressMarkNode.setAttribute(
              "transform",
              "translate(0," + mProgress + ")"
            );
            mBestProgressMarkNode.setAttribute(
              "transform",
              "translate(0," + mBestProgress + ")"
            );
          },
        };
      })();
      ...
      mLifeCounter = (function () {
        ...
        var mInfiniteLivesNode = document.getElementById(
          "hud-lives-indicator-infinite"
        );
        var mZeroLivesNode = document.getElementById(
          "hud-lives-indicator-none"
        );

        var mLivesNodes = [];
        for (i = 0; i < 5; i++) {
          mLivesNodes[i] = document.getElementById(
            "hud-lives-indicator-missile-" + (i + 1)
          );
        }
          ...
          updateDOM: function () {
            ...
            switch (mLives) {
              ...
              default:
                ...
                for (i = 0; i < 5; i++) {
                  mLivesNodes[i].setAttribute(
                    "visibility",
                    i < mLives ? "visible" : "hidden"
                  );
                }
                break;
            }
      ...
      mFrameRateIndicator = (function () {
        var mTextNode = document.createTextNode("");
        document
          .getElementById("hud-frame-rate-indicator")
          .appendChild(mTextNode);
