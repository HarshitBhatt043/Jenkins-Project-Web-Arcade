...
export class Hub {
  constructor() {
    ...
    this.windowsStyle =
      " top:40px; left:10px; border:1px solid " +
      this.colors[1] +
      "; background:" +
      this.colors[3] +
      ";";
    ...
    this.full.style.cssText =
      "position:absolute; top:0px; left:0px; width:100%; height:100%; pointer-events:none; display:block; background:rgba(144,163,183,1); "; //+ this.degrade();

    this.text = document.createElement("div");
    this.text.style.cssText =
      "position:absolute; font-size:18px; left:calc(50% - 150px); top:calc(50% + 80px); width:300px; height:80px; pointer-events:none; text-align:center; font-weight: bold;";
    this.text.innerHTML = "Welcome";

    this.loader = document.getElementById("loader");
    this.loader.style.cssText =
      "pointer-events:none; position:absolute; left:calc(50% - 100px); top:calc(50% - 100px); width:200px; height:200px;";
    ...
    this.link = UIL.add("button", {
      ...
      .icon(UIL.Tools.icon("github", "#DEDEDE", 50))
      .onChange(function (v) {
    ...
    this.donate = UIL.add("button", {
      ...
      w: 64,
      h: 64,
      pos: { left: "84px", bottom: "10px" },
      simple: true,
      button: "#8397ac",
    })
      .icon(UIL.Tools.icon("donate", "#DEDEDE", 50))
      .onChange(function (v) {
        let w = window.open(
          "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=8KTXA987XHYNQ",
          "_blank"
        );
      });

    this.version = document.createElement("div");
    this.version.style.cssText =
      "position:absolute; font-size:14px; right:10px; bottom:10px; text-align:right; width:100px; pointer-events:none; display:block;";
  ...
  initGameHub() {
    ...
    this.toolSet.style.cssText =
      "position:absolute; margin:0px; padding:0px; top:60px; right:12px; width:198px; height:456px; pointer-events:none;";
    this.hub.appendChild(this.toolSet);
    this.toolInfo = document.createElement("div");
    this.toolInfo.style.cssText =
      "position:absolute; top:15px; right:12px; width:198px; height:50px; pointer-events:none; font-size:16px;";
    ...
    this.selector.style.cssText =
      "position:absolute; top:0px; left:0px; pointer-events:none; display:none;";
    ...
    img.style.cssText =
      "position:absolute; margin:0px; padding:0px; top:0px; right:0px; width:198px; height:396px; pointer-events:none;";
    ...
    var b1 = this.addButton(
      this.hub,
      "Budget",
      [75, 16, 14],
      "position:absolute; left:10px; top:-7px; font-weight:bold;",
      true
    );
    b1.addEventListener(
      "click",
    ...
    var b2 = this.addButton(
      this.hub,
      "Eval",
      [75, 16, 14],
      "position:absolute; left:110px; top:-7px; font-weight:bold;",
      true
    );
    b2.addEventListener(
      "click",
    ...
    var b4 = this.addButton(
      this.hub,
      "Exit",
      [75, 16, 14],
      "position:absolute; left:310px; top:-7px; font-weight:bold;",
      true
    );
    b4.addEventListener(
      "click",
    ...
    var b5 = this.addButton(
      this.hub,
      "About",
      [75, 16, 14],
      "position:absolute; left:410px; top:-7px; font-weight:bold;",
      true
    );
    b5.addEventListener(
      "click",
    ...
    this.roo.style.cssText =
      "position:absolute; bottom:11px; left:10px; width:60px; height:60px; pointer-events:none; transform:rotate(45deg); ";
    this.roo.style.cssText +=
    ...
    for (i = 0; i < 4; i++) {
      ...
      if (i == 0)
        dd.style.cssText =
          "position:absolute; top:0px; left:0px; width:30px; height:30px; pointer-events:auto; cursor:pointer; background:#ffffff;";
      if (i == 1)
        dd.style.cssText =
          "position:absolute; top:0px; right:0px; width:30px; height:30px; pointer-events:auto; cursor:pointer;";
      if (i == 2)
        dd.style.cssText =
          "position:absolute; bottom:0px; right:0px; width:30px; height:30px; pointer-events:auto; cursor:pointer;";
      if (i == 3)
        dd.style.cssText =
          "position:absolute; bottom:0px; left:0px; width:30px; height:30px; pointer-events:auto; cursor:pointer;";
      dd.name = i;
    ...
    winter.style.cssText =
      "position:absolute; bottom:80px; left:25px; width:30px; height:30px; pointer-events:auto; cursor:pointer; background:rgba(0,0,0,0); ";
    winter.style.cssText +=
    ...
    img2.style.cssText =
      "position:absolute; margin:0px; padding:0px; bottom:0px; left:0px; width:630px; height:120px; pointer-events:none;";
  ...
  initCITYinfo() {
    ...
    this.date.style.cssText =
      "font-size:14px; position:absolute; width:70px; height:19px; bottom:15px; left:65px; text-align:right; font-weight:bold;";

    this.money = document.createElement("div");
    this.money.style.cssText =
      "font-size:14px; position:absolute; width:70px; height:19px; bottom:15px; left:295px; text-align:right; font-weight:bold;";

    this.population = document.createElement("div");
    this.population.style.cssText =
      "font-size:14px; position:absolute; width:70px; height:19px; bottom:15px; left:180px; text-align:right; font-weight:bold;";

    this.score = document.createElement("div");
    this.score.style.cssText =
      "font-size:14px; position:absolute; width:70px; height:19px; bottom:15px; left:410px; text-align:right; font-weight:bold;";

    this.msg = document.createElement("div");
    this.msg.style.cssText =
      "font-size:14px; letter-spacing:0.02em; position:absolute; width:420px; height:20px; bottom:44px; left:76px; text-align:left; color:" +
      this.colors[4] +
      "; font-weight:bold;";
  ...
  openAbout(data) {
    ...
    if (this.aboutWindow == null) {
      ...
      this.aboutWindow.style.cssText =
        this.radius +
        "position:absolute; width:200px; height:210px; pointer-events:none; display:block;" +
        this.windowsStyle;
      this.hub.appendChild(this.aboutWindow);
      var bg1 = this.addButton(
        this.aboutWindow,
        "X",
        [16, 16, 14],
      ...
      this.fps.style.cssText =
        "position:absolute; top:20px; left:60px; width:120px; height:20px; pointer-events:none; font-size:12px; text-align:center; color:" +
        this.colors[0] +
        ";";
      this.aboutWindow.appendChild(this.fps);
      this.abb = document.createElement("div");
      this.abb.style.cssText =
        "position:absolute; top:60px; left:10px; width:180px; height:180px; pointer-events:none; font-size:12px; text-align:center; color:" +
        this.colors[0] +
        ";";
      this.aboutWindow.appendChild(this.abb);
      this.linke = document.createElement("div");
      this.linke.style.cssText =
        "position:absolute; top:160px; left:10px; width:180px; height:20px; pointer-events:auto; font-size:12px; text-align:center; color:" +
        this.colors[0] +
        ";";
      this.aboutWindow.appendChild(this.linke);

      this.abb.innerHTML =
        "3D CITY<br><br>All 3d side made by Lo.th<br>Simulation from MicropolisJS<br><br><br>More info and source<br>";
      this.linke.innerHTML =
        "<a href='https://github.com/lo-th/3d.city' target='_blank'>https://github.com/lo-th/3d.city";
    } else {
  ...
  openOverlays(data) {
    ...
    if (this.overlaysWindow == null) {
      ...
      this.overlaysWindow.style.cssText =
        this.radius +
        "position:absolute; width:140px; height:420px; pointer-events:none; display:block;" +
        this.windowsStyle;
      ...
      for (var i = 0; i < this.overlaysTypes.length; i++) {
        this.overlaysButtons[i] = this.addButton(
          this.overlaysWindow,
          this.overlaysTypes[i].toUpperCase(),
          [96, 16, 14],
          "position:absolute; left:10px; top:" + (10 + i * 40) + "px;"
        );
        this.overlaysButtons[i].name = this.overlaysTypes[i];
        this.overlaysButtons[i].addEventListener(
          "click",
          function (e) {
            e.preventDefault();
  ...
  openQuery(data) {
    ...
    if (this.queryWindow == null) {
      ...
      this.queryWindow.style.cssText =
        this.radius +
        "position:absolute; width:140px; height:180px; pointer-events:none; display:block;" +
        this.windowsStyle;
      ...
      this.queryResult.style.cssText =
        "position:absolute; top:60px; left:10px; width:110px; height:100px; pointer-events:none; font-size:12px; text-align:center; color:" +
        this.colors[0] +
        ";";
  ...
  openEval(data) {
    ...
    if (this.evaluationWindow == null) {
      ...
      this.evaluationWindow.style.cssText =
        this.radius +
        "position:absolute; width:200px; height:300px; pointer-events:none; display:block;" +
        this.windowsStyle;
      this.hub.appendChild(this.evaluationWindow);

      this.evaltOpinion = document.createElement("div");
      this.evaltOpinion.style.cssText =
        "position:absolute; top:10px; left:10px; width:180px; height:100px; pointer-events:none; color:" +
        this.colors[0] +
        ";";
      this.evaluationWindow.appendChild(this.evaltOpinion);

      this.evaltYes = document.createElement("div");
      this.evaltYes.style.cssText =
        "position:absolute; top:46px; left:26px; width:60px; height:20px; pointer-events:none; color:#33FF33; font-size:16px; font-weight:bold;";
      this.evaluationWindow.appendChild(this.evaltYes);

      this.evaltNo = document.createElement("div");
      this.evaltNo.style.cssText =
        "position:absolute; top:46px; right:26px; width:60px; height:20px; pointer-events:none; color:#FF3300;  font-size:16px; font-weight:bold;";
      this.evaluationWindow.appendChild(this.evaltNo);

      this.evaltProb = document.createElement("div");
      this.evaltProb.style.cssText =
        "position:absolute; top:100px; left:10px; width:180px; height:60px; pointer-events:none; color:" +
        this.colors[0] +
        "; font-size:16px; ";
  ...
  openBudget(data) {
    ...
    if (this.budgetWindow == null) {
      ...
      this.budgetResult.style.cssText =
        "position:absolute; top:200px; left:10px; width:180px; height:300px; pointer-events:none; color:" +
        this.colors[0] +
        ";";
      ...
      var bg2 = this.addButton(
        ...
        "APPLY",
        [70, 16, 14],
        "position:absolute; rigth:10px; bottom:10px;"
      );
  ...
  openDisaster() {
    ...
    if (this.disasterWindow == null) {
      ...
      this.disasterWindow.style.cssText =
        this.radius +
        "position:absolute; width:140px; height:300px; pointer-events:none; display:block;" +
        this.windowsStyle;
      this.hub.appendChild(this.disasterWindow);

      for (var i = 0; i < this.disasterTypes.length; i++) {
        this.disasterButtons[i] = this.addButton(
          this.disasterWindow,
          this.disasterTypes[i].toUpperCase(),
          [96, 16, 14],
          "position:absolute; left:10px; top:" + (10 + i * 40) + "px;"
        );
        this.disasterButtons[i].name = this.disasterTypes[i];
        this.disasterButtons[i].addEventListener(
          "click",
          function (e) {
            e.preventDefault();
            Main.setDisaster(this.name);
          },
          false
        );
      }
  ...
  addSlider(target, py, name, value, v2, color, max) {
    ...
    txt.style.cssText =
      "position:absolute; left:10px; top:-18px; pointer-events:none; width:180px; height:20px; font-size:12px; color:" +
      this.colors[0] +
      ";";
    bg.style.cssText =
      this.radius +
      ...
      (py + 20) +
      "px; padding:0; cursor:w-resize; pointer-events:auto; width:180px; height:20px; background-color:" +
      _this.colors[1] +
      ";";
    sel.style.cssText =
      this.radius +
      "position:absolute; pointer-events:none; margin:5px; width:100px; height:10px; background-color:" +
      color +
      ";";
    ...
    bg.addEventListener(
      ...
      function (e) {
        e.preventDefault();
        this.className = "up";
        this.style.backgroundColor = _this.colors[1];
      },
      false
    );
    bg.addEventListener(
      ...
      function (e) {
        e.preventDefault();
        this.style.backgroundColor = _this.colors[2];
      },
      false
    );
    bg.addEventListener(
    ...
    bg.addEventListener(
      ...
      function (e) {
        e.preventDefault();
        this.className = "down";
        _this.dragSlider(this, e.clientX, max);
      },
      false
    );
    bg.addEventListener(
      ...
      switch (t.name) {
        ...
        case "Roads":
          children[1].innerHTML =
            ...
            this.roadFund +
            "$ = " +
            Math.floor(this.roadFund * (value / 100)) +
            "$";
          this.roadRate = value;
          break;
        case "Fire":
          children[1].innerHTML =
            ...
            this.fireFund +
            "$ = " +
            Math.floor(this.fireFund * (value / 100)) +
            "$";
          this.fireRate = value;
          break;
        case "Police":
          children[1].innerHTML =
            ...
            this.policeFund +
            "$ = " +
            Math.floor(this.policeFund * (value / 100)) +
            "$";
          this.policeRate = value;
          break;
      }
    }
  }
  ...
  initRCI() {
    ...
    cont.id = "RCI";
    cont.style.cssText =
      "font-size:10px; position:absolute; width:70px; height:70px; bottom:20px; right:20px;";

    var txt = document.createElement("div");
    txt.style.cssText =
      "font-size:10px; position:absolute; width:46px; height:14px; bottom:28px; left:10px; background:#cccccc; padding:0px 2px;  letter-spacing:12px; text-align:center; color:#000000;";
    txt.innerHTML = "RCI";
    ...
    this.C.style.cssText =
      "position:absolute; width:10px; height:20px; bottom:42px; left:30px; background:#3030ff;";
    cont.appendChild(this.C);

    this.I = document.createElement("div");
    this.I.id = "I";
    this.I.style.cssText =
      "position:absolute; width:10px; height:20px; bottom:42px; left:50px; background:#ffff30;";
  ...
  addSelector(type, names, fun, current, size) {
    ...
    cont.style.cssText =
      "font-size:14px; margin-top:10px; color:" + this.colors[0] + ";";
    if (type == "Speed")
      cont.style.cssText =
        "font-size:20px; position:absolute; bottom:8px; left:497px; ";
    ...
    for (var i = 0; i !== names.length; i++) {
      ...
      if (type == "Speed")
        t[i].style.cssText +=
          " width:70px; height:16px; margin-left:2px; padding:6px; pointer-events:auto;  cursor:pointer; display:inline-block; ";
      else
        t[i].style.cssText +=
          " width:70px; height:16px; margin:2px; padding:7px; pointer-events:auto;  cursor:pointer; display:inline-block; ";
      ...
      if (size) {
        if (size[i]) {
          ...
          t[i].style.height = size[i] + "px";
          t[i].style.padding = "0px";
      ...
      t[i].addEventListener(
        ...
        function (e) {
          e.preventDefault();
          this.style.border = "1px solid " + _this.colors[0];
        },
        false
      );
      t[i].addEventListener(
        ...
        function (e) {
          e.preventDefault();
          this.style.border = "1px solid " + _this.colors[5];
        },
        false
      );
      ...
      t[i].addEventListener(
        ...
        function (e) {
          e.preventDefault();
          fun(this.name);
          _this.setActiveSelector(this.name, type);
        },
        false
      );
    }
  ...
  showToolSelect(id) {
    if (id.name !== this.currentToolName) {
      ...
      var px =
        id.getBoundingClientRect().left -
        this.toolSet.getBoundingClientRect().left;
      var py =
        id.getBoundingClientRect().top -
        this.toolSet.getBoundingClientRect().top;
  ...
  showToolInfo(id, t) {
    ...
    if (id.name === 16) t.toolInfo.innerHTML = "Drag view";
      ...
      t.toolInfo.innerHTML = name + "<br>" + Base.toolSet[id.name].price + "$";
  }
  ...
  addSVGButton(target) {
    ...
    b.style.cssText =
      " margin:0px; padding:0px; width:66px; height:66px; pointer-events:auto; cursor:pointer; display:inline-block; line-height:0px; vertical-align: top;";
    ...
    b.addEventListener(
      ...
      function (e) {
        ...
        var px =
          ...
          _this.toolSet.getBoundingClientRect().left;
        var py =
          this.getBoundingClientRect().top -
          _this.toolSet.getBoundingClientRect().top;
  ...
  addButton(target, name, size, style, top) {
    ...
    if (top)
      defStyle +=
        "margin:4px; padding:7px; pointer-events:auto;  cursor:pointer; display:inline-block; " +
        this.radiusB;
    else
      defStyle +=
        "margin:4px; padding:7px; pointer-events:auto;  cursor:pointer; display:inline-block; " +
    ...
    b.addEventListener(
      ...
      function (e) {
        e.preventDefault();
        this.style.backgroundColor = _this.colors[5];
        this.style.color = _this.colors[2];
      },
      false
    );
    b.addEventListener(
