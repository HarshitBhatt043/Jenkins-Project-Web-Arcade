    ...
    if (index + param_length < tokens.length) {
      ...
      switch (mode) {
        case "A":
          ...
          var x1 = startPoint.x;
          var y1 = startPoint.y;
          var bezier_param_list = arcToCurve.apply(
            this,
            [x1, y1].concat(params)
          );
          for (var i = 0; i < bezier_param_list.length / 6; i++) {
            ...
            this.segments.push(
              new AbsoluteCurveto3(bezier_params, this, previous)
            );
        ...
        case "C":
          this.segments.push(new AbsoluteCurveto3(params, this, previous));
          break;
        case "c":
          this.segments.push(new RelativeCurveto3(params, this, previous));
          break;
        case "H":
          this.segments.push(new AbsoluteHLineto(params, this, previous));
          break;
        case "L":
          this.segments.push(new AbsoluteLineto(params, this, previous));
          break;
        case "l":
          this.segments.push(new RelativeLineto(params, this, previous));
          break;
        case "M":
          this.segments.push(new AbsoluteMoveto(params, this, previous));
          break;
        case "m":
          this.segments.push(new RelativeMoveto(params, this, previous));
          break;
        case "Q":
          this.segments.push(new AbsoluteCurveto2(params, this, previous));
          break;
        case "q":
          this.segments.push(new RelativeCurveto2(params, this, previous));
          break;
        case "S":
          this.segments.push(
            new AbsoluteSmoothCurveto3(params, this, previous)
          );
          break;
        case "s":
          this.segments.push(
            new RelativeSmoothCurveto3(params, this, previous)
          );
          break;
        case "T":
          this.segments.push(
            new AbsoluteSmoothCurveto2(params, this, previous)
          );
          break;
        case "t":
          this.segments.push(
            new RelativeSmoothCurveto2(params, this, previous)
          );
          break;
        case "Z":
          this.segments.push(new RelativeClosePath(params, this, previous));
          break;
        case "z":
          this.segments.push(new RelativeClosePath(params, this, previous));
          break;
