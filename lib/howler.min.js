!(function () {
  ...
  e.prototype = {
    ...
    _setup: function () {
      var e = this || n;
      if (
        ((e.state = (e.usingWebAudio && e.ctx && e.ctx.state) || "running"),
        e._autoSuspend(),
        !e.usingWebAudio)
      )
    ...
    _autoResume: function () {
      var e = this;
      if (e.usingWebAudio && void 0 !== e.ctx.resume && n.usingWebAudio)
        return (
  ...
  t.prototype = {
      ...
      if (o._webAudio) {
        var c = function () {
          ...
          l.gain.setValueAtTime(e, n.ctx.currentTime),
            ...
            s !== 1 / 0 &&
              (o._endTimers[a._id] = setTimeout(o._ended.bind(o, a), s)),
            t ||
              setTimeout(function () {
                o._emit("play", a._id);
              }, 0);
        ...
        "running" === n.state
          ? c()
          : (o.once("resume", c), o._clearTimer(a._id));
      } else {
        var f = function (e) {
            (l.currentTime = d),
              (l.muted = a._muted || o._muted || n._muted || l.muted),
              (l.volume = a._volume * n.volume()),
              (l.playbackRate = a._rate),
              e &&
                e !== 1 / 0 &&
                (o._endTimers[a._id] = setTimeout(o._ended.bind(o, a), e));
            try {
              var r = l.play();
              if (
      ...
      if (
        (1 === a.length || (2 === a.length && void 0 === a[1])
          ? r._getSoundIds().indexOf(a[0]) >= 0
            ? (t = parseInt(a[0], 10))
            : (e = parseFloat(a[0]))
          : a.length >= 2 && ((e = parseFloat(a[0])), (t = parseInt(a[1], 10))),
        !(void 0 !== e && e >= 0 && e <= 1))
      )
    ...
    rate: function () {
      ...
      if (0 === a.length) t = r._sounds[0]._id;
        ...
        2 === a.length && ((e = parseFloat(a[0])), (t = parseInt(a[1], 10)));
      if ("number" != typeof e)
        return (o = r._soundById(t)) ? o._rate : r._rate;
      if ("loaded" !== r._state)
        return (
          r._queue.push({
            event: "rate",
      ...
      for (var u = 0; u < t.length; u++)
        if ((o = r._soundById(t[u]))) {
          ...
          var i = r.seek(t[u]),
            d =
              (1e3 *
                ((r._sprite[o._sprite][0] + r._sprite[o._sprite][1]) / 1e3 -
                  i)) /
              Math.abs(o._rate);
          (!r._endTimers[t[u]] && o._paused) ||
            (r._clearTimer(t[u]),
            (r._endTimers[t[u]] = setTimeout(r._ended.bind(r, o), d))),
            r._emit("rate", o._id);
        }
      return r;
    },
    seek: function () {
      ...
      if (a) {
        ...
        d && o.pause(t, !0),
          ...
          o._clearTimer(t),
          d && o.play(t, !0),
          !o._webAudio && a._node && (a._node.currentTime = e),
          o._emit("seek", t);
      }
      return o;
    },
    ...
    _clearTimer: function (e) {
      return (
        this._endTimers[e] &&
          (clearTimeout(this._endTimers[e]), delete this._endTimers[e]),
        this
      );
    },
  ...
  o.prototype = {
    ...
    _loadListener: function () {
      ...
      (e._duration = Math.ceil(10 * this._node.duration) / 10),
        ...
        this._node.removeEventListener(n._canPlayEvent, this._loadFn, !1);
    },
  };
  var r = {},
    a = function (e) {
    ...
    _ = function () {
      try {
        "undefined" != typeof AudioContext
          ? ((n.ctx = new AudioContext()), (n.usingWebAudio = !0))
          : "undefined" != typeof webkitAudioContext
          ? ((n.ctx = new webkitAudioContext()), (n.usingWebAudio = !0))
          : ((n.ctx = "DISABLED"), (n.usingWebAudio = !1));
      } catch (e) {
        n.usingWebAudio = !1;
      }
      ...
      n.usingWebAudio &&
        ((n.dynamicsCompressorNode = n.ctx.createDynamicsCompressor()),
        n.dynamicsCompressorNode.connect(n.ctx.destination),
        (n.masterGain =
          void 0 === n.ctx.createGain
            ? n.ctx.createGainNode()
            : n.ctx.createGain()),
        n.masterGain.gain.setValueAtTime(n._muted ? 0 : 1, n.ctx.currentTime),
        n.masterGain.connect(n.dynamicsCompressorNode)),
        n._setup();
    };
