  ...
  return (
    (a.copy = (function () {
      ...
      function e() {
        ...
        if (!document.queryCommandEnabled("copy") && a.isCollapsed) {
          ...
          b.selectNodeContents(document.body),
            a.removeAllRanges(),
            a.addRange(b),
            (c = !0);
        }
    ...
    (a.paste = (function () {
      var b,
        ...
        a = !1;
      return (
        document.addEventListener("paste", function (d) {
          if (a) {
    ...
    "undefined" == typeof ClipboardEvent &&
      "undefined" != typeof window.clipboardData &&
      "undefined" != typeof window.clipboardData.setData &&
      (!(function (a) {
        function b(a, b) {
          return function () {
            a.apply(b, arguments);
