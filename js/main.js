...
(function () {
  ...
  _pio.channel.prototype.call = function (a, c, b, e, d) {
    ...
    var h = Error();
    null != g
      ? (g.send("[" + a + "|" + (this.token || "") + "]" + JSON.stringify(c)),
        (g.onload = function () {
          var l = null;
          try {
            ...
            _pio.handleError(
              ...
              "Error decoding response from webservice: " + n
            );
            return;
          }
          if (
  ...
  _pio.error = function (a, c) {
    ...
    if ("string" != typeof a)
      throw (console.log(a, c, Error().stack), "Code must be a string!");
    var b = Error();
  ...
  _pio.convertFromKVArray = function (a) {
    var c = {};
    if (a && a.length) for (var b in a) c[a[b].key] = a[b].value;
    return c;
  };
  _pio.convertToSegmentArray = function (a) {
    var c = [];
    if (a) for (var b in a) c.push(b + ":" + a[b]);
    return c;
  };
})();
PlayerIO = {
...
(function () {
    ...
    switch (typeof r) {
      ...
      case "object":
        ...
        if ("[object Array]" === Object.prototype.toString.apply(r)) {
          var v = r.length;
          for (n = 0; n < v; n += 1) z[n] = b(n, r) || "null";
          var t =
            0 === z.length
              ? "[]"
              : f
  ...
  "function" !== typeof JSON.stringify &&
    (JSON.stringify = function (k, m, n) {
      var p;
      g = f = "";
      if ("number" === typeof n) for (p = 0; p < n; p += 1) g += " ";
      else "string" === typeof n && (g = n);
      if (
        (l = m) &&
        "function" !== typeof m &&
  ...
  function a(h) {
    if (null != d) h(d);
      ...
      var k = function (m) {
        ...
        f = null == m;
        clearInterval(l);
        for (var n = 0; n != g.length; n++) g[n](m);
      };
    } else g.push(h);
  }
  function c() {
  ...
  _pio.flashSocketConnection = function (h, l, k, m, n) {
    var p = "cb" + e++,
      ...
      B = setTimeout(function () {
        v || ((v = !0), k(!1, "Connect attempt timed out"));
      }, l);
      ...
      null == w
        ...
        : ((b[p] = function (y, q) {
            switch (y) {
              case "onopen":
                v ||
                  (clearTimeout(B), (t = v = !0), w.socketSend(p, [0]), k(t));
                break;
              case "onclose":
                r.disconnect();
                break;
  ...
  _pio.gameFS = function (c, b) {
    ...
    this.getUrl = function (h, l) {
      ...
      return k
        ...
        : (l ? "https" : "http") + "://r.playerio.com/r/" + c + h;
    };
  };
})();
(function () {
  ...
  _pio.payVault = function (a) {
    ...
    this.has = function (d) {
      ...
      for (var f = 0; f != this.items.length; f++)
        if (this.items[f].itemKey == d) return !0;
      return !1;
    };
    this.first = function (d) {
      ...
      for (var f = 0; f != this.items.length; f++)
        if (this.items[f].itemKey == d) return this.items[f];
      return null;
    };
  ...
  _pio.bigDB = function (a) {
    ...
    this.saveChanges = function (f, g, h, l, k, m) {
      ...
      for (var p in h) {
        var r = h[p];
        if (
          !(r.existsInDatabase && r.key && r.table && r._internal_ && r.save)
        ) {
          f = _pio.error(
        ...
        var z = _pio.compareForChanges(
          g ? {} : r._internal_("get-dbCurrent"),
          r,
          !0,
          !0
        );
                ...
                function (t) {
                  for (var B = 0; B != v.objects.length; B++) {
                    ...
                    for (var y = 0; y != v.futureSaves.length; y++)
                      for (
                        var q = v.futureSaves[y], u = 0;
                        u < q.objects.length;
                        u++
                      )
                        q.objects[u] == w &&
                          (q.changesets.splice(u, 1),
...
(function () {
            ...
            for (var p = 0; p != m.rooms.length; p++) {
              ...
              n.push(
                new _pio.roomInfo(
                  ...
                  r.roomtype,
                  r.onlineusers,
                  _pio.convertFromKVArray(r.roomdata)
                )
              );
            }
          return n;
      ...
      if (p)
        if (b) {
          ...
          t.onloadend = function () {
            for (
              var B = new Uint8Array(t.result), w = Array(B.length), y = 0;
              y != B.length;
              y++
            )
              w[y] = B[y];
    ...
    this.sendMessage = function (v) {
      ...
      if (b) {
        for (var t = new Uint8Array(v.length), B = 0; B < v.length; B++)
          t[B] = v[B];
        r.send(t.buffer);
      } else (v = _pio.base64encode(v)), r.send(v);
    };
  };
  _pio.connection = function (b, e, d, f, g, h, l, k) {
          ...
          var L = y(
            ...
            function (J, M) {
              if (J) {
                ...
                O.addString(g);
                if (null != h)
                  for (var U in h) O.addString(U), O.addString("" + h[U]);
                n.sendMessage(O);
              } else
                _pio.debugLog(
            ...
            function (J) {
              p
                ? "playerio.joinresult" == J.type
                  ? ((p = !1),
                    J.getBoolean(0)
                      ? _pio.runCallback(l, n, null)
                      : _pio.handleError(b, k, J.getInt(1), J.getString(2)))
                  : _pio.handleError(
                      b,
                      k,
                      PlayerIOErrorCode.GeneralError,
    ...
    (window.FileReader && "WebKit" == w && 535 <= B) ||
    ("Firefox" == w && 11 <= B) ||
    ("Trident" == w && 6 <= B)
      ? m(function (y, q, u, A, F, C) {
  ...
  _pio.message = function (b) {
    function e(m, n, p, r) {
      if (m) k.push(n), l.push(p), (h.length = k.length);
      else throw _pio.error("The given value (" + n + ") is not " + r);
    }
    function d(m, n) {
      if (m > k.length)
        throw _pio.error(
    ...
    this.add = function () {
      for (var m = 0; m < arguments.length; m++) {
        ...
        switch (typeof n) {
          ...
          default:
            throw _pio.error(
              "The type of the value (" + n + ") cannot be inferred"
            );
        }
      }
    };
  ...
  _pio.byteWriter = function () {
    ...
    this.writeBottomPatternAndBytes = function (b, e) {
      ...
      this.writeByte(b | d);
      for (d = e.length - d - 1; d != e.length; d++) this.writeByte(e[d]);
    };
    this.writeLongPattern = function (b, e, d) {
      ...
      for (g = d.length - f - 1; g != d.length; g++) this.writeByte(d[g]);
    };
  };
  _pio.messageSerializer = function () {
    this.serializeMessage = function (b) {
      ...
      for (var f = 0; f != b.length; f++)
        switch (
          ((d = b._internal_("get-objects")[f]), b._internal_("get-types")[f])
        ) {
          case 6:
          ...
          case 1:
            e.writeBottomPatternAndBytes(
              8,
              _pio.binaryserializer.bytesFromUInt(d)
            );
            break;
          case 2:
          ...
          case 192:
            null == d
              ? ((d = new _pio.message(
                ...
                g++)
              : d.addString(_pio.binaryserializer.stringFromBytes(b, f, h));
            break;
          case 4:
  ...
  _pio.binaryserializer = {
    ...
    _floatEncode: function (b, e, d) {
      ...
      g = (g << e) | b;
      for (d += e; 8 <= d; ) h.push(g & 255), (g >>>= 8), (d -= 8);
      h.push((f << d) | g);
      h.reverse();
      return h;
    },
    bytesFromString: function (b) {
      for (var e = [], d = 0; d < b.length; d++)
        if (127 >= b.charCodeAt(d)) e.push(b.charCodeAt(d));
        else
          for (
            var f = encodeURIComponent(b.charAt(d)).substr(1).split("%"), g = 0;
            g < f.length;
            g++
          )
    ...
    _float32Decode: function (b, e) {
      ...
      return 128 === g
        ...
        : -127 === g
        ? f * d * this.pow2(-149)
        : f * (1 + d * this.pow2(-23)) * this.pow2(g);
    },
    _float64Decode: function (b, e) {
      ...
      return 1024 === g
        ...
        : -1023 === g
        ? f * d * this.pow2(-1074)
        : f * (1 + d * this.pow2(-52)) * this.pow2(g);
    },
  ...
  _pio.achievements = function (a) {
    ...
    this.get = function (d) {
      ...
      for (var f = 0; f < e.myAchievements.length; f++)
        if (e.myAchievements[f].id == d) return e.myAchievements[f];
      return null;
    };
    this.refresh = function (d, f) {
    ...
    this.load = function (d, f, g) {
      "object" == typeof d || requests.length
        ? a.achievementsLoad(d, f, g, function (h) {
            if (null == h || 0 == h.length) return {};
            for (var l = {}, k = 0; k < h.userachievements.length; k++) {
              for (
                var m = h.userachievements[k], n = [], p = 0;
                p < m.achievements.length;
                p++
              ) {
        ...
        for (var m = [], n = 0; n < k.leaderboardentry.length; n++)
          m.push(
            new _pio.leaderboardEntry(
              k.leaderboardentry[n].userid,
              k.leaderboardentry[n].rank,
              k.leaderboardentry[n].score
            )
          );
        return m;
      });
  ...
  _pio.oneScore = function (a) {
    ...
    this.refresh = function (b, e) {
      a.oneScoreRefresh(b, e, function (d) {
        d = new _pio.oneScoreValue(
          d.onescore.percentile,
          d.onescore.score,
          d.onescore.toprank
        );
...
(function () {
  _pio.notifications = function (a) {
    ...
    this.registerEndpoint = function (f, g, h, l, k, m) {
      ...
      (p = null == n || n.enabled != l) ||
        (p = JSON.stringify(n.configuration) != JSON.stringify(h));
      p
    ...
    this.toggleEndpoints = function (f, g, h, l) {
      f = b(f);
      0 < f.length
        ? a.notificationsToggleEndpoints(d, f, g ? !0 : !1, h, l, c)
        : h && h();
    };
    ...
    this.send = function (f, g, h) {
      for (var l = [], k = 0; k != f.length; k++) {
        ...
        (0 != (n.recipient + "").length && 0 != (n.endpointtype + "").length) ||
          console.log("error");
        for (var p in m)
      ...
      a.payVaultPaymentInfo(
        ...
        function (f) {
          _pio.showDialog("buy", a, f, function (g) {
            g.error
              ? d(new PlayerIOError(PlayerIOErrorCode.GeneralError, g.error))
              : e(g);
          });
        },
        d,
...
(function () {
  _pio.publishingNetworkRelations = function (a, c, b) {
    ...
    this.isFriend = function (e) {
      if (
        "undefined" != typeof _pio.friendLookup &&
        "undefined" != typeof _pio.friendLookup[c]
      )
    ...
    this.isBlocked = function (e) {
      if (
        ...
        "undefined" != typeof _pio.blockedLookup[c]
      )
...
(function () {
  ...
  function e(w, y) {
    for (var q in w) v.call(w, q) && y(w[q], q, w);
  }
  function d(w) {
  ...
  function f(w, y) {
    ...
    return (
      !/^(?:boolean|number|string|undefined)$/.test(q) &&
      ("object" == q ? !!w[y] : !0)
    );
  }
  function g(w) {
  ...
  function l(w) {
    function y(N) {
      return h(N, function (K, I) {
        ...
        !K &&
          (K =
            RegExp("\\b" + P + " *\\d+[.\\w_]*", "i").exec(w) ||
            RegExp("\\b" + P + " *\\w+-[\\w]*", "i").exec(w) ||
            RegExp(
              "\\b" + P + "(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)",
              "i"
            ).exec(w)) &&
          ((K = String(
            I.label && !RegExp(P, "i").test(I.label) ? I.label : K
          ).split("/"))[1] &&
            !/[\d.]+/.test(K[0]) &&
            (K[0] += " " + K[1]),
          (I = I.label || I),
    ...
    var ca = O ? "a" : "\u03b1",
      da = O ? "b" : "\u03b2",
      Y = u.document || {},
      S = u.operamini || u.opera,
      V = z.test((V = A && S ? S["[[Class]]"] : d(S))) ? V : (S = null),
      x,
      W = w;
    A = [];
    var X = null,
    ...
    var G = (function (N) {
        return h(N, function (K, I) {
          return (
            K ||
            (RegExp("\\b" + (I.pattern || g(I)) + "\\b", "i").exec(w) &&
              (I.label || I))
          );
        });
      })([
    ...
    "IE" == D && /\blike iPhone OS\b/.test(w)
      ...
      : "Konqueror" != D || /buntu/i.test(E)
      ? (Q &&
          "Google" != Q &&
          ((/Chrome/.test(D) && !/\bMobile Safari\b/i.test(w)) ||
            /\bVita\b/.test(H))) ||
        (/\bAndroid\b/.test(E) && /^Chrome/.test(D) && /\bVersion\//i.test(w))
        ? ((D = "Android Browser"), (E = /\bAndroid\b/.test(E) ? E : "Android"))
        : "Silk" == D
        ? (/\bMobi/i.test(w) || ((E = "Android"), A.unshift("desktop mode")),
          /Accelerated *= *true/i.test(w) && A.unshift("accelerated"))
        : "PaleMoon" == D && (x = /\bFirefox\/([\d.]+)\b/.exec(w))
        ? A.push("identifying as Firefox " + x[1])
        : "Firefox" == D && (x = /\b(Mobile|Tablet|TV)\b/i.exec(w))
        ? (E || (E = "Firefox OS"), H || (H = x[1]))
        : !D ||
          (x = !/\bMinefield\b/i.test(w) && /\b(?:Firefox|Safari)\b/.exec(D))
        ? (D &&
            !H &&
            /[\/,]|^[^(]+?\)/.test(w.slice(w.indexOf(x + "/") + 8)) &&
            (D = null),
          (x = H || Q || E) &&
            (H || Q || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(E)) &&
            (D =
              /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(E) ? E : x) +
              " Browser"))
        : "Electron" == D &&
    ...
    if (
      (x =
        ("iCab" == G && 3 < parseFloat(C) && "WebKit") ||
        (/\bOpera\b/.test(D) && (/\bOPR\b/.test(w) ? "Blink" : "Presto")) ||
        (/\b(?:Midori|Nook|Safari)\b/i.test(w) &&
          !/^(?:Trident|EdgeHTML)$/.test(G) &&
          "WebKit") ||
        (!G && /\bMSIE\b/i.test(w) && ("Mac OS" == E ? "Tasman" : "Trident")) ||
        ("WebKit" == G && /\bPlayStation\b(?! Vita\b)/i.test(D) && "NetFront"))
    )
      G = [x];
    "IE" == D && (x = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(w) || 0)[1])
      ? ((D += " Mobile"),
      ...
      ? ((D = "IE Mobile"),
        (E = "Windows Phone 8.x"),
        A.unshift("desktop mode"),
        C || (C = (/\brv:([\d.]+)/.exec(w) || 0)[1]))
      : "IE" != D &&
        "Trident" == G &&
        (x = /\brv:([\d.]+)/.exec(w)) &&
        (D && A.push("identifying as " + D + (C ? " " + C : "")),
        (D = "IE"),
        (C = x[1]));
    if (T) {
      if (f(u, "global"))
        if (
          ...
          try {
            (C = u.require("ringo/engine").version.join(".")), (D = "RingoJS");
          } catch (N) {
            (x = u.system) &&
              x.global.system == u.system &&
              ((D = "Narwhal"), E || (E = x[0].os || null));
          }
          D || (D = "Rhino");
        } else
          "object" == typeof u.process &&
            ...
            ("object" == typeof x.versions &&
              ("string" == typeof x.versions.electron
                ? (A.push("Node " + x.versions.node),
                  (D = "Electron"),
                  (C = x.versions.electron))
                : "string" == typeof x.versions.nw &&
                  (A.push("Chromium " + C, "Node " + x.versions.node),
                  (D = "NW.js"),
                  (C = x.versions.nw))),
            D ||
              ((D = "Node.js"),
        ...
        d((x = u.runtime)) == J
          ? ((D = "Adobe AIR"), (E = x.flash.system.Capabilities.os))
          : d((x = u.phantom)) == U
          ? ((D = "PhantomJS"),
            (C =
              (x = x.version || null) &&
          ...
          ? ((C = [C, Y.documentMode]),
            (x = +x[1] + 4) != C[1] &&
              (A.push("IE " + C[1] + " mode"), G && (G[1] = ""), (C[1] = x)),
            (C = "IE" == D ? String(C[1].toFixed(1)) : C[0]))
          : "number" == typeof Y.documentMode &&
            /^(?:Chrome|Firefox)\b/.test(D) &&
            (A.push("masking as " + D + " " + C),
            (D = "IE"),
            (C = "11.0"),
            (G = ["Trident"]),
            (E = "Windows"));
    ...
    C &&
      (x =
        ...
        /(?:alpha|beta)(?: ?\d)?/i.exec(w + ";" + (T && F.appMinorVersion)) ||
        (/\bMinefield\b/i.test(w) && "a")) &&
      ((X = /b/i.test(x) ? "beta" : "alpha"),
      (C =
        C.replace(RegExp(x + "\\+?$"), "") +
        ("beta" == X ? da : ca) +
        (/\d+\+?/.exec(x) || "")));
    if (
      "Fennec" == D ||
      ("Firefox" == D && /\b(?:Android|Firefox OS)\b/.test(E))
    )
      D = "Firefox Mobile";
    else if ("Maxthon" == D && C) C = C.replace(/\.[\d.]+/, ".x");
    else if (/\bXbox\b/i.test(H))
      "Xbox 360" == H && (E = null),
        "Xbox 360" == H && /\bIEMobile\b/.test(w) && A.unshift("mobile mode");
    else if (
      (!/^(?:Chrome|IE|Opera)$/.test(D) &&
        (!D || H || /Browser|Mobi/.test(D))) ||
      ("Windows CE" != E && !/Mobi/i.test(w))
    )
      if ("IE" == D && T)
        try {
        ...
        (/\bBlackBerry\b/.test(H) || /\bBB10\b/.test(w)) &&
        (x =
          (RegExp(H.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(w) ||
            0)[1] || C)
          ? ((x = [x, /BB10/.test(w)]),
            (E =
              (x[1] ? ((H = null), (Q = "BlackBerry")) : "Device Software") +
              " " +
              x[0]),
            (C = null))
          : this != e &&
            "Wii" != H &&
            ((T && S) ||
              (/Opera/.test(D) && /\b(?:MSIE|Firefox)\b/i.test(w)) ||
              ("Firefox" == D && /\bOS X (?:\d+\.){2,}/.test(E)) ||
              ("IE" == D &&
                ((E && !/^Win/.test(E) && 5.5 < C) ||
                  (/\bWindows XP\b/.test(E) && 8 < C) ||
                  (8 == C && !/\bTrident\b/.test(w))))) &&
            !z.test((x = l.call(e, w.replace(z, "") + ";"))) &&
            x.name &&
            ((x = "ing as " + x.name + ((x = x.version) ? " " + x : "")),
            z.test(D)
              ? (/\bIE\b/.test(x) && "Mac OS" == E && (E = null),
                (x = "identify" + x))
              : ((x = "mask" + x),
    ...
    if ((x = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(w) || 0)[1])) {
      ...
      if ("Safari" == D && "+" == x[1].slice(-1))
        (D = "WebKit Nightly"), (X = "alpha"), (C = x[1].slice(0, -1));
      else if (
        C == x[1] ||
        C == (x[2] = (/\bSafari\/([\d.]+\+?)/i.exec(w) || 0)[1])
      )
        C = null;
    ...
    "Opera" == D && (x = /\bzbov|zvav$/.exec(E))
      ? ((D += " "),
        A.unshift("desktop mode"),
        "zvav" == x ? ((D += "Mini"), (C = null)) : (D += "Mobile"),
        (E = E.replace(RegExp(" *" + x + "$"), "")))
      : "Safari" == D &&
        /\bChrome\b/.exec(G && G[1]) &&
        (A.unshift("desktop mode"),
        (D = "Chrome Mobile"),
        (C = null),
        /\bOS X\b/.test(E) ? ((Q = "Apple"), (E = "iOS 4.3+")) : (E = null));
    C &&
      0 == C.indexOf((x = /[\d.]+$/.exec(E))) &&
      -1 < w.indexOf("/" + x + "-") &&
      (E = String(E.replace(x, "")).replace(/^ +| +$/g, ""));
    G &&
      !/\b(?:Avant|Nook)\b/.test(D) &&
      (/Browser|Lunascape|Maxthon/.test(D) ||
        ("Safari" != D && /^iOS/.test(E) && /\bSafari\b/.test(G[1])) ||
    ...
    if (E) {
      var ba =
        (x = / ([\d.+]+)$/.exec(E)) &&
        "/" == E.charAt(E.length - x[0].length - 1);
      E = {
        architecture: 32,
    ...
    (x = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(W)) && !/\bi686\b/i.test(W)
      ? (E &&
          ((E.architecture = 64),
    ...
    E &&
      D &&
      (E != String(E).split(" ")[0] || (E != D.split(" ")[0] && !H)) &&
      A.push(H ? "(" + E + ")" : "on " + E);
...
function sizeHandler() {
  ...
  if ($("#canvas")) {
    ...
    if (b < a) {
      ...
      e < c &&
        ((d = c - e), (e += d), (b += (CANVAS_HEIGHT / CANVAS_WIDTH) * d));
    d = a / 2 - b / 2;
    var f = c / 2 - e / 2,
      g = CANVAS_WIDTH / e;
...
function createBitmap(a, c, b) {
  ...
  c && b
    ? d.graphics.beginFill("#fff").drawRect(0, 0, c, b)
...
function calculateIntersection(a, c) {
  ...
  h = Math.abs(h - k) - (e + f);
  return 0 > g && 0 > h
    ? ((g = Math.min(Math.min(a.width, c.width), -g)),
  ...
  onEvent: function (a) {
    switch (a.name) {
      ...
      case "SDK_GAME_START":
        ...
        break;
      case "SDK_GAME_PAUSE":
        (s_bAdShown = !0), s_oMain && s_oMain.stopUpdate();
    }
  },
};
(function (a, c, b) {
...
function CTextButton(a, c, b, e, d, f, g, h) {
  ...
  this.disable = function () {
    l = !0;
    var q = new createjs.ColorMatrix()
...
!(function () {
  function a(d) {
          ...
          if (h[2]) {
            ...
            if (null !== (p = b.key.exec(n)))
              for (m.push(p[1]); "" !== (n = n.substring(p[0].length)); )
                if (null !== (p = b.key_access.exec(n))) m.push(p[1]);
                else if (null !== (p = b.index_access.exec(n))) m.push(p[1]);
                else
    ...
    var r, z;
    for (n = 0; n < l; n++)
      if ("string" === typeof f[n]) m += f[n];
      else if ("object" === typeof f[n]) {
        p = f[n];
        if (p.keys)
          for (k = g[h], r = 0; r < p.keys.length; r++) {
            if (void 0 == k)
              throw Error(
                a(
        ...
        else k = p.param_no ? g[p.param_no] : g[h++];
        b.not_type.test(p.type) &&
          b.not_primitive.test(p.type) &&
        ...
        switch (p.type) {
          ...
          case "e":
            k = p.precision
              ? parseFloat(k).toExponential(p.precision)
              : parseFloat(k).toExponential();
            break;
          case "f":
            k = p.precision
              ? parseFloat(k).toFixed(p.precision)
              : parseFloat(k);
            break;
          case "g":
            k = p.precision
              ? String(Number(k.toPrecision(p.precision)))
              : parseFloat(k);
            break;
          case "o":
        ...
        if (b.json.test(p.type)) m += k;
        else {
          if (!b.number.test(p.type) || (z && !p.sign)) var v = "";
          else (v = z ? "+" : "-"), (k = k.toString().replace(b.sign, ""));
          r = p.pad_char
            ? "0" === p.pad_char
              ? "0"
              : p.pad_char.charAt(1)
  ...
  "undefined" !== typeof exports &&
    ((exports.sprintf = a), (exports.vsprintf = c));
...
var CCTLMultiplayerGui = function () {
  ...
  jQuery(document).on(
    ...
    function () {
      var c = jQuery(this)
          .find("." + g_oCTLMultiplayer._cssClassDomain + "room-name")
          .text(),
      ...
      "false" !== b &&
        ...
        "true" === e
          ? g_oCTLMultiplayer.showTypeRoomPassword(c)
...
CCTLMultiplayerGui.prototype.refreshRoomList = function (a) {
  for (var c = "", b = 0; b < a.length; b++)
    (c +=
      ...
      (c =
        !0 === a[b]["private"]
          ? c + ('<i class="' + this._cssClassDomain + 'icons-lock"></i>')
          : !1 === a[b].accessible
          ? c + ('<i class="' + this._cssClassDomain + 'icons-block"></i>')
          : c + ('<i class="' + this._cssClassDomain + 'icons-login"></i>')),
      (c += "</li>");
...
CCTLMultiplayerGui.prototype.updateRoomUserList = function (a, c) {
  ...
  if (0 < b.length) {
    b.html("");
    for (var e = 0; e < a.length; e++) b.append("<li>" + a[e] + "</li>");
    b = TEXT_WAITING_ROOM_MESSAGE.replace("%d", c);
    jQuery("." + this._cssClassDomain + "room-info").text(b);
    0 < jQuery("." + this._cssClassDomain + "room-play-now").length &&
      (1 === a.length
        ? jQuery("." + this._cssClassDomain + "room-play-now").addClass(
            this._cssClassDomain + "display-none"
          )
        : jQuery("." + this._cssClassDomain + "room-play-now").removeClass(
            this._cssClassDomain + "display-none"
          ));
  }
};
CCTLMultiplayerGui.prototype.showWaitingPlayersInRoom = function (a, c, b) {
  ...
  e +=
    ...
    this._cssClassDomain +
    "user-list'>";
  for (a = 0; a < c.length; a++) e += "<li>" + c[a] + "</li>";
  e += "</ul>";
...
function CNetworkManager() {
  ...
  this.connectToSystem = function () {
    a
      ? (y.addEventListener(ON_LOGIN_SUCCESS, y.gotoLobby, y),
        g_oCTLMultiplayer.showChooseNickName())
      : y.showErrorMessage(TEXT_NO_CONNECTION);
  };
  ...
  this._onConnectionChangeStatusOffline = function () {
    ...
    0 < jQuery(".ctl-multiplayer-dlg-content").length &&
      (y.showErrorMessage(TEXT_NO_CONNECTION), y.disconnect());
  };
  this._onReconnection = function () {
    null === r || void 0 === r
      ? (g_oCTLMultiplayer.closeAllDialog(), y.connectToSystem())
      : (g_oCTLMultiplayer.closeAllDialog(), y.gotoLobby());
  };
  ...
  this.callbackError = function (q) {
    ...
    c[ON_CONNECTION_ERROR] &&
      c[ON_CONNECTION_ERROR].call(b[ON_CONNECTION_ERROR], q);
  ...
  this.callbackDisconnectFromMatch = function (q) {
    ...
    c[ON_DISCONNECTION_FROM_MATCH] &&
      c[ON_DISCONNECTION_FROM_MATCH].call(b[ON_DISCONNECTION_FROM_MATCH], q);
  };
    ...
    g.multiplayer.createJoinRoom(
      ...
      function (F) {
        ...
        c[ON_USEROWNERROOM_CREATE_SUCCESS] &&
          c[ON_USEROWNERROOM_CREATE_SUCCESS].call(
  ...
  this.joinRoom = function (q) {
    ...
    g.multiplayer.joinRoom(
      ...
      function (u) {
        ...
        c[ON_USEROWNERROOM_JOIN_SUCCESS] &&
          c[ON_USEROWNERROOM_JOIN_SUCCESS].call(
  ...
  this.gotoGameRoom = function (q) {
    ...
    for (var F = 0; F < A.length; F++)
      (z[F] = A[F].nickname), (v[F] = A[F].avatar);
    m = A.length;
    g.multiplayer.createJoinRoom(
      u,
      ROOM_TYPE_GAME,
      ...
      function (C) {
        ...
        c[ON_GAMEROOM_CONNECTION_SUCCESS] &&
          c[ON_GAMEROOM_CONNECTION_SUCCESS].call(
  ...
  this.gotoMatchMakingRoom = function () {
    ...
    g.multiplayer.createJoinRoom(
      ...
      function (q) {
        ...
        c[ON_MATCHMAKING_CONNECTION_SUCCESS] &&
          c[ON_MATCHMAKING_CONNECTION_SUCCESS].call(
  ...
  this._addBotInRoom = function () {
    COMBINED_PLAYERS_MODE &&
      (y.sendMsg(MSG_ADDBOT, y.generateRandomName() + "-bot"),
      jQuery(".ctl-multiplayer-room-add-bot").addClass(
        "ctl-multiplayer-display-none"
      ),
      jQuery(".ctl-multiplayer-room-remove-bot").addClass(
        "ctl-multiplayer-display-none"
      ));
  };
  this._removeBotInRoom = function () {
    COMBINED_PLAYERS_MODE &&
      (y.sendMsg(MSG_REMOVEBOT, ""),
      jQuery(".ctl-multiplayer-room-add-bot").addClass(
        "ctl-multiplayer-display-none"
      ),
      jQuery(".ctl-multiplayer-room-remove-bot").addClass(
  ...
  this.onBotAdded = function (q) {
    COMBINED_PLAYERS_MODE &&
      ...
      jQuery(".ctl-multiplayer-room-remove-bot").removeClass(
        "ctl-multiplayer-display-none"
      ));
  };
  ...
  this._onDisconnectFromARoom = function () {
    c[ON_BACK_FROM_A_ROOM] &&
      c[ON_BACK_FROM_A_ROOM].call(b[ON_BACK_FROM_A_ROOM]);
    g_oCTLMultiplayer.closeAllDialog();
  ...
  this._onRoomCreated = function () {
    ...
    g_oCTLMultiplayer.showWaitingPlayersInRoom(
      TEXT_WAITING_FOR_PLAYERS_IN_ROOM + t,
      [r],
      A
    );
  };
  ...
  this._onFinalUpdateRoomList = function () {
    ...
    0 < jQuery(".ctl-multiplayer-room-list").length
      ? g_oCTLMultiplayer.refreshRoomList(q)
      : this._showLobby(q);
  };
  ...
  this._getCombinedRoomsLists = function () {
    for (var q = [], u = 0; u < e.length; u++) q.push(e[u]);
    for (u = 0; u < d.length; u++) q.push(d[u]);
    return q;
  };
  ...
  this._checkUserPermissionToJoin = function (q) {
    0 < q.length
      ? y.joinRoom(q[0].roomData.id, q[0].roomData.pass)
      : (g_oCTLMultiplayer.closeAllDialog(),
        g_oCTLMultiplayer.showGeneralDialog(
          TEXT_WRONG_PASSWORD,
  ...
  this.getRoomInfo = function (q, u) {
    g.multiplayer.listRooms(
      ...
      0,
      0,
      y._onRoomInfoReturned,
      y.callbackError
    );
  };
  this._onRoomInfoReturned = function (q) {
    c[ON_ROOM_INFO_RETURNED] &&
      c[ON_ROOM_INFO_RETURNED].call(b[ON_ROOM_INFO_RETURNED], q);
  };
  this._init();
}
...
function CNetworkMessageForwarder() {
  ...
  this._onGameStart = function (c) {
    ...
    console.log(c);
    if (s_oMenu) s_oMenu.onRemoteGameStart(b);
  ...
  this._onNextMatchResults = function (c) {
    if (c.getBoolean(0)) s_oGame.onOpponentAcceptNextMatch();
    else s_oGame.onOpponentRefuseNextMatch();
  };
  this._onRematchResults = function (c) {
    if (c.getBoolean(0)) s_oGame.onOpponentAcceptRematch();
          ...
          onplayerror: function (m) {
            for (var n = 0; n < s_aSoundsInfo.length; n++)
              if (m === s_aSounds[s_aSoundsInfo[n].ingamename]._sounds[0]._id) {
                s_aSounds[s_aSoundsInfo[n].ingamename].once(
                  "unlock",
                  function () {
...
function CTurnManager() {
  ...
  this.prevTurn = function () {
    !0 === a
      ? (b--, (c = b + 1), 0 > b && ((b = NUM_PLAYERS - 1), (c = 0)))
      : (b++,
        (c = b - 1),
        b === NUM_PLAYERS && ((b = 0), (c = NUM_PLAYERS - 1)));
  };
...
function CMenu() {
  ...
  this.refreshButtonPos = function () {
    ...
    (!1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile) ||
      l.setPosition(b - s_iOffsetX, s_iOffsetY + e);
...
function CSelectPlayers() {
  ...
  this.refreshButtonPos = function () {
    (!1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile) ||
      m.setPosition(b - s_iOffsetX, s_iOffsetY + e);
...
function CDeckDisplayer(a, c, b, e) {
  ...
  this.initializeDeck = function () {
    for (var n, p = 0, r = 0; 4 > r; r++)
      for (var z = 0; 10 > z; z++)
        (n = z), d.push(new CCard(0, 0, f, "card_" + r + "_" + z, n, r, p++));
    for (r = 0; 4 > r; r++)
      for (z = 0; 9 > z; z++)
        (n = z + 1),
  ...
  this.clearCards = function () {
    for (var n = 0; n < d.length; n++) d[n].unload();
    d = [];
  };
...
function CHandDisplayer(a, c, b, e, d, f, g, h) {
  ...
  this.setPosition = function (q, u, A, F, C) {
    ...
    switch (C) {
      ...
      case LEFT:
        ...
        break;
      case RIGHT:
        (L = p.x - 110), (J = p.y), z.setPosition(p.x - 20, p.y, m);
    }
    r.setPosition(L, J, m);
  };
  this.clearCards = function () {
    for (var q = 0; q < n.length; q++) n[q].unload();
    n = [];
  };
  this.getGlobalPosition = function () {
  ...
  this.searchIndexCard = function (q) {
    for (var u = 0; u < n.length; u++) if (q === n[u]) return u;
  };
  ...
  this.organizeHand = function (q) {
    ...
    if (0 !== l)
      for (var A = 0; A < n.length; A++)
        (q = l * A),
          createjs.Tween.get(n[A].getSprite())
            .to(
              {
                x: q,
              },
  ...
  this.checkUno = function () {
    1 === n.length &&
      ...
      0 !== l
        ? p.y < CANVAS_HEIGHT / 2
          ? (v.gotoAndStop("cloud2"),
            (v.x = CANVAS_WIDTH / 2 - 270),
            (v.y = CANVAS_HEIGHT / 2 - 300))
          : (v.gotoAndStop("cloud1"),
            (v.x = CANVAS_WIDTH / 2 + 300),
            (v.y = CANVAS_HEIGHT / 2 + 100))
        : p.x < CANVAS_WIDTH / 2
        ? (v.gotoAndStop("cloud1"),
          (v.x = CANVAS_WIDTH / 2 - 350),
          (v.y = CANVAS_HEIGHT / 2 - 30))
        : (v.gotoAndStop("cloud2"),
          (v.x = CANVAS_WIDTH / 2 + 350),
          (v.y = CANVAS_HEIGHT / 2 - 200)),
      s_oStage.addChild(v),
      new createjs.Tween.get(v)
        .to(
          {
            alpha: 1,
            scaleX: 1,
  ...
  this.showAllCards = function () {
    for (var q = 0; q < n.length; q++) n[q].showCard();
  };
  ...
  this.getCardByUniqueID = function (q) {
    for (var u = 0; u < n.length; u++)
      if (n[u].getUniqueID() === q) return n[u];
  };
...
CGameBase.prototype._init = function () {
  ...
  for (var c = 0; c < NUM_PLAYERS; c++) {
    var b = 0,
      e = 0;
    HAND_POS["num_player_" + NUM_PLAYERS][c].x === CANVAS_WIDTH / 2
      ? (b = CARD_WIDTH / 2)
      : (e = CARD_HEIGHT / 4);
    this._aPlayersHand[c] = new CHandDisplayer(
      b,
      e,
      HAND_POS["num_player_" + NUM_PLAYERS][c].x,
      HAND_POS["num_player_" + NUM_PLAYERS][c].y,
      c,
      this._oHandsContainer,
      a[c],
      HAND_POS["num_player_" + NUM_PLAYERS][c].side
    );
  }
...
CGameBase.prototype.onCardDealed = function (a) {
  ...
  this._aPlayersHand[c].pushCard(
    new CCard(
      this._aPlayersHand[c].getPosNewCard().x,
      this._aPlayersHand[c].getPosNewCard().y,
      this._aPlayersHand[c].getContainer(),
      a.getFotogram(),
      a.getRank(),
      a.getSuit(),
      a.getUniqueID()
...
CGameBase.prototype.cardCanBePlayed = function (a, c) {
  if (a.getFotogram() === FOTOGRAM_DRAW_FOUR) {
    ...
    for (var e = 0; e < this._aPlayersHand[c].getLength(); e++) {
      ...
      if (
        d.getFotogram() !== FOTOGRAM_DRAW_FOUR &&
        (d.getRank() === this._oUsedCards.getLastCard().getRank() ||
          d.getSuit() === this._iCurrentColor ||
          d.getFotogram() === FOTOGRAM_COLOR)
      ) {
        b = !0;
        break;
      }
...
CGameBase.prototype.cardMatchTheWaste = function (a) {
  var c = !1;
  if (
    a.getRank() === this._oUsedCards.getLastCard().getRank() ||
    a.getSuit() === this._iCurrentColor ||
    a.getFotogram() === FOTOGRAM_COLOR ||
    a.getFotogram() === FOTOGRAM_DRAW_FOUR
  )
    c = !0;
  return c;
};
...
CGameBase.prototype._showAllPlayersMatchScore = function () {
  for (var a = 0; a < this._aPlayersHand.length; a++) {
    ...
    0 < this._aPlayersHand[a].getLength()
      ? this._aPlayersHand[a].showHandScore(sprintf(TEXT_PTS_TO_WINNER, c))
...
CGameSingle.prototype.onNextTurn = function () {
  ...
  null !== a
    ? (this.gameOver(a),
      0 === a && $(s_oMain).trigger("save_score", this._calculateMatchScore()))
    : (this.setOffTurn(),
      this._oDeck.enableInputDraw(),
      this._oTurnManager.nextTurn(),
      ...
      0 === a
        ...
        : this._oAIManager.selectACard(a));
};
...
CGameSingle.prototype._applySelectColor = function () {
  if (0 === this._iCurPlayer)
    new CSelectColorPanel(EFFECT_SELECT_COLOR).addEventListener(
      ON_COLOR_SELECTED,
      function (c) {
...
CGameSingle.prototype._applyDrawThreeEffect = function () {
  if (0 === this._iCurPlayer)
    new CSelectColorPanel(EFFECT_DRAW_FOUR).addEventListener(
      ON_COLOR_SELECTED,
      function (c) {
...
CGameMulti.prototype._initHandPlayers = function () {
  for (
    var a = HAND_POS["num_player_" + NUM_PLAYERS], c = [], b = 0;
    b < a.length;
    b++
  ) {
    var e = a[b];
  ...
  for (b = 0; b < e; b++) (a = c.pop()), c.splice(0, 0, a);
...
CGameMulti.prototype.shuffleCards = function (a, c, b, e) {
  ...
  this._oAnimation.shuffleAnimation().then(function () {
    d.onActionStop();
    d._iCurPlayer === s_oNetworkManager.getPlayerOrderID() &&
      (shuffle(g),
      s_oNetworkManager.sendMsg(
        MSG_MOVE,
        JSON.stringify({
...
CGameMulti.prototype._checkIfCanStillPlayTheTurn = function (a) {
  if (this.playerCanPlay(a)) this.onInputPlayer(a);
  else this._aPlayersHand[a].centerContainer(), this._notifyChangeTurn();
};
...
function CSelectColorPanel(a) {
  ...
  this.onSelectColor = function (p) {
    ...
    h.disableButtons();
    b[ON_COLOR_SELECTED] &&
      b[ON_COLOR_SELECTED].call(e[ON_COLOR_SELECTED], p, a);
  };
  h = this;
  this._init();
}
...
function CAIManager() {
  ...
  this.onSelectColorCpu = function (a) {
    ...
    for (
      ...
      for (var d = 0; d < b.length; d++) c.getSuit() === d && b[d].iPoints++;
    }
    b.sort(function (f, g) {
  ...
  this.selectACard = function (a) {
    for (
      var c = s_oGame.getPlayersHand(a),
        b = s_oGame.getCurColor(),
        e = s_oGame.getLastCard(),
        d = [],
        f = 0;
      f < c.getLength();
      f++
    )
      4 === c.getCardByIndex(f).getSuit() ||
      (c.getCardByIndex(f).getRank() !== e.getRank() &&
        c.getCardByIndex(f).getSuit() !== b)
        ? c.getCardByIndex(f).getFotogram() === FOTOGRAM_COLOR
          ? d.push({
              oCard: c.getCardByIndex(f),
              iValue: 2,
            })
          : c.getCardByIndex(f).getFotogram() === FOTOGRAM_DRAW_FOUR &&
            d.push({
              oCard: c.getCardByIndex(f),
              iValue: 1,
            })
        : 12 === c.getCardByIndex(f).getRank()
        ? d.push({
            oCard: c.getCardByIndex(f),
            iValue: 6,
          })
        : 10 === c.getCardByIndex(f).getRank()
        ? d.push({
            oCard: c.getCardByIndex(f),
            iValue: 5,
          })
        : 11 === c.getCardByIndex(f).getRank()
        ? d.push({
            oCard: c.getCardByIndex(f),
            iValue: 4,
          })
...
function CSummaryPanel(a) {
  ...
  this.reset = function () {
    ...
    z.setImage(t);
    for (t = 0; t < d.length; t++) d[t].enable(), d[t].setNameColor("#FFF");
  };
  this.show = function () {
    h.visible = !0;
    f.alpha = 0.7;
