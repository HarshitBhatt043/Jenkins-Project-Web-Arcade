/*globals define*/
define(["entities/entity", "utils"], function (Entity, Utils) {
  "use strict";
  ...
  Camera.prototype.applyTransform = function (ctx) {
    ctx.translate(
      0.5 * this.world.canvas.width,
      0.5 * this.world.canvas.height
    );
    ctx.scale(
      this.world.canvas.width / this.width,
      this.world.canvas.height / this.height
    );
