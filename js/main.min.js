...
})(
  {
      ...
      function (e, t, n) {
        (function (e) {
          ...
          n.relative = function (e, t) {
            ...
            var i = r(e.split("/"));
            var s = r(t.split("/"));
            var a = Math.min(i.length, s.length);
            var o = a;
            for (var u = 0; u < a; u++) {
              if (i[u] !== s[u]) {
                o = u;
      ...
      function (e, t, n) {
        (function (r, i) {
          ...
          if (typeof define === "function" && define.amd) {
            ...
            t.exports = i(r, e("5"), e("4"));
          } else {
            r.imagesLoaded = i(r, r.EventEmitter, r.eventie);
          }
        })(window, function r(e, t, n) {
          "use strict";
          var r = e.jQuery;
          var i = e.console;
          var s = typeof i !== "undefined";
          function a(e, t) {
            for (var n in t) {
              e[n] = t[n];
            }
          ...
          h.prototype.check = function () {
            var e = d[this.img.src] || new p(this.img.src);
            if (e.isConfirmed) {
          ...
          p.prototype.confirm = function (e, t) {
            this.isConfirmed = true;
            this.isLoaded = e;
            this.emit("confirm", this, t);
          };
          p.prototype.unbindProxyEvents = function (e) {
    ...
    5: [
      function (e, t, n) {
        (function () {
          ...
          n.flattenListeners = function u(e) {
            var t = [];
            var n;
          ...
          n.getListenersAsObject = function c(e) {
          ...
          n.addListener = function l(e, t) {
            ...
            var i;
            for (i in n) {
              if (n.hasOwnProperty(i) && s(n[i], t) === -1) {
                n[i].push(r ? t : { listener: t, once: false });
              }
            }
            return this;
          };
          n.on = a("addListener");
          n.addOnceListener = function h(e, t) {
            return this.addListener(e, { listener: t, once: true });
          };
          n.once = a("addOnceListener");
          n.defineEvent = function d(e) {
            this.getListeners(e);
            return this;
          };
          n.defineEvents = function p(e) {
            for (var t = 0; t < e.length; t += 1) {
              this.defineEvent(e[t]);
            }
            return this;
          };
          n.removeListener = function f(e, t) {
            var n = this.getListenersAsObject(e);
            var r;
            var i;
            for (i in n) {
          ...
          n.setOnceReturnValue = function w(e) {
            this._onceReturnValue = e;
            return this;
          };
          n._getOnceReturnValue = function E() {
          ...
          n._getEvents = function S() {
            return this._events || (this._events = {});
          };
          e.noConflict = function j() {
            r.EventEmitter = i;
            return e;
          };
          if (typeof define === "function" && define.amd) {
          ...
          } else if (typeof t === "object" && t.exports) {
            t.exports = e;
          } else {
            r.EventEmitter = e;
          }
    ...
    6: [
      function (e, t, n) {
        ...
        var n = (t.exports = function () {
          var e = s(arguments).map(u);
          return o(e[0]) ? i.apply(i, e) : r.join.apply(r, e);
        });
        var o = (n.isUrl = function (e) {
          return a(e) || e === "http://" || e === "https://" || e === "ftp://";
        });
        var u = (n.replaceUndefined = function (e, t, n) {
          return e === undefined || e === null ? (o(n[0]) ? "/" : r.sep) : e;
        });
      },
      { 1: 1, 7: 7, 8: 8, 9: 9 },
    ],
    ...
    10: [
      function (e, t, n) {
        t.exports = function a(e, t, n) {
          ...
          o.async = "async" in t ? !!t.async : true;
          o.src = e;
          if (t.attrs) {
            r(o, t.attrs);
          }
        ...
        (function () {
          ...
          (function () {
            ...
            a.without = function (e) {
              ...
              var n = -1,
                r = e.length,
                i = a.toArray(arguments).slice(1);
              while (++n < r) {
                if (a.indexOf(i, e[n]) === -1) {
                  t.push(e[n]);
                }
              }
              return t;
          ...
          (function () {
            ...
            function i(e, t, n) {
              return function () {
                ...
                if (r > e.length) {
                  ...
                  var u = Array.prototype.slice.call(arguments, i.length, r);
            ...
            function f(e, t, n) {
              var r = t.lookup(n);
              return r !== undefined && r !== null ? r : e.lookup(n);
            }
            function v(e, n, r) {
              if (e.lineno) {
                return e;
              } else {
                return new t.TemplateError(e, n, r);
              }
            }
            function g(e, n, r, i) {
              if (t.isArray(e)) {
            ...
            var i = n.extend({
              ...
              emit: function (e) {
                ...
                if (this.listeners && this.listeners[e]) {
                  r.each(this.listeners[e], function (e) {
                    e.apply(null, t);
                  });
                }
              },
          ...
          (function () {
            ...
            var n = t.extend({
              ...
              getSource: function (e) {
                if (this.precompiled[e]) {
                  ...
                  return { src: t, path: e, noCache: !this.neverUpdate };
                }
              },
              fetch: function (e, t) {
                var n;
            ...
            e["web-loaders"] = { WebLoader: n };
          })();
          (function () {
            if (typeof window === "undefined" || window !== this) {
              e["loaders"] = e["node-loaders"];
            } else {
              e["loaders"] = e["web-loaders"];
            }
          })();
          (function () {
            "use strict";
            ...
            var r = {
              ...
              center: function (e, r) {
                ...
                var i = r - e.length;
                var s = t.repeat(" ", i / 2 - (i % 2));
                var a = t.repeat(" ", i / 2);
                return n.copySafeness(e, s + e + a);
              },
              default: function (e, t) {
                return e ? e : t;
              },
              dictsort: function (e, n, r) {
                if (!t.isObject(e)) {
              ...
              escape: function (e) {
                if (typeof e === "string" || e instanceof n.SafeString) {
                  return t.escape(e);
                }
                return e;
              },
              ...
              reverse: function (e) {
                ...
                i.reverse();
                if (t.isString(e)) {
                  return n.copySafeness(e, i.join(""));
                }
                return i;
              },
              ...
              sort: function (e, n, r, i) {
                ...
                e.sort(function (e, s) {
                  ...
                  if (!r && t.isString(a) && t.isString(o)) {
                    a = a.toLowerCase();
                    o = o.toLowerCase();
                  }
                  if (a < o) {
              ...
              truncate: function (e, t, r, i) {
                ...
                e += i !== undefined && i !== null ? i : "...";
                return n.copySafeness(s, e);
              },
              upper: function (e) {
          ...
          (function () {
            ...
            var h = r.extend({
              init: function (e, t) {
                var t = (this.opts = t || {});
                this.opts.dev = !!t.dev;
                this.opts.autoescape = !!t.autoescape;
                this.opts.trimBlocks = !!t.trimBlocks;
                this.opts.lstripBlocks = !!t.lstripBlocks;
                if (!e) {
                  if (o.FileSystemLoader) {
                    this.loaders = [new o.FileSystemLoader("views")];
                  } else {
                    this.loaders = [new o.WebLoader("/views")];
                  }
                } else {
                  this.loaders = n.isArray(e) ? e : [e];
                }
                this.initCache();
                this.filters = {};
                this.asyncFilters = [];
              ...
              resolveTemplate: function (e, t, n) {
                var r = e.isRelative && t ? e.isRelative(n) : false;
                return r && e.resolve ? e.resolve(t, n) : n;
              },
              getTemplate: function (e, t, r, i) {
                var s = this;
                var a = null;
                if (e && e.raw) {
                  e = e.raw;
                ...
                for (var o = 0; o < this.loaders.length; o++) {
                  var u = this.resolveTemplate(this.loaders[o], r, e);
                  a = this.loaders[o].cache[u];
                  if (a) break;
                }
                if (a) {
                  if (t) {
                  ...
                  n.asyncIter(
                    ...
                    function (t, n, i, a) {
                      ...
                      e = s.resolveTemplate(t, r, e);
                      if (t.async) {
                        t.getSource(e, function (e, t) {
                          if (e) {
                            throw e;
                          }
                          o(t);
                    ...
                    function (n) {
                      if (!n) {
                        var r = new Error("template not found: " + e);
                        if (i) {
                          i(r);
                        } else {
                          throw r;
                        ...
                        var s = new p(n.src, this, n.path, t);
                        if (!n.noCache) {
                          n.loader.cache[e] = s;
                        }
                        if (i) {
              ...
              render: function (e, t, r) {
                ...
                var i = null;
                this.getTemplate(e, function (e, n) {
                  if (e && r) {
                    r(e);
                  } else if (e) {
                    throw e;
              ...
              renderString: function (e, t, r, i) {
                if (n.isFunction(r)) {
                  i = r;
                  r = {};
                }
                r = r || {};
                var s = new p(e, this, r.path);
                return s.render(t, i);
              },
            });
            var d = r.extend({
              ...
              getSuper: function (e, t, r, i, s, a) {
                var o = n.indexOf(this.blocks[t] || [], r);
                var u = this.blocks[t][o + 1];
                var c = this;
                if (o === -1 || !u) {
              ...
              getExported: function () {
                var e = {};
                for (var t = 0; t < this.exported.length; t++) {
            ...
            var p = r.extend({
              ...
              getExported: function (e, t, n) {
                ...
                var i = new d(e || {}, this.blocks);
                this.rootRenderFunc(this.env, i, t || new l(), u, function () {
                  n(null, i.getExported());
                });
              },
              compile: function () {
                if (!this.compiled) {
            ...
            e["environment"] = { Environment: h, Template: p };
          })();
          var n;
          var r = e["lib"];
          var i = e["environment"];
          ...
          var h = e["precompile"];
          n = {};
          n.Environment = i.Environment;
          n.Template = i.Template;
          n.Loader = c;
          n.FileSystemLoader = l.FileSystemLoader;
          n.WebLoader = l.WebLoader;
          n.compiler = s;
          n.parser = a;
          n.lexer = o;
          n.runtime = u;
          ...
          n.configure = function (e, t) {
            ...
            var n = "watch" in t ? !t.watch : false;
            var s = l.FileSystemLoader || l.WebLoader;
            d = new i.Environment(new s(e, n), t);
            if (t && t.express) {
              d.express(t.express);
            }
            return d;
          };
          n.compile = function (e, t, r, i) {
            if (!d) {
              n.configure();
            }
            return new n.Template(e, t, r, i);
          };
          n.render = function (e, t, r) {
            if (!d) {
              n.configure();
            }
            return d.render(e, t, r);
          };
          n.renderString = function (e, t, r) {
            if (!d) {
              n.configure();
            }
            return d.renderString(e, t, r);
          };
          if (h) {
            n.precompile = h.precompile;
            n.precompileString = h.precompileString;
          }
          ...
          if (typeof define === "function" && define.amd) {
            ...
            window.nunjucks = n;
            if (typeof t !== "undefined") t.exports = n;
          }
        })();
      },
      {},
    ...
    12: [
      function (e, t, n) {
        ...
        r.alternateExtensions = ["mp3"];
        var u = false;
        var c = {};
        var l = {
          loadAll: function () {
            _.keys(o).forEach(function (e) {
              this.load(e);
            }, this);
          },
          load: function (e) {
            ...
            r.registerSound(i(s.paths.audio, o[e]), e);
            return t.promise();
          },
          play: function (e, t) {
            r.play(e, { volume: t !== undefined ? 1 - t / 8 : 1, pan: 1e-4 });
          },
          playHit: function (e) {
            this.play(a.getRandomFromArray(["hit1", "hit2", "hit3"]), e);
          },
          playRandomSword: function () {
            this.play(a.getRandomFromArray(["sword1", "sword2", "sword3"]));
          },
          playFootStep: function () {
            this.play(
              a.getRandomFromArray([
                "footStep4",
                "footStep5",
                "footStep6",
                "footStep7",
          ...
          playHurt: function () {
            this.play(a.getRandomFromArray(["hurt1", "hurt2", "hurt3"]));
          },
          playJarBreak: function (e) {
            this.play(
              a.getRandomFromArray(["jarBreak1", "jarBreak2", "jarBreak3"]),
              e
            );
          },
          startTorchLoop: function () {
            this.torchLoop = r.createInstance(i(s.paths.audio, o["torch"]));
          ...
          setTorchVolume: function (e) {
            this.torchVolume
              .reset(this.torchLoop)
              .to({ volume: 1 - e / 2.5 }, 250)
              .start();
          },
          mute: function () {
            r.muted = true;
        ...
        (function () {
          (window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})[
            ...
            function e(e, t, n, r, i) {
              ...
              try {
                o +=
                  '<div class="about modal large js-about">\n  <div class="inner">\n    <div class="title"><img src="img/common/modals/about.png" alt="About"></div>\n    <div class="content">\n      <div class="text">\n        Keep Out! is a WebGL game experiment. Explore the dungeon, fight monsters and unlock epic weapons! <br><a class="js-ext-link" target="_blank" href="http://www.littleworkshop.fr/keepout.html">Read more about the project</a>\n      </div>\n      <div class="credit-block primary">\n        Made by<br>\n        <a class="js-ext-link" href="http://www.littleworkshop.fr/" target="_blank">Little Workshop</a>\n      </div>\n      <div class="separator"><img src="img/common/modals/separator.png"></div>\n      <div class="ext-link">Follow <a class="js-ext-link" target="_blank" href="http://twitter.com/playkeepout">@PlayKeepOut</a> for updates</div>\n    </div>\n    <div class="main-button button primary js-close js-hover-sound js-click-sound">Okay</div>\n  </div>\n</div>';
                i(null, o);
              } catch (u) {
                i(r.handleError(u, s, a));
              }
            }
            return { root: e };
          })();
              ...
              try {
                ...
                e.getTemplate(
                  ...
                  function (e, r) {
                    ...
                    r.render(t.getVariables(), n.push(), function (e, t) {
                      if (e) {
                        i(e);
                        return;
                      }
    ...
    15: [
      function (e, t, n) {
        t.exports = {
          common: [
            "modals/about.png",
            "modals/landscape-modal.png",
            "modals/large-modal.png",
            "modals/modal-button.png",
            "modals/portrait-modal.png",
            "modals/separator.png",
          ...
          game: [
            ...
            "end/glow.png",
            "end/ribbon.png",
            "hud/audio-toggle.png",
            "hud/bomb.png",
            "hud/bow.png",
            "hud/coin.png",
            "hud/healthbar-bg.png",
            "hud/healthbar-fill-white.png",
            "hud/healthbar-fill.png",
            "hud/healthbar-glow.png",
            "hud/key.png",
            "hud/map.png",
            "hud/movement.png",
            "hud/potion.png",
            "hud/sword.png",
            "hud/wand.png",
            "hud/wooden-button.png",
            "map-tileset.png",
            "menu-button-burger.png",
            "menu-button-close.png",
            "modals/key-mapping-azerty.png",
            "modals/key-mapping-qwerty.png",
            "modals/key-mapping-qzerty.png",
            "modals/select-arrows.png",
            "popups/bomb.png",
            "popups/bow.png",
            "popups/death.png",
            "popups/potion.png",
            ...
            "shop/purchase.png",
            "shop/purchased.png",
            "shop/right-arrow.png",
            "shop/shop-bg.jpg",
            "shop/sign.png",
            "titles/cleared.png",
            "titles/digits.png",
            "titles/how-to-play.png",
            "titles/level.png",
            "titles/shop.png",
          ],
          home: [
        ...
        (function (n) {
          ...
          (function i(e, t, n) {
            (function (e, t) {
              ...
              var r = "._tapActive";
              var i = "tap";
              var s = "clientX clientY screenX screenY pageX pageY".split(" ");
              var a;
              var o;
              var u;
              var c = { count: 0, event: 0 };
              var l = function (e, n) {
              ...
              var h = function (e) {
                ...
                var n = c.event;
                var r = Math.abs(e.pageX - n.pageX);
                var i = Math.abs(e.pageY - n.pageY);
                var s = Math.max(r, i);
                return (
                  e.timeStamp - n.timeStamp < t.tap.TIME_DELTA &&
                  s < t.tap.POSITION_DELTA &&
                  (!n.touches || c.count === 1) &&
                  f.isTracking
                );
              };
              var d = function (e) {
                ...
                var n = Math.abs(e.pageX - u.pageX);
                var r = Math.abs(e.pageY - u.pageY);
                var i = Math.max(n, r);
                return (
                  Math.abs(e.timeStamp - u.timeStamp) < 750 &&
                  i < t.tap.POSITION_DELTA
                );
              };
              var p = function (e) {
              ...
              var f = {
                ...
                enable: function () {
                  ...
                  f.isEnabled = true;
                  a = t(e.body)
                    .on("touchstart" + n, f.onStart)
                    .on("mousedown" + n, f.onStart)
                    .on("click" + n, f.onClick);
                },
                disable: function () {
                  if (!f.isEnabled) {
                    return;
                ...
                onStart: function (e) {
                  ...
                  p(e);
                  if (t.tap.LEFT_BUTTON_ONLY && !e.touches && e.which !== 1) {
                    return;
                  }
                  if (e.touches) {
                    c.count = e.touches.length;
                  }
                  if (f.isTracking) {
                    return;
                  }
                  ...
                  if (e.touches) {
                    u = e;
                    a.on("touchend" + n + r, f.onEnd).on(
                      "touchcancel" + n + r,
                      f.onCancel
                    );
                  } else {
                    a.on("mouseup" + n + r, f.onEnd);
                  }
                },
                onEnd: function (e) {
                  var n;
    ...
    19: [
      function (e, t, n) {
            ...
            (e.initialize = function (e) {
              ...
              (t.dispatchEvent = function (e) {
                ...
                if (e.bubbles && this.parent) {
                  ...
                  for (s = 1; a > s && !e.propagationStopped; s++)
            ...
            (e.ABSOLUTE_PATT = /^(?:\w+:)?\/{2}/i),
              ...
              (e.parseURI = function (t) {
                ...
                return (
                  ...
                  (i = t.match(e.EXTENSION_PATT)) &&
                    (n.extension = i[1].toLowerCase()),
                  n
                );
              }),
            ...
            (e.ACTIVEX_VERSIONS = [
              ...
              (t.load = function () {
                ...
                try {
                  ...
                  this.dispatchEvent(
                    new createjs.ErrorEvent("XHR_SEND", null, e)
                  );
                }
              }),
              ...
              (t._createXHR = function (e) {
                ...
                if (window.XMLHttpRequest)
                  ...
                  for (var i = 0, a = s.ACTIVEX_VERSIONS.length; a > i; i++) {
                    {
          ...
          (function () {
            ...
            (n.INTERRUPT_ANY = "any"),
              ...
              Object.defineProperty(n, "volume", {
                ...
                set: function (e) {
                  ...
                  if (
                    ...
                    for (
                      var t = this._instances, r = 0, i = t.length;
                      i > r;
                      r++
                    )
              ...
              Object.defineProperty(n, "muted", {
                ...
                set: function (e) {
                  ...
                  if (
                    ...
                    for (
                      var t = this._instances, n = 0, r = t.length;
                      r > n;
                      n++
                    )
                      t[n].setMasterMute(e);
              ...
              (n.getCapability = function (e) {
                return null == n.activePlugin
                  ? null
                  : n.activePlugin._capabilities[e];
              }),
              ...
              (n._registerSound = function (e) {
                ...
                if (
                  ...
                  for (var a, o = i.audioSprite.length; o--; )
                    (a = i.audioSprite[o]),
                      (n._idHash[a.id] = {
                        src: e.src,
              ...
              (n.registerSound = function (e, t, r, i, s) {
                var a = { src: e, id: t, data: r, defaultPlayProps: s };
                e instanceof Object && e.src && ((i = t), (a = e)),
                  (a = createjs.LoadItem.create(a)),
                  (a.path = i),
                  null == i || a.src instanceof Object || (a.src = i + e);
                var o = n._registerSound(a);
                if (!o) return !1;
                if (
              ...
              (n._parsePath = function (e) {
                ...
                if (null == t) return !1;
                for (var r = t[4], i = t[5], s = n.capabilities, a = 0; !s[i]; )
                  if (
                    ((i = n.alternateExtensions[a++]),
                    a > n.alternateExtensions.length)
                  )
                    return null;
                e = e.replace("." + t[5], "." + i);
                var o = { name: r, src: e, extension: i };
                return o;
              }),
              (n._parseSrc = function (e) {
                ...
                return (t.name = -1 != s ? t.src.slice(s + 1) : t.src), t;
              }),
              (n.play = function (e, t, r, i, s, a, o, u, c) {
                var l;
                l = createjs.PlayPropsConfig.create(
                ...
                var h = n.createInstance(e, l.startTime, l.duration),
                  d = n._playInstance(h, l);
                return d || h._playFailed(), h;
              }),
                ...
                return (
                  null != a && null != a.src
                    ? (t.create(a.src),
                      ...
                      (o = n.activePlugin.create(a.src, r, i || e.duration)),
                      (s = s || n._defaultPlayPropsHash[a.src]),
                      s && o.applyPlayProps(s))
                    : (o = new createjs.DefaultSoundInstance(e, r, i)),
              ...
              (t.removeSrc = function (e) {
                ...
                return null == n
                  ? !1
                  : (n._removeAll(), delete t.channels[e], !0);
              }),
            ...
            (r.constructor = t),
              ...
              (r._getSlot = function (t) {
                var n, r;
                if (t != e.INTERRUPT_NONE && ((r = this._get(0)), null == r))
                  return !0;
          ...
          (function () {
            ...
            (e._capabilities = null),
              ...
              (t.create = function (e, t, n) {
                ...
                var r = new this._soundInstanceClass(
                  e,
                  t,
                  n,
              ...
              (t._handlePreloadComplete = function (e) {
                ...
                for (
                  var n = 0, r = this._soundInstances[t].length;
                  r > n;
                  n++
                ) {
        ...
        if (typeof t === "object") {
          t.exports = window.createjs.Sound;
        }
      },
      {},
    ],
    ...
    21: [
      function (e, t, n) {
        ...
        var l = e("16");
        var h = e("17");
        var d = document.querySelector("#preload");
        var p = e("13");
        var f = null;
        var v = false;
        window.isMobile =
        ...
        if (!p.IGNORE_PIXEL_RATIO && window.isMobile) {
          window.PIXEL_RATIO =
            window.devicePixelRatio > 1.5 ? 1.5 : window.devicePixelRatio;
        } else {
          window.PIXEL_RATIO = 1;
        }
        s(d).on("done", function () {
          var e = {};
          var t = new a({ container: $("body"), context: e });
          var n = new o({ el: $(".js-about"), context: e });
          t.on("showAbout", function () {
            n.show();
            t.veil();
          });
          n.on("close", function () {
          ...
          t.once(
            ...
            function () {
              t.showSpinner();
              v = true;
              if (window.isMobile && p.ALLOW_FULL_SCREEN) {
                y();
              }
            },
            this
          ...
          m("three", function () {
            var e = c.map(function (e) {
              return i(p.paths.images, "game/", e);
            });
            var r = _.union(l.props, l.weapons, l.items, l.mobs);
            var s = _.union(
              h.props,
              h.weapons,
              h.items,
            ...
            $.when(
              ...
              var e = window.initGame;
              delete window.initGame;
              u.parseMeshData(r);
              f = e(u.getCaches(), { about: n });
              if (p.AUTOPLAY || v) {
                t.hide();
                f.startGame();
              } else {
                t.off("pressPlay");
                t.once("pressPlay", function () {
                  if (window.isMobile && p.ALLOW_FULL_SCREEN) {
                    y();
                  }
                  setTimeout(function () {
        ...
        function m(e, t) {
          r(i(p.paths.scripts, p.scripts[e]), t);
        }
        function y() {
    ...
    22: [
      function (e, t, n) {
        ...
        s.getCaches = function () {
          return [a, o, u];
        };
        s.setCaches = function (e, t, n) {
          a = e;
          o = t;
          u = n;
        };
        s.loadJSONMesh = function (e) {
          if (!_.has(c, e)) {
            throw "Unknown mesh id: " + e;
          }
          if (_.has(a, e)) {
            return new $.Deferred().resolve(a[e]).promise();
          }
          return $.ajax({
        ...
        s.loadJSONMeshes = function (e) {
          return $.when.apply($, _.map(e, s.loadJSONMesh));
        };
        s.parseMeshData = function (e) {
          e.forEach(function (e) {
            if (!_.has(a, e)) {
              throw "No JSON found for id: " + e;
            }
            if (_.has(o, e)) return;
            var t = new THREE.JSONLoader();
            var n = JSON.parse(a[e]);
            var i = t.parse(n, r.paths.textures);
            var u;
            if (i.materials.length > 1) {
              u = new THREE.MeshFaceMaterial(i.materials);
            } else {
              u = i.materials[0];
            }
            var c = i.geometry;
            if (e !== "key") {
              c = new THREE.BufferGeometry().fromGeometry(i.geometry);
            }
            if (i.geometry.animations && i.geometry.animations.length > 0) {
              c.animations = i.geometry.animations;
              c.bones = i.geometry.bones;
              var l = i.geometry.skinIndices;
              var h = i.geometry.skinWeights;
              var d = i.geometry.faces;
              s.normalizeSkinIndices(l, h);
              var p = s.fillFloat32Array(l, d);
              c.addAttribute("skinIndex", new THREE.BufferAttribute(p, 4));
              var f = s.fillFloat32Array(h, d);
              c.addAttribute("skinWeight", new THREE.BufferAttribute(f, 4));
            }
            o[e] = { geometry: c, material: u };
          });
        };
        s.fillFloat32Array = function (e, t) {
          var n = new Float32Array(t.length * 3 * 4);
          for (var r = 0, i = 0, s = t.length; r < s; r++, i += 3 * 4) {
            var a = t[r];
            var o = e[a.a];
            var u = e[a.b];
            var c = e[a.c];
        ...
        s.normalizeSkinIndices = function (e, t) {
        ...
        s.loadTextures = function (e) {
          return $.when.apply($, _.map(e, s.loadTexture));
        };
        s.getTexture = function (e) {
          if (!_.has(u, e)) {
            throw "Texture not found: " + e;
          }
          return u[e];
        };
        s.loadImage = function (e) {
          var t = new $.Deferred();
          var n = new Image();
          n.onload = function () {
            t.resolve(n);
        ...
        s.loadImages = function (e) {
          return $.when.apply($, _.map(e, s.loadImage));
        };
        t.exports = s;
      },
      { 13: 13, 16: 16, 17: 17, 6: 6 },
    ],
    23: [
      function (e, t, n) {
        var r = {
    ...
    26: [
      function (e, t, n) {
        var r = {};
        r.getRandomInt = function (e, t) {
          return Math.floor(Math.random() * (t - e)) + e;
        };
        r.getRandomFloat = function (e, t) {
          return Math.random() * (t - e) + e;
        };
        r.getRandomFromArray = function (e) {
          return e[Math.floor(Math.random() * e.length)];
        };
        r.pad = function (e, t, n) {
          n = n || "0";
          e = e + "";
          return e.length >= t ? e : new Array(t - e.length + 1).join(n) + e;
        };
        r.getAspectRatio = function () {
      ...
      function (e, t, n) {
        ...
        var s = r.extend({
          ...
          onTap: function (e) {
            if (
              !$(e.target).is(".inner") &&
              $(e.target).parents(".inner").length === 0
            ) {
              this.hide();
              this.trigger("close");
            }
    ...
    29: [
      function (e, t, n) {
        ...
        var a = r.extend({
          template: "home.html",
          events: {
            "tap .js-more-info": "showAbout",
            "touchstart .js-play-button": "touchstartButton",
            "touchend .js-play-button": "touchendButton",
            "tap .js-play-button": "onTapPlayButton",
            "tap .js-ext-link": "onClickExternalLink",
          },
          initialize: function () {
            this.$playButton = this.$(".js-play-button");
            this.$content = this.$(".js-title-screen");
            this.$moreInfo = this.$(".js-more-info");
            if (window.isMobile) {
          ...
          hide: function () {
            ...
            setTimeout(
              function () {
                this.$content.removeClass("fadeout visible");
              }.bind(this),
              350
            );
          },
          ...
          veil: function () {
            this.$el.addClass("veiled");
          },
          unveil: function () {
            this.$el.removeClass("veiled");
          },
          touchstartButton: function () {
            this.$playButton.addClass("pressed");
          },
          touchendButton: function () {
            this.$playButton.removeClass("pressed");
          },
          onTapPlayButton: function () {
            this.$playButton.removeClass("pressed");
            this.trigger("pressPlay");
          },
          showSpinner: function () {
            this.$playButton.addClass("waiting");
            this.$moreInfo.addClass("hidden");
          },
          onClickExternalLink: function (e) {
            var t = $(e.target).closest(".js-ext-link").attr("href");
            s.log("ext-link", t, "home");
          },
          checkContinue: function () {
            ...
            try {
              var t = atob(e);
              JSON.parse(t);
              this.$playButton.addClass("continue");
            } catch (n) {}
          },
        });
        t.exports = a;
      ...
      function (e, t, n) {
        ...
        var i = Backbone.View.extend({
          constructor: function (e) {
            ...
            this.views = {};
            if (this.template) {
              this._renderTemplate(e.context);
              this._insert();
            }
            if (e.willInitialize && _.isFunction(e.willInitialize)) {
              this.setElement(e.willInitialize.call(this));
              delete e.willInitialize;
            }
            this._initSubViews(e);
          ...
          _initSubViews: function (e) {
            this._forEachSubView(function (t, n, r) {
              var i = _.clone(e);
              i.container = r;
              this.addSubView(t, new n(i));
            });
          },
          ...
          _renderSubViews: function (e) {
            this._forEachSubView(function (t, n, r) {
              this.views[t]._container = r;
              this.views[t].render(e);
            }, this);
          },
          render: function (e) {
            e = e || this._context;
