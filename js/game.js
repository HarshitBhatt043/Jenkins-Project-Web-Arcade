...
define(function (require) {
  ...
  function Game() {
    ...
    contactListener.BeginContact = function (contact) {
      ...
      if (
        player &&
        !(player.material & other.material) &&
        player.game &&
        other.game
      ) {
      ...
      if (trigger && !trigger.active && trigger.material & other.material) {
