var CPlants = NewO({
      ...
      (function (h) {
        ...
        oSym.addTask(
          ...
          [
            ...
            c,
            d,
            EditEle(g.BulletEle.cloneNode(false), { id: h }, 0, EDPZ),
            a,
          ]
        );
      })("StarB" + Math.random());
        ...
        oSym.addTask(
          ...
          function (n, l, m, k, i, j) {
            j(oZ.getZ0(n, l), 7, i) &&
              ((n += 4) > 900 || (k -= 3) < -15
                ? ClearChild(i)
                : (SetStyle(i, { left: (m += 4) + "px", top: k + "px" }),
                  oSym.addTask(1, arguments.callee, [
                    n,
                    GetR(k + 15),
                    m,
    ...
    NormalAttack: function () {
      ...
      oSym.addTask(
        ...
        function (f, j, h, c, n, i, m, k, o, g) {
          ...
          d && d.Altitude == 1
            ? (d[{ "-1": "getSnowPea", 0: "getPea", 1: "getFirePea" }[m]](
                d,
                h,
                c
              ),
              (SetStyle(j, { left: o + 28 + "px" }).src = [
                "images/Plants/PeaBulletHit.gif",
      ...
      for (a in c.oTrigger) {
        ...
        oSym.addTask(
          ...
          function (h, l, j, e, p, k, o, m, q, i) {
            ...
            f && f.Altitude == 1
              ? (f[{ "-1": "getSnowPea", 0: "getPea", 1: "getFirePea" }[o]](
                  f,
                  j,
                  e
                ),
                (SetStyle(l, { left: q + 28 + "px" }).src = [
                  "images/Plants/PeaBulletHit.gif",
                  "images/Plants/PeaBulletHit2.gif",
                ][o]),
        ...
        b = function () {
          ...
          oSym.addTask(
            ...
            function (i, m, k, f, q, l, p, n, r, j) {
              ...
              g && g.Altitude == 1
                ? (g[{ "-1": "getSnowPea", 0: "getPea", 1: "getFirePea" }[p]](
                    g,
                    k,
                    f
                  ),
                  (SetStyle(m, { left: r + 28 + "px" }).src = [
                    "images/Plants/PeaBulletHit.gif",
                    "images/Plants/PeaBulletHit2.gif",
                  ][m]),
  ...
  oSunFlower = InheritO(CPlants, {
    ...
    ChangePosition: function (c, a) {
      ...
      a
        ? SetStyle(b, { clip: "rect(74px,auto,auto,auto)", top: "-74px" })
        : SetStyle(b, { clip: "rect(auto,auto,74px,auto)", top: 0 });
    },
    PrivateBirth: function (a) {
      oS.ProduceSun
        ? oSym.addTask(
  ...
  oTwinSunflower = InheritO(oSunFlower, {
    ...
    ChangePosition: function (c, a) {
      var b = c.childNodes[1];
      a
        ? SetStyle(b, { clip: "rect(84px,auto,auto,auto)", top: "-84px" })
        : SetStyle(b, { clip: "rect(auto,auto,84px,auto)", top: 0 });
    },
    PrivateBirth: function (a) {
      var b = GetX(a.C);
      oSym.addTask(
  ...
  oLilyPad1 = InheritO(oLilyPad, { EName: "oLilyPad1" }),
    ...
    getHurt: function (e, b, a) {
      ...
      !(b % 3)
        ? (c.HP -= a) < 1
          ...
          : c.HP < 1334
          ? c.HurtStatus < 2 &&
            ((c.HurtStatus = 2), (d.src = "images/Plants/Ling/Ling.gif"))
          : c.HP < 2667 &&
            c.HurtStatus < 1 &&
        ...
        function (b) {
          ...
          if (c) {
            ...
            EditEle(
              ...
              { width: "213px", height: "196px", left: "-50px", top: "-37px" }
            );
    ...
    getHurt: function (e, b, a) {
      ...
      !(b % 3)
        ? (c.HP -= a) < 1
          ...
          ? c.HurtStatus < 2 &&
            ((c.HurtStatus = 2),
            (d.src = "images/Plants/FlamesMushroom/FlamesMushroom2.gif"))
          : c.HP < 5333 &&
            c.HurtStatus < 1 &&
            ((c.HurtStatus = 1),
            (d.src = "images/Plants/FlamesMushroom/FlamesMushroom1.gif"))
        : c.Die(1);
    },
    NormalAttack: function () {},
    PrivateBirth: function (a) {
    ...
    NormalAttack: function () {
      ...
      ImgSpriter(
        ...
        function (m, n) {
          var i = $(n);
          $P[n] &&
            (i.childNodes[1].src = "images/Plants/SeaAnemone/GloomShroom.gif");
          SetHidden($(m));
        }
      );
    },
        ...
        function (j) {
          ...
          if (h) {
            ...
            EditEle(
              ...
              { width: "176px", height: "148px", left: "-1px", top: "-1px" }
            );
