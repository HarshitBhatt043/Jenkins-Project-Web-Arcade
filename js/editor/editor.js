  ...
  Editor.prototype.onMouseDown = function (event) {
    ...
    if (this.keys[86]) {
        ...
        function (element) {
          if (element.type === "polygon") {
            ...
            for (var i = 0; i < vertexCount; i++) {
              ...
              var point = Intersection.closestPointOnSegment(
                x,
                y,
                xi,
                yi,
      ...
      if (minElement) {
        ...
        minElement.vertices.splice(
          2 * ((minIndex + 1) % vertexCount),
          0,
          mx,
          my
        );
    ...
    if (event.altKey) {
      this.elements.forEach(
        function (element) {
          if (element.type === "polygon") {
            var vertices = element.verticesContain(
              this.mouse.x,
              this.mouse.y,
              vertexRadius
            );
      ...
      this.selection.forEach(
        function (element, index) {
          ...
          if (this.snapping && element.type === "vertex") {
            ...
            if (
              minDistanceSquared <
              this.snappingRadius * this.snappingRadius
            ) {
