    ...
    return (
      ...
      (i.Text.prototype.determineFontProperties = function (t) {
        ...
        if (!e) {
          ...
          n.font = t;
          var r = Math.ceil(n.measureText("|MÃ‰q").width),
            o = Math.ceil(n.measureText("|MÃ‰q").width),
            a = 2 * o;
          if (
            ((o = (1.4 * o) | 0),
            (s.width = r),
      ...
      (i.Loader.prototype = {
        ...
        loadImageTag: function (t) {
          var e = this;
          (t.data = new Image()), (e.crossOrigin = "Anonymous");
          (t.data.name = t.key),
