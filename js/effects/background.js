/*globals define*/
define(["object2d", "utils"], function (Object2D, Utils) {
  "use strict";
  ...
  Background.prototype.prerender = function () {
    ...
    while (rectCount--) {
      ...
      rectSaturation = this.saturationSpread
        ? Utils.intSpread(saturation, this.saturationSpread)
        : saturation;
      rectLightness = this.lightnessSpread
        ? Utils.intSpread(lightness, this.lightnessSpread)
        : lightness;
