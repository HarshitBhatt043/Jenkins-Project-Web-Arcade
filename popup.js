...
function startTypingAnimation() {
  ...
  const messageText = [
    "The game may stuck for a while.",
    "Specially while generating maps and textures.",
    "If not resumed even after 5 mins! Refresh.",
...
function checkLocalStorage() {
  const visited = localStorage.getItem(city);
  if (visited !== "no") {
    const popup = document.getElementById("popup");
    const popupContent = document.querySelector(".popup-content");
