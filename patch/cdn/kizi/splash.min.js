      ...
      function b(b, c) {
        ...
        return (
          ...
          b.hasOwnProperty("analytics")
            ? Object.defineProperty(b.analytics, "game", { value: d })
            : (b.analytics = { game: d }),
          d
        );
      }
    ...
    var c = (function (b) {
      function c(c, d) {
        ...
        c.hasOwnProperty("analytics")
          ? Object.defineProperty(c.analytics, "google", { value: e })
          : (c.analytics = { google: e });
      ...
      return (
        ...
        (c.prototype.sendScreenView = function (a) {
          ga("fbrq.send", "screenview", { screenName: a }),
            ga("send", "screenview", { screenName: a });
        }),
      ...
      return (
        ...
        (d.prototype.handler = function (a, b) {
          if (!this.clicked && "mouseout" !== b.type) {
            ...
            c.to({ x: 0, y: 0 }, 250, Phaser.Easing.Back.In).start(),
        ...
        (d.prototype.animateButton = function () {
          a.Utils.isOnDevice(this.game) ||
            ...
            this.buttonTween.to(
              { x: 1.14 * this.scaleFactor, y: 1.14 * this.scaleFactor },
              420,
    ...
    var c = (function (c) {
      ...
      return (
        ...
        (d.prototype.startAnimation = function () {
          ...
          a.to({ x: 1.2 * this.scaleFactor, y: 1.2 * this.scaleFactor }, 100),
            a.to(
              { x: 1.5 * this.scaleFactor, y: 1.5 * this.scaleFactor },
              450,
  ...
  !(function (b) {
    var c = (function (c) {
      ...
      return (
        ...
        (d.prototype.startAnimation = function () {
          var a = this.game.add.tween(this.logo.scale);
          a.to({ x: 0.6 * this.scaleFactor, y: 0.6 * this.scaleFactor }, 100),
            a.to(
              { x: 0.75 * this.scaleFactor, y: 0.75 * this.scaleFactor },
              450,
              Phaser.Easing.Back.InOut
            ),
            a.start();
        ...
        (b.prototype.start = function (a, b, c, d) {
          void 0 === d && (d = !1),
            ...
            this.game.add
              ...
              .to({ x: 1, y: 1 }, 400, Phaser.Easing.Linear.None, !0)
              .onComplete.addOnce(function () {
                this.game.add
                  .tween(this.graphic3.scale)
                  .to({ x: 0.2, y: 0.2 }, 200, Phaser.Easing.Linear.None, !0),
                  this.game.add
                    .tween(this.graphic3)
                    .to({ alpha: 0 }, 200, Phaser.Easing.Linear.None, !0);
              }, this),
            this.game.add
              .tween(this.graphic2)
              .to({ alpha: 1 }, 200, Phaser.Easing.Linear.None, !0, 200),
            this.game.add
              .tween(this.graphic2.scale)
              .to({ y: 1.4 }, 200, Phaser.Easing.Linear.None, !0, 200)
              .onComplete.addOnce(function () {
                this.game.add
                  .tween(this.graphic2.scale)
                  .to({ x: 0.25 }, 300, Phaser.Easing.Linear.None, !0, 200),
                  this.game.add
                    .tween(this.graphic2)
                    .to({ alpha: 0 }, 300, Phaser.Easing.Linear.None, !0, 200);
              }, this),
            this.game.add
              .tween(this.graphic1)
              .to({ alpha: 1 }, 200, Phaser.Easing.Linear.None, !0, 200),
            this.game.add
              ...
              .onComplete.addOnce(function () {
                this.game.add
                  .tween(this.graphic1.scale)
                  .to({ x: 0.25 }, 300, Phaser.Easing.Linear.None, !0, 400),
                  this.game.add
                    .tween(this.graphic1)
                    .to({ alpha: 0 }, 300, Phaser.Easing.Linear.None, !0, 400)
                    .onComplete.addOnce(function () {
                      this.visible = !1;
                    }, this);
              }, this);
    ...
    var b = (function (a) {
      ...
      return (
        ...
        (b.prototype.show = function (a) {
          (this.dir = a), this.setTween(1, 14, { scaleX: 1 });
        }),
            ...
            : (this.resizeObjects(),
              ...
              this.spine.onComplete.add(function () {
                (a.logo.visible = !0),
                  ...
                  a.buttonTween.to(
                    { x: 1.14 * a.scaleFactor, y: 1.14 * a.scaleFactor },
                    420,
                    Phaser.Easing.Quadratic.InOut,
                    !0,
                    500
    ...
    var b = (function (b) {
      ...
      return (
        ...
        (c.prototype.tweenRandomItem = function () {
          ...
          this.game.add
            .tween(a)
            .to({ alpha: 1 }, 1e3, Phaser.Easing.Linear.None, !0, 0, 0, !0);
        }),
        (c.prototype.resize = function () {
          (this.scaleFactor = this.getScale()),
            this.background.resize(this.scaleFactor),
    ...
    function b(a, b, c, d) {
      ...
      (e = new XMLHttpRequest()),
        (e.onreadystatechange = function () {
          4 == e.readyState &&
            (200 === e.status
              ? d({ success: !0, message: e.responseText })
              : e.status > 0 &&
                d({
                  success: !1,
                  message:
