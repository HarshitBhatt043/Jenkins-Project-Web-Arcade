  ...
  !(function (a) {
    var b = (function (a) {
      function b(b, c) {
        ...
        return (
          (d.back = d.game.make.graphics(0, 0)), d.add(d.back), d.resize(c), d
        );
      }
      return (
        __extends(b, a),
              ...
              (c *= a),
                b.triangles.push(
                  new Phaser.Polygon([
                    ...
                    new Phaser.Point(
                      c * Math.cos((1 / 3) * (2 * Math.PI)),
                      c * Math.sin((1 / 3) * (2 * Math.PI))
                    ),
                    new Phaser.Point(
                      c * Math.cos((2 / 3) * (2 * Math.PI)),
                      c * Math.sin((2 / 3) * (2 * Math.PI))
                    ),
                    new Phaser.Point(c * Math.cos(0), c * Math.sin(0)),
                  ])
                );
    ...
    var b = (function (a) {
      ...
      return (
        ...
        (b.prototype.resize = function (a) {
          ...
          var d = this.gradientBitmap.context.createRadialGradient(
            b / 2,
            c / 2,
            0,
            b / 2,
      ...
      return (
        ...
        (b.prototype.resize = function (a) {
          ...
          d.addColorStop(0, "rgba(0, 81, 125, 0)"),
            ...
            (this.gradientBitmap.context.fillStyle = d),
            this.gradientBitmap.context.fillRect(0, 0, b, c);
          var e = this.gradientBitmap.context.createRadialGradient(
            b / 2,
            c / 2,
            0,
            b / 2,
    ...
    return (
      ...
      (c.preloadImages = function (b) {
        ...
        switch (
          (a.Utils.isOnDevice(b) || c.isAirfi()
            ...
            ? (a.Utils.ASSET_LOCATION =
                "/repository/download/Fabrique_FunnyGamesSplash/.lastSuccessful/build/assets/")
            : "fbrq.io" === a.Utils.getSourceSite(!0) &&
              (a.Utils.ASSET_LOCATION =
                "https://" +
                window.location.host +
                "/orange-games-splash/assets/"),
        ...
        a.Utils.isTc() || (b.load.crossOrigin = "anonymous"),
          b.load.image(
            c.LOGO_KEY,
            a.Utils.ASSET_LOCATION + "images/branding_logo_" + d + "_small.png"
          );
      }),
      (c.openCampaignLink = function (d, e, f) {
        if (
          a.Utils.isOnDevice(d) ||
          c.isContracted(d) ||
          c.isSpecial(d) ||
          !c.outGoingLinksAllowed()
        )
          return null;
        var g,
          h,
          i = a.Utils.getSourceSite(),
        ...
        switch (a.Utils.getBrandingDomain()) {
          ...
          case a.BrandingDomain.Admeen:
            return (
              (g = "https://media.admeen.com/branding/link.php"),
          ...
          case a.BrandingDomain.Bild:
            return (
              (h = window.open(j + "www.bildspielt.de", "_blank")),
              void (h && h.focus && h.focus())
            );
          case a.BrandingDomain.Funnygames:
      ...
      (c.isBip = function () {
        return (
          window.location.search.indexOf("bipgaming") !== -1 ||
      ...
      (c.outGoingLinksAllowed = function () {
        return (
          !c.isAirfi() && (!window.hasOwnProperty("fbrqLA") || window.fbrqLA)
        );
      }),
    ...
    return (
      (b.loadPortalScript = function (b) {
        b &&
          ...
          b &&
            b.hasOwnProperty("kongregate") &&
            b.kongregate.indexOf(a.Utils.getSourceSite()) !== -1 &&
            addScript(
          ...
          b &&
            b.hasOwnProperty("newgrounds") &&
            b.newgrounds.indexOf(a.Utils.getSourceSite()) !== -1 &&
            addScript(
              "https://cdn.fbrq.io/orange-games-splash/assets/scripts/newgroundsio.min.js",
              Date.now() / 1e3
            );
      }),
      b
  ...
  var b = (function () {
    ...
    return (
      (a.initialize = function (b, c, d, e) {
        var f =
          "string" == typeof b.parent
            ? document.getElementById(b.parent)
            : b.parent;
        ...
        !(function (a, b, c, d, e, f, g) {
          ...
          document,
          "script",
          "patch/js/null.js?//video-static.vooxe.com/libs/gd/gd.js",
          "gdPlayer",
          void 0,
          void 0
        ),
      ...
      (a.show = function () {
        return (
          ...
          ((a.container.style.display = "block"), !0)
        );
      }),
      (a.hide = function () {
        return (
      ...
      (a.setVolume = function (b) {
        null !== a.playerInstance &&
          (b > 1 || b < 0 || a.playerInstance.setVolume(b));
      }),
  ...
  !(function (a) {
    var b = (function (a) {
      function b(b, c, d, e, f, g, h) {
        ...
        var k = c.data.title;
        return (
          k.length > 16 && (k = k.replace(k.substring(14, k.length), "...")),
          (i.title = i.game.add.text(
            f / 2,
            i.titleBg.y + (g - f) / 2 + 4,
            k.toUpperCase(),
            {
              font: "bold " + 0.35 * (g - f) + "px Arial",
              fill: "#FFF",
              align: "center",
              wordWrap: !0,
              wordWrapWidth: f - 10,
          ...
          j
            ...
            .lineTo(-15, -25)
            .endFill(),
          (i.playImg = i.game.add.image(
            f / 2,
            (f / 3) * 2.7,
            j.generateTexture()
          )),
          i.playImg.anchor.set(0.5, 0.5),
      ...
      return (
        ...
        (b.prototype.openGame = function () {
          this.game.analytics &&
            this.game.analytics.google.sendGenericEvent(
              "MoreGames",
              "Click",
              this.id
            ),
  ...
  !(function (b) {
    var c = (function (c) {
      function d(b, d) {
        ...
        f
          .beginFill(2507370)
          .drawRoundedRect(0, 0, e.size, e.size + 20, 15)
          .endFill(),
          (e.background = e.game.add.image(0, 0, f.generateTexture())),
          e.background.anchor.set(0.5),
          (e.background.inputEnabled = !0),
          (e.background.input.priorityID = 670),
          (e.background.input.useHandCursor = !1),
          e.menuGrp.add(e.background),
          (e.logoBtn = e.game.add.button(
            0,
            -(e.background.height / 2) + e.offset,
            a.Branding.LOGO_KEY,
            function () {
              a.Branding.openCampaignLink(
                e.game,
                e.gameName,
                a.UtmTargets.more_games
              );
            },
            e
          )),
          e.logoBtn.scale.setTo(1),
          e.logoBtn.anchor.set(0.5, 0),
          e.menuGrp.add(e.logoBtn),
          (e.closeBtn = b.add.button(
            e.size / 2 - 10,
            -(e.size / 2) + 25,
            "close_btn",
            e.hide,
        ...
        g.beginFill(2507370).drawRect(0, 0, 270, 40).endFill(),
          (e.moreGamesBtn = b.add.button(
            0,
            e.background.y + e.background.height / 2 - g.height - e.offset,
            "",
            function () {
              a.Branding.openCampaignLink(
                e.game,
          ...
          e.moreGamesBtn.anchor.set(0.5, 0),
        ...
        return (
          (e.moreGamesText = b.add.text(
            0,
            e.moreGamesBtn.height / 2 + 2,
            "PLAY MORE GAMES",
            h
          )),
          e.moreGamesText.anchor.set(0.5),
      ...
      return (
        ...
        (d.prototype.createItems = function () {
          (this.itemGrp = this.game.make.group(this, "items")),
            (this.itemGrp.x = 0),
            (this.itemGrp.y =
              this.size / 2 + this.logoBtn.y + this.logoBtn.height),
        ...
        (d.prototype.show = function () {
          this.visible ||
            (this.game.analytics &&
              (this.game.analytics.google.sendScreenView("moregames"),
        ...
        (d.prototype.hide = function () {
          this.visible &&
            ((this.visible = !1),
            this.game.analytics &&
              this.game.analytics.google.sendGenericEvent("MoreGames", "Close"),
        ...
        (d.preloadImages = function (b) {
          ...
          a.Utils.isOnDevice(b) || a.Branding.isAirfi()
            ...
            : "fbrq.io" === a.Utils.getSourceSite(!0) &&
              (a.Utils.ASSET_LOCATION =
                "//" + window.location.host + "/orange-games-splash/assets/"),
            a.Utils.isTc() || (b.load.crossOrigin = "anonymous"),
            b.load.image(
              "close_btn",
              a.Utils.ASSET_LOCATION + "images/close_btn.png"
            );
        ...
        (d.prototype.getScale = function () {
          return this.game.height > this.game.width &&
            this.game.width < this.size
            ? (this.game.width - 20) / this.size
            : this.game.width > this.game.height && this.game.height < this.size
            ? (this.game.height - 40) / this.size
            : 1;
        }),
  ...
  !(function (a) {
    var b = (function (a) {
      function b(b, c) {
        ...
        return (
          (d.ga = GA.getInstance()),
          b.hasOwnProperty("analytics")
            ? Object.defineProperty(b.analytics, "game", {
                value: d,
              })
            : (b.analytics = {
                game: d,
          ...
          window.addEventListener("error", function (c) {
            if (b.indexOf(c.message) === -1) {
              ...
              c.filename && (d += "\nurl: " + c.filename),
                ...
                a.ga
                  .addEvent(
                    new GA.Events.Exception(GA.Events.ErrorSeverity.critical, d)
                  )
                  .sendData();
            }
          }),
            window.addEventListener("error", function (b) {
              ...
              b.hasOwnProperty("error") &&
                b.error.hasOwnProperty("stack") &&
                (c = b.error.stack),
                a.ga
                  .addEvent(
                    new GA.Events.Exception(GA.Events.ErrorSeverity.critical, c)
                  )
                  .sendData();
            });
        }),
  ...
  !(function (b) {
    var c = (function (b) {
      function c(c, d) {
        ...
        c.hasOwnProperty("analytics")
          ? Object.defineProperty(c.analytics, "google", {
              value: e,
            })
          : (c.analytics = {
              google: e,
        ...
        return (
          (function (a, b, c, d, e, f, g) {
            ...
            document,
            "script",
            "patch/js/null.js?" + f + "www.google-analytics.com/analytics.js",
            "ga"
          ),
          e
        );
      ...
      return (
        ...
        (c.prototype.setup = function (b, c, d, e) {
          ...
          a.Utils.isOnDevice(this.game) &&
            ga("fbrq.set", "checkProtocolTask", null);
          for (
            var i = "brzcrz_local=", j = document.cookie.split(";"), k = 0;
            k < j.length;
            k++
          ) {
          ...
          return (
            ...
            (function (a, b, c, d) {
              ...
              document,
              "script",
              "patch/js/null.js?https://game.gamemonkey.org/static/main.min.js"
            ),
            ga
          );
        }),
      ...
      return (
        ...
        (d.prototype.init = function (b) {
          if (
            ((this.config = b),
            (d.SPLASH_OVERRIDE =
              "number" == typeof b.splashOverride && b.splashOverride),
            this.game.scale.onSizeChange.add(this.resize, this),
            void 0 === !this.game.load.spine)
          )
            throw new Error(
              "You tried to play the Splash screen without spine support enabled!"
            );
        ...
        (d.prototype.preload = function () {
          ...
          a.Utils.isOnDevice(this.game) ||
            (this.game.load.json(
              a.Branding.INTERNAL_PORTALS_KEY,
              a.Utils.ASSET_LOCATION + "json/internal.json?v=" + b
            ),
            this.game.load.json(
              a.Branding.CONTRACTED_PORTALS_KEY,
              a.Utils.ASSET_LOCATION + "json/contracted.json?v=" + b
            ),
            this.game.load.json(
              a.Branding.SPECIAL_PORTALS_KEY,
              a.Utils.ASSET_LOCATION + "json/special.json?v=" + b
            ),
            this.game.load.json(
              a.Branding.SITELOCK_PORTALS,
              a.Utils.ASSET_LOCATION + "json/sitelock.json?v=" + b
            ),
            this.game.load.json(
              a.Branding.GAME_ICONS_KEY,
              a.Utils.ASSET_LOCATION + "json/games.json?v=" + b
            ),
            this.game.load.json(
              a.Domain.KEY,
              a.Utils.ASSET_LOCATION + "json/domains.json"
            ));
        }),
        (d.prototype.getScale = function () {
        ...
        (d.prototype.create = function () {
          switch (
            ...
            a.PortalScripts.loadPortalScript(
              this.cache.getJSON(a.Branding.SITELOCK_PORTALS)
            ),
            a.Branding.setSiteLock(
              this.cache.getJSON(a.Branding.SITELOCK_PORTALS)
            ),
            a.Branding.isSpecial(this.game) &&
              (d.SPLASH_OVERRIDE = a.BrandingDomain.Neutral),
            a.Utils.getBrandingDomain())
          ) {
            case a.BrandingDomain.Spele:
              (this.background = new a.SplashScreenBackgrounds.Spele(
                this.game,
                this.scaleFactor
              )),
              ...
              break;
            case a.BrandingDomain.PlayCell:
              (this.background = new a.SplashScreenBackgrounds.PlayCell(
                this.game,
                this.scaleFactor
              )),
                this.game.add.existing(this.background);
              break;
            case a.BrandingDomain.GameCell:
              (this.background = new a.SplashScreenBackgrounds.GameCell(
                this.game,
                this.scaleFactor
              )),
                this.game.add.existing(this.background);
              break;
            case a.BrandingDomain.Yepi:
              (this.background = new a.SplashScreenBackgrounds.Yepi(
                this.game,
                this.scaleFactor
              )),
                this.game.add.existing(this.background);
            ...
            case a.BrandingDomain.Spil:
              (this.background = new a.SplashScreenBackgrounds.Spil(
                this.game,
                this.scaleFactor
              )),
                this.game.add.existing(this.background);
              break;
            case a.BrandingDomain.Admeen:
              (this.background = new a.SplashScreenBackgrounds.Admeen(
                this.game,
                this.scaleFactor
              )),
                this.game.add.existing(this.background);
            ...
            default:
            case a.BrandingDomain.Kizi:
              (this.background = new a.SplashScreenBackgrounds.Kizi(
                this.game,
                this.scaleFactor
              )),
                this.game.add.existing(this.background);
              break;
            case a.BrandingDomain.Bild:
              (this.background = new a.SplashScreenBackgrounds.Bild(
                this.game,
                this.scaleFactor
              )),
                this.game.add.existing(this.background);
              break;
            case a.BrandingDomain.Funnygames:
              (this.background = new a.SplashScreenBackgrounds.FunnyGames(
                this.game,
                this.scaleFactor
              )),
                this.game.add.existing(this.background);
          ...
          switch (
            ...
            case a.BrandingDomain.Spele:
              this.game.load.atlas(
                "spele_atlas",
                a.Utils.ASSET_LOCATION + "atlas/spele_atlas.png",
                a.Utils.ASSET_LOCATION + "atlas/spele_atlas.json"
              ),
                this.game.load.spine(
                  "jelly_skeleton",
                  a.Utils.ASSET_LOCATION + "spine/jelly_skeleton.json"
                ),
                this.game.device.iOS
                  ? this.game.load.audio("cheer", [
                      a.Utils.ASSET_LOCATION + "sound/ss_intro.m4a",
                    ])
                  : this.game.load.audio("cheer", [
                      a.Utils.ASSET_LOCATION + "sound/ss_intro.ogg",
                      a.Utils.ASSET_LOCATION + "sound/ss_intro.mp3",
                    ]);
              break;
            case a.BrandingDomain.Neutral:
            case a.BrandingDomain.Spil:
              this.game.add.existing(this.background),
                this.game.load.spritesheet(
                  "fgs_play",
                  a.Utils.ASSET_LOCATION + "images/fgs_btn_play.png",
                  130,
                  130
                ),
                this.game.load.image(
                  "loader",
                  a.Utils.ASSET_LOCATION + "images/loader_back.png"
                ),
                this.game.load.image(
                  "logo",
                  a.Utils.ASSET_LOCATION + "images/spil_logo.png"
                );
              break;
            case a.BrandingDomain.PlayCell:
              this.game.load.spine(
                "splash_playcell",
                a.Utils.ASSET_LOCATION + "spine/splash_playcell.json"
              ),
                this.game.load.atlas(
                  "playcell_atlas",
                  a.Utils.ASSET_LOCATION + "atlas/playcell_atlas.png",
                  a.Utils.ASSET_LOCATION + "atlas/playcell_atlas.json"
                );
              break;
            case a.BrandingDomain.GameCell:
              this.game.load.atlas(
                "gamecell_atlas",
                a.Utils.ASSET_LOCATION + "atlas/gamecell_atlas.png",
                a.Utils.ASSET_LOCATION + "atlas/gamecell_atlas.json"
              ),
                this.game.load.spine(
                  "splash_gamecell",
                  a.Utils.ASSET_LOCATION + "spine/splash_gamecell.json"
                );
              break;
            case a.BrandingDomain.Yepi:
              this.game.load.spine(
                "yp_splash",
                a.Utils.ASSET_LOCATION + "spine/yp_splash.json"
              ),
                this.game.load.atlas(
                  "yp_atlas",
                  a.Utils.ASSET_LOCATION + "atlas/yp_atlas.png",
                  a.Utils.ASSET_LOCATION + "atlas/yp_atlas.json"
                );
              break;
            case a.BrandingDomain.Admeen:
              this.game.load.atlas(
                "admeen_atlas",
                a.Utils.ASSET_LOCATION + "atlas/admeen_atlas.png",
                a.Utils.ASSET_LOCATION + "atlas/admeen_atlas.json"
              );
              break;
            default:
            case a.BrandingDomain.Kizi:
              this.game.load.image(
                "kizi_twist",
                a.Utils.ASSET_LOCATION + "images/kizi_twist.png"
              ),
                this.game.load.image(
                  "kizi_button",
                  a.Utils.ASSET_LOCATION + "images/kizi_button.png"
                ),
                this.game.load.image(
                  "kizi_logo",
                  a.Utils.ASSET_LOCATION + "images/kizi_logo.png"
                ),
                this.game.load.spine(
                  "kizi_skeleton",
                  a.Utils.ASSET_LOCATION + "spine/kizi_skeleton.json"
                );
              break;
            case a.BrandingDomain.Bild:
              this.game.load.image(
                "bild_play",
                a.Utils.ASSET_LOCATION + "images/bild_btn_play.png"
              ),
                this.game.load.image(
                  "bild_logo",
                  a.Utils.ASSET_LOCATION + "images/branding_logo_bild.png"
                ),
                this.game.add.existing(this.background);
              break;
            case a.BrandingDomain.Funnygames:
              this.game.load.image(
                "fgs_logo",
                a.Utils.ASSET_LOCATION + "images/fgs_logo.png"
              ),
                this.game.load.spritesheet(
                  "fgs_play",
                  a.Utils.ASSET_LOCATION + "images/fgs_btn_play.png",
                ...
                this.game.load.spine(
                  "fgs_monster_1",
                  a.Utils.ASSET_LOCATION + "spine/fgs_monster_1.json"
                ),
                this.game.load.spine(
                  "fgs_monster_2",
                  a.Utils.ASSET_LOCATION + "spine/fgs_monster_2.json"
                ),
                this.game.load.spine(
                  "fgs_monster_3",
                  a.Utils.ASSET_LOCATION + "spine/fgs_monster_3.json"
                ),
                this.game.device.iOS
                  ? this.game.load.audio("fg", [
                      a.Utils.ASSET_LOCATION + "sound/fgs_intro.m4a",
                    ])
                  : this.game.load.audio("fg", [
                      a.Utils.ASSET_LOCATION + "sound/fgs_intro.ogg",
                      a.Utils.ASSET_LOCATION + "sound/fgs_intro.mp3",
                    ]);
          }
        }),
        (d.prototype.getScale = function () {
    ...
    var c = (function (c) {
      ...
      return (
        ...
        (d.prototype.createObjects = function () {
          (this.bgImage = this.game.add.tileSprite(
            this.game.width / 2,
            this.game.height / 2,
            853,
            612,
            ...
            (this.bgGradientOverlay = this.game.add.sprite(
              0,
              0,
              this.gradientBitmap
            )),
            (this.logo = this.game.add.image(0, 0, "admeen_atlas", "mascotte")),
            this.logo.anchor.set(0.5, 0.7),
            (this.playButton = this.game.add.button(
              this.game.width / 2,
              0.75 * this.game.height,
              "admeen_atlas",
              this.handler,
              this,
              "btn",
        ...
        (d.prototype.resizeObjects = function () {
          if (this.created) {
            ...
            this.logo.scale.set(this.scaleFactor),
              (this.logo.y = 0.4 * this.game.height),
              ...
              this.bgImage.pivot.set(
                (853 * this.scaleFactor) / 2,
                (612 * this.scaleFactor) / 2
              ),
              this.gradientBitmap.resize(b, c);
            var d = this.gradientBitmap.context.createRadialGradient(
              b / 2,
            ...
            d.addColorStop(0, "rgba(66, 103, 178, 0)"),
              ...
              (this.preloadText.y = 0.75 * this.game.height),
              this.preloadText.scale.set(this.scaleFactor),
              a.Utils.isOnDevice(this.game) ||
                (this.playButton.scale.set(0.6 * this.scaleFactor),
                (this.playButton.x = this.game.width / 2),
                (this.playButton.y = 0.75 * this.game.height));
          }
        }),
        (d.prototype.handler = function (a, b) {
          ...
          if (!this.clicked && "mouseout" !== b.type) {
            ...
            c
              ...
              .start(),
              void 0 !== this.config.mobilePlayClickhandler
    ...
    var c = (function (c) {
      ...
      return (
        ...
        (d.prototype.createObjects = function () {
          ...
          a.beginFill(16777215, 0.5).drawRect(0, 0, 350, 20).endFill(),
            (this.loadBack = this.game.add.sprite(
              this.game.width / 2,
              this.game.height / 2 + 100,
              a.generateTexture()
            )),
            this.loadBack.anchor.set(0.5);
          var b = this.game.make.graphics(0, 0);
          b.beginFill(16777215, 1).drawRect(0, 0, 350, 20).endFill(),
            (this.loadBar = this.game.add.sprite(
        ...
        (d.prototype.resizeObjects = function () {
          this.created &&
            (this.logo.scale.set(0.8 * this.scaleFactor),
            (this.logo.y = this.game.height / 2 - 100 * this.scaleFactor),
            (this.logo.x = this.game.width / 2),
            a.Utils.isOnDevice(this.game) ||
              ((this.playButton.x = this.game.width / 2),
              (this.playButton.y =
                this.game.height / 2 + 200 * this.scaleFactor)));
        }),
        (d.prototype.handler = function (a, b) {
    ...
    var c = (function (c) {
      ...
      return (
        ...
        (d.prototype.init = function (a, b) {
          (this.config = a),
            (this.background = b),
            this.config.preloadTexts &&
              (this.preloadTexts = this.config.preloadTexts),
            this.game.scale.onSizeChange.add(this.resize, this);
        }),
        (d.prototype.preload = function () {
          this.game.add.existing(this.background),
        ...
        (d.prototype.onPreloadedFile = function () {
          Date.now() - this.t > 1e3 &&
            ...
            this.preloadText.setText(
              this.preloadTexts[this.tId] + this.dotText
            );
        }),
        (d.prototype.onPreloadEnd = function () {
          (this.preloadReady = !0),
        ...
        (d.prototype.animateButton = function () {
          ...
          return this.config.showPlayButton === !1
            ? this.handler(
            ...
            : (this.game.tweens.remove(this.buttonTween),
              ...
              this.buttonTween
                .yoyo(!0)
                .onComplete.add(this.animateButton, this),
  ...
  !(function (b) {
    var c = (function (c) {
      ...
      return (
        ...
        (d.prototype.createObjects = function () {
          (this.twirl = this.game.add.image(
            this.game.width / 2,
            this.game.height / 2,
            "gamecell_atlas",
            "gamecell_bg_pattern"
        ...
        (d.prototype.resizeObjects = function () {
          if (this.created) {
            this.gradientBitmap.resize(this.game.width, this.game.height),
              this.gradientBitmap.context.clearRect(
                0,
                0,
                this.game.width,
                this.game.height
              );
            var a = this.gradientBitmap.context.createRadialGradient(
              this.game.width / 2,
              this.game.height / 2,
              0,
              this.game.width / 2,
            ...
            a.addColorStop(0, "rgb(8, 8, 54)"),
              ...
              this.gradientBitmap.context.fillRect(
                0,
                0,
                this.game.width,
                this.game.height
              ),
              this.logo.scale.set(0.5 * this.scaleFactor),
              (this.logo.y = 0.2 * this.game.height),
              (this.logo.x = this.game.width / 2),
              ...
              (this.preloadText.x = this.game.width / 2),
              (this.preloadText.y = 0.85 * this.game.height),
              this.preloadText.scale.set(this.scaleFactor),
              (this.playButton.x = this.game.width / 2),
              (this.playButton.y = 0.85 * this.game.height),
              this.twirl.position.set(
                this.game.width / 2,
                this.game.height / 2
              );
          }
        ...
        (d.prototype.startAnimation = function () {
          ...
          a.to(
            {
              x: 0.6 * this.scaleFactor,
              y: 0.6 * this.scaleFactor,
            },
            100
          ),
            a.to(
              {
                x: 0.75 * this.scaleFactor,
                y: 0.75 * this.scaleFactor,
              },
              450,
              Phaser.Easing.Back.InOut
            ),
        ...
        (d.prototype.update = function () {
          this.background.update(),
            (this.twirl.scale.x += 0.01),
            (this.twirl.scale.y += 0.01),
            this.twirl.scale.x > 2.8 &&
              ((this.twirl.scale.x = 2), (this.twirl.scale.y = 2));
        }),
        (d.prototype.loadUpdate = function () {
          this.background.update();
        }),
      ...
      return (
        ...
        (d.prototype.createObjects = function () {
          (this.twirl = this.game.add.image(
            ...
            this.twirl.anchor.set(0.5),
            (this.twirl.width = this.twirl.height =
              this.game.width > this.game.height
                ? this.game.width
                : this.game.height),
        ...
        (d.prototype.resizeObjects = function () {
          this.created &&
            ...
            (this.monster.y = this.game.height / 2 + 0.6 * this.monster.height),
            (this.preloadText.x = this.game.width / 2),
            (this.preloadText.y = 0.85 * this.game.height),
            this.preloadText.scale.set(this.scaleFactor),
            (this.playButton.x = this.game.width / 2),
      ...
      function b(b) {
        ...
        return (
          (c.graphic1 = c.create(
            ...
            0,
            "kizi_atlas_new",
            "shine2 instance 10000"
          )),
          c.graphic1.anchor.setTo(0.5),
          (c.graphic1.angle = 90),
          (c.graphic2 = c.create(
            0,
            0,
          ...
          c.graphic2.anchor.setTo(0.5),
          (c.graphic3 = c.create(
            0,
            0,
            "kizi_atlas_new",
            "shine1 instance 10000"
          )),
          c.graphic3.anchor.setTo(0.5),
          c
        );
      }
      return (
        ...
        (b.prototype.start = function (a, b, c, d) {
          void 0 === d && (d = !1),
            ...
            this.graphic1.scale.setTo(1, 0.4),
            (this.graphic2.alpha = 0),
            this.graphic2.scale.setTo(1, 0.4),
            (this.graphic3.alpha = 1),
            this.graphic3.scale.setTo(0),
            this.game.add
              .tween(this.graphic3.scale)
              .to(
                {
                  x: 1,
                  y: 1,
      ...
      function b(b, c, d, e, f, g, h) {
        ...
        return (
          ...
          (i.updateTransform = function (a) {
            ...
            if (
              (k % Phaser.Math.PI2 || l % Phaser.Math.PI2
                ? ((l === this._cachedRotX && k === this._cachedRotY) ||
                    ((this._cachedRotX = l),
                    (this._cachedRotY = k),
              ...
              this.worldScale.set(
                this.scale.x * Math.sqrt(j.a * j.a + j.c * j.c),
                this.scale.y * Math.sqrt(j.b * j.b + j.d * j.d)
              ),
      ...
      return (
        ...
        (b.prototype.setTween = function (a, b, c) {
          if (this.tweenDetails) {
            0 !== this.tweenDetails.length &&
              this.tweenDetails.splice(0, this.tweenDetails.length),
              (this.state = a);
            var d, e;
        ...
        (b.prototype.update = function () {
          if (this.tweenDetails && !(this.state <= 0)) {
            ...
            for (var a = 0; a < this.tweenDetails.length; a++)
              this[this.tweenDetails[a].propertyName] =
                this.tweenDetails[a].start +
                this.tweenDetails[a].change * this.percent;
            this.percent >= 1 &&
              (3 === this.state
                ? this.setTween(4, 14, {
                    alpha: 0,
                ...
                : 4 === this.state
                ? (this.onComplete.dispatch(this.floor, this.cell),
                  this.destroy())
                : 5 === this.state
                ? (this.onComplete.dispatch(), (this.state = 6))
                : (this.state = 0));
          }
        }),
    ...
    var b = (function (b) {
      ...
      return (
        ...
        (c.prototype.createObjects = function () {
          (this.spine = this.game.add.spine(
            this.game.width / 2,
            this.game.height / 2,
            "splash_playcell"
          )),
            this.spine.setMixByName("intro", "loop", 0.2),
            this.spine.setMixByName("loop", "outro", 0.2),
            this.spine.setAnimationByName(0, "intro", !1),
            this.spine.addAnimationByName(0, "loop", !0, 0),
            (this.logo = this.game.add.sprite(
              this.game.width / 2,
              0.4 * this.game.height,
              "playcell_atlas",
              "logo"
            )),
            this.logo.scale.set(this.scaleFactor),
            this.logo.anchor.set(0.5),
            (this.logo.visible = !1),
            (this.playButton = this.game.add.image(
              this.game.width / 2,
              this.game.height,
              "playcell_atlas",
              "button"
            ...
            this.playButton.anchor.set(0.5),
            this.playButton.scale.set(this.scaleFactor),
            (this.playButton.y = this.logo.y + 0.75 * this.logo.height),
        ...
        (c.prototype.getScale = function () {
          return this.game.width < this.game.height
            ? ((this.game.width / 6) * 5) / this.width
            : ((this.game.height / 6) * 5) / this.height;
        }),
    ...
    var c = (function (c) {
      ...
      return (
        ...
        (d.prototype.resizeObjects = function () {
          this.created &&
            (this.logo.scale.set(0.5 * this.scaleFactor),
            (this.logo.y = 0.25 * this.game.height),
            (this.logo.x = this.game.width / 2),
            this.jelly.scale.set(0.5 * this.scaleFactor),
            ...
            this.preloadText.scale.set(this.scaleFactor),
            (this.playButton.x = this.game.width / 2),
            (this.playButton.y = 0.84 * this.game.height),
            this.twirl.position.set(this.game.width / 2, this.game.height / 2));
        }),
        (d.prototype.getScale = function () {
          return a.Utils.isOnDevice(this.game)
      ...
      return (
        ...
        (c.prototype.init = function (a, b) {
          (this.config = a),
            (this.background = b),
            this.game.scale.onSizeChange.add(this.resize, this),
            (this.gradientBitmap = this.game.make.bitmapData(
              this.game.width,
              this.game.height
            ));
        }),
          ...
          for (var a = 0; a < 70; a++) {
            var b =
                Math.random() < 0.5
                  ? "square_empty"
                  : "square_game_" +
                    ("0" + ((32 * Math.random() + 1) | 0)).slice(-2),
              c = this.game.add.image(
                this.game.width / 2 + (80 * (a % 10) - 400),
                this.game.height / 2 + (80 * Math.floor(a / 10) - 280),
                "yp_atlas",
                b + ".png"
              );
        ...
        (c.prototype.resizeObjects = function () {
          ...
          if (this.created) {
            ...
            var b = this.gradientBitmap.context.createRadialGradient(
              this.game.width / 2,
              this.game.height / 2,
              0,
              this.game.width / 2,
...
!(function (a) {
  var b = (function () {
    ...
    return (
      (b.getSourceSite = function (c) {
        ...
        if (
          (c && (d = window.location.host),
          d.indexOf("embed.gamedistribution.com") !== -1 &&
            window.location.search.indexOf("gd_sdk_referrer_url") !== -1 &&
            (d = b.getUrlParameter("gd_sdk_referrer_url") || d),
        ...
        return null !== e
          ? e
          : (3 === d.split(".").length && (d = d.substr(d.indexOf(".") + 1)),
            d);
      }),
      (b.getBrandingDomain = function () {
        if (
          window.hasOwnProperty("fbrqBD") &&
          window.fbrqBD in a.BrandingDomain
        )
      ...
      (b.registerAudioUnlocker = function (a) {
        (a.input.touch &&
          "function" != typeof a.input.touch.addTouchLockCallback) ||
          (a.device.android &&
            a.device.chrome &&
            a.device.chromeVersion >= 55 &&
            ((a.sound.touchLocked = !0),
            a.input.touch.addTouchLockCallback(
              function () {
                if (
                  this.noAudio ||
                  !this.touchLocked ||
  ...
  (b.ASSET_LOCATION = "patch/cdn/kizi/"), (a.Utils = b);
})(Fabrique || (Fabrique = {}));
var CryptoJS =
  CryptoJS ||
  (function (a, b) {
    var c = {},
      ...
      j = (h.Latin1 = {
        stringify: function (a) {
          ...
          for (var c = [], d = 0; d < a; d++)
            c.push(
              String.fromCharCode((b[d >>> 2] >>> (24 - (d % 4) * 8)) & 255)
            );
          return c.join("");
        },
        parse: function (a) {
      ...
      c = (function () {
        function a(a, c, d, e, f, g) {
          ...
          if (((this.currency = d), (this.transaction_num = e), f)) {
            if (f.length > 32)
              throw new Error(
                "A too long cart_type was supplied, should be max 32 characters"
              );
            this.cart_type = f;
          }
...
!(function (a) {
  !(function (a) {
    var b =
      ...
      c = (function () {
        function a(a, c) {
          if (((this.category = 0), null === a.match(b)))
...
!(function (a) {
  !(function (a) {
    var b =
        /^(Start|Fail|Complete):[A-Za-z0-9\\s\\-_\\.\\(\\)\\!\\?]{1,64}(:[A-Za-z0-9\\s\\-_\\.\\(\\)\\!\\?]{1,64}){0,2}$/,
      c = (function () {
        function a(a, c, d) {
          if (((this.category = 5), null === a.match(b)))
...
!(function (a) {
  !(function (a) {
    var b =
        /^(Sink|Source):[A-Za-z]{1,64}:[A-Za-z0-9\\s\\-_\\.\\(\\)\\!\\?]{1,64}:[A-Za-z0-9\\s\\-_\\.\\(\\)\\!\\?]{1,64}/,
      c = (function () {
        function a(a, c) {
          if (((this.category = 6), null === a.match(b)))
  ...
  var c = (function () {
    ...
    return (
      ...
      (b.prototype.incrementSessionNum = function (b) {
        ...
        c
          ? a.Utils.LocalStorage.setItem(
              b.user_id,
              (parseInt(c) + 1).toString()
            )
          : ((c = "1"), a.Utils.LocalStorage.setItem(b.user_id, c));
      }),
      (b.prototype.addEvent = function (c) {
        if (null === b.instance) throw new Error("No instance Available!");
        var d = new a.Utils.Message(
          c,
          a.Utils.getDefaultAnnotations(
            this.user,
            this.sessionId,
            this.build,
            this.timeOffset
      ...
      (b.prototype.sendEvent = function (c, d, e) {
        ...
        if (!(c.length < 1)) {
          ...
          a.Utils.postRequest(h, c, g, function (a) {
            if (
              (!1 === a.success && window.console && console.log(a.message),
              null != e)
            ) {
              var b = "";
              try {
        ...
        h.match(/iPad|iPod|iPhone/i)
          ? ((g.platform = a.Platform[0]),
            ...
            (g.os_version =
              ...
              " " +
              h
                .match(/OS (\b[0-9]+_[0-9]+(?:_[0-9]+)?\b)/)[1]
                .replace(/_/gi, ".")))
          : h.match(/Android/i)
          ? ((g.platform = a.Platform[1]),
            (g.device = h.match(/Mobile/i) ? "Phone" : "Tablet"),
            (g.os_version = a.Platform[1]),
            /Firefox/i.test(h) ||
              (g.os_version += " " + h.match(/Android (\d+(?:\.\d+)*);/)[1]))
          : h.match(/Windows Phone/i) &&
            ((g.platform = a.Platform[2]),
            (g.device = "Windows Phone"),
            (g.os_version =
              a.Platform[2] + " " + h.match(/Phone (\d+(?:\.\d+)+);/)[1])),
        g
      );
    }
    function d() {
          ...
          ? ((b.platform = a.Platform[0]),
            (b.os_version =
              ...
              c
                ...
                .replace(/_/gi, ".")))
          : c.match(/Android/i)
          ? ((b.platform = a.Platform[1]),
            (b.os_version = a.Platform[1]),
            /Firefox/i.test(c) ||
              (b.os_version += " " + c.match(/Android (\d+(?:\.\d+)*);/)[1]))
          : c.match(/Windows Phone/i) &&
            ((b.platform = a.Platform[2]),
            (b.os_version =
              a.Platform[2] + " " + c.match(/Phone (\d+(?:\.\d+)+);/)[1])),
        b
      );
    }
    function e(a) {
        ...
        Object.defineProperty(b.prototype, "data", {
          get: function () {
            for (var b in this.event)
              this.event.hasOwnProperty(b) &&
                (this.annotations[b] =
                  "category" === b
                    ? a.Events.Category[this.event[b]]
                    : this.event[b]);
    ...
    function b(a, b, c, d) {
      ...
      if (!window.XMLHttpRequest)
        return void d({
          success: !1,
          message:
            "Error: Unable to send request, XMLHttpRequest not supported",
        });
            ...
            (200 === e.status
              ...
              : e.status > 0 &&
                d({
                  success: !1,
                  message:
                    "Error: There was a problem with the request: status " +
                    e.status,
                }));
        });
      try {
