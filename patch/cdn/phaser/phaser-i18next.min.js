...
!(function (a, b) {
  ...
  function c(a, b, c) {
    ...
    for (
      var f = "string" != typeof b ? [].concat(b) : b.split(".");
      f.length > 1;
  ...
  function j(a) {
    return (
      (a.interpolation = { unescapeSuffix: "HTML" }),
      (a.interpolation.prefix = a.interpolationPrefix || "__"),
      (a.interpolation.suffix = a.interpolationSuffix || "__"),
      (a.interpolation.escapeValue = a.escapeInterpolation || !1),
      (a.interpolation.nestingPrefix = a.reusePrefix || "$t("),
      (a.interpolation.nestingSuffix = a.reuseSuffix || ")"),
      a
    );
  }
  function k(a) {
    return (
      a.resStore && (a.resources = a.resStore),
      a.ns && a.ns.defaultNs
        ? ((a.defaultNS = a.ns.defaultNs), (a.ns = a.ns.namespaces))
        : (a.defaultNS = a.ns || "translation"),
      a.fallbackToDefaultNS && a.defaultNS && (a.fallbackNS = a.defaultNS),
      (a.saveMissing = a.sendMissing),
      (a.saveMissingTo = a.sendMissingTo || "current"),
      (a.returnNull = !a.fallbackOnNull),
      (a.returnEmptyString = !a.fallbackOnEmpty),
      (a.returnObjects = a.returnObjectTrees),
      (a.joinArrays = "\n"),
      (a.returnedObjectHandler = a.objectTreeKeyHandler),
      (a.parseMissingKeyHandler = a.parseMissingKey),
      (a.appendNamespaceToMissingKey = !0),
      (a.nsSeparator = a.nsseparator || ":"),
      (a.keySeparator = a.keyseparator || "."),
      "sprintf" === a.shortcutFunction &&
        (a.overloadTranslationOptionHandler = function (a) {
          for (var b = [], c = 1; c < a.length; c++) b.push(a[c]);
          return { postProcess: "sprintf", sprintf: b };
        }),
      (a.whitelist = a.lngWhitelist),
      (a.preload = a.preload),
      "current" === a.load && (a.load = "currentOnly"),
      "unspecific" === a.load && (a.load = "languageOnly"),
      (a.backend = a.backend || {}),
      (a.backend.loadPath = a.resGetPath || "locales/__lng__/__ns__.json"),
      (a.backend.addPath = a.resPostPath || "locales/add/__lng__/__ns__"),
      (a.backend.allowMultiLoading = a.dynamicLoad),
      (a.cache = a.cache || {}),
      (a.cache.prefix = "res_"),
      (a.cache.expirationTime = 6048e5),
      (a.cache.enabled = a.useLocalStorage),
      (a = j(a)),
      a.defaultVariables &&
        (a.interpolation.defaultVariables = a.defaultVariables),
      a
    );
  }
  function l(a) {
    return (a = j(a)), (a.joinArrays = "\n"), a;
  }
  function m(a) {
    return (
      (a.interpolationPrefix ||
        a.interpolationSuffix ||
        void 0 !== a.escapeInterpolation) &&
        (a = j(a)),
      (a.nsSeparator = a.nsseparator),
      (a.keySeparator = a.keyseparator),
      (a.returnObjects = a.returnObjectTrees),
    ...
    (a.lng = function () {
      ...
      (a.setLng = function (b, c, d) {
        return (
          ...
          c || (c = {}),
          c.fixLng === !0 && d
            ? d(null, a.getFixedT(b))
            : a.changeLanguage(b, d)
        );
      }),
      (a.addPostProcessor = function (b, c) {
        D.deprecate(
          ...
          a.use({ type: "postProcessor", name: b, process: c });
      });
  }
  function o(a) {
    ...
    return (
      K.forEach(function (b) {
        b.lngs.forEach(function (c) {
          a[c] = { numbers: b.nr, plurals: L[b.fc] };
        });
      }),
      a
    );
  ...
  function q(a, b) {
    for (var c = a.indexOf(b); c !== -1; ) a.splice(c, 1), (c = a.indexOf(b));
  }
  function r() {
    return {
      debug: !1,
  ...
  function s(a) {
    return (
      ...
      "string" == typeof a.fallbackLng && (a.fallbackLng = [a.fallbackLng]),
      "string" == typeof a.fallbackNS && (a.fallbackNS = [a.fallbackNS]),
      a.whitelist &&
        a.whitelist.indexOf("cimode") < 0 &&
        a.whitelist.push("cimode"),
      a
    );
  }
  function t() {}
  var u =
    ...
    B = {
      ...
      output: function (a, b) {
        var c;
        console && console[a] && (c = console)[a].apply(c, A(b));
      },
    },
    C = (function () {
      function a(b) {
      ...
      return (
        ...
        (a.prototype.create = function (b) {
          return new a(
            this.logger,
            w({ prefix: this.prefix + ":" + b + ":" }, this.options)
          );
        }),
        a
      );
    ...
    G = (function (a) {
      ...
      return (
        x(b, a),
        (b.prototype.addNamespaces = function (a) {
        ...
        (b.prototype.getResource = function (a, b, c) {
          var d =
              arguments.length > 3 && void 0 !== arguments[3]
                ? arguments[3]
                : {},
            e = d.keySeparator || this.options.keySeparator;
          void 0 === e && (e = ".");
          var g = [a, b];
          return (
            c && "string" != typeof c && (g = g.concat(c)),
            c && "string" == typeof c && (g = g.concat(e ? c.split(e) : c)),
        ...
        (b.prototype.addResource = function (a, b, c, e) {
          ...
          void 0 === g && (g = ".");
          var h = [a, b];
          c && (h = h.concat(g ? c.split(g) : c)),
            a.indexOf(".") > -1 && ((h = a.split(".")), (e = b), (b = h[1])),
            this.addNamespaces(b),
            d(this.data, h, e),
            f.silent || this.emit("added", a, b, c, e);
        }),
        (b.prototype.addResources = function (a, b, c) {
          for (var d in c)
            "string" == typeof c[d] &&
              this.addResource(a, b, d, c[d], { silent: !0 });
          this.emit("added", a, b, c);
        }),
        (b.prototype.addResourceBundle = function (a, b, c, e, h) {
          var i = [a, b];
          a.indexOf(".") > -1 &&
            ((i = a.split(".")), (e = c), (c = b), (b = i[1])),
            this.addNamespaces(b);
          var j = f(this.data, i) || {};
          e ? g(j, c, h) : (j = w({}, j, c)),
            d(this.data, i, j),
        ...
        (b.prototype.removeResourceBundle = function (a, b) {
          this.hasResourceBundle(a, b) && delete this.data[a][b],
        ...
        (b.prototype.getResourceBundle = function (a, b) {
          return (
            b || (b = this.options.defaultNS),
            "v1" === this.options.compatibilityAPI
              ? w({}, this.getResource(a, b))
    ...
    I = (function (a) {
      function c(d) {
        ...
        return (
          ...
          (f.options = e),
          (f.logger = D.create("translator")),
          f
        );
      }
      return (
        x(c, a),
        (c.prototype.changeLanguage = function (a) {
          a && (this.language = a);
        }),
        (c.prototype.exists = function (a) {
          var b =
            arguments.length > 1 && void 0 !== arguments[1]
              ...
              : { interpolation: {} };
          return (
            "v1" === this.options.compatibilityAPI && (b = m(b)),
            void 0 !== this.resolve(a, b)
          );
        }),
        (c.prototype.extractFromKey = function (a, b) {
          ...
          var d = b.keySeparator || this.options.keySeparator || ".",
            e = b.ns || this.options.defaultNS;
          if (c && a.indexOf(c) > -1) {
            var f = a.split(c);
            (c !== d || (c === d && this.options.ns.indexOf(f[0]) > -1)) &&
              (e = f.shift()),
              (a = f.join(d));
          }
          return "string" == typeof e && (e = [e]), { key: a, namespaces: e };
        }),
        (c.prototype.translate = function (a) {
          var b =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
          if (
            ("object" !== ("undefined" == typeof b ? "undefined" : u(b))
              ? (b = this.options.overloadTranslationOptionHandler(arguments))
              : "v1" === this.options.compatibilityAPI && (b = m(b)),
            void 0 === a || null === a || "" === a)
          )
            return "";
          "number" == typeof a && (a = String(a)),
            "string" == typeof a && (a = [a]);
          var c = b.keySeparator || this.options.keySeparator || ".",
            d = this.extractFromKey(a[a.length - 1], b),
            e = d.key,
            f = d.namespaces,
            g = f[f.length - 1],
            h = b.lng || this.language,
            i =
              b.appendNamespaceToCIMode || this.options.appendNamespaceToCIMode;
          if (h && "cimode" === h.toLowerCase()) {
            if (i) {
              var j = b.nsSeparator || this.options.nsSeparator;
              return g + j + e;
            }
            return e;
          }
          var k = this.resolve(a, b),
            l = Object.prototype.toString.apply(k),
            n = ["[object Number]", "[object Function]", "[object RegExp]"],
            o =
              void 0 !== b.joinArrays ? b.joinArrays : this.options.joinArrays;
          if (
            k &&
            "string" != typeof k &&
            n.indexOf(l) < 0 &&
            ...
            if (!b.returnObjects && !this.options.returnObjects)
              return (
                this.logger.warn(
                  "accessing an object - but returnObjects options is not enabled!"
                ),
                this.options.returnedObjectHandler
                  ? this.options.returnedObjectHandler(e, k, b)
                  : "key '" +
                    e +
                    " (" +
                    this.language +
            ...
            if (b.keySeparator || this.options.keySeparator) {
              ...
              for (var q in k)
                Object.prototype.hasOwnProperty.call(k, q) &&
                  (p[q] = this.translate(
                    "" + e + c + q,
                    w({}, b, { joinArrays: !1, ns: f })
                  ));
              k = p;
            }
          } else if (o && "[object Array]" === l)
            (k = k.join(o)), k && (k = this.extendTranslation(k, e, b));
          else {
            var r = !1,
              s = !1;
            if (
              (this.isValidLookup(k) ||
                void 0 === b.defaultValue ||
                ((r = !0), (k = b.defaultValue)),
              this.isValidLookup(k) || ((s = !0), (k = e)),
              s || r)
            ) {
              ...
              if ("fallback" === this.options.saveMissingTo && v && v[0])
                for (var x = 0; x < v.length; x++) t.push(v[x]);
              else
                "all" === this.options.saveMissingTo
                  ? (t = this.languageUtils.toResolveHierarchy(
                      b.lng || this.language
                    ))
                  : t.push(b.lng || this.language);
              this.options.saveMissing &&
                (this.options.missingKeyHandler
                  ? this.options.missingKeyHandler(t, g, e, k)
                  : this.backendConnector &&
                    this.backendConnector.saveMissing &&
                    this.backendConnector.saveMissing(t, g, e, k)),
                this.emit("missingKey", t, g, e, k);
            }
            (k = this.extendTranslation(k, e, b)),
              s &&
                k === e &&
        ...
        (c.prototype.extendTranslation = function (a, b, c) {
          ...
          this.options.interpolation.defaultVariables &&
            (e = w({}, this.options.interpolation.defaultVariables, e)),
            (a = this.interpolator.interpolate(a, e, c.lng || this.language)),
            c.nest !== !1 &&
          ...
          var f = c.postProcess || this.options.postProcess,
          ...
          return (
            ...
            a.forEach(function (a) {
              if (!b.isValidLookup(d)) {
                ...
                var h = void 0 !== c.count && "string" != typeof c.count,
                  i =
                    void 0 !== c.context &&
                    "string" == typeof c.context &&
                    "" !== c.context,
                  j = c.lngs
                    ? c.lngs
                    : b.languageUtils.toResolveHierarchy(c.lng || b.language);
                    ...
                    j.forEach(function (e) {
                      if (!b.isValidLookup(d)) {
                        var g = f,
                          j = [g],
                          k = void 0;
                        h && (k = b.pluralResolver.getSuffix(e, c.count)),
                          h && i && j.push(g + k),
                          i &&
                            j.push(
                              (g += "" + b.options.contextSeparator + c.context)
                            ),
                          h && j.push((g += k));
                        for (var l = void 0; (l = j.pop()); )
                          b.isValidLookup(d) || (d = b.getResource(e, a, l, c));
                      }
                    });
                });
              }
    ...
    J = (function () {
      ...
      return (
        (a.prototype.getScriptPartFromCode = function (a) {
          if (!a || a.indexOf("-") < 0) return null;
          var b = a.split("-");
          return 2 === b.length
            ? null
            : (b.pop(), this.formatLanguageCode(b.join("-")));
        }),
          ...
          if ("string" == typeof a && a.indexOf("-") > -1) {
            ...
            return (
              this.options.lowerCaseLng
                ...
                ? ((c[0] = c[0].toLowerCase()),
                  (c[1] = c[1].toUpperCase()),
                  b.indexOf(c[1].toLowerCase()) > -1 &&
                    (c[1] = o(c[1].toLowerCase())))
                : 3 === c.length &&
                  ((c[0] = c[0].toLowerCase()),
                  ...
                  b.indexOf(c[1].toLowerCase()) > -1 &&
                    (c[1] = o(c[1].toLowerCase())),
                  b.indexOf(c[2].toLowerCase()) > -1 &&
                    (c[2] = o(c[2].toLowerCase()))),
              c.join("-")
            );
          }
        ...
        (a.prototype.getFallbackCodes = function (a, b) {
          ...
          var c = a[b];
          return (
            c || (c = a[this.getScriptPartFromCode(b)]),
            c || (c = a[this.formatLanguageCode(b)]),
            c || (c = a["default"]),
            c || []
          );
        }),
        (a.prototype.toResolveHierarchy = function (a, b) {
          var c = this,
            d = this.getFallbackCodes(b || this.options.fallbackLng || [], a),
            e = [],
            f = function (a) {
              a &&
                (c.isWhitelisted(a)
                  ? e.push(a)
                  : c.logger.warn(
                      "rejecting non-whitelisted language code: " + a
                    ));
            };
          return (
            "string" == typeof a && a.indexOf("-") > -1
              ...
              : "string" == typeof a && f(this.formatLanguageCode(a)),
    ...
    M = (function () {
      function a(b) {
        var c =
          arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        v(this, a),
          (this.languageUtils = b),
          (this.options = c),
          (this.logger = D.create("pluralResolver")),
          (this.rules = p());
      }
      return (
        (a.prototype.addRule = function (a, b) {
          this.rules[a] = b;
        }),
        ...
        (a.prototype.getSuffix = function (a, b) {
          ...
          if (d) {
            ...
            this.options.simplifyPluralSuffix &&
              ...
              (2 === f ? (f = "plural") : 1 === f && (f = ""));
            var g = function () {
              return c.options.prepend && f.toString()
                ? c.options.prepend + f.toString()
                : f.toString();
            };
      ...
      return (
        (b.prototype.init = function () {
          ...
          b &&
            ...
            (this.escape = (a.interpolation && a.interpolation.escape) || i)),
            a.interpolation || (a.interpolation = { escapeValue: !0 });
          var c = a.interpolation;
          (this.escapeValue = void 0 === c.escapeValue || c.escapeValue),
            (this.prefix = c.prefix ? h(c.prefix) : c.prefixEscaped || "{{"),
            (this.suffix = c.suffix ? h(c.suffix) : c.suffixEscaped || "}}"),
            (this.formatSeparator = c.formatSeparator
              ? c.formatSeparator
              : c.formatSeparator || ","),
            (this.unescapePrefix = c.unescapeSuffix
              ? ""
              : c.unescapePrefix || "-"),
            (this.unescapeSuffix = this.unescapePrefix
              ? ""
              : c.unescapeSuffix || ""),
            (this.nestingPrefix = c.nestingPrefix
              ? h(c.nestingPrefix)
              : c.nestingPrefixEscaped || h("$t(")),
            (this.nestingSuffix = c.nestingSuffix
              ? h(c.nestingSuffix)
              : c.nestingSuffixEscaped || h(")")),
            this.resetRegExp();
        }),
        ...
        (b.prototype.interpolate = function (b, c, d) {
          ...
          var g = this,
            ...
            j = function (a) {
              ...
              var b = a.split(g.formatSeparator),
                e = b.shift().trim(),
                h = b.join(g.formatSeparator).trim();
              return g.format(f(c, e), h, d);
            };
          for (this.resetRegExp(); (h = this.regexpUnescape.exec(b)); )
            (i = j(h[1].trim())),
              (b = b.replace(h[0], i)),
              (this.regexpUnescape.lastIndex = 0);
          for (; (h = this.regexp.exec(b)); )
            (i = j(h[1].trim())),
              ...
              i ||
                ...
                (i = "")),
              (i = e(this.escapeValue ? this.escape(i) : i)),
              (b = b.replace(h[0], i)),
        ...
        (b.prototype.nest = function (b, c) {
          function d(a) {
            ...
            a = b.shift();
            var c = b.join(",");
            (c = this.interpolate(c, h)), (c = c.replace(/'/g, '"'));
            try {
              h = JSON.parse(c);
            } catch (d) {
              this.logger.error(
          ...
          for (h.applyPostProcessor = !1; (f = this.nestingRegexp.exec(b)); ) {
            if (
              ((g = c(d.call(this, f[1].trim()), h)),
              g && f[0] === b && "string" != typeof g)
            )
              return g;
            "string" != typeof g && (g = a(g)),
              g ||
                (this.logger.warn(
                  "missed to resolve " + f[1] + " for nesting " + b
                ),
                (g = "")),
              (b = b.replace(f[0], g)),
              (this.regexp.lastIndex = 0);
    ...
    O = (function (a) {
      function b(c, d, e) {
        ...
        return (
          ...
          (g.services = e),
          (g.options = f),
          (g.logger = D.create("backendConnector")),
          (g.state = {}),
          (g.queue = []),
          g.backend && g.backend.init && g.backend.init(e, f.backend, f),
          g
        );
      }
      return (
        x(b, a),
        (b.prototype.queueLoad = function (a, b, c) {
          var d = this,
            e = [],
            f = [],
            g = [],
          ...
          return (
            ...
            { toLoad: e, pending: f, toLoadLanguages: g, toLoadNamespaces: h }
          );
        }),
        (b.prototype.loaded = function (a, b, c) {
          var d = this,
            ...
            h = g[0],
            i = g[1];
          b && this.emit("failedLoading", h, i, b),
            c && this.store.addResourceBundle(h, i, c),
            (this.state[a] = b ? -1 : 2),
        ...
        (b.prototype.read = function (a, b, c) {
          var d =
            ...
            g = arguments[5];
          return a.length
            ? this.backend[c](a, b, function (h, i) {
                return h && i && d < 5
        ...
        (b.prototype.load = function (a, b, c) {
          ...
          "string" == typeof a &&
            (a = this.services.languageUtils.toResolveHierarchy(a)),
            "string" == typeof b && (b = [b]);
          var g = this.queueLoad(a, b, c);
          return g.toLoad.length
            ? void (e.allowMultiLoading && this.backend.readMulti
                ? this.read(
                    g.toLoadLanguages,
                    g.toLoadNamespaces,
                    "readMulti",
                    ...
                    function (a, b) {
                      a &&
                        d.logger.warn(
                          "loading namespaces " +
                            g.toLoadNamespaces.join(", ") +
                            " for languages " +
                            g.toLoadLanguages.join(", ") +
        ...
        (b.prototype.reload = function (a, b) {
          ...
          "string" == typeof a &&
            (a = this.services.languageUtils.toResolveHierarchy(a)),
            "string" == typeof b && (b = [b]),
            d.allowMultiLoading && this.backend.readMulti
              ? this.read(a, b, "readMulti", null, null, function (d, e) {
                  d &&
                    c.logger.warn(
        ...
        (b.prototype.loadOne = function (a) {
          ...
          this.read(f, g, "read", null, null, function (d, e) {
            d &&
              b.logger.warn(
                c + "loading namespace " + g + " for language " + f + " failed",
                d
              ),
              !d &&
                e &&
                b.logger.log(
                  c + "loaded namespace " + g + " for language " + f,
                  e
                ),
              b.loaded(a, d, e);
          });
    ...
    P = (function (a) {
      function b(c, d, e) {
        ...
        return (
          ...
          (g.services = e),
          (g.options = f),
          (g.logger = D.create("cacheConnector")),
          g.cache && g.cache.init && g.cache.init(e, f.cache, f),
          g
        );
      }
      return (
        ...
        (b.prototype.load = function (a, b, c) {
          ...
          var e = w({}, this.cache.options, this.options.cache),
            f =
              "string" == typeof a
                ? this.services.languageUtils.toResolveHierarchy(a)
                : a;
          e.enabled
            ? this.cache.load(f, function (a, b) {
                if (
                  (a &&
                    d.logger.error(
                      "loading languages " +
                  ...
                  for (var e in b)
                    if (Object.prototype.hasOwnProperty.call(b, e))
                      for (var g in b[e])
                        if (
                          Object.prototype.hasOwnProperty.call(b[e], g) &&
                          "i18nStamp" !== g
                        ) {
                          var h = b[e][g];
      ...
      return (
        ...
        (b.prototype.init = function (a, b) {
          ...
          if (
            ...
            a || (a = {}),
            "v1" === a.compatibilityAPI
              ? (this.options = w({}, r(), s(k(a)), {}))
              : "v1" === a.compatibilityJSON
              ? (this.options = w({}, r(), s(l(a)), {}))
              : (this.options = w({}, r(), this.options, s(a))),
            (this.format = this.options.interpolation.format),
            b || (b = t),
            !this.options.isClone)
          ) {
            this.modules.logger
              ? D.init(c(this.modules.logger), this.options)
            ...
            (f.logger = D),
              ...
              f.resourceStore.on("added removed", function (a, b) {
                f.cacheConnector.save();
              }),
              (f.languageUtils = e),
              (f.pluralResolver = new M(e, {
                prepend: this.options.pluralSeparator,
                compatibilityJSON: this.options.compatibilityJSON,
                simplifyPluralSuffix: this.options.simplifyPluralSuffix,
              })),
              (f.interpolator = new N(this.options)),
              (f.backendConnector = new O(
              ...
              (f.cacheConnector = new P(
                c(this.modules.cache),
                f.resourceStore,
                f,
                this.options
              )),
              ...
              this.modules.languageDetector &&
                ((f.languageDetector = c(this.modules.languageDetector)),
          ...
          g.forEach(function (a) {
            ...
            "v1" === this.options.compatibilityAPI && n(this);
          var h = function () {
            d.changeLanguage(d.options.lng, function (a, c) {
              (d.isInitialized = !0),
                d.logger.log("initialized", d.options),
                d.emit("initialized", d.options),
                b(a, c);
            });
          };
          return (
          ...
          var a = this,
            b =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : t;
          if (this.options.resources) b(null);
          else {
            ...
            if (this.language) d(this.language);
            else {
          ...
          var c = this,
            ...
            e = function (a) {
              a &&
                ...
                c.services.languageDetector &&
                  c.services.languageDetector.cacheUserLanguage(a)),
        ...
        (b.prototype.getFixedT = function (a, b) {
          var c = this,
            d = function e(a) {
              ...
              return (
                (d.lng = d.lng || e.lng),
                (d.lngs = d.lngs || e.lngs),
                (d.ns = d.ns || e.ns),
                c.t(a, d)
              );
            };
          return (
            "string" == typeof a ? (d.lng = a) : (d.lngs = a), (d.ns = b), d
          );
        }),
        ...
        (b.prototype.exists = function () {
          var a;
          return (
            this.translator && (a = this.translator).exists.apply(a, arguments)
          );
        }),
        ...
        (b.prototype.loadLanguages = function (a, b) {
          ...
          return d.length
            ? ((this.options.preload = c.concat(d)), void this.loadResources(b))
            : b();
        }),
          ...
          var a = this,
            ...
            d =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : t,
            e = w({}, this.options, c, { isClone: !0 }),
            f = new b(e, d),
            g = ["store", "services", "language"];
          return (
            g.forEach(function (b) {
              f[b] = a[b];
            }),
            (f.translator = new I(f.services, f.options)),
            f.translator.on("*", function (a) {
              for (
                var b = arguments.length, c = Array(b > 1 ? b - 1 : 0), d = 1;
                d < b;
                d++
    ...
    var b = (function () {
      ...
      return (
        ...
        (a.prototype.read = function (a, b, c) {
          var d = this,
            e = this.services.interpolator.interpolate(this.loadPath, {
              lng: a,
              ns: b,
            }),
            f = b + "_" + a,
            g = function (a, b) {
              b === f &&
                (c(null, d.game.cache.getJSON(f)),
                d.game.load.onFileComplete.remove(g));
            };
          this.game.load.onFileComplete.add(g), this.game.load.json(f, e);
        }),
        (a.prototype.readMulti = function (a, b, c) {}),
        (a.prototype.create = function (a, b, c, d) {}),
        a
      );
    })();
    a.Backend = b;
  })((b = a.I18next || (a.I18next = {})));
  ...
  var b = (function (b) {
    function c(a, c) {
      ...
      return (
        ...
        (d.wasLoaderLocked = !1),
        (d.started = !1),
        Object.defineProperty(a, "i18n", { value: d }),
        d.addLocaleLoader(),
        d.addLocaleFactory(),
        d.addLocaleCreator(),
        d
    ...
    return (
      ...
      (c.prototype.init = function (b) {
        for (var c = this, d = [], e = 1; e < arguments.length; e++)
          d[e - 1] = arguments[e];
        (this.wasLoaderLocked = this.game.load.resetLocked),
          ...
          (this.backend = new a.I18next.Backend(this.game)),
      ...
      (c.prototype.recursiveUpdateText = function (a) {
        var b = this;
        (a instanceof Phaser.Text || a instanceof Phaser.BitmapText) &&
          (a.dirty = !0),
          a.children &&
            a.children.length > 0 &&
      ...
      (c.prototype.addLocaleLoader = function () {
        ...
        Phaser.Loader.prototype.locale = function (b, c, d) {
          ...
          Array.isArray(c)
            ? (d = c)
            : "undefined" != typeof c &&
              (a.backend.setLoadPath(c),
              console.warn(
                "Using loadPath trough load.locale is deprecated, please set it as part of the Plugin config instead!"
              )),
            i18next.loadLanguages(b, function () {
              a.started ||
                ((a.started = !0),
                (e.game.load.resetLocked = a.wasLoaderLocked));
            }),
            d && i18next.loadNamespaces(d);
        };
      }),
      (c.prototype.addLocaleFactory = function () {
        (Phaser.GameObjectFactory.prototype.translatedText = function (
          b,
          c,
          d,
          e,
          ...
          return (
            void 0 === g && (g = this.world),
            g.add(new a.TranslatedText(this.game, b, c, d, e, f))
          );
        }),
          (Phaser.GameObjectFactory.prototype.translatedBitmapText = function (
            b,
            c,
            d,
            e,
            ...
            return (
              ...
              i.add(new a.TranslatedBitmapText(this.game, b, c, d, e, f, g, h))
            );
          });
      }),
      (c.prototype.addLocaleCreator = function () {
        (Phaser.GameObjectCreator.prototype.translatedText = function (
          b,
          c,
          d,
          e,
          ...
          (Phaser.GameObjectCreator.prototype.translatedBitmapText = function (
            b,
            c,
            d,
            e,
...
!(function (a) {
  var b = (function (a) {
    ...
    return (
      __extends(b, a),
      (b.prototype.setTranslationParamameter = function (a, b) {
      ...
      Object.defineProperty(b.prototype, "_text", {
        ...
        set: function (a) {
          a !== this._nonTranslated &&
            (this._nonTranslated = a.toString() || "");
        },
        enumerable: !0,
        configurable: !0,
      }),
