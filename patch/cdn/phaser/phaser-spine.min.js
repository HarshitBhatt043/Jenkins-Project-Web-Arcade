...
(spine.temp = new spine.Float32Array(2)),
  ...
  (spine.Bone.prototype = {
    ...
    updateWorldTransform: function (a, b, c, d, e) {
      ...
      if (
        ...
        this.skeleton.flipX && ((this.a = -this.a), (this.b = -this.b)),
          this.skeleton.flipY != spine.Bone.yDown &&
    ...
    localToWorld: function (a) {
      var b = a[0],
        c = a[1];
      return (
        (a[0] = b * this.a + c * this.b + this.worldX),
        ...
        for (
          ...
          if (b[c] == a) {
            (this.attachment = null),
              this.setAttachment(
                this.bone.skeleton.getAttachmentBySlotIndex(c, a.attachmentName)
              );
            break;
          }
  ...
  (spine.IkConstraint.apply1 = function (a, b, c, d) {
    ...
    (a.worldSignX != a.worldSignY) !=
      (a.skeleton.flipX != (a.skeleton.flipY != spine.Bone.yDown)) &&
      (g = 360 - g),
    ...
    if (0 != f) {
      ...
      a: if (q) {
        ...
        (da = D * D + E * E),
          ...
          P <= (Y + aa) / 2
            ? ((F = L - Math.atan2($ * e, Z)), (G = X * e))
            : ((F = L - Math.atan2(ca * e, ba)), (G = _ * e));
      }
  ...
  (spine.Animation.prototype = {
    apply: function (a, b, c, d, e) {
      d &&
        0 != this.duration &&
        ((c %= this.duration), b > 0 && (b %= this.duration));
  ...
  (spine.RotateTimeline.prototype = {
    ...
    apply: function (a, b, c, d, e) {
      ...
      if (!(c < f[0])) {
        ...
        if (c >= f[f.length - 2]) {
          for (
            var h = g.data.rotation + f[f.length - 1] - g.rotation;
            h > 180;
  ...
  (spine.TranslateTimeline.prototype = {
    ...
    apply: function (a, b, c, d, e) {
      ...
      if (!(c < f[0])) {
        ...
        if (c >= f[f.length - 3])
          return (
            (g.x += (g.data.x + f[f.length - 2] - g.x) * e),
  ...
  (spine.ScaleTimeline.prototype = {
    ...
    apply: function (a, b, c, d, e) {
      ...
      if (!(c < f[0])) {
        ...
        if (c >= f[f.length - 3])
          return (
            (g.scaleX += (g.data.scaleX * f[f.length - 2] - g.scaleX) * e),
        ...
        (l = this.curves.getCurvePercent(h / 3 - 1, l)),
          (g.scaleX +=
            (g.data.scaleX * (i + (f[h + 1] - i) * l) - g.scaleX) * e),
          (g.scaleY +=
            (g.data.scaleY * (j + (f[h + 2] - j) * l) - g.scaleY) * e);
      }
    },
  }),
  ...
  (spine.AttachmentTimeline.prototype = {
    ...
    apply: function (a, b, c, d, e) {
      ...
      var g =
        c >= f[f.length - 1]
          ? f.length - 1
          : spine.Animation.binarySearch1(f, c) - 1;
      if (!(f[g] < b)) {
        var h = this.attachmentNames[g];
        a.slots[this.slotIndex].setAttachment(
          h ? a.getAttachmentBySlotIndex(this.slotIndex, h) : null
        );
      }
    },
  }),
  ...
  (spine.DrawOrderTimeline.prototype = {
    ...
    apply: function (a, b, c, d, e) {
      ...
      if (!(c < f[0])) {
        ...
        else for (var k = 0, l = i.length; k < l; k++) h[k] = i[k];
      }
    },
  }),
  ...
  (spine.FfdTimeline.prototype = {
    ...
    apply: function (a, b, c, d, e) {
      ...
      if (
        g &&
        (g == this.attachment ||
          (g.inheritFFD && g.parentMesh == this.attachment))
      ) {
        var h = this.frames;
        if (!(c < h[0])) {
          ...
          if (
            (k.length != j &&
              ((f.attachmentVertices = k = new spine.Float32Array(j)), (e = 1)),
            c >= h[h.length - 1])
          ) {
            var l = i[h.length - 1];
  ...
  (spine.Skeleton = function (a) {
    ...
    for (var b = 0, c = a.transformConstraints.length; b < c; b++)
      this.transformConstraints[b] = new spine.TransformConstraint(
        a.transformConstraints[b],
        this
      );
  ...
  (spine.WeightedMeshAttachment.prototype = {
    ...
    updateUVs: function (a, b, c, d, e) {
      ...
      if (
        ((this.uvs && this.uvs.length == h) ||
          (this.uvs = new spine.Float32Array(h)),
        this.regionRotate)
      )
        for (var i = 0; i < h; i += 2)
    ...
    computeWorldVertices: function (a, b, c, d) {
      ...
      if (c.attachmentVertices.length)
        for (var t = c.attachmentVertices; p < s; o += 2) {
          for (f = 0, g = 0, e = n[p++] + p; p < e; p++, q += 3, r += 2)
            (h = l[n[p]]),
              (i = m[q] + t[r]),
              (j = m[q + 1] + t[r + 1]),
              (k = m[q + 2]),
  ...
  (spine.AnimationState.prototype = {
    ...
    addAnimation: function (a, b, c, d) {
      ...
      return (
        d <= 0 &&
          (f ? (d += f.endTime - this.data.getMix(f.animation, b)) : (d = 0)),
        (e.delay = d),
        e
      );
    },
  ...
  (spine.SkeletonJson.prototype = {
    ...
    readSkeletonData: function (a, b) {
      ...
      for (var e = a.bones, f = 0, g = e.length; f < g; f++) {
        var h = e[f],
          i = null;
        if (h.parent && ((i = c.findBone(h.parent)), !i))
        ...
        (j.length = (h.length || 0) * this.scale),
          ...
          (j.inheritScale =
            !h.hasOwnProperty("inheritScale") || h.inheritScale),
          (j.inheritRotation =
            !h.hasOwnProperty("inheritRotation") || h.inheritRotation),
          (c.bones[f] = j);
      }
      var k = a.ik;
      if (k)
        for (var f = 0, g = k.length; f < g; f++) {
          for (
            var l = k[f],
              m = new spine.IkConstraintData(l.name),
              e = l.bones,
              n = 0,
              o = e.length;
            n < o;
          ...
          if (((m.target = c.findBone(l.target)), !m.target))
            throw "Target bone not found: " + l.target;
          (m.bendDirection =
            !l.hasOwnProperty("bendPositive") || l.bendPositive ? 1 : -1),
      ...
      if (q)
        for (var f = 0, g = q.length; f < g; f++) {
          ...
          if (((s.bone = c.findBone(r.bone)), !s.bone))
            throw "Bone not found: " + r.bone;
          if (((s.target = c.findBone(r.target)), !s.target))
          ...
          if (
            ...
            for (
              var k = this.getFloatArray(d, "uvs", 1),
                ...
                m = new spine.Float32Array(3 * k.length * 3),
                n = new spine.Uint32Array(3 * k.length),
                o = 0,
                p = 0,
                q = 0,
                r = l.length;
    ...
    readAnimation: function (a, b, c) {
          ...
          for (var j in h)
            if (h.hasOwnProperty(j)) {
              ...
              if ("color" == j) {
                ...
                if ("attachment" != j)
                  throw (
                    "Invalid timeline type for a slot: " + j + " (" + g + ")"
                  );
            ...
            if (y.hasOwnProperty(j)) {
              ...
              if ("rotate" == j) {
                ...
                if ("translate" != j && "scale" != j)
                  throw (
                    "Invalid timeline type for a bone: " + j + " (" + w + ")"
                  );
                var l,
                  z = 1;
                "scale" == j
                  ? (l = new spine.ScaleTimeline(k.length))
                  : ((l = new spine.TranslateTimeline(k.length)),
                    (z = this.scale)),
                  (l.boneIndex = x);
                for (var m = 0, n = 0, o = k.length; n < o; n++) {
                  var p = k[n],
          ...
          for (var L in K) {
            ...
            for (var m = 0, n = 0, o = k.length; n < o; n++) {
              ...
              if (p.vertices) {
                ...
                O
                  ? (P = M.vertices)
                  : ((P = new spine.Float32Array(N)), (P.length = N));
      ...
      if ((V || (V = b.draworder), V)) {
        for (
          var l = new spine.DrawOrderTimeline(V.length),
            W = c.slots.length,
            m = 0,
            n = 0,
            o = V.length;
      ...
      if (ca) {
        for (
          var l = new spine.EventTimeline(ca.length),
            m = 0,
            n = 0,
            o = ca.length;
          n < o;
          ...
          (fa.intValue = da.hasOwnProperty("int") ? da.int : ea.intValue),
            (fa.floatValue = da.hasOwnProperty("float")
              ? da.float
              : ea.floatValue),
            (fa.stringValue = da.hasOwnProperty("string")
              ? da.string
              : ea.stringValue),
            l.setFrame(m++, fa);
        }
    ...
    getUint32Array: function (a, b) {
      for (
        var c = a[b], d = new spine.Uint32Array(c.length), e = 0, f = c.length;
        e < f;
        e++
      )
        d[e] = 0 | c[e];
    ...
    getUint16Array: function (a, b) {
      for (
        var c = a[b], d = new spine.Uint16Array(c.length), e = 0, f = c.length;
        e < f;
        e++
      )
        d[e] = 0 | c[e];
        ...
        if (e) {
          ...
          (e.uWrap = spine.Atlas.TextureWrap.clampToEdge),
            ...
            "x" == l
              ...
              : "xy" == l &&
                (e.uWrap = e.vWrap = spine.Atlas.TextureWrap.repeat),
            b.load(e, f, this),
  ...
  (spine.AtlasAttachmentLoader.prototype = {
    newRegionAttachment: function (a, b, c) {
      ...
      if (!d)
        throw (
          "Region not found in atlas: " + c + " (region attachment: " + b + ")"
        );
    ...
    newMeshAttachment: function (a, b, c) {
      ...
      if (!d)
        throw (
          "Region not found in atlas: " + c + " (mesh attachment: " + b + ")"
        );
      ...
      for (var j = 0; j < d; j++) {
        ...
        if (m.type == spine.AttachmentType.boundingbox) {
          ...
          var n,
            o = h.length;
          o > 0
            ? ((n = h[o - 1]), h.splice(o - 1, 1))
            : (n = new spine.Float32Array()),
            (i[i.length] = n),
    ...
    return (
      ...
      (c.prototype.addSpineFactory = function () {
        (Phaser.GameObjectFactory.prototype.spine = function (b, c, d, e, f) {
          ...
          return (
            g.setToSetupPose(), (g.position.x = b), (g.position.y = c), f.add(g)
          );
        }),
...
!(function (a) {
  var b = (function (b) {
    function c(c, d, e) {
      ...
      void 0 !== e && g.variants.indexOf(e) !== -1
        ? (f.imageScale = f.getScaleFromVariant(e))
        : g.variants &&
          g.variants.length >= 1 &&
          (f.imageScale = f.getScaleFromVariant(g.variants[0]));
      ...
      if (
        ((f.skeletonData = k.readSkeletonData(c.cache.getJSON(d))),
        !f.skeletonData)
      )
    ...
    return (
      ...
      Object.defineProperty(c.prototype, "autoUpdate", {
        ...
        set: function (b) {
          this.updateTransform = b
            ? a.Spine.prototype.autoUpdateTransform
      ...
      (c.prototype.update = function (a) {
        if (void 0 !== a) {
          ...
          for (
            ...
            void 0 !== b[d].currentSprite &&
              (this.children[d] = b[d].currentSprite.parent);
          for (var d = 0, e = c.length; d < e; d++) {
            ...
            if (g) {
              ...
              if (i === spine.AttachmentType.region) {
                if (
                  g.rendererObject &&
                  (!f.currentSpriteName || f.currentSpriteName !== g.name)
                ) {
                  var j = g.rendererObject.name;
                  if (
                    (void 0 !== f.currentSprite &&
                ...
                (h.position.x = g.x * l.a + g.y * l.b + l.worldX),
                  ...
                  (h.rotation =
                    ((l.getWorldRotationX() - g.rotation) * Math.PI) / 180),
                  l.getWorldScaleY() < 0 && (h.scale.y = -h.scale.y),
                  l.getWorldScaleX() < 0 && (h.scale.x = -h.scale.x),
                  (l.getWorldScaleY() < 0 || l.getWorldScaleX() < 0) &&
                    (h.rotation = -h.rotation),
                  (f.currentSprite.blendMode = f.blendMode),
                  this.globalTint ||
                    (f.currentSprite.tint = f.currentSprite.tint =
                      parseInt(
                        Phaser.Color.componentToHex(255 * f.r).substring(0, 2) +
                          Phaser.Color.componentToHex(255 * f.g).substring(
                            0,
                            2
                          ) +
                          Phaser.Color.componentToHex(255 * f.b).substring(
                            0,
                            2
                          ),
                        16
                ...
                if (
                  i !== spine.AttachmentType.weightedmesh &&
                  i !== spine.AttachmentType.weightedlinkedmesh
                ) {
                  h.visible = !1;
                  continue;
                }
                if (!f.currentMeshName || f.currentMeshName !== g.name) {
                  var m = g.name;
                  if (
                    (void 0 !== f.currentMesh && (f.currentMesh.visible = !1),
                    (f.meshes = f.meshes || {}),
                    void 0 !== f.meshes[m])
                  )
                ...
                g.computeWorldVertices(
                  f.bone.skeleton.x,
                  f.bone.skeleton.y,
                  f,
                  f.currentMesh.vertices
                );
              }
      ...
      (c.prototype.createSprite = function (a, b) {
        var c = b.rendererObject,
          ...
          e = new PIXI.Rectangle(
            c.x,
            c.y,
            c.rotate ? c.height : c.width,
            c.rotate ? c.width : c.height
          ),
        ...
        if (
          ((g.scale.x =
            ((c.width / c.originalWidth) * b.scaleX) / this.imageScale),
          (g.scale.y =
            ((c.height / c.originalHeight) * b.scaleY) / this.imageScale),
          (g.rotation = h),
