...
!(function (a) {
  ...
  var c = (function () {
    ...
    return (
      (a.prototype.addKeyUpListener = function (a) {
        (this.keyUpCallback = a),
      ...
      (a.prototype.setMax = function (a, c) {
        if (void 0 !== a)
          if (this.type === b.text || this.type === b.password)
            this.element.maxLength = parseInt(a, 10);
      ...
      (a.prototype.focus = function () {
        ...
        if (
          (this.element.focus(),
          !this.game.device.desktop && this.game.device.chrome)
        )
          var b = window.innerWidth,
            c = window.innerHeight,
            d = !1,
            e = setInterval(function () {
              (b > window.innerWidth || c > window.innerHeight) && (d = !0),
                d &&
                  b === window.innerWidth &&
                  c === window.innerHeight &&
                  (a.focusOut instanceof Phaser.Signal && a.focusOut.dispatch(),
                  clearInterval(e));
            }, 50);
      }),
  ...
  var c = (function (c) {
    function d(d, e, f, g) {
      ...
      return (
        ...
        (h.windowScale = 1),
        (h.blockInput = !0),
        (h.focusIn = new Phaser.Signal()),
        (h.focusOut = new Phaser.Signal()),
        (h.blink = !0),
        (h.cnt = 0),
        (h.inputOptions = g),
        (h.inputOptions.width = "number" == typeof g.width ? g.width : 150),
        (h.inputOptions.padding = "number" == typeof g.padding ? g.padding : 0),
        (h.inputOptions.textAlign = g.textAlign || "left"),
        (h.inputOptions.type = g.type || a.InputType.text),
        (h.inputOptions.forceCase = g.forceCase ? g.forceCase : b.none),
        (h.inputOptions.borderRadius =
          "number" == typeof g.borderRadius ? g.borderRadius : 0),
        (h.inputOptions.height = "number" == typeof g.height ? g.height : 14),
        (h.inputOptions.fillAlpha = void 0 === g.fillAlpha ? 1 : g.fillAlpha),
        (h.inputOptions.selectionColor =
          g.selectionColor || "rgba(179, 212, 253, 0.8)"),
        (h.inputOptions.zoom = d.device.desktop ? !1 : g.zoom || !1),
        (h.box = new a.InputBox(h.game, g)),
        h.setTexture(h.box.generateTexture()),
        (h.textMask = new a.TextMask(h.game, g)),
        h.addChild(h.textMask),
        (h.domElement = new a.InputElement(
          h.game,
        ...
        h.domElement.setMax(h.inputOptions.max, h.inputOptions.min),
        (h.selection = new a.SelectionHighlight(h.game, h.inputOptions)),
        (h.selection.mask = h.textMask),
        h.addChild(h.selection),
        g.placeHolder &&
          g.placeHolder.length > 0 &&
          ((h.placeHolder = new Phaser.Text(
            d,
            h.inputOptions.padding,
            h.inputOptions.padding,
            g.placeHolder,
            {
          ...
          (h.placeHolder.mask = h.textMask),
          h.addChild(h.placeHolder)),
        (h.cursor = new Phaser.Text(
          d,
          h.inputOptions.padding,
          h.inputOptions.padding - 2,
          "|",
          {
            font: g.font || "14px Arial",
            fontWeight: g.fontWeight || "normal",
        ...
        (h.text.mask = h.textMask),
        h.addChild(h.text),
        (h.offscreenText = new Phaser.Text(
          d,
          h.inputOptions.padding,
          h.inputOptions.padding,
          "",
        ...
        h.updateTextAlignment(),
        (h.inputEnabled = !0),
        (h.input.useHandCursor = !0),
        h.game.input.onDown.add(h.checkDown, h),
        h.focusOut.add(function () {
    ...
    return (
      ...
      Object.defineProperty(d.prototype, "width", {
        ...
        set: function (a) {
          (this.inputOptions.width = a),
            this.box.resize(a),
            this.textMask.resize(a),
        ...
        switch (this.inputOptions.textAlign) {
          case "left":
            this.text.anchor.set(0, 0),
              ...
              null !== this.placeHolder && this.placeHolder.anchor.set(0, 0),
              (this.cursor.x =
                this.inputOptions.padding + this.getCaretPosition());
            break;
          case "center":
      ...
      (d.prototype.checkDown = function (b) {
        if ((this.value || this.resetText(), this.input.checkPointerOver(b))) {
          ...
          this.inputOptions.zoom && !a.Zoomed && this.zoomIn(),
            this.startFocus();
        } else
          this.focus === !0 &&
            (this.endFocus(), this.inputOptions.zoom && this.zoomOut());
      }),
      (d.prototype.update = function () {
        if (
          (this.text.update(),
          this.placeHolder && this.placeHolder.update(),
          this.focus)
        ) {
      ...
      (d.prototype.endFocus = function () {
        ...
        this.focus &&
          ...
          this.blockInput === !0 && this.domElement.unblockKeyDownEvents(),
          (this.focus = !1),
          0 === this.value.length &&
            null !== this.placeHolder &&
          ...
          this.game.device.desktop ||
            ((a.KeyboardOpen = !1), a.onKeyboardClose.dispatch()));
      }),
      (d.prototype.startFocus = function () {
        var b = this;
        (this.focus = !0),
          null !== this.placeHolder && (this.placeHolder.visible = !1),
          this.game.device.desktop
            ? setTimeout(function () {
                b.keyUpProcessor();
              }, 0)
      ...
      (d.prototype.updateText = function () {
        ...
        if (this.inputOptions.type === a.InputType.password)
          ...
          b =
            d < parseInt(this.inputOptions.min)
              ? (this.value = this.domElement.value = this.inputOptions.min)
              : d > parseInt(this.inputOptions.max)
              ? (this.value = this.domElement.value = this.inputOptions.max)
              : this.value;
        } else b = this.value;
        if ((this.text.setText(b), this.text.width > this.inputOptions.width))
      ...
      (d.prototype.updateCursor = function () {
        if (
          ...
          "right" === this.inputOptions.textAlign
        )
      ...
      (d.prototype.getCaretPosition = function () {
        ...
        return (
          this.offscreenText.setText(c.slice(0, b)), this.offscreenText.width
        );
      }),
      (d.prototype.setCaretOnclick = function (a) {
        ...
        this.inputOptions.textAlign &&
          "center" === this.inputOptions.textAlign &&
          (b += this.text.width / 2);
        for (
          var c = this.text.width / this.value.length, d = 0, e = 0;
          e < this.value.length;
          e++
        )
          if (b >= e * c && (e + 1) * c >= b) {
        ...
        b > (this.value.length - 1) * c && (d = this.value.length),
          this.startFocus(),
          this.domElement.setCaretPosition(d),
          this.updateCursor();
      }),
      ...
      (d.prototype.zoomIn = function () {
        if (!a.Zoomed) {
          ...
          window.innerHeight > window.innerWidth
            ? (this.windowScale = this.game.width / (1.5 * b.width))
            : (this.windowScale = this.game.width / 2 / (1.5 * b.width));
          ...
          this.game.world.scale.set(
            ...
            this.game.world.pivot.set(
              b.x - c,
              b.y - 2 * this.inputOptions.padding
            ),
            (a.Zoomed = !0);
        }
      }),
      ...
      (d.prototype.keyListener = function (a) {
        return (
          ...
          13 === a.keyCode
            ? void (this.focusOutOnEnter && this.endFocus())
            : (this.updateText(),
              this.updateCursor(),
      ...
      (d.prototype.destroy = function (a) {
        this.game.input.onDown.remove(this.checkDown, this),
          ...
          c.prototype.destroy.call(this, a);
      }),
        ...
        void 0 === a && (a = ""),
          null !== this.placeHolder &&
            (a.length > 0
              ...
              : (this.placeHolder.visible = !0)),
          (this.value = this.getFormattedText(a)),
...
!(function (a) {
  var b = (function (a) {
    function b(b, c) {
      ...
      (d.bgColor = c.backgroundColor
        ? parseInt(c.backgroundColor.slice(1), 16)
        : 16777215),
        (d.borderRadius = c.borderRadius =
          "number" == typeof c.borderRadius ? c.borderRadius : 0),
        (d.borderWidth = c.borderWidth =
          "number" == typeof c.borderWidth ? c.borderWidth : 1),
        (d.borderColor = c.borderColor
          ? parseInt(c.borderColor.slice(1), 16)
          : 9803157),
        (d.boxAlpha = c.fillAlpha),
        (d.padding = c.padding);
      var e,
        e = c.height,
        f = c.width;
      c.font &&
        (e = Math.max(parseInt(c.font.substr(0, c.font.indexOf("px")), 10), e)),
        (d.boxHeight = 2 * d.padding + e);
      var f = c.width;
...
!(function (a) {
  var b = (function (a) {
    ...
    return (
      __extends(b, a),
      (b.prototype.updateSelection = function (a) {
        var c = Phaser.Color.webToColor(this.inputOptions.selectionColor);
        this.clear(),
          this.beginFill(b.rgb2hex(c), c.a),
          this.drawRect(
            a.x,
            a.y,
            a.width,
            a.height - this.inputOptions.padding
          );
      }),
  ...
  var b = (function (a) {
    function b(b, c) {
      ...
      return (
        c.font &&
          (e = Math.max(
            parseInt(c.font.substr(0, c.font.indexOf("px")), 10),
            e
          )),
        (d.maskWidth = c.width),
        (d.maskHeight = 1.3 * e),
...
!(function (a) {
  (a.Zoomed = !1),
    (a.KeyboardOpen = !1),
    (a.onKeyboardOpen = new Phaser.Signal()),
    (a.onKeyboardClose = new Phaser.Signal());
  var b = (function (b) {
    function c(a, c) {
    ...
    return (
      __extends(c, b),
      (c.prototype.addInputFieldFactory = function () {
  ...
  (b.Zoomed = !1),
    (b.KeyboardOpen = !1),
    (b.onKeyboardOpen = new Phaser.Signal()),
    (b.onKeyboardClose = new Phaser.Signal()),
    (a.Plugin = b);
})(PhaserInput || (PhaserInput = {}));
