...
!(function (a) {
  var b = (function (a) {
    function b(b, c, d, e, f, g, h, i) {
      ...
      return (
        (j.baseTexture = j.texture.baseTexture),
        (j.baseFrame = j.texture.frame),
        null === f || i
          ? i || (i = b.cache.getNineSlice(e))
          : (i = b.cache.getNineSlice(f)),
        void 0 === i
          ? j
          : ((j.topSize = i.top),
            i.left ? (j.leftSize = i.left) : (j.leftSize = j.topSize),
            i.right ? (j.rightSize = i.right) : (j.rightSize = j.leftSize),
            i.bottom ? (j.bottomSize = i.bottom) : (j.bottomSize = j.topSize),
            j.loadTexture(
              new Phaser.RenderTexture(j.game, j.localWidth, j.localHeight)
            ),
            j.resize(g, h),
            j)
      );
    ...
    return (
      ...
      (b.prototype.renderTexture = function () {
        ...
        var a = [
            0,
            this.leftSize,
            this.baseFrame.width - this.rightSize,
            this.baseFrame.width,
          ],
          b = [
            0,
            this.topSize,
            this.baseFrame.height - this.bottomSize,
            this.baseFrame.height,
          ],
          c = [
            0,
            this.leftSize,
            this.localWidth - this.rightSize,
            this.localWidth,
          ],
          d = [
            0,
            this.topSize,
            this.localHeight - this.bottomSize,
            this.localHeight,
          ];
        this.texture.clear();
        for (var e = 0; e < 3; e++)
          for (var f = 0; f < 3; f++) {
            var g = this.createTexturePart(
              a[f],
              b[e],
              a[f + 1] - a[f],
              b[e + 1] - b[e]
      ...
      (b.prototype.createTexturePart = function (a, b, c, d) {
        var e = new PIXI.Rectangle(
          this.baseFrame.x + this.texture.frame.x + a,
          this.baseFrame.y + this.texture.frame.y + b,
          Math.max(c, 1),
          Math.max(d, 1)
        );
        return new Phaser.Sprite(
          ...
          0,
          0,
          new PIXI.Texture(this.baseTexture, e)
        );
      }),
      b
    );
  ...
  var b = (function (b) {
    ...
    return (
      ...
      (c.prototype.addNineSliceFactory = function () {
        (Phaser.GameObjectFactory.prototype.nineSlice = function (
          b,
          c,
          d,
          e,
          ...
          (Phaser.GameObjectCreator.prototype.nineSlice = function (
            b,
            c,
            d,
            e,
