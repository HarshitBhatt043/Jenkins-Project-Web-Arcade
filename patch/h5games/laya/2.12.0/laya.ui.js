(function (exports, Laya) {
  ...
  class AutoBitmap extends Laya.Graphics {
    ...
    _createDrawTexture(
      ...
      return Laya.DrawTextureCmd.create.call(
        this,
        texture,
        x,
        y,
    ...
    changeSource() {
      ...
      if (!sizeGrid || (sw === width && sh === height)) {
        let cmd = this._createDrawTexture(
          source,
        ...
        let cmd = Laya.Draw9GridTexture.create(
          source,
          0,
          0,
          width,
    ...
    resetLayoutX() {
      ...
      if (parent) {
        if (!isNaN(this.centerX)) {
          ...
          if (!isNaN(this.right)) {
            var temp =
              (parent._width - this.left - this.right) / (owner.scaleX || 0.01);
            if (temp != owner.width) {
              owner.width = temp;
              return true;
            }
  ...
  UIUtils.grayFilter = new Laya.ColorFilter([
  ...
  class Image extends UIComponent {
        ...
        if (value) {
          ...
          if (source) {
            ...
            Laya.ILaya.loader.load(
              this._skin,
              Laya.Handler.create(this, this.setSource, [this._skin]),
              null,
              Laya.Loader.IMAGE,
              1,
              true,
    ...
    set sizeGrid(value) {
      this._bitmap.sizeGrid = UIUtils.fillArray(
        Styles.defaultSizeGrid,
        value,
        Number
      );
    }
  ...
  class Button extends UIComponent {
      ...
      if (this._skin != value) {
        ...
        if (value) {
          if (!Laya.Loader.getRes(value)) {
            Laya.ILaya.loader.load(
              this._skin,
              Laya.Handler.create(this, this._skinLoaded),
              null,
              Laya.Loader.IMAGE,
              1
            );
      ...
      if (clips) this._sources = clips;
        ...
        if (this._stateNum === 1) {
          ...
          for (var i = 0; i < this._stateNum; i++) {
            this._sources.push(
              Laya.Texture.createFromTexture(img, 0, height * i, width, height)
            );
          }
        }
    ...
    set labelColors(value) {
      this._labelColors = UIUtils.fillArray(
        Styles.buttonLabelColors,
        value,
        String
      );
      this._setStateChanged();
    ...
    set strokeColors(value) {
      this._strokeColors = UIUtils.fillArray(
        Styles.buttonLabelColors,
        value,
        String
      );
    ...
    set labelPadding(value) {
      this.createText();
      this._text.padding = UIUtils.fillArray(
        Styles.labelPadding,
        value,
        Number
      );
  ...
  class Clip extends UIComponent {
    ...
    changeClip() {
      ...
      if (img) {
        ...
        Laya.ILaya.loader.load(
          this._skin,
          Laya.Handler.create(this, this.loadComplete, [this._skin])
        );
      }
    }
        ...
        if (clips) this._sources = clips;
          ...
          for (var i = 0; i < this._clipY; i++) {
            for (var j = 0; j < this._clipX; j++) {
              this._sources.push(
                Laya.Texture.createFromTexture(img, w * j, h * i, w, h)
              );
            }
          }
          Laya.WeakObject.I.set(key, this._sources);
    ...
    set index(value) {
      ...
      this._bitmap &&
        this._sources &&
        (this._bitmap.source = this._sources[value]);
      this.event(Laya.Event.CHANGE);
    }
    get total() {
      this.runCallLater(this.changeClip);
  ...
  class ColorPicker extends UIComponent {
    ...
    changePanel() {
      ...
      g.clear(true);
      var mainColors = [
        0x000000, 0x333333, 0x666666, 0x999999, 0xcccccc, 0xffffff, 0xff0000,
    ...
    open() {
      ...
      var px =
        p.x + this._colorPanel.width <= stage.width
          ? p.x
          : stage.width - this._colorPanel.width;
      var py = p.y + this._colorButton.height;
      py =
        py + this._colorPanel.height <= stage.height
          ? py
          : p.y - this._colorPanel.height;
    ...
    set selectedColor(value) {
      if (this._selectedColor != value) {
        ...
        this.event(
          Laya.Event.CHANGE,
          Laya.Event.EMPTY.setTo(Laya.Event.CHANGE, this, this)
        );
      }
    }
    get skin() {
  ...
  class Slider extends UIComponent {
    ...
    mouseMove(e) {
      ...
      if (this._tick != 0) {
        ...
        this._value =
          Math.round(Math.round(this._value / this._tick) * this._tick * pow) /
          pow;
      }
    ...
    changeValue() {
      ...
      if (this.isVertical) {
        this._bar.y =
          ((this._value - this._min) / num) * (this.height - this._bar.height);
        if (this._progress)
          this._progress.height = this._bar._y + 0.5 * this._bar.height;
      } else {
        this._bar.x =
          ((this._value - this._min) / num) * (this.width - this._bar.width);
        if (this._progress)
          this._progress.width = this._bar._x + 0.5 * this._bar.width;
      }
    }
    ...
    onBgMouseDown(e) {
      ...
      if (this.isVertical)
        this.value =
          (point.y / (this.height - this._bar.height)) *
            (this._max - this._min) +
          this._min;
      else
        this.value =
          (point.x / (this.width - this._bar.width)) * (this._max - this._min) +
          this._min;
    }
    set dataSource(value) {
      this._dataSource = value;
  ...
  class ScrollBar extends UIComponent {
    ...
    onButtonMouseDown(e) {
      ...
      this.slide(isUp);
      Laya.ILaya.timer.once(Styles.scrollBarDelayTime, this, this.startLoop, [
        isUp,
      ]);
    ...
    resetPositions() {
      if (this.slider.isVertical)
        ...
        this.slider.width =
          this.width -
          (this._showButtons ? this.upButton.width + this.downButton.width : 0);
    ...
    set target(value) {
      ...
      if (value) {
        ...
        this._touchScrollEnable &&
          this._target.on(Laya.Event.MOUSE_DOWN, this, this.onTargetMouseDown);
      }
    }
    get hide() {
      return this._hide;
    ...
    checkTriggers(isTweenMove = false) {
      if (this.value >= 0 && this.value - this._lastOffset <= 0) {
        if (
          ...
          this.triggerDownDragLimit(isTweenMove)
        ) {
          this.cancelDragOp();
          this.value = 0;
          return true;
      ...
      if (this._clickOnly) {
        if (
          Math.abs(
            this._lastOffset *
              (this.isVertical
                ? Laya.ILaya.stage._canvasTransform.getScaleY()
                : Laya.ILaya.stage._canvasTransform.getScaleX())
          ) > 1
        ) {
      ...
      if (this._isElastic) {
        if (this._value <= this.min) {
          if (this._lastOffset > 0) {
            this.value -=
              this._lastOffset *
              Math.max(0, 1 - (this.min - this._value) / this.elasticDistance);
          } else {
      ...
      if (this._isElastic) {
        if (this._value < this.min) {
          Laya.Tween.to(
            ...
            Laya.Ease.sineOut,
            Laya.Handler.create(this, this.elasticOver)
          );
        } else if (this._value > this.max) {
          Laya.Tween.to(
            this,
        ...
        if (this._offsets.length < 1) {
          this._offsets[0] = this.isVertical
            ? Laya.ILaya.stage.mouseY - this._lastPoint.y
            : Laya.ILaya.stage.mouseX - this._lastPoint.x;
        }
        var offset = 0;
  ...
  class List extends Box {
      ...
      if (this._itemRender) {
        ...
        if (this._width > 0)
          this._repeatX2 = this._isVertical
            ? Math.round(this._width / cellWidth)
            : Math.ceil(this._width / cellWidth);
        if (this._height > 0)
          this._repeatY2 = this._isVertical
            ? Math.ceil(this._height / cellHeight)
            : Math.round(this._height / cellHeight);
        var listWidth = this._width
          ? this._width
          : cellWidth * this.repeatX - this._spaceX;
        var listHeight = this._height
          ? this._height
          : cellHeight * this.repeatY - this._spaceY;
        this._cellSize = this._isVertical ? cellHeight : cellWidth;
        this._cellOffset = this._isVertical
          ? cellHeight * Math.max(this._repeatY2, this._repeatY) -
            listHeight -
            this._spaceY
          : cellWidth * Math.max(this._repeatX2, this._repeatX) -
            listWidth -
            this._spaceX;
    ...
    _createItems(startY, numX, numY) {
      ...
      if (this.cacheContent) {
        ...
        cacheBox.pos(
          (this._isVertical ? 0 : startY) * cellWidth,
          (this._isVertical ? startY : 0) * cellHeight
        );
    ...
    changeSelectStatus() {
      for (var i = 0, n = this._cells.length; i < n; i++) {
        this.changeCellState(
          this._cells[i],
          this._selectedIndex === this._startIndex + i,
          1
        );
      }
    }
    ...
    set array(value) {
      ...
      this._selectedIndex =
        this._selectedIndex < length ? this._selectedIndex : length - 1;
      this.startIndex = this._startIndex;
      if (this._scrollBar) {
        ...
        if (total > 1 && lineCount >= numY) {
          ...
          this._scrollBar.setScroll(
            0,
            (lineCount - numY) * this._cellSize + this._cellOffset,
            this._scrollBar.value
          );
    ...
    changeItem(index, source) {
      if (index > -1 && this._array && index < this._array.length) {
        ...
        if (
          ...
          index < this._startIndex + this._cells.length
        ) {
  ...
  class ComboBox extends UIComponent {
    ...
    _setListEvent(list) {
      ...
      this._list.mouseHandler = Laya.Handler.create(
        this,
    ...
    set isOpen(value) {
      if (this._isOpen != value) {
        ...
        if (this._isOpen) {
          ...
          py =
            py + this._listHeight <= Laya.ILaya.stage.height
              ? py
              : p.y - this._listHeight;
    ...
    set labelPadding(value) {
      this._button.text.padding = UIUtils.fillArray(
        Styles.labelPadding,
        value,
        Number
      );
  ...
  class UIGroup extends Box {
    ...
    initItems() {
      ...
      for (var i = 0; i < 10000; i++) {
        ...
        item.clickHandler = Laya.Handler.create(
          this,
          this.itemClick,
          [i],
          false
      ...
      if (this._items) {
        ...
        for (var i = 0, n = this._items.length; i < n; i++) {
          ...
          this._labelStrokeColor &&
            (btn.labelStrokeColor = this._labelStrokeColor);
  ...
  class ViewStack extends Box {
    constructor() {
      super(...arguments);
      this._setIndexHandler = Laya.Handler.create(
        this,
        this.setIndex,
        null,
        false
  ...
  class TextInput extends Label {
    ...
    set sizeGrid(value) {
      this._bg || (this.graphics = this._bg = new AutoBitmap());
      this._bg.sizeGrid = UIUtils.fillArray(
        Styles.defaultSizeGrid,
        value,
        Number
      );
  ...
  class TextArea extends TextInput {
    ...
    changeScroll() {
      ...
      var showWidth = vShow
        ? this._width - this._vScrollBar.width
        : this._width;
      var showHeight = hShow
        ? this._height - this._hScrollBar.height
        : this._height;
      ...
      if (this._vScrollBar) {
        ...
        this._vScrollBar.height =
          this._height -
          (hShow ? this._hScrollBar.height : 0) -
          padding[1] -
          padding[3];
        this._vScrollBar.scrollSize = 1;
        this._vScrollBar.thumbPercent =
          showHeight / Math.max(this._tf.textHeight, showHeight);
      ...
      if (this._hScrollBar) {
        ...
        this._hScrollBar.y =
          this._height - this._hScrollBar.height - padding[3];
        this._hScrollBar.width =
          this._width -
          (vShow ? this._vScrollBar.width : 0) -
          padding[0] -
          padding[2];
        this._hScrollBar.scrollSize = Math.max(showWidth * 0.033, 1);
        this._hScrollBar.thumbPercent =
          showWidth / Math.max(this._tf.textWidth, showWidth);
  ...
  class Panel extends Box {
    ...
    setContentSize(width, height) {
      ...
      content._style.scrollRect ||
        (content.scrollRect = Laya.Rectangle.create());
    ...
    set vScrollBarSkin(value) {
      if (this._vScrollBar == null) {
        ...
        this._vScrollBar.on(Laya.Event.CHANGE, this, this.onScrollBarChange, [
          this._vScrollBar,
        ]);
    ...
    set hScrollBarSkin(value) {
      if (this._hScrollBar == null) {
        ...
        this._hScrollBar.on(Laya.Event.CHANGE, this, this.onScrollBarChange, [
          this._hScrollBar,
        ]);
    ...
    set cacheAs(value) {
      ...
      if (value !== "none") {
        this._hScrollBar &&
          this._hScrollBar.on(Laya.Event.START, this, this.onScrollStart);
        this._vScrollBar &&
          this._vScrollBar.on(Laya.Event.START, this, this.onScrollStart);
      } else {
        this._hScrollBar &&
          this._hScrollBar.off(Laya.Event.START, this, this.onScrollStart);
        this._vScrollBar &&
          this._vScrollBar.off(Laya.Event.START, this, this.onScrollStart);
      }
    }
    get cacheAs() {
      return super.cacheAs;
    ...
    onScrollStart() {
      ...
      super.cacheAs = "none";
      this._hScrollBar &&
        this._hScrollBar.once(Laya.Event.END, this, this.onScrollEnd);
      this._vScrollBar &&
        this._vScrollBar.once(Laya.Event.END, this, this.onScrollEnd);
    }
    onScrollEnd() {
  ...
  class Tree extends Box {
    ...
    createChildren() {
      ...
      this._list.renderHandler = Laya.Handler.create(
        this,
        this.renderItem,
        null,
        false
      ...
      for (var i = 0, n = newSource.length; i < n; i++) {
        ...
        if (newItem.isDirectory) {
          for (var j = 0, m = oldSource.length; j < m; j++) {
            ...
            if (
              oldItem.isDirectory &&
              this.isSameParent(oldItem, newItem) &&
    ...
    getFilterSource(array, result, key) {
      ...
      for (let item of array) {
        if (
          !item.isDirectory &&
          String(item.label).toLowerCase().indexOf(key) > -1
        ) {
          item.x = 0;
          result.push(item);
        }
      ...
      for (var i = 0, n = this.numChildren; i < n; i++) {
        ...
        if (item) {
          ...
          maxHeight = this._height
            ? this._height
            : Math.max(maxHeight, item.height * item.scaleY);
        }
      }
      this.sortItem(items);
      var left = 0;
      ...
      for (var i = 0, n = this.numChildren; i < n; i++) {
        ...
        if (item) {
          ...
          maxWidth = this._width
            ? this._width
            : Math.max(maxWidth, item.width * item.scaleX);
        }
      }
      if (this.isSortItem) {
        this.sortItem(items);
  ...
  class FontClip extends Clip {
    ...
    changeValue() {
      ...
      if (isHorizontal) {
        this._wordsW =
          this._valueArr.length * (texture.sourceWidth + this.spaceX);
        this._wordsH = texture.sourceHeight;
      } else {
        this._wordsW = texture.sourceWidth;
        this._wordsH =
          (texture.sourceHeight + this.spaceY) * this._valueArr.length;
      }
      var dX = 0;
      if (this._width) {
        switch (this._align) {
      ...
      for (var i = 0, sz = this._valueArr.length; i < sz; i++) {
        ...
        if (isHorizontal)
          this.graphics.drawImage(
            texture,
            dX + i * (texture.sourceWidth + this.spaceX),
            0,
            texture.sourceWidth,
  ...
  class View extends Laya.Scene {
    ...
    static __init__() {
      Laya.ILaya.ClassUtils.regShortClassName([
        ViewStack,
        Button,
        TextArea,
        ColorPicker,
  ...
  class DialogManager extends Laya.Sprite {
    ...
    _centerDialog(dialog) {
      dialog.x = Math.round(
        ((Laya.ILaya.stage.width - dialog.width) >> 1) + dialog.pivotX
      );
      dialog.y = Math.round(
        ((Laya.ILaya.stage.height - dialog.height) >> 1) + dialog.pivotY
      );
    }
  ...
  class WXOpenDataViewer extends UIComponent {
    ...
    _postMsg() {
      ...
      mat.scale(
        stage._canvasTransform.getScaleX() *
          this.globalScaleX *
          stage.transform.getScaleX(),
        stage._canvasTransform.getScaleY() *
          this.globalScaleY *
          stage.transform.getScaleY()
      );
      this.postMsg({
        type: "changeMatrix",
        a: mat.a,
