(self.webpackChunkgame_score_sdk = self.webpackChunkgame_score_sdk || []).push([
  [477],
  {
    ...
    5940: (t, e, r) => {
      ...
      class u {
        constructor(t) {
          (this.gp = t), (this.lang = o.Uo.EN);
          const e = (
            new URL(location.href).searchParams.get("lang") || ""
          ).toLowerCase();
          this.lang = Object.values(o.Uo).includes(e) ? e : null;
        }
        get appUrl() {
          return "";
        }
              ...
              (0, n.Z)({
                ...
                .then(() => {
                  (this.sdk = window.GamePix),
                    ...
                    this.sdk.lang(),
                    this.gp.ready.then(() => {
                      this.gp.achievements.on("unlock", () =>
        ...
        publishRecord(t) {
          "number" == typeof t.score && this.sdk.updateScore(t.score),
            "number" == typeof t.level && this.sdk.updateLevel(t.level);
        }
        getStorage() {
      ...
      class l {
        ...
        publishRecord(t) {
          return d(this, void 0, void 0, function* () {
            yield this.sdk.publishRecord(t);
          });
        }
        isPlatformAvatar() {
          return !1;
    ...
    449: (t, e, r) => {
      ...
      class c {
        constructor(t) {
          (this.gp = t), (this.lang = o.Uo.EN), (this.gameUrl = "");
          const e = (
            new URL(location.href).searchParams.get("lang") || ""
          ).toLowerCase();
          this.lang = Object.values(o.Uo).includes(e) ? e : null;
