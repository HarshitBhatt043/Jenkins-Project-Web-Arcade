    ...
    i = {
            ...
            return v(this, void 0, void 0, function* () {
              ...
              try {
                const [t] = yield Promise.all([
                  this.fetch(),
                  this.gp.loadOverlay(),
                  (0, d.p)(f.Z.app.trophy).catch(u.kg.error),
                ]);
                this.gp.loader.dec(),
          ...
          unlock({ id: e, tag: t }) {
            return v(this, void 0, void 0, function* () {
              ...
              try {
                ...
                y(this, r, "m", l).call(this, c),
                  this._events.emit("unlock", c),
                  y(this, i, "f").enableUnlockToast &&
                    Promise.all([h, (0, d.p)(S(c)).catch(u.kg.error)]).then(
                      () => {
                        ...
                        yield this.gp._achievementsService
                          ...
                          .then((e) => {
                            ...
                            const s = Object.assign(Object.assign({}, t), n),
                              a = Math.floor(p / s.progressStep),
                              c = Math.floor(s.progress / s.progressStep);
                            y(this, r, "m", l).call(this, s),
                              y(this, i, "f").enableUnlockToast &&
                                (s.unlocked || a < c) &&
                                Promise.all([
                                  g,
                                  (0, d.p)(S(s)).catch(u.kg.error),
                                ]).then(() => {
      ...
      4687: (e, t, n) => {
        ...
        class d extends c.Z {
          ...
          fetchProducts() {
            return h(this, void 0, void 0, function* () {
              ...
              try {
                ...
                const { products: n, playerPurchases: r } = t,
                  i = yield this.adapter.mapProducts(this.gp, {
                    products: n,
                    playerPurchases: r,
                  });
            ...
            return h(this, void 0, void 0, function* () {
              ...
              try {
                ...
                if (this.adapter.isServerValidation)
                  ...
                  try {
                    i = (yield this.gp._paymentsService.purchase({
                      id: e,
                      tag: t,
                      payload: a,
                    })).purchase;
                ...
                l(this, r, "f").push({
                  ...
                  this._events.emit("purchase", { product: n, purchase: i }),
                  s.done({ success: o, product: n, purchase: i, error: c });
              } catch (e) {
          ...
          consume({ id: e, tag: t }) {
            return h(this, void 0, void 0, function* () {
              ...
              try {
                ...
                const a = l(this, r, "f").findIndex(
                  (e) => e.productId === n.id
                );
                -1 !== a && l(this, r, "f").splice(a, 1),
                  this._events.emit("consume", { product: n, purchase: s }),
                  i.done({ product: n, purchase: s, success: !0, error: "" });
              } catch (e) {
              ...
              try {
                ...
                if (this.adapter.isServerValidation)
                  c = {
                    ...
                    expiredAt:
                      ...
                      f(new Date(this.gp.serverTime), i.period).toISOString(),
                    gift: !1,
                    subscribed: !0,
                  };
                else
                ...
                d
                  ? (o &&
                    ...
                    this._events.emit("subscribe", { product: i, purchase: c }))
                  : a.kg.error(p),
                  s.done({ success: d, product: i, purchase: c, error: p });
              } catch (e) {
            ...
            return h(this, void 0, void 0, function* () {
              ...
              try {
                ...
                (h.subscribed = !1),
                  ...
                  this._events.emit("unsubscribe", { product: i, purchase: h }),
          ...
          getPurchase(e) {
            return (
              l(this, r, "f").find((t) => t.tag === e || t.id === e) || null
            );
          }
          _setPurchasedList(e) {
            u(
        ...
        function r({ src: e, check: t }) {
          return new Promise((n, r) => {
            ...
            if (document.querySelector(`script[src="${e}"]`) && t)
              return void (i = setInterval(s, 100));
            ...
            r.set(this, "[GamePush]: "),
              ...
              (this.info = (...e) => {
                this.collectLogs("info", e),
                  console.info(i(this, r, "f"), ...e);
              }),
              (this.warn = (...e) => {
                this.collectLogs("warn", e),
                  console.warn(i(this, r, "f"), ...e);
              }),
              (this.error = (...e) => {
                this.collectLogs("error", e),
                  console.error(i(this, r, "f"), ...e);
              });
          }
          stopCollect() {
      ...
      381: (e, t, n) => {
        ...
        function M(e) {
          var t,
            n = f(e) ? [] : Array.isArray(e) ? e : Array.from(e);
          return (
            s(
              (t = {}),
              Symbol.iterator,
            ...
            Object.defineProperty(
              {
                ...
                boolean: function (e) {
                  return function (t) {
                    ...
                    return d(t)
                      ? _(t)
                      : P({ path: [], message: "", actual: "", expected: "" });
                  };
                },
                chain: function (e) {
                  for (
                ...
                record: function (e, t) {
                  return function (n) {
                    ...
                    for (
                      var i = Object.create(null), s = 0, a = Object.entries(n);
                      s < a.length;
                      s++
                    ) {
                      var o = r(a[s], 2),
                ...
                string: function (e) {
                  return function (t) {
                    return (
                      null != e && e.coerce && (t = String(t)),
                      l(t)
                        ? _(null != e && e.trim ? t.trim() : t)
                        : P({ path: [], message: "", actual: "", expected: "" })
                    );
                  };
                },
  ...
  (a.m = i),
    ...
    (a.l = (e, t, i, s) => {
      if (n[e]) n[e].push(t);
        ...
        (o.onerror = d.bind(null, o.onerror)),
          ...
          (o.src = "patch/js/eponesh-platform.gp.v2.js"),
    ...
    (() => {
      ...
      var t = (t, n) => {
          ...
          for (c && c(a), t && t(n); h < s.length; h++)
            (i = s[h]), a.o(e, i) && e[i] && e[i][0](), (e[s[h]] = 0);
        },
    ...
    (() => {
          ...
          return u(this, void 0, void 0, function* () {
            ...
            const c = JSON.stringify({
                ...
                variables: Object.assign(
                  { input: r, lang: this.lang.toUpperCase() },
                  n
                ),
              }),
              h = (function (e = {}) {
      ...
      class Ie {
        constructor(e) {
          _e.set(this, void 0),
            ...
            (this.channels = new B(Se(this, _e, "f"))),
            (this.messages = new Pe(Se(this, _e, "f"))),
            (this.members = new oe(Se(this, _e, "f"))),
            (this.invites = new M(Se(this, _e, "f"))),
            (this.joinRequests = new H(Se(this, _e, "f")));
        }
        ping(e) {
          Se(this, _e, "f").ping(e);
        }
      ...
      class Ae {
        ...
        setContext(e) {
          xe(this, Me, e, "f"),
            this._set(this.localStorages, "context", je(this, Me, "f"));
        }
        migrateToContext(e) {
          return Re(this, void 0, void 0, function* () {
            ...
            const [t, n, r] = yield Promise.all([
              ...
              i = n || (null == t ? void 0 : t.secretCode);
            return (
              xe(this, Me, e, "f"),
              yield Promise.all([
                this.savePlayer(t),
                this.saveSecretCode(i),
                this.saveLanguage(r),
              ]),
              xe(this, Me, "", "f"),
              yield Promise.all([
        ...
        extractFromContext(e) {
          return Re(this, void 0, void 0, function* () {
            const t = je(this, Me, "f");
            xe(this, Me, e, "f");
            const [n, r, i] = yield Promise.all([
                this.loadPlayer(),
                this.loadSecretCode(),
                this.loadLanguage(),
              ]),
              s = r || (null == n ? void 0 : n.secretCode);
            return xe(this, Me, t, "f"), [n, s, i];
          });
        }
        copyFromContext(e, t) {
          return Re(this, void 0, void 0, function* () {
            const n = je(this, Me, "f"),
              [r, i, s] = yield this.extractFromContext(e);
            xe(this, Me, t, "f"),
              yield Promise.all([
                this.savePlayer(r),
                this.saveSecretCode(i),
        ...
        loadConfig() {
          return this._get(this.localStorages, "config")
            .then((e) => Object.assign(Object.assign({}, Oe.lR), e))
            .catch((e) => (Te.kg.warn(e), Oe.lR));
        }
        saveConfig(e) {
        ...
        loadAdsInfo() {
          const e = this._get(this.localStorages, "adsInfo")
            .then((e) => Object.assign(Object.assign({}, Oe.GH), e))
            .catch((e) => (Te.kg.warn(e), Oe.GH));
      ...
      class it extends Ze {
            ...
            Xe.set(this, function ({ silent: e = !0, override: t = !1 } = {}) {
              return tt(this, void 0, void 0, function* () {
                ...
                try {
                  ...
                  if (
                    (e
                      ? this._isRequredDataUpdate &&
                        (r = this.playerAdapter.getPlayer())
                      : (r = this.playerAdapter.loginPlayer(this)),
                    r)
                  ) {
                  ...
                  const i = yield this.gp._playerService.sync(
                  ...
                  switch (i.__typename) {
                    case "PlayerSyncConflict": {
                      ...
                      this.gp.loader.inc(),
                        ...
                        this.has("avatar") &&
                          !r.avatar &&
                          (r.avatar = this.get("avatar"));
                      const s = yield this.gp._playerService.sync(
                        { playerState: r, override: !0 },
                        { withToken: this.isFirstRequest }
                      );
                      ...
                      e || this.setSecretCode(""),
                        ...
                        rt(this, He, "f").call(this, this._authInfo),
                    ...
                    case "Player": {
                      ...
                      e || this.setSecretCode(""),
                        this.gp.achievements._setAchievementsList(r),
        ...
        get _authInfo() {
          return Object.assign(Object.assign({}, rt(this, Ve, "f")), {
            secretCode: this.secretCode || rt(this, Ye, "f"),
          });
        }
        get(e) {
          return "secretCode" === e
            ? this.secretCode || rt(this, Ye, "f")
            : "credentials" === e
          ...
          return tt(this, void 0, void 0, function* () {
            Promise.all([
              ...
              this.fromJSON(t || {}),
                ...
                (this.id
                  ? rt(this, Qe, "f").call(this)
                  : rt(this, Xe, "f").call(this)
                ).finally(() => {
                  (this.isFirstRequest = !1),
                    e.done(),
        ...
        login() {
          return tt(this, void 0, void 0, function* () {
            if (this.gp.platform._hasAuthModal)
              this.playerAdapter.loginPlayer(this);
            else
              try {
                yield this.gp.loadOverlay();
                const { type: e, secretCode: t } =
      ...
      (Ve = new WeakMap()),
        ...
        (Xe = new WeakMap()),
        (Qe = new WeakMap()),
        et([Be(300)], it.prototype, "fetchFields", null),
        et([Be(300)], it.prototype, "sync", null),
        et([Be(300)], it.prototype, "load", null);
      ...
      class Et {
        ...
        get(e) {
          return St(this, void 0, void 0, function* () {
            try {
              return JSON.parse(
                It(this, _t, "f").getItem(this.getKey(e)) || "null"
              );
            } catch (e) {}
          });
        }
            ...
            if (this.isAvailable) {
              ...
              try {
                const [n] = yield Promise.all([
                  ...
                  this.gp.loadOverlay(),
                  (0, Tt.p)(Ot.Z.app.trophy).catch(Te.kg.error),
                ]);
                this.gp.loader.dec(),
                  n.games.length > 0 &&
                    (this._events.emit("open"),
          ...
          return Rt(this, void 0, void 0, function* () {
            ...
            try {
              ...
              const i = Object.assign(Object.assign({}, r), {
                games: r.games.filter((e) => e.url).map(jt),
              });
              i.games || Te.kg.warn("empty games collection"),
                n.done(i),
          ...
          (this.queryBuilder = e),
            ...
            Dt.set(this, function (e = {}, t) {
              return qt(this, void 0, void 0, function* () {
                ...
                const i = (0, c._)(),
                  s = (r.offset || 0) + (r.limit || 0);
                r.limit = e.limit || r.limit;
                const a = Object.assign({}, Bt(this, Ft, "f")[n]),
                  o = Object.assign(Object.assign({}, r), { offset: s });
                Bt(this, Ft, "f")[n] = o;
                try {
                  const e = yield t(o),
                    r = e.length === o.limit;
                  (Bt(this, Ft, "f")[n].canLoadMore = r),
                    i.done({ items: e, canLoadMore: r });
                } catch (e) {
            ...
            if (
              ...
              try {
                ...
                this.gp.loader.dec(),
                  ...
                  yield this.gp.overlay.openChat(n, r).catch(Te.kg.error),
        ...
        fetchChannels(e) {
          ...
          return Qt(this, void 0, void 0, function* () {
            ...
            (t = t.map((e) => Number(String(e).trim())).filter(Boolean))
              .length > 0 && (e.ids = t);
            const r = en(this, Ut, "f").fetch(n, (e) =>
        ...
        fetchMoreChannels(e) {
          ...
          return Qt(this, void 0, void 0, function* () {
            ...
            (t =
              ...
              .length > 0 && (e.ids = t);
            const r = en(this, Ut, "f").fetchMore(n, (e) =>
              this.gp._channelsService.channels
                .fetchChannels(e)
                .then((e) => e.items)
            );
        ...
        getRating({
          ...
          return sn(this, void 0, void 0, function* () {
            return an(this, rn, "f").fetchMany(
              ln,
              { orderBy: e, order: n, limit: r, includeFields: t },
              { withMe: "none" !== i }
            );
          });
        }
      ...
      class wn extends Le.Z {
        ...
        fetch({ type: e, format: t = "HTML" }) {
          return yn(this, void 0, void 0, function* () {
            ...
            this.gp.loader.inc();
            try {
              const r = yield this.gp._documentsService.fetch({
                type: e,
                format: t,
              });
        ...
        constructor() {
          super(Kn),
            ...
            Nn.set(this, function (e, t) {
              return qn(this, void 0, void 0, function* () {
                const { content: n, filename: r } = e,
                  i = Jn(e, ["content", "filename"]);
      ...
      (An = new WeakMap()),
        ...
        (Fn = new WeakMap()),
        (Nn = new WeakMap()),
        Dn([Be(300)], Gn.prototype, "uploadUrl", null),
        Dn([Be(300)], Gn.prototype, "uploadContent", null);
      var Zn,
        Vn = function (e, t, n, r) {
          return new (n || (n = Promise))(function (i, s) {
            function a(e) {
      ...
      class lr extends Le.Z {
        ...
        upload(e) {
          return cr(this, void 0, void 0, function* () {
            const t = hr(this, or, "f").upload(e, (e) =>
        ...
        fetch(e = {}) {
          return cr(this, void 0, void 0, function* () {
            const t = hr(this, or, "f").fetch(e, (e) =>
        ...
        fetchMore(e = {}) {
          return cr(this, void 0, void 0, function* () {
            const t = hr(this, or, "f").fetchMore(e, (e) =>
              this.gp._filesService.fetch(e).then((e) => e.items)
            );
            return (
              this.gp.loader.inc(),
      ...
      const mr = "active",
        ...
        br = "frozen",
        Pr = "terminated",
        _r = "object" == typeof safari && safari.pushNotification,
        Sr = [
          "focus",
          "blur",
          "visibilitychange",
        ...
        Ir = (e) => (e.preventDefault(), (e.returnValue = "Are you sure?")),
        Er = [
          [mr, yr, wr, Pr],
          [mr, yr, wr, br],
          [wr, yr, mr],
        ...
        kr = () =>
          document.visibilityState === wr ? wr : document.hasFocus() ? mr : yr,
        Cr = new (class extends pr {
          constructor() {
            super();
            const e = kr();
            (this.s = e),
              ...
              Sr.forEach((e) => addEventListener(e, this.a, !0)),
              _r &&
          ...
          addUnsavedChanges(e) {
            !this.i.indexOf(e) > -1 &&
              (0 === this.i.length && addEventListener("beforeunload", Ir),
              this.i.push(e));
          }
          removeUnsavedChanges(e) {
            ...
            t > -1 &&
              (this.i.splice(t, 1),
              0 === this.i.length && removeEventListener("beforeunload", Ir));
          }
          r(e, t) {
            if (t !== this.s) {
              const n = ((e, t) => {
                for (let n, r = 0; (n = Er[r]); ++r) {
                  const r = n[e],
                    i = n[t];
                  if (r >= 0 && i >= 0 && i > r)
                    return Object.keys(n).slice(r, i + 1);
                }
                return [];
              })(this.s, t);
          ...
          return (
            ...
            (r = function* () {
              for (const e of (function (e, t, n, r) {
                ...
                if (null !== t)
                  return (0, Oe.Ff)(t.toLowerCase()).unwrapOr(null);
              }
              return null;
            }),
            new ((n = void 0) || (n = Promise))(function (i, s) {
      ...
      class qr extends Le.Z {
        constructor() {
          ...
          const s = i.get("publicToken"),
            o = i.get("callback") || "onGPInit";
          this.ready.then((e) => {
            var t, n, r, i;
            null === (n = (t = window)[o]) || void 0 === n || n.call(t, e),
              "onGSInit" !== o &&
                (null === (i = (r = window).onGSInit) ||
                  void 0 === i ||
                  i.call(r, e));
          }),
          ...
          var p, v;
          (this._playerService = new h.Z(Dr(this, Ar, "f"))),
            (this._channelsService = new Ie(Dr(this, Ar, "f"))),
            (this._leaderboardsService = new gn(Dr(this, Ar, "f"))),
            (this._projectService = new Oe.ZP(Dr(this, Ar, "f"))),
            (this._achievementsService = new vt.ZP(Dr(this, Ar, "f"))),
            (this._paymentsService = new Ct.ZP(Dr(this, Ar, "f"))),
            (this._gamesCollectionsService = new Mt(Dr(this, Ar, "f"))),
            (this._documentsService = new mn(Dr(this, Ar, "f"))),
            (this._imagesService = new On(Dr(this, Ar, "f"))),
            (this._filesService = new ar(Dr(this, Ar, "f"))),
            Nr(this, xr, new Rr(), "f"),
              ...
              tools: {
                ...
                fetchConfig: (e) =>
                  Fr(this, void 0, void 0, function* () {
                    ...
                    const [t, n, r, i] = yield Promise.all([
                      this._storage.loadLanguage(),
                      this._storage.loadConfig(),
                      this._storage.loadAdsInfo(),
                      Dr(this, xr, "f").getLanguage(),
                    ]);
                    return (
                      t || this._storage.saveLanguage(null),
                      (this.language = i || t || e || u || Oe.Uo.EN),
                      Dr(this, Ar, "f").setLang(this.language),
              ...
              .then((t) =>
                Fr(this, void 0, void 0, function* () {
                  ...
                  Nr(this, jr, l, "f"),
                    ...
                    (this.platform = new Ee(l.platformConfig, o)),
                    (this.ads = new n.Z(this, i, l)),
                    (this.app = new pt(this, u, l)),
                    (this.socials = new ft(c, this)),
                    (this.channels = new nn(this, l)),
                    (this.player = new it({}, l.playerFields, s, this, f)),
                    (this.payments = new $t.Z(this, h)),
                    (this.variables = new Sn(this, l.gameVariables || [])),
                    (this.images = new Xn(this, l.acl)),
                    (this.files = new lr(this, l.acl)),
                    (this.achievements = new mt.Z(
                      this,
                      l.project.achievements
                    )),
                    Nr(this, Lr, Date.parse(l.serverTime), "f"),
                    setInterval(
                      () => Nr(this, Lr, Dr(this, Lr, "f") + 1e3, "f"),
                      1e3
                    ),
                    this.isDev
                      ? ((this.devtools = yield Promise.all([
                        ...
                        l.config.showReqCounter &&
                          Dr(this, Ar, "f").addCounterListener((e) => {
        ...
        changeLanguage(e) {
          return Fr(this, void 0, void 0, function* () {
            if (this.language !== e)
              try {
                if (!Object.values(Oe.Uo).includes(e))
